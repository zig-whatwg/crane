...
pub const DocumentType = struct {
    ...
    pub fn asCharacterData(self: *DocumentType) ?*CharacterData {
    ...
    pub fn asCharacterDataConst(self: *const DocumentType) ?*const CharacterData {
    ...
    pub fn asElement(self: *DocumentType) ?*Element {
        const self_parent: *Node = @ptrCast(self);
    ...
    pub fn asElementConst(self: *const DocumentType) ?*const Element {
        const self_parent: *const Node = @ptrCast(self);
    ...
    pub fn asDocument(self: *DocumentType) ?*Document {
        const self_parent: *Node = @ptrCast(self);
    ...
    pub fn asDocumentConst(self: *const DocumentType) ?*const Document {
        const self_parent: *const Node = @ptrCast(self);
    ...
    pub fn asDocumentFragment(self: *DocumentType) ?*DocumentFragment {
        const self_parent: *Node = @ptrCast(self);
    ...
    pub fn asDocumentFragmentConst(self: *const DocumentType) ?*const DocumentFragment {
        const self_parent: *const Node = @ptrCast(self);
    ...
    pub fn asText(self: *DocumentType) ?*Text {
        const self_parent: *Node = @ptrCast(self);
    ...
    pub fn asTextConst(self: *const DocumentType) ?*const Text {
        const self_parent: *const Node = @ptrCast(self);
    ...
    pub fn asAttr(self: *DocumentType) ?*Attr {
        const self_parent: *Node = @ptrCast(self);
    ...
    pub fn asAttrConst(self: *const DocumentType) ?*const Attr {
        const self_parent: *const Node = @ptrCast(self);
    ...
    pub fn get_parentNode(self: *const DocumentType) ?*Node {
        const self_parent: *const Node = @ptrCast(self);
    ...
    pub fn get_firstChild(self: *const DocumentType) ?*Node {
        const self_parent: *const Node = @ptrCast(self);
    ...
    pub fn get_lastChild(self: *const DocumentType) ?*Node {
        const self_parent: *const Node = @ptrCast(self);
    ...
    pub fn get_previousSibling(self: *const DocumentType) ?*Node {
        const self_parent: *const Node = @ptrCast(self);
    ...
    pub fn get_nextSibling(self: *const DocumentType) ?*Node {
        const self_parent: *const Node = @ptrCast(self);
    ...
    pub fn getRegisteredObservers(self: *DocumentType) *infra.List(RegisteredObserver) {
        const self_parent: *Node = @ptrCast(self);
    ...
    fn ensureEventListenerList(self: *DocumentType) !*infra.List(EventListener) {
