...
pub const ProcessingInstruction = struct {
    ...
    pub const node_type_VALUE = Node.PROCESSING_INSTRUCTION_NODE;
    ...
    ///       // use elem
    ///   }
    pub fn as(self: *ProcessingInstruction, comptime T: type) ?*T {
        comptime {
    ...
    pub fn asConst(self: *const ProcessingInstruction, comptime T: type) ?*const T {
        comptime {
            if (!@hasDecl(T, "node_type_VALUE")) {
                @compileError("Cannot cast to " ++ @typeName(T) ++ ": type must declare 'pub const node_type_VALUE'");
            }
