...
pub const CDATASection = struct {
    ...
    pub fn call_compareDocumentPosition(self: *const CDATASection, other: *const CDATASection) u16 {
        ...
        if (root1 != root2) {
            ...
            const ordering = if (ptr1 < ptr2) CDATASection.DOCUMENT_POSITION_PRECEDING else CDATASection.DOCUMENT_POSITION_FOLLOWING;
            return CDATASection.DOCUMENT_POSITION_DISCONNECTED | CDATASection.DOCUMENT_POSITION_IMPLEMENTATION_SPECIFIC | ordering;
        }

        // Step 7: If node1 is an ancestor of node2
        if (tree.isAncestor(node1, node2)) {
            return CDATASection.DOCUMENT_POSITION_CONTAINS | CDATASection.DOCUMENT_POSITION_PRECEDING;
        }

        // Step 8: If node1 is a descendant of node2
        if (tree.isDescendant(node1, node2)) {
            return CDATASection.DOCUMENT_POSITION_CONTAINED_BY | CDATASection.DOCUMENT_POSITION_FOLLOWING;
        }

        // Step 9: If node1 is preceding node2
        if (tree.isPreceding(node1, node2)) {
            return CDATASection.DOCUMENT_POSITION_PRECEDING;
        }

        // Step 10: Return DOCUMENT_POSITION_FOLLOWING
        return CDATASection.DOCUMENT_POSITION_FOLLOWING;
    }
    ...
    pub fn call_isEqualNode(self: *const CDATASection, other_node: ?*const CDATASection) bool {
        ...
        return CDATASection.nodeEquals(self, other_node.?);
    }
    ...
    pub fn call_cloneNode(self: *CDATASection, deep: bool) !*CDATASection {
        ...
        if (self.node_type == CDATASection.DOCUMENT_FRAGMENT_NODE) {
        ...
        return try CDATASection.cloneNodeInternal(self, self.owner_document, deep, null, null);
    }
    /// normalize()
    ...
    pub fn get_textContent(self: *const CDATASection) !?[]const u8 {
        ...
        return CDATASection.getTextContent(self, self.allocator);
    }
    pub fn set_textContent(self: *CDATASection, value: ?[]const u8) !void {
        ...
        const str_value = value orelse "";
        try CDATASection.setTextContent(self, str_value);
    }
