...
const WritableStreamDefaultController = @import("writableStream_default_controller").WritableStreamDefaultController;
...
/// WritableStream WebIDL interface
/// 
/// IDL:
/// ```webidl
...
pub const WritableStream = struct {
    ...
    pub fn deinit(self: *WritableStream) void {
        ...
        // Note: writeRequests promises are owned by callers, just clear the list
    ...
    pub fn addWriteRequest(self: *WritableStream, loop: eventLoop.EventLoop) !*AsyncPromise(void) {
        ...
        try self.writeRequests.append(self.allocator, promise);
    ...
    pub fn closeQueuedOrInFlight(self: *const WritableStream) bool {
        ...
        // Step 2: Return true.
        return self.closeRequest != null or self.in_flight_closeRequest != null;
    }
    ...
    fn closeInternal(self: *WritableStream) common.Promise(void) {
        ...
        self.closeRequest = common.Promise(void).pending();
    ...
    pub fn hasOperationMarkedInFlight(self: *const WritableStream) bool {
        ...
        // stream.[[inFlightCloseRequest]] is undefined, return false.
        // Step 2: Return true.
        return self.inFlightWriteRequest != null or self.in_flight_closeRequest != null;
    }
    ...
    pub fn markFirstWriteRequestInFlight(self: *WritableStream) void {
        ...
        if (self.writeRequests.items.len > 0) {
            ...
            self.inFlightWriteRequest = common.Promise(void).pending();
    ...
    pub fn markCloseRequestInFlight(self: *WritableStream) void {
        ...
        if (self.closeRequest) |close_req| {
            self.in_flight_closeRequest = close_req;
    ...
    pub fn finishInFlightWrite(self: *WritableStream) void {
        ...
        self.inFlightWriteRequest = null;
    }
    ...
    pub fn finishInFlightClose(self: *WritableStream) void {
        ...
        self.in_flight_closeRequest = null;
        ...
        if (state == .erroring) {
            ...
            self.storedError = null;

            // Step 6.2: If stream.[[pendingAbortRequest]] is not undefined,
            if (self.pendingAbortRequest) |abort_req| {
    ...
    pub fn finishErroring(self: *WritableStream) void {
        ...
        const storedError = self.storedError orelse common.JSValue{ .string = "Stream errored" };
        ...
        while (self.writeRequests.items.len > 0) {
            ...
            write_request.reject(storedError);
        ...
        if (self.pendingAbortRequest) |abort_req| {
            ...
            if (abort_req.wasAlreadyErroring) {
    ...
    fn startErroring(self: *WritableStream, reason: common.JSValue) void {
        ...
        switch (self.writer) {
            .default => |writer| {
                if (writer.readyPromise) |promise| {
    ...
    fn rejectCloseAndClosedPromiseIfNeeded(self: *WritableStream) void {
        ...
        switch (self.writer) {
            .default => |writer| {
                ...
                const error_value = self.storedError orelse common.JSValue{ .string = "Stream errored" };
                writer.closedPromise.reject(error_value);
