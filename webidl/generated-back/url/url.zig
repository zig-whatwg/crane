...
//! WebIDL URL Interface (WebIDL Source)
//!
//! WHATWG URL Standard: https://url.spec.whatwg.org/#url-class
//! WebIDL: specs/url.idl lines 4-26
//!
//! This file will be processed by webidl-codegen to generate src/url.zig
...
pub const URL = struct {
    ...
    internal: URLRecord,
    searchParamsPtr: *URLSearchParams,
    ...
    pub fn deinit(self: *URL) void {
        ...
        self.searchParamsPtr.deinit();
        self.allocator.destroy(self.searchParamsPtr);
    }
    ...
    fn setHrefUtf8(self: *URL, href_utf8: []const u8) !void {
        ...
        try self.searchParamsPtr.updateFromString(query_str);
    }
    /// static URL? parse(USVString url, optional USVString base)
    ...
    pub fn set_search(self: *URL, search: webidl.USVString) !void {
        ...
        if (input.len == 0) {
            ...
            try self.searchParamsPtr.updateFromString("");
            return;
        }
        ...
        try self.searchParamsPtr.updateFromString(new_query);
    }
    /// [SameObject] readonly attribute URLSearchParams searchParams
    pub fn get_searchParams(self: *const URL) *URLSearchParams {
        return self.searchParamsPtr;
    }
    /// attribute USVString hash
