...
test "clear - empty console (no-op)" {
    ...
    var console = try console_mod.console.console.init(allocator);
...
test "clear - with full message buffer" {
    ...
    var console = try console_mod.console.console.initWithBufferSize(allocator, 5);
    defer console.deinit();
...
test "clear - preserves console configuration" {
    const allocator = testing.allocator;
    var console = try console_mod.console.console.initWithBufferSize(allocator, 100);
    defer console.deinit();
