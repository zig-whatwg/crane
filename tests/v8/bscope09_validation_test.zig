...
test "BSCOPE-09: implemented contexts are window and dedicated_worker" {
    // Per BSCOPE-09 design, only window and dedicated_worker are fully implemented
    ...
    try testing.expectEqual(@as(usize, 2), implemented_count);
}
