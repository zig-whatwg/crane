...
/// ReadableStreamBYOBRequest zoop class
/// 
/// IDL:
/// ```webidl
/// [Exposed=*]
...
pub const ReadableStreamBYOBRequest = struct {
    ...
    /// 
    /// Spec algorithm: § 4.8.3 "The view getter steps are:"
    ...
    /// 
    /// Spec algorithm: § 4.8.3 "The respond(bytesWritten) method steps are:"
    pub fn call_respond(self: *ReadableStreamBYOBRequest, bytes_written: u64) !void {
    ...
    /// 
    /// Spec algorithm: § 4.8.3 "The respondWithNewView(view) method steps are:"
    ...
    fn respondInternal(self: *ReadableStreamBYOBRequest, bytes_written: u64) !void {
        _ = self;
        _ = bytes_written;
