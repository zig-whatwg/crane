...
pub fn parseHost(
    ...
    // Per URL Standard § 3.3 step 3: "domain to ASCII with domain and false"
    // be_strict=false means UseSTD3ASCIIRules=false, allowing non-LDH chars like !"$&'()*+, etc.
    // This enables domains like "http://!"$&'()*+,-.;=_`{}~/" to parse successfully
