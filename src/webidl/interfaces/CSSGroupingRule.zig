...
pub const CSSGroupingRule = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        return CSSGroupingRuleImpl.init(allocator, State, &vtable);
    }
