...
pub const OverconstrainedError = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        return OverconstrainedErrorImpl.init(allocator, State, &vtable);
    }
    ...
    /// WebIDL constructor
    pub fn call_constructor(allocator: std.mem.Allocator, constraint: DOMString, message: DOMString) !*runtime.Instance {
        const instance = try init(allocator);
        errdefer deinit(instance);
        
        try OverconstrainedErrorImpl.constructor(instance, constraint, message);
        
        return instance;
    }

    pub fn get_name(instance: *runtime.Instance) anyerror!DOMString {
        return try OverconstrainedErrorImpl.get_name(instance);
    }

    pub fn get_message(instance: *runtime.Instance) anyerror!DOMString {
        return try OverconstrainedErrorImpl.get_message(instance);
    }

    pub fn get_code(instance: *runtime.Instance) anyerror!u16 {
        return try OverconstrainedErrorImpl.get_code(instance);
    }
