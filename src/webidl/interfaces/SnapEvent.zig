...
pub const SnapEvent = struct {
    ...
    pub fn initWithState(
        ...
        return SnapEventImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, @"type": DOMString, eventInitDict: webidl.Opt(SnapEventInit)) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try SnapEventImpl.call_constructor(ctx, @"type", eventInitDict);
    }
