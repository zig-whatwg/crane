...
pub const PaymentRequestUpdateEvent = struct {
    ...
    pub fn initWithState(
        ...
        return PaymentRequestUpdateEventImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, @"type": DOMString, eventInitDict: webidl.Opt(PaymentRequestUpdateEventInit)) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try PaymentRequestUpdateEventImpl.call_constructor(ctx, @"type", eventInitDict);
    }

    pub fn call_updateWith(instance: *runtime.Instance, detailsPromise: runtime.JSValue) anyerror!void {
