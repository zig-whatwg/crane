...
pub const CSSPositionTryDescriptors = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        struct {
            ...
            marginBlock: typedefs.CSSOMString = undefined,
            marginBlockStart: typedefs.CSSOMString = undefined,
            marginBlockEnd: typedefs.CSSOMString = undefined,
            marginInline: typedefs.CSSOMString = undefined,
            marginInlineStart: typedefs.CSSOMString = undefined,
            marginInlineEnd: typedefs.CSSOMString = undefined,
            ...
            @"margin-block": typedefs.CSSOMString = undefined,
            @"margin-block-start": typedefs.CSSOMString = undefined,
            @"margin-block-end": typedefs.CSSOMString = undefined,
            @"margin-inline": typedefs.CSSOMString = undefined,
            @"margin-inline-start": typedefs.CSSOMString = undefined,
            @"margin-inline-end": typedefs.CSSOMString = undefined,
            inset: typedefs.CSSOMString = undefined,
            insetBlock: typedefs.CSSOMString = undefined,
            insetBlockStart: typedefs.CSSOMString = undefined,
            insetBlockEnd: typedefs.CSSOMString = undefined,
            insetInline: typedefs.CSSOMString = undefined,
            insetInlineStart: typedefs.CSSOMString = undefined,
            insetInlineEnd: typedefs.CSSOMString = undefined,
            top: typedefs.CSSOMString = undefined,
            left: typedefs.CSSOMString = undefined,
            right: typedefs.CSSOMString = undefined,
            bottom: typedefs.CSSOMString = undefined,
            @"inset-block": typedefs.CSSOMString = undefined,
            @"inset-block-start": typedefs.CSSOMString = undefined,
            @"inset-block-end": typedefs.CSSOMString = undefined,
            @"inset-inline": typedefs.CSSOMString = undefined,
            @"inset-inline-start": typedefs.CSSOMString = undefined,
            @"inset-inline-end": typedefs.CSSOMString = undefined,
            width: typedefs.CSSOMString = undefined,
            minWidth: typedefs.CSSOMString = undefined,
            maxWidth: typedefs.CSSOMString = undefined,
            height: typedefs.CSSOMString = undefined,
            minHeight: typedefs.CSSOMString = undefined,
            maxHeight: typedefs.CSSOMString = undefined,
            blockSize: typedefs.CSSOMString = undefined,
            minBlockSize: typedefs.CSSOMString = undefined,
            maxBlockSize: typedefs.CSSOMString = undefined,
            inlineSize: typedefs.CSSOMString = undefined,
            minInlineSize: typedefs.CSSOMString = undefined,
            maxInlineSize: typedefs.CSSOMString = undefined,
            @"min-width": typedefs.CSSOMString = undefined,
            @"max-width": typedefs.CSSOMString = undefined,
            @"min-height": typedefs.CSSOMString = undefined,
            @"max-height": typedefs.CSSOMString = undefined,
            @"block-size": typedefs.CSSOMString = undefined,
            @"min-block-size": typedefs.CSSOMString = undefined,
            @"max-block-size": typedefs.CSSOMString = undefined,
            @"inline-size": typedefs.CSSOMString = undefined,
            @"min-inline-size": typedefs.CSSOMString = undefined,
            @"max-inline-size": typedefs.CSSOMString = undefined,
            placeSelf: typedefs.CSSOMString = undefined,
            alignSelf: typedefs.CSSOMString = undefined,
            justifySelf: typedefs.CSSOMString = undefined,
            @"place-self": typedefs.CSSOMString = undefined,
            @"align-self": typedefs.CSSOMString = undefined,
            @"justify-self": typedefs.CSSOMString = undefined,
            positionAnchor: typedefs.CSSOMString = undefined,
            @"position-anchor": typedefs.CSSOMString = undefined,
            positionArea: typedefs.CSSOMString = undefined,
            @"position-area": typedefs.CSSOMString = undefined,
    ...
    pub fn initWithState(
        ...
        return CSSPositionTryDescriptorsImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
