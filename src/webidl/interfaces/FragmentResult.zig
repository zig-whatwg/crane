...
pub const FragmentResult = struct {
    ...
    pub fn initWithState(
        ...
        return FragmentResultImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, options: webidl.Opt(FragmentResultOptions)) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try FragmentResultImpl.call_constructor(ctx, options);
    }
