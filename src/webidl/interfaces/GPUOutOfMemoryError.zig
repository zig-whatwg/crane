...
pub const GPUOutOfMemoryError = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        Meta.MixinTypes,
        struct {
            _internal: ?*GPUOutOfMemoryErrorImpl.InternalState = null,
        },
    );
    ...
    pub fn initWithState(
        ...
        return GPUOutOfMemoryErrorImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, message: DOMString) !*runtime.Instance {
        ...
        return try GPUOutOfMemoryErrorImpl.call_constructor(ctx, message);
    }
