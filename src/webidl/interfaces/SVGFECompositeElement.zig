...
const SVGFECompositeElementImpl = @import("impls").SVGFECompositeElement;
...
pub const SVGFECompositeElement = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        struct {
            ...
            operator: *runtime.Instance = undefined,
            k1: *runtime.Instance = undefined,
            k2: *runtime.Instance = undefined,
            k3: *runtime.Instance = undefined,
            k4: *runtime.Instance = undefined,
            ...
            _internal: ?*SVGFECompositeElementImpl.InternalState = null,
        },
    );
    ...
    /// WebIDL constant: const unsigned short SVG_FECOMPOSITE_OPERATOR_UNKNOWN = 0;
    pub fn get_SVG_FECOMPOSITE_OPERATOR_UNKNOWN() u16 {
        return 0;
    }

    /// WebIDL constant: const unsigned short SVG_FECOMPOSITE_OPERATOR_OVER = 1;
    pub fn get_SVG_FECOMPOSITE_OPERATOR_OVER() u16 {
        return 1;
    }

    /// WebIDL constant: const unsigned short SVG_FECOMPOSITE_OPERATOR_IN = 2;
    pub fn get_SVG_FECOMPOSITE_OPERATOR_IN() u16 {
        return 2;
    }

    /// WebIDL constant: const unsigned short SVG_FECOMPOSITE_OPERATOR_OUT = 3;
    pub fn get_SVG_FECOMPOSITE_OPERATOR_OUT() u16 {
        return 3;
    }

    /// WebIDL constant: const unsigned short SVG_FECOMPOSITE_OPERATOR_ATOP = 4;
    pub fn get_SVG_FECOMPOSITE_OPERATOR_ATOP() u16 {
        return 4;
    }

    /// WebIDL constant: const unsigned short SVG_FECOMPOSITE_OPERATOR_XOR = 5;
    pub fn get_SVG_FECOMPOSITE_OPERATOR_XOR() u16 {
        return 5;
    }

    /// WebIDL constant: const unsigned short SVG_FECOMPOSITE_OPERATOR_ARITHMETIC = 6;
    pub fn get_SVG_FECOMPOSITE_OPERATOR_ARITHMETIC() u16 {
        return 6;
    }
    ...
    const delegates = .{
        ...
        .get_SVG_FECOMPOSITE_OPERATOR_OUT = &get_SVG_FECOMPOSITE_OPERATOR_OUT,
        .get_SVG_FECOMPOSITE_OPERATOR_OVER = &get_SVG_FECOMPOSITE_OPERATOR_OVER,
        .get_SVG_FECOMPOSITE_OPERATOR_UNKNOWN = &get_SVG_FECOMPOSITE_OPERATOR_UNKNOWN,
        .get_SVG_FECOMPOSITE_OPERATOR_XOR = &get_SVG_FECOMPOSITE_OPERATOR_XOR,
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return SVGFECompositeElementImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return SVGFECompositeElementImpl.init(allocator, StateType, vtable_ptr, ctx);
    }

    /// Clean up instance resources
    pub fn deinit(instance: *runtime.Instance) void {
        SVGFECompositeElementImpl.deinit(instance);
    }

    pub fn get_in1(instance: *runtime.Instance) anyerror!*runtime.Instance {
        return try SVGFECompositeElementImpl.get_in1(instance);
    }

    pub fn get_in2(instance: *runtime.Instance) anyerror!*runtime.Instance {
        return try SVGFECompositeElementImpl.get_in2(instance);
    }

    pub fn get_operator(instance: *runtime.Instance) anyerror!*runtime.Instance {
        return try SVGFECompositeElementImpl.get_operator(instance);
    }

    pub fn get_k1(instance: *runtime.Instance) anyerror!*runtime.Instance {
        return try SVGFECompositeElementImpl.get_k1(instance);
    }

    pub fn get_k2(instance: *runtime.Instance) anyerror!*runtime.Instance {
        return try SVGFECompositeElementImpl.get_k2(instance);
    }

    pub fn get_k3(instance: *runtime.Instance) anyerror!*runtime.Instance {
        return try SVGFECompositeElementImpl.get_k3(instance);
    }

    pub fn get_k4(instance: *runtime.Instance) anyerror!*runtime.Instance {
        return try SVGFECompositeElementImpl.get_k4(instance);
    }

    pub fn get_x(instance: *runtime.Instance) anyerror!*runtime.Instance {
        return try SVGFECompositeElementImpl.get_x(instance);
    }

    pub fn get_y(instance: *runtime.Instance) anyerror!*runtime.Instance {
        return try SVGFECompositeElementImpl.get_y(instance);
    }

    pub fn get_width(instance: *runtime.Instance) anyerror!*runtime.Instance {
        return try SVGFECompositeElementImpl.get_width(instance);
    }

    pub fn get_height(instance: *runtime.Instance) anyerror!*runtime.Instance {
        return try SVGFECompositeElementImpl.get_height(instance);
    }
