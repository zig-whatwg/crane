...
pub const PageRevealEvent = struct {
    ...
    pub fn initWithState(
        ...
        return PageRevealEventImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, @"type": DOMString, eventInitDict: webidl.Opt(PageRevealEventInit)) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try PageRevealEventImpl.call_constructor(ctx, @"type", eventInitDict);
    }
