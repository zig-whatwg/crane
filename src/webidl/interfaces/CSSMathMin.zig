...
pub const CSSMathMin = struct {
    ...
    pub const vtable = runtime.buildVTable(CSSMathMin, .{
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        CSSMathMinImpl.deinit(instance);
    }
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, args: CSSNumberish) !*runtime.Instance {
        ...
        try CSSMathMinImpl.constructor(instance, args);
        
        return instance;
    }

    pub fn get_operator(instance: *runtime.Instance) anyerror!CSSMathOperator {
        return try CSSMathMinImpl.get_operator(instance);
    }
    ...
    pub fn call_parse(instance: *runtime.Instance, args: ParseArgs) anyerror!CSSStyleValue {
        switch (args) {
            .USVString_USVString => |a| return try CSSMathMinImpl.USVString_USVString(instance, a.property, a.cssText),
            .USVString => |arg| return try CSSMathMinImpl.USVString(instance, arg),
        }
    }

    pub fn call_type(instance: *runtime.Instance) anyerror!CSSNumericType {
        return try CSSMathMinImpl.call_type(instance);
    }
