...
pub const GamepadHapticActuator = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        return GamepadHapticActuatorImpl.init(allocator, State, &vtable);
    }
    ...
    pub fn call_playEffect(instance: *runtime.Instance, @"type": GamepadHapticEffectType, params: GamepadEffectParameters) anyerror!anyopaque {
