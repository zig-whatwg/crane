...
pub const SmartCardError = struct {
    ...
    /// WebIDL constructor
    pub fn call_constructor(allocator: std.mem.Allocator, message: DOMString, options: SmartCardErrorOptions) !*runtime.Instance {
        const instance = try init(allocator);
        errdefer deinit(instance);
        
        try SmartCardErrorImpl.constructor(instance, message, options);
        
        return instance;
    }

    pub fn get_name(instance: *runtime.Instance) anyerror!DOMString {
        return try SmartCardErrorImpl.get_name(instance);
    }

    pub fn get_message(instance: *runtime.Instance) anyerror!DOMString {
        return try SmartCardErrorImpl.get_message(instance);
    }

    pub fn get_code(instance: *runtime.Instance) anyerror!u16 {
        return try SmartCardErrorImpl.get_code(instance);
    }
