...
pub const WindowControlsOverlayGeometryChangeEvent = struct {
    ...
    pub fn initWithState(
        ...
        return WindowControlsOverlayGeometryChangeEventImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, @"type": DOMString, eventInitDict: WindowControlsOverlayGeometryChangeEventInit) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try WindowControlsOverlayGeometryChangeEventImpl.call_constructor(ctx, @"type", eventInitDict);
    }
