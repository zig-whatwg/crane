...
pub const CustomEvent = struct {
    ...
    /// WebIDL constructor
    pub fn call_constructor(allocator: std.mem.Allocator, type_: DOMString, eventInitDict: CustomEventInit) !*runtime.Instance {
        const instance = try init(allocator);
        errdefer deinit(instance);
        
        try CustomEventImpl.constructor(instance, type_, eventInitDict);
    ...
    pub fn call_initEvent(instance: *runtime.Instance, type_: DOMString, bubbles: bool, cancelable: bool) anyerror!void {
        ...
        return try CustomEventImpl.call_initEvent(instance, type_, bubbles, cancelable);
    }

    pub fn call_initCustomEvent(instance: *runtime.Instance, type_: DOMString, bubbles: bool, cancelable: bool, detail: anyopaque) anyerror!void {
        
        return try CustomEventImpl.call_initCustomEvent(instance, type_, bubbles, cancelable, detail);
    }
