...
pub const StereoPannerNode = struct {
    ...
    pub fn initWithState(
        ...
        return StereoPannerNodeImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, context: *runtime.Instance, options: webidl.Opt(StereoPannerOptions)) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try StereoPannerNodeImpl.call_constructor(ctx, context, options);
    }
