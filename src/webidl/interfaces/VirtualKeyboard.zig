...
pub const VirtualKeyboard = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        return VirtualKeyboardImpl.init(allocator, State, &vtable);
    }
    ...
    pub fn call_dispatchEvent(instance: *runtime.Instance, event: Event) anyerror!bool {
        ...
        return try VirtualKeyboardImpl.call_dispatchEvent(instance, event);
    }

    pub fn call_when(instance: *runtime.Instance, @"type": DOMString, options: ObservableEventListenerOptions) anyerror!Observable {
        
        return try VirtualKeyboardImpl.call_when(instance, @"type", options);
    }
    ...
    pub fn call_addEventListener(instance: *runtime.Instance, @"type": DOMString, callback: EventListener, options: anyopaque) anyerror!void {
        ...
        return try VirtualKeyboardImpl.call_addEventListener(instance, @"type", callback, options);
    }

    pub fn call_removeEventListener(instance: *runtime.Instance, @"type": DOMString, callback: EventListener, options: anyopaque) anyerror!void {
        
        return try VirtualKeyboardImpl.call_removeEventListener(instance, @"type", callback, options);
    }
