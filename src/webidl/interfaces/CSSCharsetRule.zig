...
pub const CSSCharsetRule = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        return CSSCharsetRuleImpl.init(allocator, State, &vtable);
    }
