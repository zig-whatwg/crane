...
const SVGTextPositioningElement = @import("SVGTextPositioningElement.zig").SVGTextPositioningElement;
...
pub const SVGTSpanElement = struct {
    pub const Meta = struct {
        ...
        pub const BaseType = SVGTextPositioningElement.State;
        pub const ParentInterface = SVGTextPositioningElement;
    ...
    pub const State = runtime.FlattenedState(
        ...
        Meta.MixinTypes,
        struct {
            _internal: ?*SVGTSpanElementImpl.InternalState = null,
        },
    );
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return SVGTSpanElementImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return SVGTSpanElementImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
