...
pub const CSSColorProfileRule = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        return CSSColorProfileRuleImpl.init(allocator, State, &vtable);
    }
    ...
    pub fn get_cssText(instance: *runtime.Instance) anyerror!anyopaque {
        return try CSSColorProfileRuleImpl.get_cssText(instance);
    }

    pub fn set_cssText(instance: *runtime.Instance, value: anyopaque) anyerror!void {
        try CSSColorProfileRuleImpl.set_cssText(instance, value);
    }

    pub fn get_parentRule(instance: *runtime.Instance) anyerror!CSSRule {
        return try CSSColorProfileRuleImpl.get_parentRule(instance);
    }

    pub fn get_parentStyleSheet(instance: *runtime.Instance) anyerror!CSSStyleSheet {
        return try CSSColorProfileRuleImpl.get_parentStyleSheet(instance);
    }

    pub fn get_type(instance: *runtime.Instance) anyerror!u16 {
        return try CSSColorProfileRuleImpl.get_type(instance);
    }
    ...
    pub fn get_renderingIntent(instance: *runtime.Instance) anyerror!anyopaque {
        return try CSSColorProfileRuleImpl.get_renderingIntent(instance);
    }

    pub fn get_components(instance: *runtime.Instance) anyerror!anyopaque {
