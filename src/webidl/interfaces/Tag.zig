...
pub const Tag = struct {
    ...
    pub fn initWithState(
        ...
        return TagImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, @"type": TagType) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try TagImpl.call_constructor(ctx, @"type");
    }
