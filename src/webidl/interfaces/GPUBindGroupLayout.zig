...
pub const GPUBindGroupLayout = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        struct {
            ...
            _internal: ?*GPUBindGroupLayoutImpl.InternalState = null,
        },
    );
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return GPUBindGroupLayoutImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return GPUBindGroupLayoutImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
