...
const SpeechRecognitionResult = @import("SpeechRecognitionResult.zig").SpeechRecognitionResult;
...
pub const SpeechRecognitionResultList = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        struct {
            ...
            _internal: ?*SpeechRecognitionResultListImpl.InternalState = null,
        },
    );
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return SpeechRecognitionResultListImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return SpeechRecognitionResultListImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
