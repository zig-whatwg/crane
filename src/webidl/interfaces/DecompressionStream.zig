...
pub const DecompressionStream = struct {
    ...
    pub fn initWithState(
        ...
        return DecompressionStreamImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, format: CompressionFormat) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try DecompressionStreamImpl.call_constructor(ctx, format);
    }
