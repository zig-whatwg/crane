...
pub const MediaStreamTrackEvent = struct {
    ...
    pub fn initWithState(
        ...
        return MediaStreamTrackEventImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, @"type": DOMString, eventInitDict: MediaStreamTrackEventInit) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try MediaStreamTrackEventImpl.call_constructor(ctx, @"type", eventInitDict);
    }
