...
const ContentIndex = @import("ContentIndex.zig").ContentIndex;
const USVString = @import("typedefs").USVString;
const CookieStoreManager = @import("CookieStoreManager.zig").CookieStoreManager;
...
const SyncManager = @import("SyncManager.zig").SyncManager;
const ServiceWorker = @import("ServiceWorker.zig").ServiceWorker;
const AddEventListenerOptions = @import("dictionaries").AddEventListenerOptions;
const PeriodicSyncManager = @import("PeriodicSyncManager.zig").PeriodicSyncManager;
...
const BackgroundFetchManager = @import("BackgroundFetchManager.zig").BackgroundFetchManager;
const NavigationPreloadManager = @import("NavigationPreloadManager.zig").NavigationPreloadManager;
const PaymentManager = @import("PaymentManager.zig").PaymentManager;
