...
pub const HTMLTrackElement = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        struct {
            ...
            srclang: typedefs.DOMString = undefined,
    ...
    pub fn initWithState(
        ...
        return HTMLTrackElementImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context) !*runtime.Instance {
        ...
        return try HTMLTrackElementImpl.call_constructor(ctx);
    }
