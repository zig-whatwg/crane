...
pub const XRSessionEvent = struct {
    ...
    pub fn initWithState(
        ...
        return XRSessionEventImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, @"type": DOMString, eventInitDict: XRSessionEventInit) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try XRSessionEventImpl.call_constructor(ctx, @"type", eventInitDict);
    }
