...
pub const WebGLRenderingContextOverloads = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        Meta.MixinTypes,
        struct {
            _internal: ?*WebGLRenderingContextOverloadsImpl.InternalState = null,
        },
    );
    ...
    pub fn initWithState(
        ...
        return WebGLRenderingContextOverloadsImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_texSubImage2D__1(instance: *runtime.Instance, target: GLenum, level: GLint, xoffset: GLint, yoffset: GLint, format: GLenum, @"type": GLenum, source: TexImageSource) anyerror!void {
        if (comptime @hasDecl(WebGLRenderingContextOverloadsImpl, "call_texSubImage2D__1")) {
            return try WebGLRenderingContextOverloadsImpl.call_texSubImage2D__1(instance, target, level, xoffset, yoffset, format, @"type", source);
        } else {
    ...
    pub fn call_texImage2D__1(instance: *runtime.Instance, target: GLenum, level: GLint, internalformat: GLint, format: GLenum, @"type": GLenum, source: TexImageSource) anyerror!void {
        if (comptime @hasDecl(WebGLRenderingContextOverloadsImpl, "call_texImage2D__1")) {
            return try WebGLRenderingContextOverloadsImpl.call_texImage2D__1(instance, target, level, internalformat, format, @"type", source);
        } else {
            return error.NotImplemented;
        }
    }
    ...
    pub fn call_bufferData__1(instance: *runtime.Instance, target: GLenum, data: ?AllowSharedBufferSource, usage: GLenum) anyerror!void {
        if (comptime @hasDecl(WebGLRenderingContextOverloadsImpl, "call_bufferData__1")) {
            return try WebGLRenderingContextOverloadsImpl.call_bufferData__1(instance, target, data, usage);
        } else {
            return error.NotImplemented;
        }
    }
    ...
    pub const overloads = .{
        .{ "texSubImage2D", &[_]webidl.overload_resolution.Overload{
            ...
            .{ .function = "call_texSubImage2D__1", .implemented = @hasDecl(WebGLRenderingContextOverloadsImpl, "call_texSubImage2D__1"), .args = &.{ .{ .kinds = &.{.other} }, .{ .kinds = &.{.other} }, .{ .kinds = &.{.other} }, .{ .kinds = &.{.other} }, .{ .kinds = &.{.other} }, .{ .kinds = &.{.other} }, .{ .kinds = &.{.other} } } },
        } },
        .{ "texImage2D", &[_]webidl.overload_resolution.Overload{
            ...
            .{ .function = "call_texImage2D__1", .implemented = @hasDecl(WebGLRenderingContextOverloadsImpl, "call_texImage2D__1"), .args = &.{ .{ .kinds = &.{.other} }, .{ .kinds = &.{.other} }, .{ .kinds = &.{.other} }, .{ .kinds = &.{.other} }, .{ .kinds = &.{.other} }, .{ .kinds = &.{.other} } } },
        } },
        .{ "bufferData", &[_]webidl.overload_resolution.Overload{
            .{ .function = "call_bufferData", .args = &.{ .{ .kinds = &.{.other} }, .{ .kinds = &.{.other} }, .{ .kinds = &.{.other} } } },
            .{ .function = "call_bufferData__1", .implemented = @hasDecl(WebGLRenderingContextOverloadsImpl, "call_bufferData__1"), .args = &.{ .{ .kinds = &.{.other} }, .{ .kinds = &.{ .array_buffer, .{ .typed_array = "Int8Array" }, .{ .typed_array = "Int16Array" }, .{ .typed_array = "Int32Array" }, .{ .typed_array = "Uint8Array" }, .{ .typed_array = "Uint16Array" }, .{ .typed_array = "Uint32Array" }, .{ .typed_array = "Uint8ClampedArray" }, .{ .typed_array = "BigInt64Array" }, .{ .typed_array = "BigUint64Array" }, .{ .typed_array = "Float16Array" }, .{ .typed_array = "Float32Array" }, .{ .typed_array = "Float64Array" }, .data_view }, .nullable = true }, .{ .kinds = &.{.other} } } },
        } },
    };
};
