...
pub const GPUSupportedLimits = struct {
    pub const Meta = struct {
        ...
        pub const properties = .{
            .{ "maxTextureDimension1D", "get_maxTextureDimension1D", null },
            .{ "maxTextureDimension2D", "get_maxTextureDimension2D", null },
            .{ "maxTextureDimension3D", "get_maxTextureDimension3D", null },
            .{ "maxTextureArrayLayers", "get_maxTextureArrayLayers", null },
            .{ "maxBindGroups", "get_maxBindGroups", null },
            .{ "maxBindGroupsPlusVertexBuffers", "get_maxBindGroupsPlusVertexBuffers", null },
            .{ "maxBindingsPerBindGroup", "get_maxBindingsPerBindGroup", null },
            .{ "maxDynamicUniformBuffersPerPipelineLayout", "get_maxDynamicUniformBuffersPerPipelineLayout", null },
            .{ "maxDynamicStorageBuffersPerPipelineLayout", "get_maxDynamicStorageBuffersPerPipelineLayout", null },
            ...
            .{ "minUniformBufferOffsetAlignment", "get_minUniformBufferOffsetAlignment", null },
            .{ "minStorageBufferOffsetAlignment", "get_minStorageBufferOffsetAlignment", null },
            .{ "maxVertexBuffers", "get_maxVertexBuffers", null },
            .{ "maxBufferSize", "get_maxBufferSize", null },
            .{ "maxVertexAttributes", "get_maxVertexAttributes", null },
            .{ "maxVertexBufferArrayStride", "get_maxVertexBufferArrayStride", null },
            .{ "maxInterStageShaderVariables", "get_maxInterStageShaderVariables", null },
            .{ "maxColorAttachments", "get_maxColorAttachments", null },
            .{ "maxColorAttachmentBytesPerSample", "get_maxColorAttachmentBytesPerSample", null },
            .{ "maxComputeWorkgroupStorageSize", "get_maxComputeWorkgroupStorageSize", null },
            .{ "maxComputeInvocationsPerWorkgroup", "get_maxComputeInvocationsPerWorkgroup", null },
            .{ "maxComputeWorkgroupSizeX", "get_maxComputeWorkgroupSizeX", null },
            .{ "maxComputeWorkgroupSizeY", "get_maxComputeWorkgroupSizeY", null },
            .{ "maxComputeWorkgroupSizeZ", "get_maxComputeWorkgroupSizeZ", null },
            .{ "maxComputeWorkgroupsPerDimension", "get_maxComputeWorkgroupsPerDimension", null },
        };
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return GPUSupportedLimitsImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return GPUSupportedLimitsImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
