...
pub const XRBoundedReferenceSpace = struct {
    pub const Meta = struct {
        ...
        pub const BaseType = XRReferenceSpace.State;
        pub const ParentInterface = XRReferenceSpace;
    ...
    pub fn initWithState(
        ...
        return XRBoundedReferenceSpaceImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
