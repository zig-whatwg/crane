...
pub const ClipboardEvent = struct {
    pub const Meta = struct {
        ...
        pub const properties = .{
            .{ "clipboardData", "get_clipboardData", null },
        };
    ...
    pub const State = runtime.FlattenedState(
        ...
        struct {
            ...
            _internal: ?*ClipboardEventImpl.InternalState = null,
        },
    );
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return ClipboardEventImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return ClipboardEventImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, @"type": DOMString, eventInitDict: webidl.Opt(ClipboardEventInit)) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try ClipboardEventImpl.call_constructor(ctx, @"type", eventInitDict);
    }
