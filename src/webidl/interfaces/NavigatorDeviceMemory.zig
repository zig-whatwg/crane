...
pub const NavigatorDeviceMemory = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        struct {
            ...
            _internal: ?*NavigatorDeviceMemoryImpl.InternalState = null,
        },
    );
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return NavigatorDeviceMemoryImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return NavigatorDeviceMemoryImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
