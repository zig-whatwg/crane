...
const SVGFilterElementImpl = @import("impls").SVGFilterElement;
...
pub const SVGFilterElement = struct {
    pub const Meta = struct {
        pub const name = "SVGFilterElement";
        ...
        pub const properties = .{
            ...
            .{ "primitiveUnits", "get_primitiveUnits", null },
            .{ "x", "get_x", null },
            .{ "y", "get_y", null },
    ...
    pub const State = runtime.FlattenedState(
        ...
        Meta.MixinTypes,
        struct {
            filterUnits: *runtime.Instance = undefined,
            primitiveUnits: *runtime.Instance = undefined,
            ...
            _internal: ?*SVGFilterElementImpl.InternalState = null,
        },
    );
    ...
    const delegates = .{
        ...
        .get_href = &get_href,
        .get_primitiveUnits = &get_primitiveUnits,
        .get_width = &get_width,
        .get_x = &get_x,
        .get_y = &get_y,
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return SVGFilterElementImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return SVGFilterElementImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn get_primitiveUnits(instance: *runtime.Instance) anyerror!*runtime.Instance {
        return try SVGFilterElementImpl.get_primitiveUnits(instance);
    }

    pub fn get_x(instance: *runtime.Instance) anyerror!*runtime.Instance {
        return try SVGFilterElementImpl.get_x(instance);
    }

    pub fn get_y(instance: *runtime.Instance) anyerror!*runtime.Instance {
        return try SVGFilterElementImpl.get_y(instance);
    }

    pub fn get_width(instance: *runtime.Instance) anyerror!*runtime.Instance {
        return try SVGFilterElementImpl.get_width(instance);
    }

    pub fn get_height(instance: *runtime.Instance) anyerror!*runtime.Instance {
        return try SVGFilterElementImpl.get_height(instance);
    }
    ...
    pub fn get_href(instance: *runtime.Instance) anyerror!*runtime.Instance {
        ...
        const value = try SVGFilterElementImpl.get_href(instance);
