...
pub const CSSScopeRule = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        return CSSScopeRuleImpl.init(allocator, State, &vtable);
    }
    ...
    pub fn get_cssRules(instance: *runtime.Instance) anyerror!CSSRuleList {
        ...
        const value = try CSSScopeRuleImpl.get_cssRules(instance);
        state.cached_cssRules = value;
        return value;
    }

    pub fn get_start(instance: *runtime.Instance) anyerror!anyopaque {
        return try CSSScopeRuleImpl.get_start(instance);
    }

    pub fn get_end(instance: *runtime.Instance) anyerror!anyopaque {
        return try CSSScopeRuleImpl.get_end(instance);
    }

    pub fn call_deleteRule(instance: *runtime.Instance, index: u32) anyerror!void {
        
        return try CSSScopeRuleImpl.call_deleteRule(instance, index);
    }

    pub fn call_insertRule(instance: *runtime.Instance, rule: anyopaque, index: u32) anyerror!u32 {
        
        return try CSSScopeRuleImpl.call_insertRule(instance, rule, index);
    }
