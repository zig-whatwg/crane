...
pub const NavigationEvent = struct {
    ...
    pub fn initWithState(
        ...
        return NavigationEventImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, @"type": DOMString, eventInitDict: webidl.Opt(NavigationEventInit)) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try NavigationEventImpl.call_constructor(ctx, @"type", eventInitDict);
    }
