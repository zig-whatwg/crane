...
const PerformanceTiming = @import("PerformanceTiming.zig").PerformanceTiming;
const EventCounts = @import("EventCounts.zig").EventCounts;
const MemoryMeasurement = @import("dictionaries").MemoryMeasurement;
const PerformanceMeasure = @import("PerformanceMeasure.zig").PerformanceMeasure;
const PerformanceMarkOptions = @import("dictionaries").PerformanceMarkOptions;
const Observable = @import("Observable.zig").Observable;
const Event = @import("Event.zig").Event;
const EventListenerOptions = @import("dictionaries").EventListenerOptions;
const PerformanceNavigation = @import("PerformanceNavigation.zig").PerformanceNavigation;
const EventListener = @import("EventListener.zig").EventListener;
const PerformanceMark = @import("PerformanceMark.zig").PerformanceMark;
...
pub const Performance = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        Meta.MixinTypes,
        struct {
            timeOrigin: typedefs.DOMHighResTimeStamp = undefined,
            ...
            onresourcetimingbufferfull: typedefs.EventHandler = undefined,
    ...
    pub fn call_toJSON(instance: *runtime.Instance) anyerror!PerformanceToJSON {
