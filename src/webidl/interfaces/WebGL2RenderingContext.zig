...
const WebGL2RenderingContextImpl = @import("impls").WebGL2RenderingContext;
...
pub const WebGL2RenderingContext = struct {
    pub const Meta = struct {
        ...
        pub const properties = .{
            ...
            .{ "drawingBufferWidth", "get_drawingBufferWidth", null },
            .{ "drawingBufferHeight", "get_drawingBufferHeight", null },
            .{ "drawingBufferFormat", "get_drawingBufferFormat", null },
        ...
        pub const methods = .{
            ...
            .{ "getSupportedExtensions", "call_getSupportedExtensions", 0 },
            .{ "getExtension", "call_getExtension", 1 },
            .{ "drawingBufferStorage", "call_drawingBufferStorage", 3 },
            .{ "activeTexture", "call_activeTexture", 1 },
            .{ "attachShader", "call_attachShader", 2 },
            .{ "bindAttribLocation", "call_bindAttribLocation", 3 },
            .{ "bindBuffer", "call_bindBuffer", 2 },
            .{ "bindFramebuffer", "call_bindFramebuffer", 2 },
            .{ "bindRenderbuffer", "call_bindRenderbuffer", 2 },
            .{ "bindTexture", "call_bindTexture", 2 },
            .{ "blendColor", "call_blendColor", 4 },
            .{ "blendEquation", "call_blendEquation", 1 },
            .{ "blendEquationSeparate", "call_blendEquationSeparate", 2 },
            .{ "blendFunc", "call_blendFunc", 2 },
            .{ "blendFuncSeparate", "call_blendFuncSeparate", 4 },
            .{ "checkFramebufferStatus", "call_checkFramebufferStatus", 1 },
            .{ "clear", "call_clear", 1 },
            .{ "clearColor", "call_clearColor", 4 },
            .{ "clearDepth", "call_clearDepth", 1 },
            .{ "clearStencil", "call_clearStencil", 1 },
            .{ "colorMask", "call_colorMask", 4 },
            .{ "compileShader", "call_compileShader", 1 },
            .{ "copyTexImage2D", "call_copyTexImage2D", 8 },
            .{ "copyTexSubImage2D", "call_copyTexSubImage2D", 8 },
            .{ "createBuffer", "call_createBuffer", 0 },
            .{ "createFramebuffer", "call_createFramebuffer", 0 },
            .{ "createProgram", "call_createProgram", 0 },
            .{ "createRenderbuffer", "call_createRenderbuffer", 0 },
            .{ "createShader", "call_createShader", 1 },
            .{ "createTexture", "call_createTexture", 0 },
            .{ "cullFace", "call_cullFace", 1 },
            .{ "deleteBuffer", "call_deleteBuffer", 1 },
            .{ "deleteFramebuffer", "call_deleteFramebuffer", 1 },
            .{ "deleteProgram", "call_deleteProgram", 1 },
            .{ "deleteRenderbuffer", "call_deleteRenderbuffer", 1 },
            .{ "deleteShader", "call_deleteShader", 1 },
            .{ "deleteTexture", "call_deleteTexture", 1 },
            .{ "depthFunc", "call_depthFunc", 1 },
            .{ "depthMask", "call_depthMask", 1 },
            .{ "depthRange", "call_depthRange", 2 },
            .{ "detachShader", "call_detachShader", 2 },
            .{ "disable", "call_disable", 1 },
            .{ "disableVertexAttribArray", "call_disableVertexAttribArray", 1 },
            .{ "drawArrays", "call_drawArrays", 3 },
            .{ "drawElements", "call_drawElements", 4 },
            .{ "enable", "call_enable", 1 },
            .{ "enableVertexAttribArray", "call_enableVertexAttribArray", 1 },
            .{ "finish", "call_finish", 0 },
            .{ "flush", "call_flush", 0 },
            .{ "framebufferRenderbuffer", "call_framebufferRenderbuffer", 4 },
            .{ "framebufferTexture2D", "call_framebufferTexture2D", 5 },
            .{ "frontFace", "call_frontFace", 1 },
            .{ "generateMipmap", "call_generateMipmap", 1 },
            .{ "getActiveAttrib", "call_getActiveAttrib", 2 },
            .{ "getActiveUniform", "call_getActiveUniform", 2 },
            .{ "getAttachedShaders", "call_getAttachedShaders", 1 },
            .{ "getAttribLocation", "call_getAttribLocation", 2 },
            .{ "getBufferParameter", "call_getBufferParameter", 2 },
            .{ "getParameter", "call_getParameter", 1 },
            .{ "getError", "call_getError", 0 },
            .{ "getFramebufferAttachmentParameter", "call_getFramebufferAttachmentParameter", 3 },
            .{ "getProgramParameter", "call_getProgramParameter", 2 },
            .{ "getProgramInfoLog", "call_getProgramInfoLog", 1 },
            .{ "getRenderbufferParameter", "call_getRenderbufferParameter", 2 },
            .{ "getShaderParameter", "call_getShaderParameter", 2 },
            .{ "getShaderPrecisionFormat", "call_getShaderPrecisionFormat", 2 },
            .{ "getShaderInfoLog", "call_getShaderInfoLog", 1 },
            .{ "getShaderSource", "call_getShaderSource", 1 },
            .{ "getTexParameter", "call_getTexParameter", 2 },
            .{ "getUniform", "call_getUniform", 2 },
            .{ "getUniformLocation", "call_getUniformLocation", 2 },
            .{ "getVertexAttrib", "call_getVertexAttrib", 2 },
            .{ "getVertexAttribOffset", "call_getVertexAttribOffset", 2 },
            .{ "hint", "call_hint", 2 },
            .{ "isBuffer", "call_isBuffer", 1 },
            .{ "isEnabled", "call_isEnabled", 1 },
            .{ "isFramebuffer", "call_isFramebuffer", 1 },
            .{ "isProgram", "call_isProgram", 1 },
            .{ "isRenderbuffer", "call_isRenderbuffer", 1 },
            .{ "isShader", "call_isShader", 1 },
            .{ "isTexture", "call_isTexture", 1 },
            .{ "lineWidth", "call_lineWidth", 1 },
            .{ "linkProgram", "call_linkProgram", 1 },
            .{ "pixelStorei", "call_pixelStorei", 2 },
            .{ "polygonOffset", "call_polygonOffset", 2 },
            .{ "renderbufferStorage", "call_renderbufferStorage", 4 },
            .{ "sampleCoverage", "call_sampleCoverage", 2 },
            .{ "scissor", "call_scissor", 4 },
            .{ "shaderSource", "call_shaderSource", 2 },
            .{ "stencilFunc", "call_stencilFunc", 3 },
            .{ "stencilFuncSeparate", "call_stencilFuncSeparate", 4 },
            .{ "stencilMask", "call_stencilMask", 1 },
            .{ "stencilMaskSeparate", "call_stencilMaskSeparate", 2 },
            .{ "stencilOp", "call_stencilOp", 3 },
            .{ "stencilOpSeparate", "call_stencilOpSeparate", 4 },
            .{ "texParameterf", "call_texParameterf", 3 },
            .{ "texParameteri", "call_texParameteri", 3 },
            .{ "uniform1f", "call_uniform1f", 2 },
            .{ "uniform2f", "call_uniform2f", 3 },
            .{ "uniform3f", "call_uniform3f", 4 },
            .{ "uniform4f", "call_uniform4f", 5 },
            .{ "uniform1i", "call_uniform1i", 2 },
            .{ "uniform2i", "call_uniform2i", 3 },
            .{ "uniform3i", "call_uniform3i", 4 },
            .{ "uniform4i", "call_uniform4i", 5 },
            .{ "useProgram", "call_useProgram", 1 },
            .{ "validateProgram", "call_validateProgram", 1 },
            .{ "vertexAttrib1f", "call_vertexAttrib1f", 2 },
            .{ "vertexAttrib2f", "call_vertexAttrib2f", 3 },
            .{ "vertexAttrib3f", "call_vertexAttrib3f", 4 },
            .{ "vertexAttrib4f", "call_vertexAttrib4f", 5 },
            .{ "vertexAttrib1fv", "call_vertexAttrib1fv", 2 },
            .{ "vertexAttrib2fv", "call_vertexAttrib2fv", 2 },
            .{ "vertexAttrib3fv", "call_vertexAttrib3fv", 2 },
            .{ "vertexAttrib4fv", "call_vertexAttrib4fv", 2 },
            .{ "vertexAttribPointer", "call_vertexAttribPointer", 6 },
            .{ "viewport", "call_viewport", 4 },
            .{ "makeXRCompatible", "call_makeXRCompatible", 0 },
            .{ "copyBufferSubData", "call_copyBufferSubData", 5 },
            .{ "getBufferSubData", "call_getBufferSubData", 3 },
            .{ "blitFramebuffer", "call_blitFramebuffer", 10 },
            .{ "framebufferTextureLayer", "call_framebufferTextureLayer", 5 },
            .{ "invalidateFramebuffer", "call_invalidateFramebuffer", 2 },
            .{ "invalidateSubFramebuffer", "call_invalidateSubFramebuffer", 6 },
            .{ "readBuffer", "call_readBuffer", 1 },
            .{ "getInternalformatParameter", "call_getInternalformatParameter", 3 },
            .{ "renderbufferStorageMultisample", "call_renderbufferStorageMultisample", 5 },
            .{ "texStorage2D", "call_texStorage2D", 5 },
            .{ "texStorage3D", "call_texStorage3D", 6 },
            .{ "texImage3D", "call_texImage3D", 10 },
            .{ "texImage3D", "call_texImage3D", 10 },
            .{ "texImage3D", "call_texImage3D", 10 },
            .{ "texImage3D", "call_texImage3D", 11 },
            ...
            .{ "uniform3ui", "call_uniform3ui", 4 },
            .{ "uniform4ui", "call_uniform4ui", 5 },
            .{ "uniform1uiv", "call_uniform1uiv", 2 },
            .{ "uniform2uiv", "call_uniform2uiv", 2 },
            .{ "uniform3uiv", "call_uniform3uiv", 2 },
            .{ "uniform4uiv", "call_uniform4uiv", 2 },
            .{ "uniformMatrix3x2fv", "call_uniformMatrix3x2fv", 3 },
            .{ "uniformMatrix4x2fv", "call_uniformMatrix4x2fv", 3 },
            .{ "uniformMatrix2x3fv", "call_uniformMatrix2x3fv", 3 },
            .{ "uniformMatrix4x3fv", "call_uniformMatrix4x3fv", 3 },
            .{ "uniformMatrix2x4fv", "call_uniformMatrix2x4fv", 3 },
            .{ "uniformMatrix3x4fv", "call_uniformMatrix3x4fv", 3 },
            .{ "vertexAttribI4i", "call_vertexAttribI4i", 5 },
            .{ "vertexAttribI4iv", "call_vertexAttribI4iv", 2 },
            .{ "vertexAttribI4ui", "call_vertexAttribI4ui", 5 },
            .{ "vertexAttribI4uiv", "call_vertexAttribI4uiv", 2 },
            .{ "vertexAttribIPointer", "call_vertexAttribIPointer", 5 },
            .{ "vertexAttribDivisor", "call_vertexAttribDivisor", 2 },
            .{ "drawArraysInstanced", "call_drawArraysInstanced", 4 },
            .{ "drawElementsInstanced", "call_drawElementsInstanced", 5 },
            .{ "drawRangeElements", "call_drawRangeElements", 6 },
            .{ "drawBuffers", "call_drawBuffers", 1 },
            .{ "clearBufferfv", "call_clearBufferfv", 3 },
            .{ "clearBufferiv", "call_clearBufferiv", 3 },
            .{ "clearBufferuiv", "call_clearBufferuiv", 3 },
            .{ "clearBufferfi", "call_clearBufferfi", 4 },
            .{ "createQuery", "call_createQuery", 0 },
            .{ "deleteQuery", "call_deleteQuery", 1 },
            .{ "isQuery", "call_isQuery", 1 },
            .{ "beginQuery", "call_beginQuery", 2 },
            .{ "endQuery", "call_endQuery", 1 },
            .{ "getQuery", "call_getQuery", 2 },
            .{ "getQueryParameter", "call_getQueryParameter", 2 },
            .{ "createSampler", "call_createSampler", 0 },
            .{ "deleteSampler", "call_deleteSampler", 1 },
            .{ "isSampler", "call_isSampler", 1 },
            .{ "bindSampler", "call_bindSampler", 2 },
            .{ "samplerParameteri", "call_samplerParameteri", 3 },
            .{ "samplerParameterf", "call_samplerParameterf", 3 },
            .{ "getSamplerParameter", "call_getSamplerParameter", 2 },
            .{ "fenceSync", "call_fenceSync", 2 },
            .{ "isSync", "call_isSync", 1 },
            .{ "deleteSync", "call_deleteSync", 1 },
            .{ "clientWaitSync", "call_clientWaitSync", 3 },
            .{ "waitSync", "call_waitSync", 3 },
            .{ "getSyncParameter", "call_getSyncParameter", 2 },
            .{ "createTransformFeedback", "call_createTransformFeedback", 0 },
            .{ "deleteTransformFeedback", "call_deleteTransformFeedback", 1 },
            .{ "isTransformFeedback", "call_isTransformFeedback", 1 },
            .{ "bindTransformFeedback", "call_bindTransformFeedback", 2 },
            .{ "beginTransformFeedback", "call_beginTransformFeedback", 1 },
            .{ "endTransformFeedback", "call_endTransformFeedback", 0 },
            .{ "transformFeedbackVaryings", "call_transformFeedbackVaryings", 3 },
            .{ "getTransformFeedbackVarying", "call_getTransformFeedbackVarying", 2 },
            .{ "pauseTransformFeedback", "call_pauseTransformFeedback", 0 },
            .{ "resumeTransformFeedback", "call_resumeTransformFeedback", 0 },
            .{ "bindBufferBase", "call_bindBufferBase", 3 },
            .{ "bindBufferRange", "call_bindBufferRange", 5 },
            .{ "getIndexedParameter", "call_getIndexedParameter", 2 },
            .{ "getUniformIndices", "call_getUniformIndices", 2 },
            .{ "getActiveUniforms", "call_getActiveUniforms", 3 },
            .{ "getUniformBlockIndex", "call_getUniformBlockIndex", 2 },
            .{ "getActiveUniformBlockParameter", "call_getActiveUniformBlockParameter", 3 },
            .{ "getActiveUniformBlockName", "call_getActiveUniformBlockName", 2 },
            .{ "uniformBlockBinding", "call_uniformBlockBinding", 3 },
            .{ "createVertexArray", "call_createVertexArray", 0 },
            .{ "deleteVertexArray", "call_deleteVertexArray", 1 },
            .{ "isVertexArray", "call_isVertexArray", 1 },
        ...
        pub const constants = .{
            ...
            .{ "STENCIL_BUFFER_BIT", "get_STENCIL_BUFFER_BIT" },
            .{ "COLOR_BUFFER_BIT", "get_COLOR_BUFFER_BIT" },
            .{ "POINTS", "get_POINTS" },
            .{ "LINES", "get_LINES" },
            .{ "LINE_LOOP", "get_LINE_LOOP" },
            .{ "LINE_STRIP", "get_LINE_STRIP" },
            .{ "TRIANGLES", "get_TRIANGLES" },
            .{ "TRIANGLE_STRIP", "get_TRIANGLE_STRIP" },
            .{ "TRIANGLE_FAN", "get_TRIANGLE_FAN" },
            .{ "ZERO", "get_ZERO" },
            .{ "ONE", "get_ONE" },
            .{ "SRC_COLOR", "get_SRC_COLOR" },
            .{ "ONE_MINUS_SRC_COLOR", "get_ONE_MINUS_SRC_COLOR" },
            .{ "SRC_ALPHA", "get_SRC_ALPHA" },
            .{ "ONE_MINUS_SRC_ALPHA", "get_ONE_MINUS_SRC_ALPHA" },
            .{ "DST_ALPHA", "get_DST_ALPHA" },
            .{ "ONE_MINUS_DST_ALPHA", "get_ONE_MINUS_DST_ALPHA" },
            .{ "DST_COLOR", "get_DST_COLOR" },
            .{ "ONE_MINUS_DST_COLOR", "get_ONE_MINUS_DST_COLOR" },
            .{ "SRC_ALPHA_SATURATE", "get_SRC_ALPHA_SATURATE" },
            .{ "FUNC_ADD", "get_FUNC_ADD" },
            .{ "BLEND_EQUATION", "get_BLEND_EQUATION" },
            .{ "BLEND_EQUATION_RGB", "get_BLEND_EQUATION_RGB" },
            .{ "BLEND_EQUATION_ALPHA", "get_BLEND_EQUATION_ALPHA" },
            .{ "FUNC_SUBTRACT", "get_FUNC_SUBTRACT" },
            .{ "FUNC_REVERSE_SUBTRACT", "get_FUNC_REVERSE_SUBTRACT" },
            .{ "BLEND_DST_RGB", "get_BLEND_DST_RGB" },
            .{ "BLEND_SRC_RGB", "get_BLEND_SRC_RGB" },
            .{ "BLEND_DST_ALPHA", "get_BLEND_DST_ALPHA" },
            .{ "BLEND_SRC_ALPHA", "get_BLEND_SRC_ALPHA" },
            .{ "CONSTANT_COLOR", "get_CONSTANT_COLOR" },
            .{ "ONE_MINUS_CONSTANT_COLOR", "get_ONE_MINUS_CONSTANT_COLOR" },
            .{ "CONSTANT_ALPHA", "get_CONSTANT_ALPHA" },
            .{ "ONE_MINUS_CONSTANT_ALPHA", "get_ONE_MINUS_CONSTANT_ALPHA" },
            .{ "BLEND_COLOR", "get_BLEND_COLOR" },
            .{ "ARRAY_BUFFER", "get_ARRAY_BUFFER" },
            .{ "ELEMENT_ARRAY_BUFFER", "get_ELEMENT_ARRAY_BUFFER" },
            .{ "ARRAY_BUFFER_BINDING", "get_ARRAY_BUFFER_BINDING" },
            .{ "ELEMENT_ARRAY_BUFFER_BINDING", "get_ELEMENT_ARRAY_BUFFER_BINDING" },
            .{ "STREAM_DRAW", "get_STREAM_DRAW" },
            .{ "STATIC_DRAW", "get_STATIC_DRAW" },
            .{ "DYNAMIC_DRAW", "get_DYNAMIC_DRAW" },
            .{ "BUFFER_SIZE", "get_BUFFER_SIZE" },
            .{ "BUFFER_USAGE", "get_BUFFER_USAGE" },
            .{ "CURRENT_VERTEX_ATTRIB", "get_CURRENT_VERTEX_ATTRIB" },
            .{ "FRONT", "get_FRONT" },
            .{ "BACK", "get_BACK" },
            .{ "FRONT_AND_BACK", "get_FRONT_AND_BACK" },
            .{ "CULL_FACE", "get_CULL_FACE" },
            .{ "BLEND", "get_BLEND" },
            .{ "DITHER", "get_DITHER" },
            .{ "STENCIL_TEST", "get_STENCIL_TEST" },
            .{ "DEPTH_TEST", "get_DEPTH_TEST" },
            .{ "SCISSOR_TEST", "get_SCISSOR_TEST" },
            .{ "POLYGON_OFFSET_FILL", "get_POLYGON_OFFSET_FILL" },
            .{ "SAMPLE_ALPHA_TO_COVERAGE", "get_SAMPLE_ALPHA_TO_COVERAGE" },
            .{ "SAMPLE_COVERAGE", "get_SAMPLE_COVERAGE" },
            .{ "NO_ERROR", "get_NO_ERROR" },
            .{ "INVALID_ENUM", "get_INVALID_ENUM" },
            .{ "INVALID_VALUE", "get_INVALID_VALUE" },
            .{ "INVALID_OPERATION", "get_INVALID_OPERATION" },
            .{ "OUT_OF_MEMORY", "get_OUT_OF_MEMORY" },
            .{ "CW", "get_CW" },
            .{ "CCW", "get_CCW" },
            .{ "LINE_WIDTH", "get_LINE_WIDTH" },
            .{ "ALIASED_POINT_SIZE_RANGE", "get_ALIASED_POINT_SIZE_RANGE" },
            .{ "ALIASED_LINE_WIDTH_RANGE", "get_ALIASED_LINE_WIDTH_RANGE" },
            .{ "CULL_FACE_MODE", "get_CULL_FACE_MODE" },
            .{ "FRONT_FACE", "get_FRONT_FACE" },
            .{ "DEPTH_RANGE", "get_DEPTH_RANGE" },
            .{ "DEPTH_WRITEMASK", "get_DEPTH_WRITEMASK" },
            .{ "DEPTH_CLEAR_VALUE", "get_DEPTH_CLEAR_VALUE" },
            .{ "DEPTH_FUNC", "get_DEPTH_FUNC" },
            .{ "STENCIL_CLEAR_VALUE", "get_STENCIL_CLEAR_VALUE" },
            .{ "STENCIL_FUNC", "get_STENCIL_FUNC" },
            .{ "STENCIL_FAIL", "get_STENCIL_FAIL" },
            .{ "STENCIL_PASS_DEPTH_FAIL", "get_STENCIL_PASS_DEPTH_FAIL" },
            .{ "STENCIL_PASS_DEPTH_PASS", "get_STENCIL_PASS_DEPTH_PASS" },
            .{ "STENCIL_REF", "get_STENCIL_REF" },
            .{ "STENCIL_VALUE_MASK", "get_STENCIL_VALUE_MASK" },
            .{ "STENCIL_WRITEMASK", "get_STENCIL_WRITEMASK" },
            .{ "STENCIL_BACK_FUNC", "get_STENCIL_BACK_FUNC" },
            .{ "STENCIL_BACK_FAIL", "get_STENCIL_BACK_FAIL" },
            .{ "STENCIL_BACK_PASS_DEPTH_FAIL", "get_STENCIL_BACK_PASS_DEPTH_FAIL" },
            .{ "STENCIL_BACK_PASS_DEPTH_PASS", "get_STENCIL_BACK_PASS_DEPTH_PASS" },
            .{ "STENCIL_BACK_REF", "get_STENCIL_BACK_REF" },
            .{ "STENCIL_BACK_VALUE_MASK", "get_STENCIL_BACK_VALUE_MASK" },
            .{ "STENCIL_BACK_WRITEMASK", "get_STENCIL_BACK_WRITEMASK" },
            .{ "VIEWPORT", "get_VIEWPORT" },
            .{ "SCISSOR_BOX", "get_SCISSOR_BOX" },
            .{ "COLOR_CLEAR_VALUE", "get_COLOR_CLEAR_VALUE" },
            .{ "COLOR_WRITEMASK", "get_COLOR_WRITEMASK" },
            .{ "UNPACK_ALIGNMENT", "get_UNPACK_ALIGNMENT" },
            .{ "PACK_ALIGNMENT", "get_PACK_ALIGNMENT" },
            .{ "MAX_TEXTURE_SIZE", "get_MAX_TEXTURE_SIZE" },
            .{ "MAX_VIEWPORT_DIMS", "get_MAX_VIEWPORT_DIMS" },
            .{ "SUBPIXEL_BITS", "get_SUBPIXEL_BITS" },
            .{ "RED_BITS", "get_RED_BITS" },
            .{ "GREEN_BITS", "get_GREEN_BITS" },
            .{ "BLUE_BITS", "get_BLUE_BITS" },
            .{ "ALPHA_BITS", "get_ALPHA_BITS" },
            .{ "DEPTH_BITS", "get_DEPTH_BITS" },
            .{ "STENCIL_BITS", "get_STENCIL_BITS" },
            .{ "POLYGON_OFFSET_UNITS", "get_POLYGON_OFFSET_UNITS" },
            .{ "POLYGON_OFFSET_FACTOR", "get_POLYGON_OFFSET_FACTOR" },
            .{ "TEXTURE_BINDING_2D", "get_TEXTURE_BINDING_2D" },
            .{ "SAMPLE_BUFFERS", "get_SAMPLE_BUFFERS" },
            .{ "SAMPLES", "get_SAMPLES" },
            .{ "SAMPLE_COVERAGE_VALUE", "get_SAMPLE_COVERAGE_VALUE" },
            .{ "SAMPLE_COVERAGE_INVERT", "get_SAMPLE_COVERAGE_INVERT" },
            .{ "COMPRESSED_TEXTURE_FORMATS", "get_COMPRESSED_TEXTURE_FORMATS" },
            .{ "DONT_CARE", "get_DONT_CARE" },
            .{ "FASTEST", "get_FASTEST" },
            .{ "NICEST", "get_NICEST" },
            .{ "GENERATE_MIPMAP_HINT", "get_GENERATE_MIPMAP_HINT" },
            .{ "BYTE", "get_BYTE" },
            .{ "UNSIGNED_BYTE", "get_UNSIGNED_BYTE" },
            .{ "SHORT", "get_SHORT" },
            .{ "UNSIGNED_SHORT", "get_UNSIGNED_SHORT" },
            .{ "INT", "get_INT" },
            .{ "UNSIGNED_INT", "get_UNSIGNED_INT" },
            .{ "FLOAT", "get_FLOAT" },
            .{ "DEPTH_COMPONENT", "get_DEPTH_COMPONENT" },
            .{ "ALPHA", "get_ALPHA" },
            .{ "RGB", "get_RGB" },
            .{ "RGBA", "get_RGBA" },
            .{ "LUMINANCE", "get_LUMINANCE" },
            .{ "LUMINANCE_ALPHA", "get_LUMINANCE_ALPHA" },
            .{ "UNSIGNED_SHORT_4_4_4_4", "get_UNSIGNED_SHORT_4_4_4_4" },
            .{ "UNSIGNED_SHORT_5_5_5_1", "get_UNSIGNED_SHORT_5_5_5_1" },
            .{ "UNSIGNED_SHORT_5_6_5", "get_UNSIGNED_SHORT_5_6_5" },
            .{ "FRAGMENT_SHADER", "get_FRAGMENT_SHADER" },
            .{ "VERTEX_SHADER", "get_VERTEX_SHADER" },
            .{ "MAX_VERTEX_ATTRIBS", "get_MAX_VERTEX_ATTRIBS" },
            .{ "MAX_VERTEX_UNIFORM_VECTORS", "get_MAX_VERTEX_UNIFORM_VECTORS" },
            .{ "MAX_VARYING_VECTORS", "get_MAX_VARYING_VECTORS" },
            .{ "MAX_COMBINED_TEXTURE_IMAGE_UNITS", "get_MAX_COMBINED_TEXTURE_IMAGE_UNITS" },
            .{ "MAX_VERTEX_TEXTURE_IMAGE_UNITS", "get_MAX_VERTEX_TEXTURE_IMAGE_UNITS" },
            .{ "MAX_TEXTURE_IMAGE_UNITS", "get_MAX_TEXTURE_IMAGE_UNITS" },
            .{ "MAX_FRAGMENT_UNIFORM_VECTORS", "get_MAX_FRAGMENT_UNIFORM_VECTORS" },
            .{ "SHADER_TYPE", "get_SHADER_TYPE" },
            .{ "DELETE_STATUS", "get_DELETE_STATUS" },
            .{ "LINK_STATUS", "get_LINK_STATUS" },
            .{ "VALIDATE_STATUS", "get_VALIDATE_STATUS" },
            .{ "ATTACHED_SHADERS", "get_ATTACHED_SHADERS" },
            .{ "ACTIVE_UNIFORMS", "get_ACTIVE_UNIFORMS" },
            .{ "ACTIVE_ATTRIBUTES", "get_ACTIVE_ATTRIBUTES" },
            .{ "SHADING_LANGUAGE_VERSION", "get_SHADING_LANGUAGE_VERSION" },
            ...
            .{ "DECR", "get_DECR" },
            .{ "INVERT", "get_INVERT" },
            .{ "INCR_WRAP", "get_INCR_WRAP" },
            .{ "DECR_WRAP", "get_DECR_WRAP" },
            .{ "VENDOR", "get_VENDOR" },
            .{ "RENDERER", "get_RENDERER" },
            .{ "VERSION", "get_VERSION" },
            .{ "NEAREST", "get_NEAREST" },
            .{ "LINEAR", "get_LINEAR" },
            .{ "NEAREST_MIPMAP_NEAREST", "get_NEAREST_MIPMAP_NEAREST" },
            .{ "LINEAR_MIPMAP_NEAREST", "get_LINEAR_MIPMAP_NEAREST" },
            .{ "NEAREST_MIPMAP_LINEAR", "get_NEAREST_MIPMAP_LINEAR" },
            .{ "LINEAR_MIPMAP_LINEAR", "get_LINEAR_MIPMAP_LINEAR" },
            .{ "TEXTURE_MAG_FILTER", "get_TEXTURE_MAG_FILTER" },
            .{ "TEXTURE_MIN_FILTER", "get_TEXTURE_MIN_FILTER" },
            .{ "TEXTURE_WRAP_S", "get_TEXTURE_WRAP_S" },
            .{ "TEXTURE_WRAP_T", "get_TEXTURE_WRAP_T" },
            .{ "TEXTURE_2D", "get_TEXTURE_2D" },
            .{ "TEXTURE", "get_TEXTURE" },
            .{ "TEXTURE_CUBE_MAP", "get_TEXTURE_CUBE_MAP" },
            .{ "TEXTURE_BINDING_CUBE_MAP", "get_TEXTURE_BINDING_CUBE_MAP" },
            .{ "TEXTURE_CUBE_MAP_POSITIVE_X", "get_TEXTURE_CUBE_MAP_POSITIVE_X" },
            .{ "TEXTURE_CUBE_MAP_NEGATIVE_X", "get_TEXTURE_CUBE_MAP_NEGATIVE_X" },
            .{ "TEXTURE_CUBE_MAP_POSITIVE_Y", "get_TEXTURE_CUBE_MAP_POSITIVE_Y" },
            .{ "TEXTURE_CUBE_MAP_NEGATIVE_Y", "get_TEXTURE_CUBE_MAP_NEGATIVE_Y" },
            .{ "TEXTURE_CUBE_MAP_POSITIVE_Z", "get_TEXTURE_CUBE_MAP_POSITIVE_Z" },
            .{ "TEXTURE_CUBE_MAP_NEGATIVE_Z", "get_TEXTURE_CUBE_MAP_NEGATIVE_Z" },
            .{ "MAX_CUBE_MAP_TEXTURE_SIZE", "get_MAX_CUBE_MAP_TEXTURE_SIZE" },
            .{ "TEXTURE0", "get_TEXTURE0" },
            .{ "TEXTURE1", "get_TEXTURE1" },
            .{ "TEXTURE2", "get_TEXTURE2" },
            .{ "TEXTURE3", "get_TEXTURE3" },
            .{ "TEXTURE4", "get_TEXTURE4" },
            .{ "TEXTURE5", "get_TEXTURE5" },
            .{ "TEXTURE6", "get_TEXTURE6" },
            .{ "TEXTURE7", "get_TEXTURE7" },
            .{ "TEXTURE8", "get_TEXTURE8" },
            .{ "TEXTURE9", "get_TEXTURE9" },
            .{ "TEXTURE10", "get_TEXTURE10" },
            .{ "TEXTURE11", "get_TEXTURE11" },
            .{ "TEXTURE12", "get_TEXTURE12" },
            .{ "TEXTURE13", "get_TEXTURE13" },
            .{ "TEXTURE14", "get_TEXTURE14" },
            .{ "TEXTURE15", "get_TEXTURE15" },
            .{ "TEXTURE16", "get_TEXTURE16" },
            .{ "TEXTURE17", "get_TEXTURE17" },
            .{ "TEXTURE18", "get_TEXTURE18" },
            .{ "TEXTURE19", "get_TEXTURE19" },
            .{ "TEXTURE20", "get_TEXTURE20" },
            .{ "TEXTURE21", "get_TEXTURE21" },
            .{ "TEXTURE22", "get_TEXTURE22" },
            .{ "TEXTURE23", "get_TEXTURE23" },
            .{ "TEXTURE24", "get_TEXTURE24" },
            .{ "TEXTURE25", "get_TEXTURE25" },
            .{ "TEXTURE26", "get_TEXTURE26" },
            .{ "TEXTURE27", "get_TEXTURE27" },
            .{ "TEXTURE28", "get_TEXTURE28" },
            .{ "TEXTURE29", "get_TEXTURE29" },
            .{ "TEXTURE30", "get_TEXTURE30" },
            .{ "TEXTURE31", "get_TEXTURE31" },
            .{ "ACTIVE_TEXTURE", "get_ACTIVE_TEXTURE" },
            .{ "REPEAT", "get_REPEAT" },
            .{ "CLAMP_TO_EDGE", "get_CLAMP_TO_EDGE" },
            .{ "MIRRORED_REPEAT", "get_MIRRORED_REPEAT" },
            .{ "FLOAT_VEC2", "get_FLOAT_VEC2" },
            .{ "FLOAT_VEC3", "get_FLOAT_VEC3" },
            .{ "FLOAT_VEC4", "get_FLOAT_VEC4" },
            .{ "INT_VEC2", "get_INT_VEC2" },
            .{ "INT_VEC3", "get_INT_VEC3" },
            .{ "INT_VEC4", "get_INT_VEC4" },
            .{ "BOOL", "get_BOOL" },
            .{ "BOOL_VEC2", "get_BOOL_VEC2" },
            .{ "BOOL_VEC3", "get_BOOL_VEC3" },
            .{ "BOOL_VEC4", "get_BOOL_VEC4" },
            .{ "FLOAT_MAT2", "get_FLOAT_MAT2" },
            .{ "FLOAT_MAT3", "get_FLOAT_MAT3" },
            .{ "FLOAT_MAT4", "get_FLOAT_MAT4" },
            .{ "SAMPLER_2D", "get_SAMPLER_2D" },
            .{ "SAMPLER_CUBE", "get_SAMPLER_CUBE" },
            .{ "VERTEX_ATTRIB_ARRAY_ENABLED", "get_VERTEX_ATTRIB_ARRAY_ENABLED" },
            .{ "VERTEX_ATTRIB_ARRAY_SIZE", "get_VERTEX_ATTRIB_ARRAY_SIZE" },
            .{ "VERTEX_ATTRIB_ARRAY_STRIDE", "get_VERTEX_ATTRIB_ARRAY_STRIDE" },
            .{ "VERTEX_ATTRIB_ARRAY_TYPE", "get_VERTEX_ATTRIB_ARRAY_TYPE" },
            .{ "VERTEX_ATTRIB_ARRAY_NORMALIZED", "get_VERTEX_ATTRIB_ARRAY_NORMALIZED" },
            .{ "VERTEX_ATTRIB_ARRAY_POINTER", "get_VERTEX_ATTRIB_ARRAY_POINTER" },
            .{ "VERTEX_ATTRIB_ARRAY_BUFFER_BINDING", "get_VERTEX_ATTRIB_ARRAY_BUFFER_BINDING" },
            .{ "IMPLEMENTATION_COLOR_READ_TYPE", "get_IMPLEMENTATION_COLOR_READ_TYPE" },
            .{ "IMPLEMENTATION_COLOR_READ_FORMAT", "get_IMPLEMENTATION_COLOR_READ_FORMAT" },
            .{ "COMPILE_STATUS", "get_COMPILE_STATUS" },
            .{ "LOW_FLOAT", "get_LOW_FLOAT" },
            .{ "MEDIUM_FLOAT", "get_MEDIUM_FLOAT" },
            .{ "HIGH_FLOAT", "get_HIGH_FLOAT" },
            .{ "LOW_INT", "get_LOW_INT" },
            .{ "MEDIUM_INT", "get_MEDIUM_INT" },
            .{ "HIGH_INT", "get_HIGH_INT" },
            .{ "FRAMEBUFFER", "get_FRAMEBUFFER" },
            .{ "RENDERBUFFER", "get_RENDERBUFFER" },
            .{ "RGBA4", "get_RGBA4" },
            .{ "RGB5_A1", "get_RGB5_A1" },
            .{ "RGBA8", "get_RGBA8" },
            .{ "RGB565", "get_RGB565" },
            .{ "DEPTH_COMPONENT16", "get_DEPTH_COMPONENT16" },
            .{ "STENCIL_INDEX8", "get_STENCIL_INDEX8" },
            .{ "DEPTH_STENCIL", "get_DEPTH_STENCIL" },
            .{ "RENDERBUFFER_WIDTH", "get_RENDERBUFFER_WIDTH" },
            .{ "RENDERBUFFER_HEIGHT", "get_RENDERBUFFER_HEIGHT" },
            .{ "RENDERBUFFER_INTERNAL_FORMAT", "get_RENDERBUFFER_INTERNAL_FORMAT" },
            .{ "RENDERBUFFER_RED_SIZE", "get_RENDERBUFFER_RED_SIZE" },
            .{ "RENDERBUFFER_GREEN_SIZE", "get_RENDERBUFFER_GREEN_SIZE" },
            .{ "RENDERBUFFER_BLUE_SIZE", "get_RENDERBUFFER_BLUE_SIZE" },
            .{ "RENDERBUFFER_ALPHA_SIZE", "get_RENDERBUFFER_ALPHA_SIZE" },
            .{ "RENDERBUFFER_DEPTH_SIZE", "get_RENDERBUFFER_DEPTH_SIZE" },
            .{ "RENDERBUFFER_STENCIL_SIZE", "get_RENDERBUFFER_STENCIL_SIZE" },
            .{ "FRAMEBUFFER_ATTACHMENT_OBJECT_TYPE", "get_FRAMEBUFFER_ATTACHMENT_OBJECT_TYPE" },
            .{ "FRAMEBUFFER_ATTACHMENT_OBJECT_NAME", "get_FRAMEBUFFER_ATTACHMENT_OBJECT_NAME" },
            .{ "FRAMEBUFFER_ATTACHMENT_TEXTURE_LEVEL", "get_FRAMEBUFFER_ATTACHMENT_TEXTURE_LEVEL" },
            .{ "FRAMEBUFFER_ATTACHMENT_TEXTURE_CUBE_MAP_FACE", "get_FRAMEBUFFER_ATTACHMENT_TEXTURE_CUBE_MAP_FACE" },
            .{ "COLOR_ATTACHMENT0", "get_COLOR_ATTACHMENT0" },
            .{ "DEPTH_ATTACHMENT", "get_DEPTH_ATTACHMENT" },
            .{ "STENCIL_ATTACHMENT", "get_STENCIL_ATTACHMENT" },
            .{ "DEPTH_STENCIL_ATTACHMENT", "get_DEPTH_STENCIL_ATTACHMENT" },
            .{ "NONE", "get_NONE" },
            .{ "FRAMEBUFFER_COMPLETE", "get_FRAMEBUFFER_COMPLETE" },
            .{ "FRAMEBUFFER_INCOMPLETE_ATTACHMENT", "get_FRAMEBUFFER_INCOMPLETE_ATTACHMENT" },
            .{ "FRAMEBUFFER_INCOMPLETE_MISSING_ATTACHMENT", "get_FRAMEBUFFER_INCOMPLETE_MISSING_ATTACHMENT" },
            .{ "FRAMEBUFFER_INCOMPLETE_DIMENSIONS", "get_FRAMEBUFFER_INCOMPLETE_DIMENSIONS" },
            .{ "FRAMEBUFFER_UNSUPPORTED", "get_FRAMEBUFFER_UNSUPPORTED" },
            .{ "FRAMEBUFFER_BINDING", "get_FRAMEBUFFER_BINDING" },
            .{ "RENDERBUFFER_BINDING", "get_RENDERBUFFER_BINDING" },
            .{ "MAX_RENDERBUFFER_SIZE", "get_MAX_RENDERBUFFER_SIZE" },
            .{ "INVALID_FRAMEBUFFER_OPERATION", "get_INVALID_FRAMEBUFFER_OPERATION" },
            .{ "UNPACK_FLIP_Y_WEBGL", "get_UNPACK_FLIP_Y_WEBGL" },
            .{ "UNPACK_PREMULTIPLY_ALPHA_WEBGL", "get_UNPACK_PREMULTIPLY_ALPHA_WEBGL" },
            .{ "CONTEXT_LOST_WEBGL", "get_CONTEXT_LOST_WEBGL" },
            ...
            .{ "UNPACK_ROW_LENGTH", "get_UNPACK_ROW_LENGTH" },
            .{ "UNPACK_SKIP_ROWS", "get_UNPACK_SKIP_ROWS" },
            .{ "UNPACK_SKIP_PIXELS", "get_UNPACK_SKIP_PIXELS" },
            .{ "PACK_ROW_LENGTH", "get_PACK_ROW_LENGTH" },
            .{ "PACK_SKIP_ROWS", "get_PACK_SKIP_ROWS" },
            .{ "PACK_SKIP_PIXELS", "get_PACK_SKIP_PIXELS" },
            .{ "COLOR", "get_COLOR" },
            .{ "DEPTH", "get_DEPTH" },
            .{ "STENCIL", "get_STENCIL" },
            .{ "RED", "get_RED" },
            .{ "RGB8", "get_RGB8" },
            .{ "RGB10_A2", "get_RGB10_A2" },
            .{ "TEXTURE_BINDING_3D", "get_TEXTURE_BINDING_3D" },
            .{ "UNPACK_SKIP_IMAGES", "get_UNPACK_SKIP_IMAGES" },
            .{ "UNPACK_IMAGE_HEIGHT", "get_UNPACK_IMAGE_HEIGHT" },
            .{ "TEXTURE_3D", "get_TEXTURE_3D" },
            .{ "TEXTURE_WRAP_R", "get_TEXTURE_WRAP_R" },
            .{ "MAX_3D_TEXTURE_SIZE", "get_MAX_3D_TEXTURE_SIZE" },
            .{ "UNSIGNED_INT_2_10_10_10_REV", "get_UNSIGNED_INT_2_10_10_10_REV" },
            .{ "MAX_ELEMENTS_VERTICES", "get_MAX_ELEMENTS_VERTICES" },
            .{ "MAX_ELEMENTS_INDICES", "get_MAX_ELEMENTS_INDICES" },
            .{ "TEXTURE_MIN_LOD", "get_TEXTURE_MIN_LOD" },
            .{ "TEXTURE_MAX_LOD", "get_TEXTURE_MAX_LOD" },
            .{ "TEXTURE_BASE_LEVEL", "get_TEXTURE_BASE_LEVEL" },
            .{ "TEXTURE_MAX_LEVEL", "get_TEXTURE_MAX_LEVEL" },
            .{ "MIN", "get_MIN" },
            .{ "MAX", "get_MAX" },
            .{ "DEPTH_COMPONENT24", "get_DEPTH_COMPONENT24" },
            .{ "MAX_TEXTURE_LOD_BIAS", "get_MAX_TEXTURE_LOD_BIAS" },
            .{ "TEXTURE_COMPARE_MODE", "get_TEXTURE_COMPARE_MODE" },
            .{ "TEXTURE_COMPARE_FUNC", "get_TEXTURE_COMPARE_FUNC" },
            .{ "CURRENT_QUERY", "get_CURRENT_QUERY" },
            .{ "QUERY_RESULT", "get_QUERY_RESULT" },
            .{ "QUERY_RESULT_AVAILABLE", "get_QUERY_RESULT_AVAILABLE" },
            .{ "STREAM_READ", "get_STREAM_READ" },
            .{ "STREAM_COPY", "get_STREAM_COPY" },
            .{ "STATIC_READ", "get_STATIC_READ" },
            .{ "STATIC_COPY", "get_STATIC_COPY" },
            .{ "DYNAMIC_READ", "get_DYNAMIC_READ" },
            .{ "DYNAMIC_COPY", "get_DYNAMIC_COPY" },
            .{ "MAX_DRAW_BUFFERS", "get_MAX_DRAW_BUFFERS" },
            .{ "DRAW_BUFFER0", "get_DRAW_BUFFER0" },
            .{ "DRAW_BUFFER1", "get_DRAW_BUFFER1" },
            .{ "DRAW_BUFFER2", "get_DRAW_BUFFER2" },
            .{ "DRAW_BUFFER3", "get_DRAW_BUFFER3" },
            .{ "DRAW_BUFFER4", "get_DRAW_BUFFER4" },
            .{ "DRAW_BUFFER5", "get_DRAW_BUFFER5" },
            .{ "DRAW_BUFFER6", "get_DRAW_BUFFER6" },
            .{ "DRAW_BUFFER7", "get_DRAW_BUFFER7" },
            .{ "DRAW_BUFFER8", "get_DRAW_BUFFER8" },
            .{ "DRAW_BUFFER9", "get_DRAW_BUFFER9" },
            .{ "DRAW_BUFFER10", "get_DRAW_BUFFER10" },
            .{ "DRAW_BUFFER11", "get_DRAW_BUFFER11" },
            .{ "DRAW_BUFFER12", "get_DRAW_BUFFER12" },
            .{ "DRAW_BUFFER13", "get_DRAW_BUFFER13" },
            .{ "DRAW_BUFFER14", "get_DRAW_BUFFER14" },
            .{ "DRAW_BUFFER15", "get_DRAW_BUFFER15" },
            .{ "MAX_FRAGMENT_UNIFORM_COMPONENTS", "get_MAX_FRAGMENT_UNIFORM_COMPONENTS" },
            .{ "MAX_VERTEX_UNIFORM_COMPONENTS", "get_MAX_VERTEX_UNIFORM_COMPONENTS" },
            .{ "SAMPLER_3D", "get_SAMPLER_3D" },
            .{ "SAMPLER_2D_SHADOW", "get_SAMPLER_2D_SHADOW" },
            .{ "FRAGMENT_SHADER_DERIVATIVE_HINT", "get_FRAGMENT_SHADER_DERIVATIVE_HINT" },
            .{ "PIXEL_PACK_BUFFER", "get_PIXEL_PACK_BUFFER" },
            .{ "PIXEL_UNPACK_BUFFER", "get_PIXEL_UNPACK_BUFFER" },
            .{ "PIXEL_PACK_BUFFER_BINDING", "get_PIXEL_PACK_BUFFER_BINDING" },
            .{ "PIXEL_UNPACK_BUFFER_BINDING", "get_PIXEL_UNPACK_BUFFER_BINDING" },
            .{ "FLOAT_MAT2x3", "get_FLOAT_MAT2x3" },
            .{ "FLOAT_MAT2x4", "get_FLOAT_MAT2x4" },
            .{ "FLOAT_MAT3x2", "get_FLOAT_MAT3x2" },
            .{ "FLOAT_MAT3x4", "get_FLOAT_MAT3x4" },
            .{ "FLOAT_MAT4x2", "get_FLOAT_MAT4x2" },
            .{ "FLOAT_MAT4x3", "get_FLOAT_MAT4x3" },
            .{ "SRGB", "get_SRGB" },
            .{ "SRGB8", "get_SRGB8" },
            .{ "SRGB8_ALPHA8", "get_SRGB8_ALPHA8" },
            .{ "COMPARE_REF_TO_TEXTURE", "get_COMPARE_REF_TO_TEXTURE" },
            .{ "RGBA32F", "get_RGBA32F" },
            .{ "RGB32F", "get_RGB32F" },
            .{ "RGBA16F", "get_RGBA16F" },
            .{ "RGB16F", "get_RGB16F" },
            .{ "VERTEX_ATTRIB_ARRAY_INTEGER", "get_VERTEX_ATTRIB_ARRAY_INTEGER" },
            .{ "MAX_ARRAY_TEXTURE_LAYERS", "get_MAX_ARRAY_TEXTURE_LAYERS" },
            .{ "MIN_PROGRAM_TEXEL_OFFSET", "get_MIN_PROGRAM_TEXEL_OFFSET" },
            .{ "MAX_PROGRAM_TEXEL_OFFSET", "get_MAX_PROGRAM_TEXEL_OFFSET" },
            .{ "MAX_VARYING_COMPONENTS", "get_MAX_VARYING_COMPONENTS" },
            .{ "TEXTURE_2D_ARRAY", "get_TEXTURE_2D_ARRAY" },
            .{ "TEXTURE_BINDING_2D_ARRAY", "get_TEXTURE_BINDING_2D_ARRAY" },
            .{ "R11F_G11F_B10F", "get_R11F_G11F_B10F" },
            .{ "UNSIGNED_INT_10F_11F_11F_REV", "get_UNSIGNED_INT_10F_11F_11F_REV" },
            .{ "RGB9_E5", "get_RGB9_E5" },
            .{ "UNSIGNED_INT_5_9_9_9_REV", "get_UNSIGNED_INT_5_9_9_9_REV" },
            .{ "TRANSFORM_FEEDBACK_BUFFER_MODE", "get_TRANSFORM_FEEDBACK_BUFFER_MODE" },
            .{ "MAX_TRANSFORM_FEEDBACK_SEPARATE_COMPONENTS", "get_MAX_TRANSFORM_FEEDBACK_SEPARATE_COMPONENTS" },
            .{ "TRANSFORM_FEEDBACK_VARYINGS", "get_TRANSFORM_FEEDBACK_VARYINGS" },
            .{ "TRANSFORM_FEEDBACK_BUFFER_START", "get_TRANSFORM_FEEDBACK_BUFFER_START" },
            .{ "TRANSFORM_FEEDBACK_BUFFER_SIZE", "get_TRANSFORM_FEEDBACK_BUFFER_SIZE" },
            .{ "TRANSFORM_FEEDBACK_PRIMITIVES_WRITTEN", "get_TRANSFORM_FEEDBACK_PRIMITIVES_WRITTEN" },
            .{ "RASTERIZER_DISCARD", "get_RASTERIZER_DISCARD" },
            .{ "MAX_TRANSFORM_FEEDBACK_INTERLEAVED_COMPONENTS", "get_MAX_TRANSFORM_FEEDBACK_INTERLEAVED_COMPONENTS" },
            .{ "MAX_TRANSFORM_FEEDBACK_SEPARATE_ATTRIBS", "get_MAX_TRANSFORM_FEEDBACK_SEPARATE_ATTRIBS" },
            .{ "INTERLEAVED_ATTRIBS", "get_INTERLEAVED_ATTRIBS" },
            .{ "SEPARATE_ATTRIBS", "get_SEPARATE_ATTRIBS" },
            .{ "TRANSFORM_FEEDBACK_BUFFER", "get_TRANSFORM_FEEDBACK_BUFFER" },
            .{ "TRANSFORM_FEEDBACK_BUFFER_BINDING", "get_TRANSFORM_FEEDBACK_BUFFER_BINDING" },
            .{ "RGBA32UI", "get_RGBA32UI" },
            .{ "RGB32UI", "get_RGB32UI" },
            .{ "RGBA16UI", "get_RGBA16UI" },
            .{ "RGB16UI", "get_RGB16UI" },
            .{ "RGBA8UI", "get_RGBA8UI" },
            .{ "RGB8UI", "get_RGB8UI" },
            .{ "RGBA32I", "get_RGBA32I" },
            ...
            .{ "RGBA8I", "get_RGBA8I" },
            .{ "RGB8I", "get_RGB8I" },
            .{ "RED_INTEGER", "get_RED_INTEGER" },
            .{ "RGB_INTEGER", "get_RGB_INTEGER" },
            .{ "RGBA_INTEGER", "get_RGBA_INTEGER" },
            .{ "SAMPLER_2D_ARRAY", "get_SAMPLER_2D_ARRAY" },
            .{ "SAMPLER_2D_ARRAY_SHADOW", "get_SAMPLER_2D_ARRAY_SHADOW" },
            .{ "SAMPLER_CUBE_SHADOW", "get_SAMPLER_CUBE_SHADOW" },
            .{ "UNSIGNED_INT_VEC2", "get_UNSIGNED_INT_VEC2" },
            .{ "UNSIGNED_INT_VEC3", "get_UNSIGNED_INT_VEC3" },
            .{ "UNSIGNED_INT_VEC4", "get_UNSIGNED_INT_VEC4" },
            .{ "INT_SAMPLER_2D", "get_INT_SAMPLER_2D" },
            .{ "INT_SAMPLER_3D", "get_INT_SAMPLER_3D" },
            .{ "INT_SAMPLER_CUBE", "get_INT_SAMPLER_CUBE" },
            .{ "INT_SAMPLER_2D_ARRAY", "get_INT_SAMPLER_2D_ARRAY" },
            .{ "UNSIGNED_INT_SAMPLER_2D", "get_UNSIGNED_INT_SAMPLER_2D" },
            .{ "UNSIGNED_INT_SAMPLER_3D", "get_UNSIGNED_INT_SAMPLER_3D" },
            .{ "UNSIGNED_INT_SAMPLER_CUBE", "get_UNSIGNED_INT_SAMPLER_CUBE" },
            .{ "UNSIGNED_INT_SAMPLER_2D_ARRAY", "get_UNSIGNED_INT_SAMPLER_2D_ARRAY" },
            .{ "DEPTH_COMPONENT32F", "get_DEPTH_COMPONENT32F" },
            .{ "DEPTH32F_STENCIL8", "get_DEPTH32F_STENCIL8" },
            .{ "FLOAT_32_UNSIGNED_INT_24_8_REV", "get_FLOAT_32_UNSIGNED_INT_24_8_REV" },
            .{ "FRAMEBUFFER_ATTACHMENT_COLOR_ENCODING", "get_FRAMEBUFFER_ATTACHMENT_COLOR_ENCODING" },
            .{ "FRAMEBUFFER_ATTACHMENT_COMPONENT_TYPE", "get_FRAMEBUFFER_ATTACHMENT_COMPONENT_TYPE" },
            .{ "FRAMEBUFFER_ATTACHMENT_RED_SIZE", "get_FRAMEBUFFER_ATTACHMENT_RED_SIZE" },
            .{ "FRAMEBUFFER_ATTACHMENT_GREEN_SIZE", "get_FRAMEBUFFER_ATTACHMENT_GREEN_SIZE" },
            .{ "FRAMEBUFFER_ATTACHMENT_BLUE_SIZE", "get_FRAMEBUFFER_ATTACHMENT_BLUE_SIZE" },
            .{ "FRAMEBUFFER_ATTACHMENT_ALPHA_SIZE", "get_FRAMEBUFFER_ATTACHMENT_ALPHA_SIZE" },
            .{ "FRAMEBUFFER_ATTACHMENT_DEPTH_SIZE", "get_FRAMEBUFFER_ATTACHMENT_DEPTH_SIZE" },
            .{ "FRAMEBUFFER_ATTACHMENT_STENCIL_SIZE", "get_FRAMEBUFFER_ATTACHMENT_STENCIL_SIZE" },
            .{ "FRAMEBUFFER_DEFAULT", "get_FRAMEBUFFER_DEFAULT" },
            .{ "UNSIGNED_INT_24_8", "get_UNSIGNED_INT_24_8" },
            .{ "DEPTH24_STENCIL8", "get_DEPTH24_STENCIL8" },
            .{ "UNSIGNED_NORMALIZED", "get_UNSIGNED_NORMALIZED" },
            .{ "DRAW_FRAMEBUFFER_BINDING", "get_DRAW_FRAMEBUFFER_BINDING" },
            .{ "READ_FRAMEBUFFER", "get_READ_FRAMEBUFFER" },
            .{ "DRAW_FRAMEBUFFER", "get_DRAW_FRAMEBUFFER" },
            .{ "READ_FRAMEBUFFER_BINDING", "get_READ_FRAMEBUFFER_BINDING" },
            .{ "RENDERBUFFER_SAMPLES", "get_RENDERBUFFER_SAMPLES" },
            .{ "FRAMEBUFFER_ATTACHMENT_TEXTURE_LAYER", "get_FRAMEBUFFER_ATTACHMENT_TEXTURE_LAYER" },
            .{ "MAX_COLOR_ATTACHMENTS", "get_MAX_COLOR_ATTACHMENTS" },
            .{ "COLOR_ATTACHMENT1", "get_COLOR_ATTACHMENT1" },
            .{ "COLOR_ATTACHMENT2", "get_COLOR_ATTACHMENT2" },
            .{ "COLOR_ATTACHMENT3", "get_COLOR_ATTACHMENT3" },
            .{ "COLOR_ATTACHMENT4", "get_COLOR_ATTACHMENT4" },
            .{ "COLOR_ATTACHMENT5", "get_COLOR_ATTACHMENT5" },
            .{ "COLOR_ATTACHMENT6", "get_COLOR_ATTACHMENT6" },
            .{ "COLOR_ATTACHMENT7", "get_COLOR_ATTACHMENT7" },
            .{ "COLOR_ATTACHMENT8", "get_COLOR_ATTACHMENT8" },
            .{ "COLOR_ATTACHMENT9", "get_COLOR_ATTACHMENT9" },
            .{ "COLOR_ATTACHMENT10", "get_COLOR_ATTACHMENT10" },
            .{ "COLOR_ATTACHMENT11", "get_COLOR_ATTACHMENT11" },
            .{ "COLOR_ATTACHMENT12", "get_COLOR_ATTACHMENT12" },
            .{ "COLOR_ATTACHMENT13", "get_COLOR_ATTACHMENT13" },
            .{ "COLOR_ATTACHMENT14", "get_COLOR_ATTACHMENT14" },
            .{ "COLOR_ATTACHMENT15", "get_COLOR_ATTACHMENT15" },
            .{ "FRAMEBUFFER_INCOMPLETE_MULTISAMPLE", "get_FRAMEBUFFER_INCOMPLETE_MULTISAMPLE" },
            .{ "MAX_SAMPLES", "get_MAX_SAMPLES" },
            .{ "HALF_FLOAT", "get_HALF_FLOAT" },
            .{ "RG", "get_RG" },
            .{ "RG_INTEGER", "get_RG_INTEGER" },
            .{ "R8", "get_R8" },
            .{ "RG8", "get_RG8" },
            .{ "R16F", "get_R16F" },
            .{ "R32F", "get_R32F" },
            ...
            .{ "RG32I", "get_RG32I" },
            .{ "RG32UI", "get_RG32UI" },
            .{ "VERTEX_ARRAY_BINDING", "get_VERTEX_ARRAY_BINDING" },
            .{ "R8_SNORM", "get_R8_SNORM" },
            .{ "RG8_SNORM", "get_RG8_SNORM" },
            .{ "RGB8_SNORM", "get_RGB8_SNORM" },
            .{ "RGBA8_SNORM", "get_RGBA8_SNORM" },
            .{ "SIGNED_NORMALIZED", "get_SIGNED_NORMALIZED" },
            .{ "COPY_READ_BUFFER", "get_COPY_READ_BUFFER" },
            .{ "COPY_WRITE_BUFFER", "get_COPY_WRITE_BUFFER" },
            .{ "COPY_READ_BUFFER_BINDING", "get_COPY_READ_BUFFER_BINDING" },
            .{ "COPY_WRITE_BUFFER_BINDING", "get_COPY_WRITE_BUFFER_BINDING" },
            .{ "UNIFORM_BUFFER", "get_UNIFORM_BUFFER" },
            .{ "UNIFORM_BUFFER_BINDING", "get_UNIFORM_BUFFER_BINDING" },
            .{ "UNIFORM_BUFFER_START", "get_UNIFORM_BUFFER_START" },
            .{ "UNIFORM_BUFFER_SIZE", "get_UNIFORM_BUFFER_SIZE" },
            .{ "MAX_VERTEX_UNIFORM_BLOCKS", "get_MAX_VERTEX_UNIFORM_BLOCKS" },
            .{ "MAX_FRAGMENT_UNIFORM_BLOCKS", "get_MAX_FRAGMENT_UNIFORM_BLOCKS" },
            .{ "MAX_COMBINED_UNIFORM_BLOCKS", "get_MAX_COMBINED_UNIFORM_BLOCKS" },
            .{ "MAX_UNIFORM_BUFFER_BINDINGS", "get_MAX_UNIFORM_BUFFER_BINDINGS" },
            .{ "MAX_UNIFORM_BLOCK_SIZE", "get_MAX_UNIFORM_BLOCK_SIZE" },
            .{ "MAX_COMBINED_VERTEX_UNIFORM_COMPONENTS", "get_MAX_COMBINED_VERTEX_UNIFORM_COMPONENTS" },
            .{ "MAX_COMBINED_FRAGMENT_UNIFORM_COMPONENTS", "get_MAX_COMBINED_FRAGMENT_UNIFORM_COMPONENTS" },
            .{ "UNIFORM_BUFFER_OFFSET_ALIGNMENT", "get_UNIFORM_BUFFER_OFFSET_ALIGNMENT" },
            .{ "ACTIVE_UNIFORM_BLOCKS", "get_ACTIVE_UNIFORM_BLOCKS" },
            .{ "UNIFORM_TYPE", "get_UNIFORM_TYPE" },
            .{ "UNIFORM_SIZE", "get_UNIFORM_SIZE" },
            .{ "UNIFORM_BLOCK_INDEX", "get_UNIFORM_BLOCK_INDEX" },
            .{ "UNIFORM_OFFSET", "get_UNIFORM_OFFSET" },
            .{ "UNIFORM_ARRAY_STRIDE", "get_UNIFORM_ARRAY_STRIDE" },
            .{ "UNIFORM_MATRIX_STRIDE", "get_UNIFORM_MATRIX_STRIDE" },
            .{ "UNIFORM_IS_ROW_MAJOR", "get_UNIFORM_IS_ROW_MAJOR" },
            .{ "UNIFORM_BLOCK_BINDING", "get_UNIFORM_BLOCK_BINDING" },
            .{ "UNIFORM_BLOCK_DATA_SIZE", "get_UNIFORM_BLOCK_DATA_SIZE" },
            .{ "UNIFORM_BLOCK_ACTIVE_UNIFORMS", "get_UNIFORM_BLOCK_ACTIVE_UNIFORMS" },
            .{ "UNIFORM_BLOCK_ACTIVE_UNIFORM_INDICES", "get_UNIFORM_BLOCK_ACTIVE_UNIFORM_INDICES" },
            .{ "UNIFORM_BLOCK_REFERENCED_BY_VERTEX_SHADER", "get_UNIFORM_BLOCK_REFERENCED_BY_VERTEX_SHADER" },
            .{ "UNIFORM_BLOCK_REFERENCED_BY_FRAGMENT_SHADER", "get_UNIFORM_BLOCK_REFERENCED_BY_FRAGMENT_SHADER" },
            .{ "INVALID_INDEX", "get_INVALID_INDEX" },
            .{ "MAX_VERTEX_OUTPUT_COMPONENTS", "get_MAX_VERTEX_OUTPUT_COMPONENTS" },
            .{ "MAX_FRAGMENT_INPUT_COMPONENTS", "get_MAX_FRAGMENT_INPUT_COMPONENTS" },
            .{ "MAX_SERVER_WAIT_TIMEOUT", "get_MAX_SERVER_WAIT_TIMEOUT" },
            .{ "OBJECT_TYPE", "get_OBJECT_TYPE" },
            .{ "SYNC_CONDITION", "get_SYNC_CONDITION" },
            .{ "SYNC_STATUS", "get_SYNC_STATUS" },
            .{ "SYNC_FLAGS", "get_SYNC_FLAGS" },
            .{ "SYNC_FENCE", "get_SYNC_FENCE" },
            .{ "SYNC_GPU_COMMANDS_COMPLETE", "get_SYNC_GPU_COMMANDS_COMPLETE" },
            .{ "UNSIGNALED", "get_UNSIGNALED" },
            .{ "SIGNALED", "get_SIGNALED" },
            .{ "ALREADY_SIGNALED", "get_ALREADY_SIGNALED" },
            .{ "TIMEOUT_EXPIRED", "get_TIMEOUT_EXPIRED" },
            .{ "CONDITION_SATISFIED", "get_CONDITION_SATISFIED" },
            .{ "WAIT_FAILED", "get_WAIT_FAILED" },
            .{ "SYNC_FLUSH_COMMANDS_BIT", "get_SYNC_FLUSH_COMMANDS_BIT" },
            .{ "VERTEX_ATTRIB_ARRAY_DIVISOR", "get_VERTEX_ATTRIB_ARRAY_DIVISOR" },
            .{ "ANY_SAMPLES_PASSED", "get_ANY_SAMPLES_PASSED" },
            .{ "ANY_SAMPLES_PASSED_CONSERVATIVE", "get_ANY_SAMPLES_PASSED_CONSERVATIVE" },
            .{ "SAMPLER_BINDING", "get_SAMPLER_BINDING" },
            .{ "RGB10_A2UI", "get_RGB10_A2UI" },
            .{ "INT_2_10_10_10_REV", "get_INT_2_10_10_10_REV" },
            .{ "TRANSFORM_FEEDBACK", "get_TRANSFORM_FEEDBACK" },
            .{ "TRANSFORM_FEEDBACK_PAUSED", "get_TRANSFORM_FEEDBACK_PAUSED" },
            .{ "TRANSFORM_FEEDBACK_ACTIVE", "get_TRANSFORM_FEEDBACK_ACTIVE" },
            .{ "TRANSFORM_FEEDBACK_BINDING", "get_TRANSFORM_FEEDBACK_BINDING" },
            .{ "TEXTURE_IMMUTABLE_FORMAT", "get_TEXTURE_IMMUTABLE_FORMAT" },
            .{ "MAX_ELEMENT_INDEX", "get_MAX_ELEMENT_INDEX" },
            .{ "TEXTURE_IMMUTABLE_LEVELS", "get_TEXTURE_IMMUTABLE_LEVELS" },
            .{ "TIMEOUT_IGNORED", "get_TIMEOUT_IGNORED" },
            .{ "MAX_CLIENT_WAIT_TIMEOUT_WEBGL", "get_MAX_CLIENT_WAIT_TIMEOUT_WEBGL" },
        };
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return WebGL2RenderingContextImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn call_uniform4ui(instance: *runtime.Instance, location: WebGLUniformLocation, v0: GLuint, v1: GLuint, v2: GLuint, v3: GLuint) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_uniform4ui(instance, location, v0, v1, v2, v3);
    }

    pub fn call_resumeTransformFeedback(instance: *runtime.Instance) anyerror!void {
        return try WebGL2RenderingContextImpl.call_resumeTransformFeedback(instance);
    }

    pub fn call_vertexAttribDivisor(instance: *runtime.Instance, index: GLuint, divisor: GLuint) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_vertexAttribDivisor(instance, index, divisor);
    }
    ...
    pub fn call_uniformBlockBinding(instance: *runtime.Instance, program: WebGLProgram, uniformBlockIndex: GLuint, uniformBlockBinding: GLuint) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_uniformBlockBinding(instance, program, uniformBlockIndex, uniformBlockBinding);
    }
    ...
    pub fn call_vertexAttribPointer(instance: *runtime.Instance, index: GLuint, size: GLint, @"type": GLenum, normalized: GLboolean, stride: GLsizei, offset: GLintptr) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_vertexAttribPointer(instance, index, size, @"type", normalized, stride, offset);
    }
    ...
    pub fn call_readPixels(instance: *runtime.Instance, x: GLint, y: GLint, width: GLsizei, height: GLsizei, format: GLenum, @"type": GLenum, dstData: ArrayBufferView) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_readPixels(instance, x, y, width, height, format, @"type", dstData);
    }

    pub fn call_createVertexArray(instance: *runtime.Instance) anyerror!WebGLVertexArrayObject {
        return try WebGL2RenderingContextImpl.call_createVertexArray(instance);
    }

    pub fn call_getActiveAttrib(instance: *runtime.Instance, program: WebGLProgram, index: GLuint) anyerror!WebGLActiveInfo {
        
        return try WebGL2RenderingContextImpl.call_getActiveAttrib(instance, program, index);
    }
    ...
    pub fn call_texImage2D(instance: *runtime.Instance, target: GLenum, level: GLint, internalformat: GLint, width: GLsizei, height: GLsizei, border: GLint, format: GLenum, @"type": GLenum, pixels: ArrayBufferView) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_texImage2D(instance, target, level, internalformat, width, height, border, format, @"type", pixels);
    }

    pub fn call_blendFunc(instance: *runtime.Instance, sfactor: GLenum, dfactor: GLenum) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_blendFunc(instance, sfactor, dfactor);
    }
    ...
    pub fn call_texImage3D(instance: *runtime.Instance, target: GLenum, level: GLint, internalformat: GLint, width: GLsizei, height: GLsizei, depth: GLsizei, border: GLint, format: GLenum, @"type": GLenum, pboOffset: GLintptr) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_texImage3D(instance, target, level, internalformat, width, height, depth, border, format, @"type", pboOffset);
    }
    ...
    pub fn call_texStorage2D(instance: *runtime.Instance, target: GLenum, levels: GLsizei, internalformat: GLenum, width: GLsizei, height: GLsizei) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_texStorage2D(instance, target, levels, internalformat, width, height);
    }

    pub fn call_clientWaitSync(instance: *runtime.Instance, sync: WebGLSync, flags: GLbitfield, timeout: GLuint64) anyerror!GLenum {
        
        return try WebGL2RenderingContextImpl.call_clientWaitSync(instance, sync, flags, timeout);
    }
    ...
    pub fn call_uniform3fv(instance: *runtime.Instance, location: WebGLUniformLocation, data: Float32List, srcOffset: u64, srcLength: GLuint) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_uniform3fv(instance, location, data, srcOffset, srcLength);
    }
    ...
    pub fn call_getContextAttributes(instance: *runtime.Instance) anyerror!WebGLContextAttributes {
        return try WebGL2RenderingContextImpl.call_getContextAttributes(instance);
    }
    ...
    pub fn call_uniformMatrix2x3fv(instance: *runtime.Instance, location: WebGLUniformLocation, transpose: GLboolean, data: Float32List, srcOffset: u64, srcLength: GLuint) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_uniformMatrix2x3fv(instance, location, transpose, data, srcOffset, srcLength);
    }

    /// Extended attributes: [WebGLHandlesContextLoss]
    pub fn call_isRenderbuffer(instance: *runtime.Instance, renderbuffer: WebGLRenderbuffer) anyerror!GLboolean {
        
        return try WebGL2RenderingContextImpl.call_isRenderbuffer(instance, renderbuffer);
    }
    ...
    pub fn call_uniformMatrix2fv(instance: *runtime.Instance, location: WebGLUniformLocation, transpose: GLboolean, data: Float32List, srcOffset: u64, srcLength: GLuint) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_uniformMatrix2fv(instance, location, transpose, data, srcOffset, srcLength);
    }
    ...
    pub fn call_uniform4fv(instance: *runtime.Instance, location: WebGLUniformLocation, data: Float32List, srcOffset: u64, srcLength: GLuint) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_uniform4fv(instance, location, data, srcOffset, srcLength);
    }

    pub fn call_deleteTexture(instance: *runtime.Instance, texture: WebGLTexture) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_deleteTexture(instance, texture);
    }

    pub fn call_getShaderSource(instance: *runtime.Instance, shader: WebGLShader) anyerror!DOMString {
        
        return try WebGL2RenderingContextImpl.call_getShaderSource(instance, shader);
    }
    ...
    pub fn call_clearBufferiv(instance: *runtime.Instance, buffer: GLenum, drawbuffer: GLint, values: Int32List, srcOffset: u64) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_clearBufferiv(instance, buffer, drawbuffer, values, srcOffset);
    }

    pub fn call_vertexAttribI4i(instance: *runtime.Instance, index: GLuint, x: GLint, y: GLint, z: GLint, w: GLint) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_vertexAttribI4i(instance, index, x, y, z, w);
    }

    pub fn call_bindSampler(instance: *runtime.Instance, unit: GLuint, sampler: WebGLSampler) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_bindSampler(instance, unit, sampler);
    }

    pub fn call_vertexAttribI4uiv(instance: *runtime.Instance, index: GLuint, values: Uint32List) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_vertexAttribI4uiv(instance, index, values);
    }

    pub fn call_depthMask(instance: *runtime.Instance, flag: GLboolean) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_depthMask(instance, flag);
    }

    pub fn call_drawElements(instance: *runtime.Instance, mode: GLenum, count: GLsizei, @"type": GLenum, offset: GLintptr) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_drawElements(instance, mode, count, @"type", offset);
    }

    pub fn call_drawBuffers(instance: *runtime.Instance, buffers: *const anyopaque) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_drawBuffers(instance, buffers);
    }

    /// Extended attributes: [WebGLHandlesContextLoss]
    pub fn call_isShader(instance: *runtime.Instance, shader: WebGLShader) anyerror!GLboolean {
        
        return try WebGL2RenderingContextImpl.call_isShader(instance, shader);
    }

    pub fn call_getParameter(instance: *runtime.Instance, pname: GLenum) anyerror!*const anyopaque {
        
        return try WebGL2RenderingContextImpl.call_getParameter(instance, pname);
    }
    ...
    pub fn call_getBufferSubData(instance: *runtime.Instance, target: GLenum, srcByteOffset: GLintptr, dstBuffer: ArrayBufferView, dstOffset: u64, length: GLuint) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_getBufferSubData(instance, target, srcByteOffset, dstBuffer, dstOffset, length);
    }

    pub fn call_drawingBufferStorage(instance: *runtime.Instance, sizedFormat: GLenum, width: u32, height: u32) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_drawingBufferStorage(instance, sizedFormat, width, height);
    }
    ...
    pub fn call_uniform3iv(instance: *runtime.Instance, location: WebGLUniformLocation, data: Int32List, srcOffset: u64, srcLength: GLuint) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_uniform3iv(instance, location, data, srcOffset, srcLength);
    }
    ...
    pub fn call_renderbufferStorage(instance: *runtime.Instance, target: GLenum, internalformat: GLenum, width: GLsizei, height: GLsizei) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_renderbufferStorage(instance, target, internalformat, width, height);
    }

    pub fn call_bindTransformFeedback(instance: *runtime.Instance, target: GLenum, tf: WebGLTransformFeedback) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_bindTransformFeedback(instance, target, tf);
    }

    pub fn call_getVertexAttrib(instance: *runtime.Instance, index: GLuint, pname: GLenum) anyerror!*const anyopaque {
        
        return try WebGL2RenderingContextImpl.call_getVertexAttrib(instance, index, pname);
    }
    ...
    pub fn call_blendFuncSeparate(instance: *runtime.Instance, srcRGB: GLenum, dstRGB: GLenum, srcAlpha: GLenum, dstAlpha: GLenum) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_blendFuncSeparate(instance, srcRGB, dstRGB, srcAlpha, dstAlpha);
    }
    ...
    pub fn call_texSubImage2D(instance: *runtime.Instance, target: GLenum, level: GLint, xoffset: GLint, yoffset: GLint, width: GLsizei, height: GLsizei, format: GLenum, @"type": GLenum, pixels: ArrayBufferView) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_texSubImage2D(instance, target, level, xoffset, yoffset, width, height, format, @"type", pixels);
    }
    ...
    pub fn call_getTransformFeedbackVarying(instance: *runtime.Instance, program: WebGLProgram, index: GLuint) anyerror!WebGLActiveInfo {
        ...
        return try WebGL2RenderingContextImpl.call_getTransformFeedbackVarying(instance, program, index);
    }

    pub fn call_clearColor(instance: *runtime.Instance, red: GLclampf, green: GLclampf, blue: GLclampf, alpha: GLclampf) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_clearColor(instance, red, green, blue, alpha);
    }

    pub fn call_deleteRenderbuffer(instance: *runtime.Instance, renderbuffer: WebGLRenderbuffer) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_deleteRenderbuffer(instance, renderbuffer);
    }

    pub fn call_activeTexture(instance: *runtime.Instance, texture: GLenum) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_activeTexture(instance, texture);
    }
    ...
    pub fn call_compressedTexImage3D(instance: *runtime.Instance, target: GLenum, level: GLint, internalformat: GLenum, width: GLsizei, height: GLsizei, depth: GLsizei, border: GLint, imageSize: GLsizei, offset: GLintptr) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_compressedTexImage3D(instance, target, level, internalformat, width, height, depth, border, imageSize, offset);
    }

    pub fn call_createProgram(instance: *runtime.Instance) anyerror!WebGLProgram {
        return try WebGL2RenderingContextImpl.call_createProgram(instance);
    }
    ...
    pub fn call_uniform2uiv(instance: *runtime.Instance, location: WebGLUniformLocation, data: Uint32List, srcOffset: u64, srcLength: GLuint) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_uniform2uiv(instance, location, data, srcOffset, srcLength);
    }

    pub fn call_getProgramInfoLog(instance: *runtime.Instance, program: WebGLProgram) anyerror!DOMString {
        
        return try WebGL2RenderingContextImpl.call_getProgramInfoLog(instance, program);
    }
    ...
    pub fn call_uniform1fv(instance: *runtime.Instance, location: WebGLUniformLocation, data: Float32List, srcOffset: u64, srcLength: GLuint) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_uniform1fv(instance, location, data, srcOffset, srcLength);
    }

    pub fn call_deleteProgram(instance: *runtime.Instance, program: WebGLProgram) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_deleteProgram(instance, program);
    }
    ...
    pub fn call_uniform1uiv(instance: *runtime.Instance, location: WebGLUniformLocation, data: Uint32List, srcOffset: u64, srcLength: GLuint) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_uniform1uiv(instance, location, data, srcOffset, srcLength);
    }
    ...
    pub fn call_bindBufferRange(instance: *runtime.Instance, target: GLenum, index: GLuint, buffer: WebGLBuffer, offset: GLintptr, size: GLsizeiptr) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_bindBufferRange(instance, target, index, buffer, offset, size);
    }
    ...
    pub fn call_texStorage3D(instance: *runtime.Instance, target: GLenum, levels: GLsizei, internalformat: GLenum, width: GLsizei, height: GLsizei, depth: GLsizei) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_texStorage3D(instance, target, levels, internalformat, width, height, depth);
    }

    pub fn call_frontFace(instance: *runtime.Instance, mode: GLenum) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_frontFace(instance, mode);
    }

    /// Extended attributes: [WebGLHandlesContextLoss]
    pub fn call_isBuffer(instance: *runtime.Instance, buffer: WebGLBuffer) anyerror!GLboolean {
        
        return try WebGL2RenderingContextImpl.call_isBuffer(instance, buffer);
    }

    pub fn call_bindTexture(instance: *runtime.Instance, target: GLenum, texture: WebGLTexture) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_bindTexture(instance, target, texture);
    }

    pub fn call_uniform3f(instance: *runtime.Instance, location: WebGLUniformLocation, x: GLfloat, y: GLfloat, z: GLfloat) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_uniform3f(instance, location, x, y, z);
    }

    pub fn call_blendEquation(instance: *runtime.Instance, mode: GLenum) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_blendEquation(instance, mode);
    }

    pub fn call_enableVertexAttribArray(instance: *runtime.Instance, index: GLuint) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_enableVertexAttribArray(instance, index);
    }

    /// Extended attributes: [WebGLHandlesContextLoss]
    pub fn call_isFramebuffer(instance: *runtime.Instance, framebuffer: WebGLFramebuffer) anyerror!GLboolean {
        
        return try WebGL2RenderingContextImpl.call_isFramebuffer(instance, framebuffer);
    }

    pub fn call_finish(instance: *runtime.Instance) anyerror!void {
        return try WebGL2RenderingContextImpl.call_finish(instance);
    }

    /// Extended attributes: [WebGLHandlesContextLoss]
    pub fn call_checkFramebufferStatus(instance: *runtime.Instance, target: GLenum) anyerror!GLenum {
        
        return try WebGL2RenderingContextImpl.call_checkFramebufferStatus(instance, target);
    }

    pub fn call_getRenderbufferParameter(instance: *runtime.Instance, target: GLenum, pname: GLenum) anyerror!*const anyopaque {
        
        return try WebGL2RenderingContextImpl.call_getRenderbufferParameter(instance, target, pname);
    }

    /// Extended attributes: [WebGLHandlesContextLoss]
    pub fn call_isTexture(instance: *runtime.Instance, texture: WebGLTexture) anyerror!GLboolean {
        
        return try WebGL2RenderingContextImpl.call_isTexture(instance, texture);
    }

    pub fn call_linkProgram(instance: *runtime.Instance, program: WebGLProgram) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_linkProgram(instance, program);
    }

    pub fn call_framebufferRenderbuffer(instance: *runtime.Instance, target: GLenum, attachment: GLenum, renderbuffertarget: GLenum, renderbuffer: WebGLRenderbuffer) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_framebufferRenderbuffer(instance, target, attachment, renderbuffertarget, renderbuffer);
    }

    pub fn call_getActiveUniform(instance: *runtime.Instance, program: WebGLProgram, index: GLuint) anyerror!WebGLActiveInfo {
        
        return try WebGL2RenderingContextImpl.call_getActiveUniform(instance, program, index);
    }

    pub fn call_vertexAttrib1f(instance: *runtime.Instance, index: GLuint, x: GLfloat) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_vertexAttrib1f(instance, index, x);
    }

    pub fn call_getShaderInfoLog(instance: *runtime.Instance, shader: WebGLShader) anyerror!DOMString {
        
        return try WebGL2RenderingContextImpl.call_getShaderInfoLog(instance, shader);
    }

    /// Extended attributes: [WebGLHandlesContextLoss]
    pub fn call_isContextLost(instance: *runtime.Instance) anyerror!bool {
        return try WebGL2RenderingContextImpl.call_isContextLost(instance);
    }

    pub fn call_deleteFramebuffer(instance: *runtime.Instance, framebuffer: WebGLFramebuffer) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_deleteFramebuffer(instance, framebuffer);
    }

    pub fn call_uniform2ui(instance: *runtime.Instance, location: WebGLUniformLocation, v0: GLuint, v1: GLuint) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_uniform2ui(instance, location, v0, v1);
    }
    ...
    pub fn call_uniformMatrix4x3fv(instance: *runtime.Instance, location: WebGLUniformLocation, transpose: GLboolean, data: Float32List, srcOffset: u64, srcLength: GLuint) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_uniformMatrix4x3fv(instance, location, transpose, data, srcOffset, srcLength);
    }
    ...
    pub fn call_getUniformBlockIndex(instance: *runtime.Instance, program: WebGLProgram, uniformBlockName: DOMString) anyerror!GLuint {
        ...
        return try WebGL2RenderingContextImpl.call_getUniformBlockIndex(instance, program, uniformBlockName);
    }
    ...
    pub fn call_compressedTexSubImage2D(instance: *runtime.Instance, target: GLenum, level: GLint, xoffset: GLint, yoffset: GLint, width: GLsizei, height: GLsizei, format: GLenum, imageSize: GLsizei, offset: GLintptr) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_compressedTexSubImage2D(instance, target, level, xoffset, yoffset, width, height, format, imageSize, offset);
    }

    pub fn call_bindAttribLocation(instance: *runtime.Instance, program: WebGLProgram, index: GLuint, name: DOMString) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_bindAttribLocation(instance, program, index, name);
    }

    pub fn call_getUniformLocation(instance: *runtime.Instance, program: WebGLProgram, name: DOMString) anyerror!WebGLUniformLocation {
        
        return try WebGL2RenderingContextImpl.call_getUniformLocation(instance, program, name);
    }
    ...
    pub fn call_uniform4iv(instance: *runtime.Instance, location: WebGLUniformLocation, data: Int32List, srcOffset: u64, srcLength: GLuint) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_uniform4iv(instance, location, data, srcOffset, srcLength);
    }

    pub fn call_bindBufferBase(instance: *runtime.Instance, target: GLenum, index: GLuint, buffer: WebGLBuffer) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_bindBufferBase(instance, target, index, buffer);
    }

    pub fn call_getExtension(instance: *runtime.Instance, name: DOMString) anyerror!*const anyopaque {
        
        return try WebGL2RenderingContextImpl.call_getExtension(instance, name);
    }
    ...
    pub fn call_colorMask(instance: *runtime.Instance, red: GLboolean, green: GLboolean, blue: GLboolean, alpha: GLboolean) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_colorMask(instance, red, green, blue, alpha);
    }

    pub fn call_cullFace(instance: *runtime.Instance, mode: GLenum) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_cullFace(instance, mode);
    }

    pub fn call_deleteShader(instance: *runtime.Instance, shader: WebGLShader) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_deleteShader(instance, shader);
    }

    pub fn call_vertexAttrib4fv(instance: *runtime.Instance, index: GLuint, values: Float32List) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_vertexAttrib4fv(instance, index, values);
    }

    pub fn call_disableVertexAttribArray(instance: *runtime.Instance, index: GLuint) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_disableVertexAttribArray(instance, index);
    }
    ...
    pub fn call_uniformMatrix4x2fv(instance: *runtime.Instance, location: WebGLUniformLocation, transpose: GLboolean, data: Float32List, srcOffset: u64, srcLength: GLuint) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_uniformMatrix4x2fv(instance, location, transpose, data, srcOffset, srcLength);
    }

    /// Extended attributes: [WebGLHandlesContextLoss]
    pub fn call_getAttribLocation(instance: *runtime.Instance, program: WebGLProgram, name: DOMString) anyerror!GLint {
        
        return try WebGL2RenderingContextImpl.call_getAttribLocation(instance, program, name);
    }
    ...
    pub fn call_drawArraysInstanced(instance: *runtime.Instance, mode: GLenum, first: GLint, count: GLsizei, instanceCount: GLsizei) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_drawArraysInstanced(instance, mode, first, count, instanceCount);
    }

    pub fn call_uniform3i(instance: *runtime.Instance, location: WebGLUniformLocation, x: GLint, y: GLint, z: GLint) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_uniform3i(instance, location, x, y, z);
    }

    pub fn call_uniform2i(instance: *runtime.Instance, location: WebGLUniformLocation, x: GLint, y: GLint) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_uniform2i(instance, location, x, y);
    }

    pub fn call_vertexAttrib1fv(instance: *runtime.Instance, index: GLuint, values: Float32List) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_vertexAttrib1fv(instance, index, values);
    }
    ...
    pub fn call_bufferSubData(instance: *runtime.Instance, target: GLenum, dstByteOffset: GLintptr, srcData: AllowSharedBufferSource) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_bufferSubData(instance, target, dstByteOffset, srcData);
    }

    pub fn call_scissor(instance: *runtime.Instance, x: GLint, y: GLint, width: GLsizei, height: GLsizei) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_scissor(instance, x, y, width, height);
    }

    pub fn call_vertexAttribI4iv(instance: *runtime.Instance, index: GLuint, values: Int32List) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_vertexAttribI4iv(instance, index, values);
    }

    pub fn call_getShaderParameter(instance: *runtime.Instance, shader: WebGLShader, pname: GLenum) anyerror!*const anyopaque {
        
        return try WebGL2RenderingContextImpl.call_getShaderParameter(instance, shader, pname);
    }

    /// Extended attributes: [WebGLHandlesContextLoss]
    pub fn call_isProgram(instance: *runtime.Instance, program: WebGLProgram) anyerror!GLboolean {
        
        return try WebGL2RenderingContextImpl.call_isProgram(instance, program);
    }
    ...
    pub fn call_uniformMatrix3x4fv(instance: *runtime.Instance, location: WebGLUniformLocation, transpose: GLboolean, data: Float32List, srcOffset: u64, srcLength: GLuint) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_uniformMatrix3x4fv(instance, location, transpose, data, srcOffset, srcLength);
    }

    pub fn call_lineWidth(instance: *runtime.Instance, width: GLfloat) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_lineWidth(instance, width);
    }

    pub fn call_uniform1ui(instance: *runtime.Instance, location: WebGLUniformLocation, v0: GLuint) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_uniform1ui(instance, location, v0);
    }

    pub fn call_uniform1i(instance: *runtime.Instance, location: WebGLUniformLocation, x: GLint) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_uniform1i(instance, location, x);
    }

    pub fn call_getShaderPrecisionFormat(instance: *runtime.Instance, shadertype: GLenum, precisiontype: GLenum) anyerror!WebGLShaderPrecisionFormat {
        
        return try WebGL2RenderingContextImpl.call_getShaderPrecisionFormat(instance, shadertype, precisiontype);
    }

    pub fn call_samplerParameterf(instance: *runtime.Instance, sampler: WebGLSampler, pname: GLenum, param: GLfloat) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_samplerParameterf(instance, sampler, pname, param);
    }

    pub fn call_texParameterf(instance: *runtime.Instance, target: GLenum, pname: GLenum, param: GLfloat) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_texParameterf(instance, target, pname, param);
    }
    ...
    pub fn call_copyBufferSubData(instance: *runtime.Instance, readTarget: GLenum, writeTarget: GLenum, readOffset: GLintptr, writeOffset: GLintptr, size: GLsizeiptr) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_copyBufferSubData(instance, readTarget, writeTarget, readOffset, writeOffset, size);
    }

    pub fn call_sampleCoverage(instance: *runtime.Instance, value: GLclampf, invert: GLboolean) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_sampleCoverage(instance, value, invert);
    }
    ...
    pub fn call_uniform1iv(instance: *runtime.Instance, location: WebGLUniformLocation, data: Int32List, srcOffset: u64, srcLength: GLuint) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_uniform1iv(instance, location, data, srcOffset, srcLength);
    }
    ...
    pub fn call_uniformMatrix4fv(instance: *runtime.Instance, location: WebGLUniformLocation, transpose: GLboolean, data: Float32List, srcOffset: u64, srcLength: GLuint) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_uniformMatrix4fv(instance, location, transpose, data, srcOffset, srcLength);
    }

    pub fn call_getAttachedShaders(instance: *runtime.Instance, program: WebGLProgram) anyerror!*const anyopaque {
        
        return try WebGL2RenderingContextImpl.call_getAttachedShaders(instance, program);
    }

    pub fn call_createFramebuffer(instance: *runtime.Instance) anyerror!WebGLFramebuffer {
        return try WebGL2RenderingContextImpl.call_createFramebuffer(instance);
    }

    pub fn call_createTexture(instance: *runtime.Instance) anyerror!WebGLTexture {
        return try WebGL2RenderingContextImpl.call_createTexture(instance);
    }

    pub fn call_vertexAttrib4f(instance: *runtime.Instance, index: GLuint, x: GLfloat, y: GLfloat, z: GLfloat, w: GLfloat) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_vertexAttrib4f(instance, index, x, y, z, w);
    }

    pub fn call_uniform4f(instance: *runtime.Instance, location: WebGLUniformLocation, x: GLfloat, y: GLfloat, z: GLfloat, w: GLfloat) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_uniform4f(instance, location, x, y, z, w);
    }

    pub fn call_createTransformFeedback(instance: *runtime.Instance) anyerror!WebGLTransformFeedback {
        return try WebGL2RenderingContextImpl.call_createTransformFeedback(instance);
    }

    pub fn call_getQuery(instance: *runtime.Instance, target: GLenum, pname: GLenum) anyerror!WebGLQuery {
        
        return try WebGL2RenderingContextImpl.call_getQuery(instance, target, pname);
    }

    pub fn call_stencilOpSeparate(instance: *runtime.Instance, face: GLenum, fail: GLenum, zfail: GLenum, zpass: GLenum) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_stencilOpSeparate(instance, face, fail, zfail, zpass);
    }

    pub fn call_endTransformFeedback(instance: *runtime.Instance) anyerror!void {
        return try WebGL2RenderingContextImpl.call_endTransformFeedback(instance);
    }

    pub fn call_generateMipmap(instance: *runtime.Instance, target: GLenum) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_generateMipmap(instance, target);
    }

    pub fn call_getUniformIndices(instance: *runtime.Instance, program: WebGLProgram, uniformNames: *const anyopaque) anyerror!*const anyopaque {
        
        return try WebGL2RenderingContextImpl.call_getUniformIndices(instance, program, uniformNames);
    }
    ...
    pub fn call_clearBufferfi(instance: *runtime.Instance, buffer: GLenum, drawbuffer: GLint, depth: GLfloat, stencil: GLint) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_clearBufferfi(instance, buffer, drawbuffer, depth, stencil);
    }
    ...
    pub fn call_isEnabled(instance: *runtime.Instance, cap: GLenum) anyerror!GLboolean {
        ...
        return try WebGL2RenderingContextImpl.call_isEnabled(instance, cap);
    }
    ...
    pub fn call_copyTexSubImage2D(instance: *runtime.Instance, target: GLenum, level: GLint, xoffset: GLint, yoffset: GLint, x: GLint, y: GLint, width: GLsizei, height: GLsizei) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_copyTexSubImage2D(instance, target, level, xoffset, yoffset, x, y, width, height);
    }

    pub fn call_fenceSync(instance: *runtime.Instance, condition: GLenum, flags: GLbitfield) anyerror!WebGLSync {
        
        return try WebGL2RenderingContextImpl.call_fenceSync(instance, condition, flags);
    }

    pub fn call_vertexAttrib2f(instance: *runtime.Instance, index: GLuint, x: GLfloat, y: GLfloat) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_vertexAttrib2f(instance, index, x, y);
    }

    pub fn call_clear(instance: *runtime.Instance, mask: GLbitfield) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_clear(instance, mask);
    }
    ...
    pub fn call_copyTexSubImage3D(instance: *runtime.Instance, target: GLenum, level: GLint, xoffset: GLint, yoffset: GLint, zoffset: GLint, x: GLint, y: GLint, width: GLsizei, height: GLsizei) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_copyTexSubImage3D(instance, target, level, xoffset, yoffset, zoffset, x, y, width, height);
    }
    ...
    pub fn call_texSubImage3D(instance: *runtime.Instance, target: GLenum, level: GLint, xoffset: GLint, yoffset: GLint, zoffset: GLint, width: GLsizei, height: GLsizei, depth: GLsizei, format: GLenum, @"type": GLenum, pboOffset: GLintptr) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_texSubImage3D(instance, target, level, xoffset, yoffset, zoffset, width, height, depth, format, @"type", pboOffset);
    }
    ...
    pub fn call_uniform2fv(instance: *runtime.Instance, location: WebGLUniformLocation, data: Float32List, srcOffset: u64, srcLength: GLuint) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_uniform2fv(instance, location, data, srcOffset, srcLength);
    }

    pub fn call_disable(instance: *runtime.Instance, cap: GLenum) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_disable(instance, cap);
    }
    ...
    pub fn call_framebufferTextureLayer(instance: *runtime.Instance, target: GLenum, attachment: GLenum, texture: WebGLTexture, level: GLint, layer: GLint) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_framebufferTextureLayer(instance, target, attachment, texture, level, layer);
    }

    pub fn call_endQuery(instance: *runtime.Instance, target: GLenum) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_endQuery(instance, target);
    }

    pub fn call_compileShader(instance: *runtime.Instance, shader: WebGLShader) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_compileShader(instance, shader);
    }
    ...
    pub fn call_drawElementsInstanced(instance: *runtime.Instance, mode: GLenum, count: GLsizei, @"type": GLenum, offset: GLintptr, instanceCount: GLsizei) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_drawElementsInstanced(instance, mode, count, @"type", offset, instanceCount);
    }

    pub fn call_blendEquationSeparate(instance: *runtime.Instance, modeRGB: GLenum, modeAlpha: GLenum) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_blendEquationSeparate(instance, modeRGB, modeAlpha);
    }

    /// Extended attributes: [WebGLHandlesContextLoss]
    pub fn call_isSampler(instance: *runtime.Instance, sampler: WebGLSampler) anyerror!GLboolean {
        
        return try WebGL2RenderingContextImpl.call_isSampler(instance, sampler);
    }

    pub fn call_getSamplerParameter(instance: *runtime.Instance, sampler: WebGLSampler, pname: GLenum) anyerror!*const anyopaque {
        
        return try WebGL2RenderingContextImpl.call_getSamplerParameter(instance, sampler, pname);
    }

    pub fn call_depthRange(instance: *runtime.Instance, zNear: GLclampf, zFar: GLclampf) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_depthRange(instance, zNear, zFar);
    }
    ...
    pub fn call_getActiveUniformBlockName(instance: *runtime.Instance, program: WebGLProgram, uniformBlockIndex: GLuint) anyerror!DOMString {
        ...
        return try WebGL2RenderingContextImpl.call_getActiveUniformBlockName(instance, program, uniformBlockIndex);
    }

    pub fn call_polygonOffset(instance: *runtime.Instance, factor: GLfloat, units: GLfloat) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_polygonOffset(instance, factor, units);
    }

    pub fn call_vertexAttribI4ui(instance: *runtime.Instance, index: GLuint, x: GLuint, y: GLuint, z: GLuint, w: GLuint) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_vertexAttribI4ui(instance, index, x, y, z, w);
    }

    /// Extended attributes: [WebGLHandlesContextLoss]
    pub fn call_isVertexArray(instance: *runtime.Instance, vertexArray: WebGLVertexArrayObject) anyerror!GLboolean {
        
        return try WebGL2RenderingContextImpl.call_isVertexArray(instance, vertexArray);
    }

    pub fn call_bindBuffer(instance: *runtime.Instance, target: GLenum, buffer: WebGLBuffer) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_bindBuffer(instance, target, buffer);
    }

    /// Extended attributes: [NewObject]
    pub fn call_makeXRCompatible(instance: *runtime.Instance) anyerror!*const anyopaque {
        // [NewObject] - Caller owns the returned object
        return try WebGL2RenderingContextImpl.call_makeXRCompatible(instance);
    }

    pub fn call_getQueryParameter(instance: *runtime.Instance, query: WebGLQuery, pname: GLenum) anyerror!*const anyopaque {
        
        return try WebGL2RenderingContextImpl.call_getQueryParameter(instance, query, pname);
    }
    ...
    pub fn call_uniformMatrix3x2fv(instance: *runtime.Instance, location: WebGLUniformLocation, transpose: GLboolean, data: Float32List, srcOffset: u64, srcLength: GLuint) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_uniformMatrix3x2fv(instance, location, transpose, data, srcOffset, srcLength);
    }

    pub fn call_deleteQuery(instance: *runtime.Instance, query: WebGLQuery) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_deleteQuery(instance, query);
    }

    pub fn call_getSupportedExtensions(instance: *runtime.Instance) anyerror!*const anyopaque {
        return try WebGL2RenderingContextImpl.call_getSupportedExtensions(instance);
    }

    /// Extended attributes: [WebGLHandlesContextLoss]
    pub fn call_isSync(instance: *runtime.Instance, sync: WebGLSync) anyerror!GLboolean {
        
        return try WebGL2RenderingContextImpl.call_isSync(instance, sync);
    }
    ...
    pub fn call_compressedTexImage2D(instance: *runtime.Instance, target: GLenum, level: GLint, internalformat: GLenum, width: GLsizei, height: GLsizei, border: GLint, imageSize: GLsizei, offset: GLintptr) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_compressedTexImage2D(instance, target, level, internalformat, width, height, border, imageSize, offset);
    }

    pub fn call_clearStencil(instance: *runtime.Instance, s: GLint) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_clearStencil(instance, s);
    }

    pub fn call_enable(instance: *runtime.Instance, cap: GLenum) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_enable(instance, cap);
    }

    pub fn call_shaderSource(instance: *runtime.Instance, shader: WebGLShader, source: DOMString) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_shaderSource(instance, shader, source);
    }

    pub fn call_clearDepth(instance: *runtime.Instance, depth: GLclampf) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_clearDepth(instance, depth);
    }

    pub fn call_detachShader(instance: *runtime.Instance, program: WebGLProgram, shader: WebGLShader) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_detachShader(instance, program, shader);
    }

    /// Extended attributes: [WebGLHandlesContextLoss]
    pub fn call_getError(instance: *runtime.Instance) anyerror!GLenum {
        return try WebGL2RenderingContextImpl.call_getError(instance);
    }

    pub fn call_vertexAttrib3fv(instance: *runtime.Instance, index: GLuint, values: Float32List) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_vertexAttrib3fv(instance, index, values);
    }

    pub fn call_stencilFunc(instance: *runtime.Instance, func: GLenum, ref: GLint, mask: GLuint) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_stencilFunc(instance, func, ref, mask);
    }

    pub fn call_getActiveUniformBlockParameter(instance: *runtime.Instance, program: WebGLProgram, uniformBlockIndex: GLuint, pname: GLenum) anyerror!*const anyopaque {
        
        return try WebGL2RenderingContextImpl.call_getActiveUniformBlockParameter(instance, program, uniformBlockIndex, pname);
    }

    pub fn call_framebufferTexture2D(instance: *runtime.Instance, target: GLenum, attachment: GLenum, textarget: GLenum, texture: WebGLTexture, level: GLint) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_framebufferTexture2D(instance, target, attachment, textarget, texture, level);
    }

    pub fn call_invalidateFramebuffer(instance: *runtime.Instance, target: GLenum, attachments: *const anyopaque) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_invalidateFramebuffer(instance, target, attachments);
    }

    pub fn call_getIndexedParameter(instance: *runtime.Instance, target: GLenum, index: GLuint) anyerror!*const anyopaque {
        
        return try WebGL2RenderingContextImpl.call_getIndexedParameter(instance, target, index);
    }

    pub fn call_deleteVertexArray(instance: *runtime.Instance, vertexArray: WebGLVertexArrayObject) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_deleteVertexArray(instance, vertexArray);
    }

    pub fn call_createShader(instance: *runtime.Instance, @"type": GLenum) anyerror!WebGLShader {
        
        return try WebGL2RenderingContextImpl.call_createShader(instance, @"type");
    }

    pub fn call_useProgram(instance: *runtime.Instance, program: WebGLProgram) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_useProgram(instance, program);
    }
    ...
    pub fn call_clearBufferuiv(instance: *runtime.Instance, buffer: GLenum, drawbuffer: GLint, values: Uint32List, srcOffset: u64) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_clearBufferuiv(instance, buffer, drawbuffer, values, srcOffset);
    }
    ...
    pub fn call_renderbufferStorageMultisample(instance: *runtime.Instance, target: GLenum, samples: GLsizei, internalformat: GLenum, width: GLsizei, height: GLsizei) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_renderbufferStorageMultisample(instance, target, samples, internalformat, width, height);
    }

    pub fn call_bindFramebuffer(instance: *runtime.Instance, target: GLenum, framebuffer: WebGLFramebuffer) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_bindFramebuffer(instance, target, framebuffer);
    }

    pub fn call_stencilFuncSeparate(instance: *runtime.Instance, face: GLenum, func: GLenum, ref: GLint, mask: GLuint) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_stencilFuncSeparate(instance, face, func, ref, mask);
    }
    ...
    pub fn call_clearBufferfv(instance: *runtime.Instance, buffer: GLenum, drawbuffer: GLint, values: Float32List, srcOffset: u64) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_clearBufferfv(instance, buffer, drawbuffer, values, srcOffset);
    }

    pub fn call_vertexAttrib3f(instance: *runtime.Instance, index: GLuint, x: GLfloat, y: GLfloat, z: GLfloat) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_vertexAttrib3f(instance, index, x, y, z);
    }

    pub fn call_transformFeedbackVaryings(instance: *runtime.Instance, program: WebGLProgram, varyings: *const anyopaque, bufferMode: GLenum) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_transformFeedbackVaryings(instance, program, varyings, bufferMode);
    }

    pub fn call_texParameteri(instance: *runtime.Instance, target: GLenum, pname: GLenum, param: GLint) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_texParameteri(instance, target, pname, param);
    }

    pub fn call_pixelStorei(instance: *runtime.Instance, pname: GLenum, param: GLint) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_pixelStorei(instance, pname, param);
    }

    pub fn call_viewport(instance: *runtime.Instance, x: GLint, y: GLint, width: GLsizei, height: GLsizei) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_viewport(instance, x, y, width, height);
    }
    ...
    pub fn call_invalidateSubFramebuffer(instance: *runtime.Instance, target: GLenum, attachments: *const anyopaque, x: GLint, y: GLint, width: GLsizei, height: GLsizei) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_invalidateSubFramebuffer(instance, target, attachments, x, y, width, height);
    }

    pub fn call_stencilOp(instance: *runtime.Instance, fail: GLenum, zfail: GLenum, zpass: GLenum) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_stencilOp(instance, fail, zfail, zpass);
    }

    pub fn call_deleteSampler(instance: *runtime.Instance, sampler: WebGLSampler) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_deleteSampler(instance, sampler);
    }

    pub fn call_getSyncParameter(instance: *runtime.Instance, sync: WebGLSync, pname: GLenum) anyerror!*const anyopaque {
        
        return try WebGL2RenderingContextImpl.call_getSyncParameter(instance, sync, pname);
    }

    pub fn call_bindRenderbuffer(instance: *runtime.Instance, target: GLenum, renderbuffer: WebGLRenderbuffer) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_bindRenderbuffer(instance, target, renderbuffer);
    }

    pub fn call_depthFunc(instance: *runtime.Instance, func: GLenum) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_depthFunc(instance, func);
    }

    pub fn call_hint(instance: *runtime.Instance, target: GLenum, mode: GLenum) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_hint(instance, target, mode);
    }
    ...
    pub fn call_blitFramebuffer(instance: *runtime.Instance, srcX0: GLint, srcY0: GLint, srcX1: GLint, srcY1: GLint, dstX0: GLint, dstY0: GLint, dstX1: GLint, dstY1: GLint, mask: GLbitfield, filter: GLenum) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_blitFramebuffer(instance, srcX0, srcY0, srcX1, srcY1, dstX0, dstY0, dstX1, dstY1, mask, filter);
    }
    ...
    pub fn call_drawRangeElements(instance: *runtime.Instance, mode: GLenum, start: GLuint, end: GLuint, count: GLsizei, @"type": GLenum, offset: GLintptr) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_drawRangeElements(instance, mode, start, end, count, @"type", offset);
    }

    pub fn call_uniform1f(instance: *runtime.Instance, location: WebGLUniformLocation, x: GLfloat) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_uniform1f(instance, location, x);
    }

    pub fn call_beginTransformFeedback(instance: *runtime.Instance, primitiveMode: GLenum) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_beginTransformFeedback(instance, primitiveMode);
    }

    pub fn call_bindVertexArray(instance: *runtime.Instance, array: WebGLVertexArrayObject) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_bindVertexArray(instance, array);
    }
    ...
    pub fn call_uniformMatrix3fv(instance: *runtime.Instance, location: WebGLUniformLocation, transpose: GLboolean, data: Float32List, srcOffset: u64, srcLength: GLuint) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_uniformMatrix3fv(instance, location, transpose, data, srcOffset, srcLength);
    }

    pub fn call_pauseTransformFeedback(instance: *runtime.Instance) anyerror!void {
        return try WebGL2RenderingContextImpl.call_pauseTransformFeedback(instance);
    }

    /// Extended attributes: [WebGLHandlesContextLoss]
    pub fn call_isQuery(instance: *runtime.Instance, query: WebGLQuery) anyerror!GLboolean {
        
        return try WebGL2RenderingContextImpl.call_isQuery(instance, query);
    }
    ...
    pub fn call_uniform3uiv(instance: *runtime.Instance, location: WebGLUniformLocation, data: Uint32List, srcOffset: u64, srcLength: GLuint) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_uniform3uiv(instance, location, data, srcOffset, srcLength);
    }

    pub fn call_getProgramParameter(instance: *runtime.Instance, program: WebGLProgram, pname: GLenum) anyerror!*const anyopaque {
        
        return try WebGL2RenderingContextImpl.call_getProgramParameter(instance, program, pname);
    }

    pub fn call_flush(instance: *runtime.Instance) anyerror!void {
        return try WebGL2RenderingContextImpl.call_flush(instance);
    }

    pub fn call_vertexAttrib2fv(instance: *runtime.Instance, index: GLuint, values: Float32List) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_vertexAttrib2fv(instance, index, values);
    }

    pub fn call_getInternalformatParameter(instance: *runtime.Instance, target: GLenum, internalformat: GLenum, pname: GLenum) anyerror!*const anyopaque {
        
        return try WebGL2RenderingContextImpl.call_getInternalformatParameter(instance, target, internalformat, pname);
    }
    ...
    pub fn call_uniform4uiv(instance: *runtime.Instance, location: WebGLUniformLocation, data: Uint32List, srcOffset: u64, srcLength: GLuint) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_uniform4uiv(instance, location, data, srcOffset, srcLength);
    }

    pub fn call_createQuery(instance: *runtime.Instance) anyerror!WebGLQuery {
        return try WebGL2RenderingContextImpl.call_createQuery(instance);
    }

    pub fn call_uniform2f(instance: *runtime.Instance, location: WebGLUniformLocation, x: GLfloat, y: GLfloat) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_uniform2f(instance, location, x, y);
    }

    pub fn call_drawArrays(instance: *runtime.Instance, mode: GLenum, first: GLint, count: GLsizei) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_drawArrays(instance, mode, first, count);
    }

    pub fn call_validateProgram(instance: *runtime.Instance, program: WebGLProgram) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_validateProgram(instance, program);
    }

    pub fn call_deleteSync(instance: *runtime.Instance, sync: WebGLSync) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_deleteSync(instance, sync);
    }

    /// Extended attributes: [WebGLHandlesContextLoss]
    pub fn call_getFragDataLocation(instance: *runtime.Instance, program: WebGLProgram, name: DOMString) anyerror!GLint {
        
        return try WebGL2RenderingContextImpl.call_getFragDataLocation(instance, program, name);
    }

    pub fn call_createBuffer(instance: *runtime.Instance) anyerror!WebGLBuffer {
        return try WebGL2RenderingContextImpl.call_createBuffer(instance);
    }

    pub fn call_getActiveUniforms(instance: *runtime.Instance, program: WebGLProgram, uniformIndices: *const anyopaque, pname: GLenum) anyerror!*const anyopaque {
        
        return try WebGL2RenderingContextImpl.call_getActiveUniforms(instance, program, uniformIndices, pname);
    }

    /// Extended attributes: [WebGLHandlesContextLoss]
    pub fn call_getVertexAttribOffset(instance: *runtime.Instance, index: GLuint, pname: GLenum) anyerror!GLintptr {
        
        return try WebGL2RenderingContextImpl.call_getVertexAttribOffset(instance, index, pname);
    }
    ...
    pub fn call_compressedTexSubImage3D(instance: *runtime.Instance, target: GLenum, level: GLint, xoffset: GLint, yoffset: GLint, zoffset: GLint, width: GLsizei, height: GLsizei, depth: GLsizei, format: GLenum, imageSize: GLsizei, offset: GLintptr) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_compressedTexSubImage3D(instance, target, level, xoffset, yoffset, zoffset, width, height, depth, format, imageSize, offset);
    }

    pub fn call_uniform4i(instance: *runtime.Instance, location: WebGLUniformLocation, x: GLint, y: GLint, z: GLint, w: GLint) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_uniform4i(instance, location, x, y, z, w);
    }

    pub fn call_deleteBuffer(instance: *runtime.Instance, buffer: WebGLBuffer) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_deleteBuffer(instance, buffer);
    }

    pub fn call_stencilMask(instance: *runtime.Instance, mask: GLuint) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_stencilMask(instance, mask);
    }
    ...
    pub fn call_uniformMatrix2x4fv(instance: *runtime.Instance, location: WebGLUniformLocation, transpose: GLboolean, data: Float32List, srcOffset: u64, srcLength: GLuint) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_uniformMatrix2x4fv(instance, location, transpose, data, srcOffset, srcLength);
    }
    ...
    pub fn call_copyTexImage2D(instance: *runtime.Instance, target: GLenum, level: GLint, internalformat: GLenum, x: GLint, y: GLint, width: GLsizei, height: GLsizei, border: GLint) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_copyTexImage2D(instance, target, level, internalformat, x, y, width, height, border);
    }
    ...
    pub fn call_uniform2iv(instance: *runtime.Instance, location: WebGLUniformLocation, data: Int32List, srcOffset: u64, srcLength: GLuint) anyerror!void {
        ...
        return try WebGL2RenderingContextImpl.call_uniform2iv(instance, location, data, srcOffset, srcLength);
    }

    pub fn call_attachShader(instance: *runtime.Instance, program: WebGLProgram, shader: WebGLShader) anyerror!void {
        
        return try WebGL2RenderingContextImpl.call_attachShader(instance, program, shader);
    }

    pub fn call_getUniform(instance: *runtime.Instance, program: WebGLProgram, location: WebGLUniformLocation) anyerror!*const anyopaque {
        
        return try WebGL2RenderingContextImpl.call_getUniform(instance, program, location);
    }
