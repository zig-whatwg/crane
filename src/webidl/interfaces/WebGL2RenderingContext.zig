...
const WebGL2RenderingContextBase = @import("mixins").WebGL2RenderingContextBase;
const WebGL2RenderingContextOverloads = @import("mixins").WebGL2RenderingContextOverloads;
const WebGLActiveInfo = @import("WebGLActiveInfo.zig").WebGLActiveInfo;
const GLboolean = @import("typedefs").GLboolean;
const WebGLSampler = @import("WebGLSampler.zig").WebGLSampler;
const WebGLVertexArrayObject = @import("WebGLVertexArrayObject.zig").WebGLVertexArrayObject;
const GLint = @import("typedefs").GLint;
const ArrayBufferView = @import("typedefs").ArrayBufferView;
const WebGLTransformFeedback = @import("WebGLTransformFeedback.zig").WebGLTransformFeedback;
const WebGLSync = @import("WebGLSync.zig").WebGLSync;
...
const WebGLProgram = @import("WebGLProgram.zig").WebGLProgram;
const WebGLBuffer = @import("WebGLBuffer.zig").WebGLBuffer;
const PredefinedColorSpace = @import("enums").PredefinedColorSpace;
const WebGLShaderPrecisionFormat = @import("WebGLShaderPrecisionFormat.zig").WebGLShaderPrecisionFormat;
...
const WebGLRenderbuffer = @import("WebGLRenderbuffer.zig").WebGLRenderbuffer;
...
const WebGLQuery = @import("WebGLQuery.zig").WebGLQuery;
...
pub const WebGL2RenderingContext = struct {
    ...
    pub fn initWithState(
        ...
        return WebGL2RenderingContextImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
