...
const SVGFETileElementImpl = @import("impls").SVGFETileElement;
...
pub const SVGFETileElement = struct {
    pub const Meta = struct {
        pub const name = "SVGFETileElement";
    ...
    pub const State = runtime.FlattenedState(
        ...
        struct {
            ...
            _internal: ?*SVGFETileElementImpl.InternalState = null,
        },
    );
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return SVGFETileElementImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return SVGFETileElementImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
