...
pub const USBIsochronousOutTransferPacket = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        return USBIsochronousOutTransferPacketImpl.init(allocator, State, &vtable);
    }
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, status: USBTransferStatus, bytesWritten: u32) !*runtime.Instance {
        ...
        try USBIsochronousOutTransferPacketImpl.constructor(instance, status, bytesWritten);
