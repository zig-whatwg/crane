...
pub const RTCDataChannelEvent = struct {
    ...
    pub fn initWithState(
        ...
        return RTCDataChannelEventImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, @"type": DOMString, eventInitDict: RTCDataChannelEventInit) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try RTCDataChannelEventImpl.call_constructor(ctx, @"type", eventInitDict);
    }
