...
pub const CSSMathClamp = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        CSSMathClampImpl.init(instance);
    ...
    /// WebIDL constructor
    pub fn call_constructor(allocator: std.mem.Allocator, lower: CSSNumberish, value: CSSNumberish, upper: CSSNumberish) !*runtime.Instance {
        const instance = try init(allocator);
        errdefer deinit(instance);
        
        try CSSMathClampImpl.constructor(instance, lower, value, upper);
        
        return instance;
    }

    pub fn get_operator(instance: *runtime.Instance) anyerror!CSSMathOperator {
        return try CSSMathClampImpl.get_operator(instance);
    }
    ...
    pub fn call_parse(instance: *runtime.Instance, args: ParseArgs) anyerror!CSSStyleValue {
        switch (args) {
            .USVString_USVString => |a| return try CSSMathClampImpl.USVString_USVString(instance, a.property, a.cssText),
            .USVString => |arg| return try CSSMathClampImpl.USVString(instance, arg),
        }
    }

    pub fn call_type(instance: *runtime.Instance) anyerror!CSSNumericType {
        return try CSSMathClampImpl.call_type(instance);
    }
