...
pub const SFrameDecrypterStream = struct {
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return SFrameDecrypterStreamImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, ctx: runtime.Context, options: webidl.Opt(SFrameTransformOptions)) !*runtime.Instance {
        ...
        return try SFrameDecrypterStreamImpl.call_constructor(allocator, ctx, options.value);
    }
    ...
    pub fn call_setEncryptionKey(instance: *runtime.Instance, key: *runtime.Instance, keyID: webidl.Opt(CryptoKeyID)) anyerror!*const anyopaque {
        ...
        return try SFrameDecrypterStreamImpl.call_setEncryptionKey(instance, key, keyID.value);
    }
