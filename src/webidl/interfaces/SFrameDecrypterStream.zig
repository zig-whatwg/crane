...
pub const SFrameDecrypterStream = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        return SFrameDecrypterStreamImpl.init(allocator, State, &vtable);
    }

    /// Clean up instance resources
    pub fn deinit(instance: *runtime.Instance) void {
        SFrameDecrypterStreamImpl.deinit(instance);
    }
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, options: SFrameTransformOptions) !*runtime.Instance {
        ...
        try SFrameDecrypterStreamImpl.constructor(instance, options);
        
        return instance;
    }

    pub fn get_readable(instance: *runtime.Instance) anyerror!ReadableStream {
        return try SFrameDecrypterStreamImpl.get_readable(instance);
    }

    pub fn get_writable(instance: *runtime.Instance) anyerror!WritableStream {
        return try SFrameDecrypterStreamImpl.get_writable(instance);
    }

    pub fn get_onerror(instance: *runtime.Instance) anyerror!EventHandler {
        return try SFrameDecrypterStreamImpl.get_onerror(instance);
    }
    ...
    pub fn call_dispatchEvent(instance: *runtime.Instance, event: Event) anyerror!bool {
        ...
        return try SFrameDecrypterStreamImpl.call_dispatchEvent(instance, event);
    }
    ...
    pub fn call_when(instance: *runtime.Instance, @"type": DOMString, options: ObservableEventListenerOptions) anyerror!Observable {
        ...
        return try SFrameDecrypterStreamImpl.call_when(instance, @"type", options);
    }

    pub fn call_addEventListener(instance: *runtime.Instance, @"type": DOMString, callback: EventListener, options: anyopaque) anyerror!void {
        
        return try SFrameDecrypterStreamImpl.call_addEventListener(instance, @"type", callback, options);
    }

    pub fn call_removeEventListener(instance: *runtime.Instance, @"type": DOMString, callback: EventListener, options: anyopaque) anyerror!void {
        
        return try SFrameDecrypterStreamImpl.call_removeEventListener(instance, @"type", callback, options);
    }
