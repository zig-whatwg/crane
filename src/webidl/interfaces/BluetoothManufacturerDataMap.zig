...
pub const BluetoothManufacturerDataMap = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        Meta.MixinTypes,
        struct {
            _internal: ?*BluetoothManufacturerDataMapImpl.InternalState = null,
        },
    );
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return BluetoothManufacturerDataMapImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return BluetoothManufacturerDataMapImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
