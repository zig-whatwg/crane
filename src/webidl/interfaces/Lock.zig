...
pub const Lock = struct {
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return LockImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return LockImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn get_mode(instance: *runtime.Instance) anyerror!LockMode {
        return try LockImpl.get_mode(instance);
    }
