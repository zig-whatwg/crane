...
const SVGAnimationElement = @import("SVGAnimationElement.zig").SVGAnimationElement;
...
pub const SVGAnimateMotionElement = struct {
    pub const Meta = struct {
        ...
        pub const BaseType = SVGAnimationElement.State;
        pub const ParentInterface = SVGAnimationElement;
    ...
    pub const State = runtime.FlattenedState(
        ...
        Meta.MixinTypes,
        struct {
            _internal: ?*SVGAnimateMotionElementImpl.InternalState = null,
        },
    );
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return SVGAnimateMotionElementImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return SVGAnimateMotionElementImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
