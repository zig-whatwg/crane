...
const SVGFEImageElementImpl = @import("impls").SVGFEImageElement;
...
pub const SVGFEImageElement = struct {
    pub const Meta = struct {
        ...
        pub const properties = .{
            ...
            .{ "crossOrigin", "get_crossOrigin", null },
            .{ "x", "get_x", null },
            .{ "y", "get_y", null },
    ...
    pub const State = runtime.FlattenedState(
        ...
        struct {
            ...
            crossOrigin: *runtime.Instance = undefined,
            ...
            _internal: ?*SVGFEImageElementImpl.InternalState = null,
        },
    );
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return SVGFEImageElementImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return SVGFEImageElementImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn get_crossOrigin(instance: *runtime.Instance) anyerror!*runtime.Instance {
