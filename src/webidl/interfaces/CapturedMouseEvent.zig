...
pub const CapturedMouseEvent = struct {
    ...
    pub fn initWithState(
        ...
        return CapturedMouseEventImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, @"type": DOMString, eventInitDict: webidl.Opt(CapturedMouseEventInit)) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try CapturedMouseEventImpl.call_constructor(ctx, @"type", eventInitDict);
    }
