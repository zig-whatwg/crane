...
pub const CapturedMouseEvent = struct {
    ...
    /// WebIDL constructor
    pub fn call_constructor(allocator: std.mem.Allocator, ctx: runtime.Context, @"type": DOMString, eventInitDict: CapturedMouseEventInit) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try CapturedMouseEventImpl.call_constructor(allocator, ctx, @"type", eventInitDict);
    }
