...
const SVGFEMergeElementImpl = @import("impls").SVGFEMergeElement;
...
pub const SVGFEMergeElement = struct {
    pub const Meta = struct {
        pub const name = "SVGFEMergeElement";
    ...
    pub const State = runtime.FlattenedState(
        ...
        struct {
            ...
            _internal: ?*SVGFEMergeElementImpl.InternalState = null,
        },
    );
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return SVGFEMergeElementImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return SVGFEMergeElementImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
