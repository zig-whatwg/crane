...
pub const SVGSymbolElement = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        struct {
            ...
            _internal: ?*SVGSymbolElementImpl.InternalState = null,
        },
    );
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return SVGSymbolElementImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return SVGSymbolElementImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
