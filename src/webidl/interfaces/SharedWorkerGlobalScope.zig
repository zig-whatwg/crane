...
pub const SharedWorkerGlobalScope = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        SharedWorkerGlobalScopeImpl.init(instance);
    ...
    pub fn get_indexedDB(instance: *runtime.Instance) anyerror!IDBFactory {
        ...
        const value = try SharedWorkerGlobalScopeImpl.get_indexedDB(instance);
        state.cached_indexedDB = value;
        return value;
    }

    pub fn get_trustedTypes(instance: *runtime.Instance) anyerror!TrustedTypePolicyFactory {
        return try SharedWorkerGlobalScopeImpl.get_trustedTypes(instance);
    }

    /// Extended attributes: [Replaceable]
    pub fn get_performance(instance: *runtime.Instance) anyerror!Performance {
        return try SharedWorkerGlobalScopeImpl.get_performance(instance);
    }
    ...
    pub fn get_caches(instance: *runtime.Instance) anyerror!CacheStorage {
        ...
        const value = try SharedWorkerGlobalScopeImpl.get_caches(instance);
    ...
    pub fn get_scheduler(instance: *runtime.Instance) anyerror!Scheduler {
        return try SharedWorkerGlobalScopeImpl.get_scheduler(instance);
    }
    ...
    pub fn get_crypto(instance: *runtime.Instance) anyerror!Crypto {
        ...
        const value = try SharedWorkerGlobalScopeImpl.get_crypto(instance);
    ...
    pub fn call_when(instance: *runtime.Instance, type_: DOMString, options: ObservableEventListenerOptions) anyerror!Observable {
        ...
        return try SharedWorkerGlobalScopeImpl.call_when(instance, type_, options);
    }

    pub fn call_reportError(instance: *runtime.Instance, e: anyopaque) anyerror!void {
        
        return try SharedWorkerGlobalScopeImpl.call_reportError(instance, e);
    }

    pub fn call_setInterval(instance: *runtime.Instance, handler: TimerHandler, timeout: i32, arguments: anyopaque) anyerror!i32 {
        
        return try SharedWorkerGlobalScopeImpl.call_setInterval(instance, handler, timeout, arguments);
    }

    pub fn call_clearInterval(instance: *runtime.Instance, id: i32) anyerror!void {
        
        return try SharedWorkerGlobalScopeImpl.call_clearInterval(instance, id);
    }

    pub fn call_importScripts(instance: *runtime.Instance, urls: anyopaque) anyerror!void {
        
        return try SharedWorkerGlobalScopeImpl.call_importScripts(instance, urls);
    }

    pub fn call_setTimeout(instance: *runtime.Instance, handler: TimerHandler, timeout: i32, arguments: anyopaque) anyerror!i32 {
        
        return try SharedWorkerGlobalScopeImpl.call_setTimeout(instance, handler, timeout, arguments);
    }

    pub fn call_addEventListener(instance: *runtime.Instance, type_: DOMString, callback: anyopaque, options: anyopaque) anyerror!void {
        
        return try SharedWorkerGlobalScopeImpl.call_addEventListener(instance, type_, callback, options);
    }

    pub fn call_removeEventListener(instance: *runtime.Instance, type_: DOMString, callback: anyopaque, options: anyopaque) anyerror!void {
        
        return try SharedWorkerGlobalScopeImpl.call_removeEventListener(instance, type_, callback, options);
    }
    ...
    pub fn call_fetch(instance: *runtime.Instance, input: RequestInfo, init: RequestInit) anyerror!anyopaque {
        ...
        return try SharedWorkerGlobalScopeImpl.call_fetch(instance, input, init);
    }

    pub fn call_atob(instance: *runtime.Instance, data: DOMString) anyerror!runtime.ByteString {
        
        return try SharedWorkerGlobalScopeImpl.call_atob(instance, data);
    }

    pub fn call_btoa(instance: *runtime.Instance, data: DOMString) anyerror!DOMString {
        
        return try SharedWorkerGlobalScopeImpl.call_btoa(instance, data);
    }

    pub fn call_dispatchEvent(instance: *runtime.Instance, event: Event) anyerror!bool {
        
        return try SharedWorkerGlobalScopeImpl.call_dispatchEvent(instance, event);
    }
    ...
    pub fn call_createImageBitmap(instance: *runtime.Instance, args: CreateImageBitmapArgs) anyerror!anyopaque {
        switch (args) {
            .ImageBitmapSource_ImageBitmapOptions => |a| return try SharedWorkerGlobalScopeImpl.ImageBitmapSource_ImageBitmapOptions(instance, a.image, a.options),
            .ImageBitmapSource_long_long_long_long_ImageBitmapOptions => |a| return try SharedWorkerGlobalScopeImpl.ImageBitmapSource_long_long_long_long_ImageBitmapOptions(instance, a.image, a.sx, a.sy, a.sw, a.sh, a.options),
        }
    }

    pub fn call_queueMicrotask(instance: *runtime.Instance, callback: VoidFunction) anyerror!void {
        
        return try SharedWorkerGlobalScopeImpl.call_queueMicrotask(instance, callback);
    }
    ...
    pub fn call_structuredClone(instance: *runtime.Instance, value: anyopaque, options: StructuredSerializeOptions) anyerror!anyopaque {
        ...
        return try SharedWorkerGlobalScopeImpl.call_structuredClone(instance, value, options);
    }

    pub fn call_clearTimeout(instance: *runtime.Instance, id: i32) anyerror!void {
        
        return try SharedWorkerGlobalScopeImpl.call_clearTimeout(instance, id);
    }
