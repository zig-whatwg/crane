...
pub const CSS2Properties = struct {
    pub const Meta = struct {
        ...
        pub const properties = .{
            ...
            .{ "backgroundAttachment", "get_backgroundAttachment", "set_backgroundAttachment" },
            .{ "backgroundColor", "get_backgroundColor", "set_backgroundColor" },
            .{ "backgroundImage", "get_backgroundImage", "set_backgroundImage" },
            .{ "backgroundPosition", "get_backgroundPosition", "set_backgroundPosition" },
            .{ "backgroundRepeat", "get_backgroundRepeat", "set_backgroundRepeat" },
            .{ "border", "get_border", "set_border" },
            .{ "borderCollapse", "get_borderCollapse", "set_borderCollapse" },
            .{ "borderColor", "get_borderColor", "set_borderColor" },
            .{ "borderSpacing", "get_borderSpacing", "set_borderSpacing" },
            .{ "borderStyle", "get_borderStyle", "set_borderStyle" },
            .{ "borderTop", "get_borderTop", "set_borderTop" },
            .{ "borderRight", "get_borderRight", "set_borderRight" },
            .{ "borderBottom", "get_borderBottom", "set_borderBottom" },
            .{ "borderLeft", "get_borderLeft", "set_borderLeft" },
            .{ "borderTopColor", "get_borderTopColor", "set_borderTopColor" },
            .{ "borderRightColor", "get_borderRightColor", "set_borderRightColor" },
            .{ "borderBottomColor", "get_borderBottomColor", "set_borderBottomColor" },
            .{ "borderLeftColor", "get_borderLeftColor", "set_borderLeftColor" },
            .{ "borderTopStyle", "get_borderTopStyle", "set_borderTopStyle" },
            .{ "borderRightStyle", "get_borderRightStyle", "set_borderRightStyle" },
            .{ "borderBottomStyle", "get_borderBottomStyle", "set_borderBottomStyle" },
            .{ "borderLeftStyle", "get_borderLeftStyle", "set_borderLeftStyle" },
            .{ "borderTopWidth", "get_borderTopWidth", "set_borderTopWidth" },
            .{ "borderRightWidth", "get_borderRightWidth", "set_borderRightWidth" },
            .{ "borderBottomWidth", "get_borderBottomWidth", "set_borderBottomWidth" },
            .{ "borderLeftWidth", "get_borderLeftWidth", "set_borderLeftWidth" },
            .{ "borderWidth", "get_borderWidth", "set_borderWidth" },
            .{ "bottom", "get_bottom", "set_bottom" },
            .{ "captionSide", "get_captionSide", "set_captionSide" },
            .{ "clear", "get_clear", "set_clear" },
            .{ "clip", "get_clip", "set_clip" },
            .{ "color", "get_color", "set_color" },
            .{ "content", "get_content", "set_content" },
            .{ "counterIncrement", "get_counterIncrement", "set_counterIncrement" },
            .{ "counterReset", "get_counterReset", "set_counterReset" },
            .{ "cue", "get_cue", "set_cue" },
            .{ "cueAfter", "get_cueAfter", "set_cueAfter" },
            .{ "cueBefore", "get_cueBefore", "set_cueBefore" },
            .{ "cursor", "get_cursor", "set_cursor" },
            .{ "direction", "get_direction", "set_direction" },
            .{ "display", "get_display", "set_display" },
            .{ "elevation", "get_elevation", "set_elevation" },
            .{ "emptyCells", "get_emptyCells", "set_emptyCells" },
            ...
            .{ "fontSizeAdjust", "get_fontSizeAdjust", "set_fontSizeAdjust" },
            .{ "fontStretch", "get_fontStretch", "set_fontStretch" },
            .{ "fontStyle", "get_fontStyle", "set_fontStyle" },
            .{ "fontVariant", "get_fontVariant", "set_fontVariant" },
            ...
            .{ "lineHeight", "get_lineHeight", "set_lineHeight" },
            .{ "listStyle", "get_listStyle", "set_listStyle" },
            .{ "listStyleImage", "get_listStyleImage", "set_listStyleImage" },
            .{ "listStylePosition", "get_listStylePosition", "set_listStylePosition" },
            .{ "listStyleType", "get_listStyleType", "set_listStyleType" },
            ...
            .{ "markerOffset", "get_markerOffset", "set_markerOffset" },
            ...
            .{ "orphans", "get_orphans", "set_orphans" },
            .{ "outline", "get_outline", "set_outline" },
            .{ "outlineColor", "get_outlineColor", "set_outlineColor" },
            .{ "outlineStyle", "get_outlineStyle", "set_outlineStyle" },
            .{ "outlineWidth", "get_outlineWidth", "set_outlineWidth" },
            .{ "overflow", "get_overflow", "set_overflow" },
            .{ "padding", "get_padding", "set_padding" },
            .{ "paddingTop", "get_paddingTop", "set_paddingTop" },
            .{ "paddingRight", "get_paddingRight", "set_paddingRight" },
            .{ "paddingBottom", "get_paddingBottom", "set_paddingBottom" },
            .{ "paddingLeft", "get_paddingLeft", "set_paddingLeft" },
            .{ "page", "get_page", "set_page" },
            .{ "pageBreakAfter", "get_pageBreakAfter", "set_pageBreakAfter" },
            .{ "pageBreakBefore", "get_pageBreakBefore", "set_pageBreakBefore" },
            .{ "pageBreakInside", "get_pageBreakInside", "set_pageBreakInside" },
            .{ "pause", "get_pause", "set_pause" },
            .{ "pauseAfter", "get_pauseAfter", "set_pauseAfter" },
            .{ "pauseBefore", "get_pauseBefore", "set_pauseBefore" },
            .{ "pitch", "get_pitch", "set_pitch" },
            .{ "pitchRange", "get_pitchRange", "set_pitchRange" },
            .{ "playDuring", "get_playDuring", "set_playDuring" },
            .{ "position", "get_position", "set_position" },
            .{ "quotes", "get_quotes", "set_quotes" },
            .{ "richness", "get_richness", "set_richness" },
            .{ "right", "get_right", "set_right" },
            .{ "size", "get_size", "set_size" },
            .{ "speak", "get_speak", "set_speak" },
            .{ "speakHeader", "get_speakHeader", "set_speakHeader" },
            .{ "speakNumeral", "get_speakNumeral", "set_speakNumeral" },
            .{ "speakPunctuation", "get_speakPunctuation", "set_speakPunctuation" },
            .{ "speechRate", "get_speechRate", "set_speechRate" },
            .{ "stress", "get_stress", "set_stress" },
            .{ "tableLayout", "get_tableLayout", "set_tableLayout" },
            .{ "textAlign", "get_textAlign", "set_textAlign" },
            .{ "textDecoration", "get_textDecoration", "set_textDecoration" },
            .{ "textIndent", "get_textIndent", "set_textIndent" },
            .{ "textShadow", "get_textShadow", "set_textShadow" },
            .{ "textTransform", "get_textTransform", "set_textTransform" },
            .{ "top", "get_top", "set_top" },
            .{ "unicodeBidi", "get_unicodeBidi", "set_unicodeBidi" },
            .{ "verticalAlign", "get_verticalAlign", "set_verticalAlign" },
            .{ "visibility", "get_visibility", "set_visibility" },
            .{ "voiceFamily", "get_voiceFamily", "set_voiceFamily" },
            .{ "volume", "get_volume", "set_volume" },
            .{ "whiteSpace", "get_whiteSpace", "set_whiteSpace" },
            .{ "widows", "get_widows", "set_widows" },
    ...
    pub const State = runtime.FlattenedState(
        ...
        Meta.MixinTypes,
        struct {
            azimuth: typedefs.DOMString = undefined,
            background: typedefs.DOMString = undefined,
            backgroundAttachment: typedefs.DOMString = undefined,
            backgroundColor: typedefs.DOMString = undefined,
            backgroundImage: typedefs.DOMString = undefined,
            backgroundPosition: typedefs.DOMString = undefined,
            backgroundRepeat: typedefs.DOMString = undefined,
            border: typedefs.DOMString = undefined,
            borderCollapse: typedefs.DOMString = undefined,
            borderColor: typedefs.DOMString = undefined,
            borderSpacing: typedefs.DOMString = undefined,
            borderStyle: typedefs.DOMString = undefined,
            borderTop: typedefs.DOMString = undefined,
            borderRight: typedefs.DOMString = undefined,
            borderBottom: typedefs.DOMString = undefined,
            borderLeft: typedefs.DOMString = undefined,
            borderTopColor: typedefs.DOMString = undefined,
            borderRightColor: typedefs.DOMString = undefined,
            borderBottomColor: typedefs.DOMString = undefined,
            borderLeftColor: typedefs.DOMString = undefined,
            borderTopStyle: typedefs.DOMString = undefined,
            borderRightStyle: typedefs.DOMString = undefined,
            borderBottomStyle: typedefs.DOMString = undefined,
            borderLeftStyle: typedefs.DOMString = undefined,
            borderTopWidth: typedefs.DOMString = undefined,
            borderRightWidth: typedefs.DOMString = undefined,
            borderBottomWidth: typedefs.DOMString = undefined,
            borderLeftWidth: typedefs.DOMString = undefined,
            borderWidth: typedefs.DOMString = undefined,
            bottom: typedefs.DOMString = undefined,
            captionSide: typedefs.DOMString = undefined,
            clear: typedefs.DOMString = undefined,
            clip: typedefs.DOMString = undefined,
            color: typedefs.DOMString = undefined,
            content: typedefs.DOMString = undefined,
            counterIncrement: typedefs.DOMString = undefined,
            counterReset: typedefs.DOMString = undefined,
            cue: typedefs.DOMString = undefined,
            cueAfter: typedefs.DOMString = undefined,
            cueBefore: typedefs.DOMString = undefined,
            cursor: typedefs.DOMString = undefined,
            direction: typedefs.DOMString = undefined,
            display: typedefs.DOMString = undefined,
            elevation: typedefs.DOMString = undefined,
            emptyCells: typedefs.DOMString = undefined,
            cssFloat: typedefs.DOMString = undefined,
            font: typedefs.DOMString = undefined,
            fontFamily: typedefs.DOMString = undefined,
            fontSize: typedefs.DOMString = undefined,
            fontSizeAdjust: typedefs.DOMString = undefined,
            fontStretch: typedefs.DOMString = undefined,
            fontStyle: typedefs.DOMString = undefined,
            fontVariant: typedefs.DOMString = undefined,
            fontWeight: typedefs.DOMString = undefined,
            height: typedefs.DOMString = undefined,
            left: typedefs.DOMString = undefined,
            letterSpacing: typedefs.DOMString = undefined,
            lineHeight: typedefs.DOMString = undefined,
            listStyle: typedefs.DOMString = undefined,
            listStyleImage: typedefs.DOMString = undefined,
            listStylePosition: typedefs.DOMString = undefined,
            listStyleType: typedefs.DOMString = undefined,
            margin: typedefs.DOMString = undefined,
            marginTop: typedefs.DOMString = undefined,
            marginRight: typedefs.DOMString = undefined,
            marginBottom: typedefs.DOMString = undefined,
            marginLeft: typedefs.DOMString = undefined,
            markerOffset: typedefs.DOMString = undefined,
            marks: typedefs.DOMString = undefined,
            maxHeight: typedefs.DOMString = undefined,
            maxWidth: typedefs.DOMString = undefined,
            minHeight: typedefs.DOMString = undefined,
            minWidth: typedefs.DOMString = undefined,
            orphans: typedefs.DOMString = undefined,
            outline: typedefs.DOMString = undefined,
            outlineColor: typedefs.DOMString = undefined,
            outlineStyle: typedefs.DOMString = undefined,
            outlineWidth: typedefs.DOMString = undefined,
            overflow: typedefs.DOMString = undefined,
            padding: typedefs.DOMString = undefined,
            paddingTop: typedefs.DOMString = undefined,
            paddingRight: typedefs.DOMString = undefined,
            paddingBottom: typedefs.DOMString = undefined,
            paddingLeft: typedefs.DOMString = undefined,
            page: typedefs.DOMString = undefined,
            pageBreakAfter: typedefs.DOMString = undefined,
            pageBreakBefore: typedefs.DOMString = undefined,
            pageBreakInside: typedefs.DOMString = undefined,
            pause: typedefs.DOMString = undefined,
            pauseAfter: typedefs.DOMString = undefined,
            pauseBefore: typedefs.DOMString = undefined,
            pitch: typedefs.DOMString = undefined,
            pitchRange: typedefs.DOMString = undefined,
            playDuring: typedefs.DOMString = undefined,
            position: typedefs.DOMString = undefined,
            quotes: typedefs.DOMString = undefined,
            richness: typedefs.DOMString = undefined,
            right: typedefs.DOMString = undefined,
            size: typedefs.DOMString = undefined,
            speak: typedefs.DOMString = undefined,
            speakHeader: typedefs.DOMString = undefined,
            speakNumeral: typedefs.DOMString = undefined,
            speakPunctuation: typedefs.DOMString = undefined,
            speechRate: typedefs.DOMString = undefined,
            stress: typedefs.DOMString = undefined,
            tableLayout: typedefs.DOMString = undefined,
            textAlign: typedefs.DOMString = undefined,
            textDecoration: typedefs.DOMString = undefined,
            textIndent: typedefs.DOMString = undefined,
            textShadow: typedefs.DOMString = undefined,
            textTransform: typedefs.DOMString = undefined,
            top: typedefs.DOMString = undefined,
            unicodeBidi: typedefs.DOMString = undefined,
            verticalAlign: typedefs.DOMString = undefined,
            visibility: typedefs.DOMString = undefined,
            voiceFamily: typedefs.DOMString = undefined,
            volume: typedefs.DOMString = undefined,
            whiteSpace: typedefs.DOMString = undefined,
            widows: typedefs.DOMString = undefined,
            width: typedefs.DOMString = undefined,
            wordSpacing: typedefs.DOMString = undefined,
            zIndex: typedefs.DOMString = undefined,
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return CSS2PropertiesImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return CSS2PropertiesImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
