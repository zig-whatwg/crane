...
const SVGPointListImpl = @import("impls").SVGPointList;
...
pub const SVGPointList = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        struct {
            ...
            _internal: ?*SVGPointListImpl.InternalState = null,
        },
    );
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return SVGPointListImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return SVGPointListImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
