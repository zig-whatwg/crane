...
pub const BiquadFilterNode = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        BiquadFilterNodeImpl.init(instance);
    ...
    /// WebIDL constructor
    pub fn call_constructor(allocator: std.mem.Allocator, context: BaseAudioContext, options: BiquadFilterOptions) !*runtime.Instance {
        const instance = try init(allocator);
        errdefer deinit(instance);
        
        try BiquadFilterNodeImpl.constructor(instance, context, options);
        
        return instance;
    }

    pub fn get_context(instance: *runtime.Instance) anyerror!BaseAudioContext {
        return try BiquadFilterNodeImpl.get_context(instance);
    }

    pub fn get_numberOfInputs(instance: *runtime.Instance) anyerror!u32 {
        return try BiquadFilterNodeImpl.get_numberOfInputs(instance);
    }

    pub fn get_numberOfOutputs(instance: *runtime.Instance) anyerror!u32 {
        return try BiquadFilterNodeImpl.get_numberOfOutputs(instance);
    }

    pub fn get_channelCount(instance: *runtime.Instance) anyerror!u32 {
        return try BiquadFilterNodeImpl.get_channelCount(instance);
    }

    pub fn set_channelCount(instance: *runtime.Instance, value: u32) anyerror!void {
        try BiquadFilterNodeImpl.set_channelCount(instance, value);
    }

    pub fn get_channelCountMode(instance: *runtime.Instance) anyerror!ChannelCountMode {
        return try BiquadFilterNodeImpl.get_channelCountMode(instance);
    }

    pub fn set_channelCountMode(instance: *runtime.Instance, value: ChannelCountMode) anyerror!void {
        try BiquadFilterNodeImpl.set_channelCountMode(instance, value);
    }

    pub fn get_channelInterpretation(instance: *runtime.Instance) anyerror!ChannelInterpretation {
        return try BiquadFilterNodeImpl.get_channelInterpretation(instance);
    }

    pub fn set_channelInterpretation(instance: *runtime.Instance, value: ChannelInterpretation) anyerror!void {
        try BiquadFilterNodeImpl.set_channelInterpretation(instance, value);
    }
    ...
    pub fn call_removeEventListener(instance: *runtime.Instance, type_: DOMString, callback: anyopaque, options: anyopaque) anyerror!void {
        ...
        return try BiquadFilterNodeImpl.call_removeEventListener(instance, type_, callback, options);
    }
    ...
    pub fn call_when(instance: *runtime.Instance, type_: DOMString, options: ObservableEventListenerOptions) anyerror!Observable {
        ...
        return try BiquadFilterNodeImpl.call_when(instance, type_, options);
    }

    pub fn call_dispatchEvent(instance: *runtime.Instance, event: Event) anyerror!bool {
        
        return try BiquadFilterNodeImpl.call_dispatchEvent(instance, event);
    }
    ...
    pub fn call_disconnect(instance: *runtime.Instance, args: DisconnectArgs) anyerror!void {
        switch (args) {
            .no_params => return try BiquadFilterNodeImpl.no_params(instance),
            .long => |arg| return try BiquadFilterNodeImpl.long(instance, arg),
            .AudioNode => |arg| return try BiquadFilterNodeImpl.AudioNode(instance, arg),
            .AudioNode_long => |a| return try BiquadFilterNodeImpl.AudioNode_long(instance, a.destinationNode, a.output),
            .AudioNode_long_long => |a| return try BiquadFilterNodeImpl.AudioNode_long_long(instance, a.destinationNode, a.output, a.input),
            .AudioParam => |arg| return try BiquadFilterNodeImpl.AudioParam(instance, arg),
            .AudioParam_long => |a| return try BiquadFilterNodeImpl.AudioParam_long(instance, a.destinationParam, a.output),
        }
    }
    ...
    pub fn call_addEventListener(instance: *runtime.Instance, type_: DOMString, callback: anyopaque, options: anyopaque) anyerror!void {
        ...
        return try BiquadFilterNodeImpl.call_addEventListener(instance, type_, callback, options);
    }
