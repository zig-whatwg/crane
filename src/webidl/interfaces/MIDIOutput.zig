...
pub const MIDIOutput = struct {
    pub const Meta = struct {
        ...
        pub const BaseType = MIDIPort.State;
        pub const ParentInterface = MIDIPort;
    ...
    pub const State = runtime.FlattenedState(
        ...
        Meta.MixinTypes,
        struct {
            _internal: ?*MIDIOutputImpl.InternalState = null,
        },
    );
    ...
    pub fn initWithState(
        ...
        return MIDIOutputImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
