...
pub const Profiler = struct {
    ...
    /// WebIDL constructor
    pub fn call_constructor(allocator: std.mem.Allocator, ctx: runtime.Context, options: ProfilerInitOptions) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try ProfilerImpl.call_constructor(allocator, ctx, options);
    }
