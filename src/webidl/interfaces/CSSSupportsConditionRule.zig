...
pub const CSSSupportsConditionRule = struct {
    ...
    pub const vtable = runtime.buildVTable(CSSSupportsConditionRule, .{
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        return CSSSupportsConditionRuleImpl.init(allocator, State, &vtable);
    }
    ...
    pub fn get_cssText(instance: *runtime.Instance) anyerror!anyopaque {
        return try CSSSupportsConditionRuleImpl.get_cssText(instance);
    }

    pub fn set_cssText(instance: *runtime.Instance, value: anyopaque) anyerror!void {
        try CSSSupportsConditionRuleImpl.set_cssText(instance, value);
    }

    pub fn get_parentRule(instance: *runtime.Instance) anyerror!CSSRule {
        return try CSSSupportsConditionRuleImpl.get_parentRule(instance);
    }

    pub fn get_parentStyleSheet(instance: *runtime.Instance) anyerror!CSSStyleSheet {
        return try CSSSupportsConditionRuleImpl.get_parentStyleSheet(instance);
    }

    pub fn get_type(instance: *runtime.Instance) anyerror!u16 {
        return try CSSSupportsConditionRuleImpl.get_type(instance);
    }
    ...
    pub fn get_cssRules(instance: *runtime.Instance) anyerror!CSSRuleList {
        ...
        const value = try CSSSupportsConditionRuleImpl.get_cssRules(instance);
    ...
    pub fn call_deleteRule(instance: *runtime.Instance, index: u32) anyerror!void {
        ...
        return try CSSSupportsConditionRuleImpl.call_deleteRule(instance, index);
    }

    pub fn call_insertRule(instance: *runtime.Instance, rule: anyopaque, index: u32) anyerror!u32 {
        
        return try CSSSupportsConditionRuleImpl.call_insertRule(instance, rule, index);
    }
