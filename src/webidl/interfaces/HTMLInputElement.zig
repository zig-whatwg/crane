...
const HTMLDataListElement = @import("HTMLDataListElement.zig").HTMLDataListElement;
...
pub const HTMLInputElement = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        Meta.MixinTypes,
        struct {
            accept: typedefs.DOMString = undefined,
            ...
            colorSpace: typedefs.DOMString = undefined,
