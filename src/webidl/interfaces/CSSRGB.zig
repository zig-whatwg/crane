...
pub const CSSRGB = struct {
    ...
    pub fn initWithState(
        ...
        return CSSRGBImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, r: CSSColorRGBComp, g: CSSColorRGBComp, b: CSSColorRGBComp, alpha: webidl.Opt(CSSColorPercent)) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try CSSRGBImpl.call_constructor(ctx, r, g, b, alpha);
    }
