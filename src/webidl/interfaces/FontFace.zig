...
pub const FontFace = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        Meta.MixinTypes,
        struct {
            family: typedefs.CSSOMString = undefined,
            style: typedefs.CSSOMString = undefined,
            weight: typedefs.CSSOMString = undefined,
            stretch: typedefs.CSSOMString = undefined,
            unicodeRange: typedefs.CSSOMString = undefined,
            featureSettings: typedefs.CSSOMString = undefined,
            variationSettings: typedefs.CSSOMString = undefined,
            display: typedefs.CSSOMString = undefined,
            ...
            status: enums.FontFaceLoadStatus = undefined,
            loaded: runtime.JSValue = undefined,
