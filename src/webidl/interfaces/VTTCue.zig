...
const VTTRegion = @import("VTTRegion.zig").VTTRegion;
...
pub const VTTCue = struct {
    pub const Meta = struct {
        ...
        pub const BaseType = TextTrackCue.State;
        pub const ParentInterface = TextTrackCue;
    ...
    pub fn initWithState(
        ...
        return VTTCueImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, startTime: f64, endTime: f64, text: DOMString) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try VTTCueImpl.call_constructor(ctx, startTime, endTime, text);
    }
