...
pub const WorkletAnimation = struct {
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, animatorName: DOMString, effects: anyopaque, timeline: anyopaque, options: anyopaque) !*runtime.Instance {
        ...
        try WorkletAnimationImpl.constructor(instance, animatorName, effects, timeline, options);
        
        return instance;
    }

    pub fn get_id(instance: *runtime.Instance) anyerror!DOMString {
        return try WorkletAnimationImpl.get_id(instance);
    }
    ...
    pub fn get_rangeStart(instance: *runtime.Instance) anyerror!anyopaque {
        return try WorkletAnimationImpl.get_rangeStart(instance);
    }

    pub fn set_rangeStart(instance: *runtime.Instance, value: anyopaque) anyerror!void {
        try WorkletAnimationImpl.set_rangeStart(instance, value);
    }

    pub fn get_rangeEnd(instance: *runtime.Instance) anyerror!anyopaque {
        return try WorkletAnimationImpl.get_rangeEnd(instance);
    }
    ...
    pub fn call_updatePlaybackRate(instance: *runtime.Instance, playbackRate: f64) anyerror!void {
        ...
        return try WorkletAnimationImpl.call_updatePlaybackRate(instance, playbackRate);
    }

    pub fn call_reverse(instance: *runtime.Instance) anyerror!void {
        return try WorkletAnimationImpl.call_reverse(instance);
    }
    ...
    pub fn call_commitStyles(instance: *runtime.Instance) anyerror!void {
        ...
        return try WorkletAnimationImpl.call_commitStyles(instance);
    }

    pub fn call_dispatchEvent(instance: *runtime.Instance, event: Event) anyerror!bool {
        
        return try WorkletAnimationImpl.call_dispatchEvent(instance, event);
    }

    pub fn call_pause(instance: *runtime.Instance) anyerror!void {
        return try WorkletAnimationImpl.call_pause(instance);
    }

    pub fn call_play(instance: *runtime.Instance) anyerror!void {
        return try WorkletAnimationImpl.call_play(instance);
    }

    pub fn call_cancel(instance: *runtime.Instance) anyerror!void {
        return try WorkletAnimationImpl.call_cancel(instance);
    }
