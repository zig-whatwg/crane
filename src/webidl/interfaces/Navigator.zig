...
const NavigatorContentUtils = @import("mixins").NavigatorContentUtils;
...
const PreferenceManager = @import("PreferenceManager.zig").PreferenceManager;
const AuctionAdConfig = @import("dictionaries").AuctionAdConfig;
const USVString = @import("typedefs").USVString;
const MediaKeySystemAccess = @import("MediaKeySystemAccess.zig").MediaKeySystemAccess;
const VibratePattern = @import("typedefs").VibratePattern;
const BatteryManager = @import("BatteryManager.zig").BatteryManager;
...
const HandwritingRecognizer = @import("HandwritingRecognizer.zig").HandwritingRecognizer;
const MIDIAccess = @import("MIDIAccess.zig").MIDIAccess;
...
const Scheduling = @import("Scheduling.zig").Scheduling;
...
const AudioSession = @import("AudioSession.zig").AudioSession;
const CredentialsContainer = @import("CredentialsContainer.zig").CredentialsContainer;
...
const MediaDevices = @import("MediaDevices.zig").MediaDevices;
const NavigatorManagedData = @import("NavigatorManagedData.zig").NavigatorManagedData;
...
const ContactsManager = @import("ContactsManager.zig").ContactsManager;
const DevicePosture = @import("DevicePosture.zig").DevicePosture;
const Geolocation = @import("Geolocation.zig").Geolocation;
const PluginArray = @import("PluginArray.zig").PluginArray;
const GPU = @import("GPU.zig").GPU;
const WakeLock = @import("WakeLock.zig").WakeLock;
const NavigatorUAData = @import("NavigatorUAData.zig").NavigatorUAData;
const ProtectedAudience = @import("ProtectedAudience.zig").ProtectedAudience;
const NavigatorLogin = @import("NavigatorLogin.zig").NavigatorLogin;
const EpubReadingSystem = @import("EpubReadingSystem.zig").EpubReadingSystem;
const Bluetooth = @import("Bluetooth.zig").Bluetooth;
const MediaSession = @import("MediaSession.zig").MediaSession;
...
const Ink = @import("Ink.zig").Ink;
const XRSystem = @import("XRSystem.zig").XRSystem;
const AuctionAdInterestGroup = @import("dictionaries").AuctionAdInterestGroup;
const Keyboard = @import("Keyboard.zig").Keyboard;
const WindowControlsOverlay = @import("WindowControlsOverlay.zig").WindowControlsOverlay;
const UserActivation = @import("UserActivation.zig").UserActivation;
...
pub const Navigator = struct {
    ...
    pub fn initWithState(
        ...
        return NavigatorImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
