...
pub const ConvolverNode = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        ConvolverNodeImpl.init(instance);
    ...
    pub fn call_removeEventListener(instance: *runtime.Instance, type_: DOMString, callback: anyopaque, options: anyopaque) anyerror!void {
        ...
        return try ConvolverNodeImpl.call_removeEventListener(instance, type_, callback, options);
    }

    pub fn call_when(instance: *runtime.Instance, type_: DOMString, options: ObservableEventListenerOptions) anyerror!Observable {
        
        return try ConvolverNodeImpl.call_when(instance, type_, options);
    }
    ...
    pub fn call_disconnect(instance: *runtime.Instance, args: DisconnectArgs) anyerror!void {
        switch (args) {
            .no_params => return try ConvolverNodeImpl.no_params(instance),
            .long => |arg| return try ConvolverNodeImpl.long(instance, arg),
            .AudioNode => |arg| return try ConvolverNodeImpl.AudioNode(instance, arg),
            .AudioNode_long => |a| return try ConvolverNodeImpl.AudioNode_long(instance, a.destinationNode, a.output),
            .AudioNode_long_long => |a| return try ConvolverNodeImpl.AudioNode_long_long(instance, a.destinationNode, a.output, a.input),
            .AudioParam => |arg| return try ConvolverNodeImpl.AudioParam(instance, arg),
            .AudioParam_long => |a| return try ConvolverNodeImpl.AudioParam_long(instance, a.destinationParam, a.output),
        }
    }
    ...
    pub fn call_addEventListener(instance: *runtime.Instance, type_: DOMString, callback: anyopaque, options: anyopaque) anyerror!void {
        ...
        return try ConvolverNodeImpl.call_addEventListener(instance, type_, callback, options);
    }
