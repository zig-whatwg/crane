...
const CSSConditionRuleImpl = @import("impls").CSSConditionRule;
...
pub const CSSConditionRule = struct {
    pub const Meta = struct {
        pub const name = "CSSConditionRule";
    ...
    pub const State = runtime.FlattenedState(
        struct {
            conditionText: CSSOMString = undefined,
        },
        Meta.BaseType,
        Meta.MixinTypes,
    );

    pub const vtable = runtime.buildVTable(CSSConditionRule, .{
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        return CSSConditionRuleImpl.init(allocator, State, &vtable);
    }

    /// Clean up instance resources
    pub fn deinit(instance: *runtime.Instance) void {
        CSSConditionRuleImpl.deinit(instance);
    }
    ...
    pub fn get_cssText(instance: *runtime.Instance) anyerror!anyopaque {
        return try CSSConditionRuleImpl.get_cssText(instance);
    }

    pub fn set_cssText(instance: *runtime.Instance, value: anyopaque) anyerror!void {
        try CSSConditionRuleImpl.set_cssText(instance, value);
    }

    pub fn get_parentRule(instance: *runtime.Instance) anyerror!CSSRule {
        return try CSSConditionRuleImpl.get_parentRule(instance);
    }

    pub fn get_parentStyleSheet(instance: *runtime.Instance) anyerror!CSSStyleSheet {
        return try CSSConditionRuleImpl.get_parentStyleSheet(instance);
    }

    pub fn get_type(instance: *runtime.Instance) anyerror!u16 {
        return try CSSConditionRuleImpl.get_type(instance);
    }
