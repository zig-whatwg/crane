...
pub const RTCPeerConnection = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        struct {
            ...
            signalingState: enums.RTCSignalingState = undefined,
            iceGatheringState: enums.RTCIceGatheringState = undefined,
            iceConnectionState: enums.RTCIceConnectionState = undefined,
            connectionState: enums.RTCPeerConnectionState = undefined,
            canTrickleIceCandidates: ?bool = null,
            onnegotiationneeded: typedefs.EventHandler = undefined,
            onicecandidate: typedefs.EventHandler = undefined,
            onicecandidateerror: typedefs.EventHandler = undefined,
            onsignalingstatechange: typedefs.EventHandler = undefined,
    ...
    pub fn initWithState(
        ...
        return RTCPeerConnectionImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, configuration: webidl.Opt(RTCConfiguration)) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try RTCPeerConnectionImpl.call_constructor(ctx, configuration);
    }
