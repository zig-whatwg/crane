...
pub const CommandEvent = struct {
    ...
    /// WebIDL constructor
    pub fn call_constructor(allocator: std.mem.Allocator, ctx: runtime.Context, @"type": DOMString, eventInitDict: CommandEventInit) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try CommandEventImpl.call_constructor(allocator, ctx, @"type", eventInitDict);
    }
