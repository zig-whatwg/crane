...
pub const CSSMathInvert = struct {
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return CSSMathInvertImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return CSSMathInvertImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, arg: CSSNumberish) !*runtime.Instance {
        ...
        return try CSSMathInvertImpl.call_constructor(ctx, arg);
    }
