...
pub const WebTransportError = struct {
    ...
    pub fn initWithState(
        ...
        return WebTransportErrorImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, message: webidl.Opt(DOMString), options: webidl.Opt(WebTransportErrorOptions)) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try WebTransportErrorImpl.call_constructor(ctx, message, options);
    }
