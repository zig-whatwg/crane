...
const FrozenArray<CSSOMString> = @import("interfaces").FrozenArray<CSSOMString>;
...
pub const CSSViewTransitionRule = struct {
    ...
    pub const State = runtime.FlattenedState(
        struct {
            ...
            types: FrozenArray<CSSOMString> = undefined,
        },
        Meta.BaseType,
        Meta.MixinTypes,
    );

    pub const vtable = runtime.buildVTable(CSSViewTransitionRule, .{
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        CSSViewTransitionRuleImpl.init(instance);
    ...
    pub fn get_cssText(instance: *runtime.Instance) anyerror!anyopaque {
        return try CSSViewTransitionRuleImpl.get_cssText(instance);
    }

    pub fn set_cssText(instance: *runtime.Instance, value: anyopaque) anyerror!void {
        try CSSViewTransitionRuleImpl.set_cssText(instance, value);
    }

    pub fn get_parentRule(instance: *runtime.Instance) anyerror!anyopaque {
        return try CSSViewTransitionRuleImpl.get_parentRule(instance);
    }

    pub fn get_parentStyleSheet(instance: *runtime.Instance) anyerror!anyopaque {
        return try CSSViewTransitionRuleImpl.get_parentStyleSheet(instance);
    }

    pub fn get_type(instance: *runtime.Instance) anyerror!u16 {
        return try CSSViewTransitionRuleImpl.get_type(instance);
    }
    ...
    pub fn get_navigation(instance: *runtime.Instance) anyerror!anyopaque {
