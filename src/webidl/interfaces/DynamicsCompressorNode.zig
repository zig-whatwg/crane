...
pub const DynamicsCompressorNode = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        DynamicsCompressorNodeImpl.init(instance);
    ...
    pub fn call_removeEventListener(instance: *runtime.Instance, type_: DOMString, callback: anyopaque, options: anyopaque) anyerror!void {
        ...
        return try DynamicsCompressorNodeImpl.call_removeEventListener(instance, type_, callback, options);
    }

    pub fn call_when(instance: *runtime.Instance, type_: DOMString, options: ObservableEventListenerOptions) anyerror!Observable {
        
        return try DynamicsCompressorNodeImpl.call_when(instance, type_, options);
    }
    ...
    pub fn call_disconnect(instance: *runtime.Instance, args: DisconnectArgs) anyerror!void {
        switch (args) {
            .no_params => return try DynamicsCompressorNodeImpl.no_params(instance),
            .long => |arg| return try DynamicsCompressorNodeImpl.long(instance, arg),
            .AudioNode => |arg| return try DynamicsCompressorNodeImpl.AudioNode(instance, arg),
            .AudioNode_long => |a| return try DynamicsCompressorNodeImpl.AudioNode_long(instance, a.destinationNode, a.output),
            .AudioNode_long_long => |a| return try DynamicsCompressorNodeImpl.AudioNode_long_long(instance, a.destinationNode, a.output, a.input),
            .AudioParam => |arg| return try DynamicsCompressorNodeImpl.AudioParam(instance, arg),
            .AudioParam_long => |a| return try DynamicsCompressorNodeImpl.AudioParam_long(instance, a.destinationParam, a.output),
        }
    }
    ...
    pub fn call_addEventListener(instance: *runtime.Instance, type_: DOMString, callback: anyopaque, options: anyopaque) anyerror!void {
        ...
        return try DynamicsCompressorNodeImpl.call_addEventListener(instance, type_, callback, options);
    }
