...
pub const USBInterface = struct {
    ...
    /// WebIDL constructor
    pub fn call_constructor(allocator: std.mem.Allocator, configuration: USBConfiguration, interfaceNumber: u8) !*runtime.Instance {
        const instance = try init(allocator);
        errdefer deinit(instance);
        
        try USBInterfaceImpl.constructor(instance, configuration, interfaceNumber);
    ...
    pub fn get_alternate(instance: *runtime.Instance) anyerror!USBAlternateInterface {
        return try USBInterfaceImpl.get_alternate(instance);
    }

    pub fn get_alternates(instance: *runtime.Instance) anyerror!anyopaque {
