...
pub const CSSFontFaceDescriptors = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        struct {
            ...
            @"font-family": typedefs.CSSOMString = undefined,
            fontStyle: typedefs.CSSOMString = undefined,
            @"font-style": typedefs.CSSOMString = undefined,
            fontWeight: typedefs.CSSOMString = undefined,
            @"font-weight": typedefs.CSSOMString = undefined,
            fontStretch: typedefs.CSSOMString = undefined,
            @"font-stretch": typedefs.CSSOMString = undefined,
            fontWidth: typedefs.CSSOMString = undefined,
            @"font-width": typedefs.CSSOMString = undefined,
            fontSize: typedefs.CSSOMString = undefined,
            @"font-size": typedefs.CSSOMString = undefined,
            sizeAdjust: typedefs.CSSOMString = undefined,
            @"size-adjust": typedefs.CSSOMString = undefined,
            unicodeRange: typedefs.CSSOMString = undefined,
            @"unicode-range": typedefs.CSSOMString = undefined,
            fontFeatureSettings: typedefs.CSSOMString = undefined,
            @"font-feature-settings": typedefs.CSSOMString = undefined,
            fontVariationSettings: typedefs.CSSOMString = undefined,
            @"font-variation-settings": typedefs.CSSOMString = undefined,
            fontNamedInstance: typedefs.CSSOMString = undefined,
            @"font-named-instance": typedefs.CSSOMString = undefined,
            fontDisplay: typedefs.CSSOMString = undefined,
            @"font-display": typedefs.CSSOMString = undefined,
            fontLanguageOverride: typedefs.CSSOMString = undefined,
            @"font-language-override": typedefs.CSSOMString = undefined,
            ascentOverride: typedefs.CSSOMString = undefined,
            @"ascent-override": typedefs.CSSOMString = undefined,
            descentOverride: typedefs.CSSOMString = undefined,
            @"descent-override": typedefs.CSSOMString = undefined,
            lineGapOverride: typedefs.CSSOMString = undefined,
            @"line-gap-override": typedefs.CSSOMString = undefined,
            superscriptPositionOverride: typedefs.CSSOMString = undefined,
            @"superscript-position-override": typedefs.CSSOMString = undefined,
            subscriptPositionOverride: typedefs.CSSOMString = undefined,
            @"subscript-position-override": typedefs.CSSOMString = undefined,
            superscriptSizeOverride: typedefs.CSSOMString = undefined,
            @"superscript-size-override": typedefs.CSSOMString = undefined,
            subscriptSizeOverride: typedefs.CSSOMString = undefined,
            @"subscript-size-override": typedefs.CSSOMString = undefined,
    ...
    pub fn initWithState(
        ...
        return CSSFontFaceDescriptorsImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
