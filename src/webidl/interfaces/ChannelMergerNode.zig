...
pub const ChannelMergerNode = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        Meta.MixinTypes,
        struct {
            _internal: ?*ChannelMergerNodeImpl.InternalState = null,
        },
    );
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return ChannelMergerNodeImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return ChannelMergerNodeImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, context: *runtime.Instance, options: webidl.Opt(ChannelMergerOptions)) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try ChannelMergerNodeImpl.call_constructor(ctx, context, options);
    }
