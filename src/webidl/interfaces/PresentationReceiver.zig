...
const PresentationConnectionList = @import("PresentationConnectionList.zig").PresentationConnectionList;
...
pub const PresentationReceiver = struct {
    ...
    pub fn initWithState(
        ...
        return PresentationReceiverImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
