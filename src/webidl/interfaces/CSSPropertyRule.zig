...
pub const CSSPropertyRule = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        return CSSPropertyRuleImpl.init(allocator, State, &vtable);
    }
    ...
    pub fn get_syntax(instance: *runtime.Instance) anyerror!anyopaque {
    ...
    pub fn get_initialValue(instance: *runtime.Instance) anyerror!anyopaque {
