...
pub const CSSMathProduct = struct {
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return CSSMathProductImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return CSSMathProductImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, args: []const CSSNumberish) !*runtime.Instance {
        ...
        return try CSSMathProductImpl.call_constructor(ctx, args);
    }
