...
pub const ResizeObserver = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        Meta.MixinTypes,
        struct {
            _internal: ?*ResizeObserverImpl.InternalState = null,
        },
    );
    ...
    pub fn initWithState(
        ...
        return ResizeObserverImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, callback: ResizeObserverCallback) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try ResizeObserverImpl.call_constructor(ctx, callback);
    }
