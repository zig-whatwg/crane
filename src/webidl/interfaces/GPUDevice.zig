...
const GPURenderBundleEncoder = @import("GPURenderBundleEncoder.zig").GPURenderBundleEncoder;
...
const GPUDeviceLostInfo = @import("GPUDeviceLostInfo.zig").GPUDeviceLostInfo;
...
const GPUShaderModule = @import("GPUShaderModule.zig").GPUShaderModule;
const GPUSampler = @import("GPUSampler.zig").GPUSampler;
...
const GPUCommandEncoder = @import("GPUCommandEncoder.zig").GPUCommandEncoder;
...
const GPUExternalTexture = @import("GPUExternalTexture.zig").GPUExternalTexture;
...
const GPUPipelineLayout = @import("GPUPipelineLayout.zig").GPUPipelineLayout;
const GPUQueue = @import("GPUQueue.zig").GPUQueue;
...
pub const GPUDevice = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        struct {
            ...
            onuncapturederror: typedefs.EventHandler = undefined,
