...
const SVGFEGaussianBlurElementImpl = @import("impls").SVGFEGaussianBlurElement;
...
pub const SVGFEGaussianBlurElement = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        struct {
            ...
            _internal: ?*SVGFEGaussianBlurElementImpl.InternalState = null,
        },
    );
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return SVGFEGaussianBlurElementImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return SVGFEGaussianBlurElementImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn get_stdDeviationX(instance: *runtime.Instance) anyerror!*runtime.Instance {
        return try SVGFEGaussianBlurElementImpl.get_stdDeviationX(instance);
    }

    pub fn get_stdDeviationY(instance: *runtime.Instance) anyerror!*runtime.Instance {
        return try SVGFEGaussianBlurElementImpl.get_stdDeviationY(instance);
    }
