...
pub const GPUUncapturedErrorEvent = struct {
    ...
    pub fn initWithState(
        ...
        return GPUUncapturedErrorEventImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, @"type": DOMString, gpuUncapturedErrorEventInitDict: GPUUncapturedErrorEventInit) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try GPUUncapturedErrorEventImpl.call_constructor(ctx, @"type", gpuUncapturedErrorEventInitDict);
    }
