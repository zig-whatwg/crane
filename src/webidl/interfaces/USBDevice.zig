...
pub const USBDevice = struct {
    pub const Meta = struct {
        ...
        pub const properties = .{
            ...
            .{ "usbVersionMinor", "get_usbVersionMinor", null },
            .{ "usbVersionSubminor", "get_usbVersionSubminor", null },
            .{ "deviceClass", "get_deviceClass", null },
            .{ "deviceSubclass", "get_deviceSubclass", null },
            .{ "deviceProtocol", "get_deviceProtocol", null },
            .{ "vendorId", "get_vendorId", null },
            .{ "productId", "get_productId", null },
            .{ "deviceVersionMajor", "get_deviceVersionMajor", null },
            .{ "deviceVersionMinor", "get_deviceVersionMinor", null },
            .{ "deviceVersionSubminor", "get_deviceVersionSubminor", null },
            .{ "manufacturerName", "get_manufacturerName", null },
            .{ "productName", "get_productName", null },
            .{ "serialNumber", "get_serialNumber", null },
            .{ "configuration", "get_configuration", null },
        ...
        pub const methods = .{
            ...
            .{ "selectConfiguration", "call_selectConfiguration", 1 },
            .{ "claimInterface", "call_claimInterface", 1 },
            .{ "releaseInterface", "call_releaseInterface", 1 },
            .{ "selectAlternateInterface", "call_selectAlternateInterface", 2 },
            .{ "controlTransferIn", "call_controlTransferIn", 2 },
            .{ "controlTransferOut", "call_controlTransferOut", 1 },
            .{ "clearHalt", "call_clearHalt", 2 },
            .{ "transferIn", "call_transferIn", 2 },
            .{ "transferOut", "call_transferOut", 2 },
            .{ "isochronousTransferIn", "call_isochronousTransferIn", 2 },
    ...
    pub const State = runtime.FlattenedState(
        ...
        struct {
            ...
            manufacturerName: ?typedefs.DOMString = null,
            productName: ?typedefs.DOMString = null,
            serialNumber: ?typedefs.DOMString = null,
            configuration: ?*runtime.Instance = null,
            configurations: runtime.JSValue = undefined,
            opened: bool = undefined,
            _internal: ?*USBDeviceImpl.InternalState = null,
        },
    );
