...
pub const SensorErrorEvent = struct {
    ...
    pub fn initWithState(
        ...
        return SensorErrorEventImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, @"type": DOMString, errorEventInitDict: SensorErrorEventInit) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try SensorErrorEventImpl.call_constructor(ctx, @"type", errorEventInitDict);
    }
