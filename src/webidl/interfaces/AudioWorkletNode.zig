...
pub const AudioWorkletNode = struct {
    ...
    /// WebIDL constructor
    pub fn call_constructor(allocator: std.mem.Allocator, ctx: runtime.Context, context: *runtime.Instance, name: DOMString, options: AudioWorkletNodeOptions) !*runtime.Instance {
