...
pub const MediaStreamAudioDestinationNode = struct {
    ...
    /// WebIDL constructor
    pub fn call_constructor(allocator: std.mem.Allocator, ctx: runtime.Context, context: *runtime.Instance, options: webidl.Opt(AudioNodeOptions)) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try MediaStreamAudioDestinationNodeImpl.call_constructor(allocator, ctx, context, options.value);
    }
