...
pub const MediaStreamAudioDestinationNode = struct {
    ...
    pub fn initWithState(
        ...
        return MediaStreamAudioDestinationNodeImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, context: *runtime.Instance, options: webidl.Opt(AudioNodeOptions)) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try MediaStreamAudioDestinationNodeImpl.call_constructor(ctx, context, options);
    }
