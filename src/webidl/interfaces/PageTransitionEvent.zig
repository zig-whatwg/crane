...
pub const PageTransitionEvent = struct {
    ...
    pub fn initWithState(
        ...
        return PageTransitionEventImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, @"type": DOMString, eventInitDict: webidl.Opt(PageTransitionEventInit)) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try PageTransitionEventImpl.call_constructor(ctx, @"type", eventInitDict);
    }
