...
const PushMessageData = @import("PushMessageData.zig").PushMessageData;
...
pub const PushEvent = struct {
    ...
    pub fn initWithState(
        ...
        return PushEventImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, @"type": DOMString, eventInitDict: webidl.Opt(PushEventInit)) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try PushEventImpl.call_constructor(ctx, @"type", eventInitDict);
    }
