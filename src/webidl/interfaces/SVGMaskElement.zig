...
pub const SVGMaskElement = struct {
    pub const Meta = struct {
        ...
        pub const properties = .{
            .{ "maskUnits", "get_maskUnits", null },
            .{ "maskContentUnits", "get_maskContentUnits", null },
            .{ "x", "get_x", null },
            .{ "y", "get_y", null },
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return SVGMaskElementImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return SVGMaskElementImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
