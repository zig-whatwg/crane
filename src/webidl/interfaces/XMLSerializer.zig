...
pub const XMLSerializer = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        Meta.MixinTypes,
        struct {
            _internal: ?*XMLSerializerImpl.InternalState = null,
        },
    );
    ...
    pub fn initWithState(
        ...
        return XMLSerializerImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context) !*runtime.Instance {
        ...
        return try XMLSerializerImpl.call_constructor(ctx);
    }

    pub fn call_serializeToString(instance: *runtime.Instance, root: *runtime.Instance) anyerror!DOMString {
