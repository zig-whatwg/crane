...
pub const IdentityCredentialError = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        return IdentityCredentialErrorImpl.init(allocator, State, &vtable);
    }
    ...
    /// WebIDL constructor
    pub fn call_constructor(allocator: std.mem.Allocator, message: DOMString, options: IdentityCredentialErrorInit) !*runtime.Instance {
        const instance = try init(allocator);
        errdefer deinit(instance);
        
        try IdentityCredentialErrorImpl.constructor(instance, message, options);
        
        return instance;
    }

    pub fn get_name(instance: *runtime.Instance) anyerror!DOMString {
        return try IdentityCredentialErrorImpl.get_name(instance);
    }

    pub fn get_message(instance: *runtime.Instance) anyerror!DOMString {
        return try IdentityCredentialErrorImpl.get_message(instance);
    }

    pub fn get_code(instance: *runtime.Instance) anyerror!u16 {
        return try IdentityCredentialErrorImpl.get_code(instance);
    }
