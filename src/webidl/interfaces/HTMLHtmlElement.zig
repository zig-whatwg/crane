...
pub const HTMLHtmlElement = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        Meta.MixinTypes,
        struct {
            version: typedefs.DOMString = undefined,
            _internal: ?*HTMLHtmlElementImpl.InternalState = null,
        },
    );
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return HTMLHtmlElementImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return HTMLHtmlElementImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
