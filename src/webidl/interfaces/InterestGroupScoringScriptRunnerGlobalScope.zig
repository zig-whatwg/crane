...
pub const InterestGroupScoringScriptRunnerGlobalScope = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        Meta.MixinTypes,
        struct {
            _internal: ?*InterestGroupScoringScriptRunnerGlobalScopeImpl.InternalState = null,
        },
    );
    ...
    pub fn initWithState(
        ...
        return InterestGroupScoringScriptRunnerGlobalScopeImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
