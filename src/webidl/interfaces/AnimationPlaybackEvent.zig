...
pub const AnimationPlaybackEvent = struct {
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return AnimationPlaybackEventImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return AnimationPlaybackEventImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, @"type": DOMString, eventInitDict: webidl.Opt(AnimationPlaybackEventInit)) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try AnimationPlaybackEventImpl.call_constructor(ctx, @"type", eventInitDict);
    }
