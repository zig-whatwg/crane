...
const SVGFEDisplacementMapElementImpl = @import("impls").SVGFEDisplacementMapElement;
...
pub const SVGFEDisplacementMapElement = struct {
    pub const Meta = struct {
        ...
        pub const properties = .{
            ...
            .{ "xChannelSelector", "get_xChannelSelector", null },
            .{ "yChannelSelector", "get_yChannelSelector", null },
            .{ "x", "get_x", null },
            .{ "y", "get_y", null },
    ...
    pub const State = runtime.FlattenedState(
        ...
        struct {
            ...
            scale: *runtime.Instance = undefined,
            xChannelSelector: *runtime.Instance = undefined,
            yChannelSelector: *runtime.Instance = undefined,
            ...
            _internal: ?*SVGFEDisplacementMapElementImpl.InternalState = null,
        },
    );
    ...
    /// WebIDL constant: const unsigned short SVG_CHANNEL_UNKNOWN = 0;
    pub fn get_SVG_CHANNEL_UNKNOWN() u16 {
        return 0;
    }

    /// WebIDL constant: const unsigned short SVG_CHANNEL_R = 1;
    pub fn get_SVG_CHANNEL_R() u16 {
        return 1;
    }

    /// WebIDL constant: const unsigned short SVG_CHANNEL_G = 2;
    pub fn get_SVG_CHANNEL_G() u16 {
        return 2;
    }

    /// WebIDL constant: const unsigned short SVG_CHANNEL_B = 3;
    pub fn get_SVG_CHANNEL_B() u16 {
        return 3;
    }

    /// WebIDL constant: const unsigned short SVG_CHANNEL_A = 4;
    pub fn get_SVG_CHANNEL_A() u16 {
        return 4;
    }
    ...
    const delegates = .{
        ...
        .get_SVG_CHANNEL_R = &get_SVG_CHANNEL_R,
        .get_SVG_CHANNEL_UNKNOWN = &get_SVG_CHANNEL_UNKNOWN,
        ...
        .get_width = &get_width,
        .get_x = &get_x,
        .get_xChannelSelector = &get_xChannelSelector,
        .get_y = &get_y,
        .get_yChannelSelector = &get_yChannelSelector,
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return SVGFEDisplacementMapElementImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return SVGFEDisplacementMapElementImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn get_in2(instance: *runtime.Instance) anyerror!*runtime.Instance {
        return try SVGFEDisplacementMapElementImpl.get_in2(instance);
    }

    pub fn get_scale(instance: *runtime.Instance) anyerror!*runtime.Instance {
        return try SVGFEDisplacementMapElementImpl.get_scale(instance);
    }

    pub fn get_xChannelSelector(instance: *runtime.Instance) anyerror!*runtime.Instance {
        return try SVGFEDisplacementMapElementImpl.get_xChannelSelector(instance);
    }
