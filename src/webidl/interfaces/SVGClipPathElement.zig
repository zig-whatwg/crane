...
pub const SVGClipPathElement = struct {
    pub const Meta = struct {
        ...
        pub const properties = .{
            .{ "clipPathUnits", "get_clipPathUnits", null },
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return SVGClipPathElementImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return SVGClipPathElementImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
