...
pub const HTMLDListElement = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        struct {
            ...
            _internal: ?*HTMLDListElementImpl.InternalState = null,
        },
    );
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return HTMLDListElementImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return HTMLDListElementImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn set_compact(instance: *runtime.Instance, value: bool) anyerror!void {
        ...
        if (comptime @hasDecl(HTMLDListElementImpl, "set_compact")) return try HTMLDListElementImpl.set_compact(instance, value);
