...
pub const USBEndpoint = struct {
    ...
    /// WebIDL constructor
    pub fn call_constructor(allocator: std.mem.Allocator, ctx: runtime.Context, alternate: USBAlternateInterface, endpointNumber: u8, direction: USBDirection) !*runtime.Instance {
