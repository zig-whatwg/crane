...
pub const CSSMarginRule = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        return CSSMarginRuleImpl.init(allocator, State, &vtable);
    }
