...
pub const DocumentPictureInPictureEvent = struct {
    ...
    pub fn initWithState(
        ...
        return DocumentPictureInPictureEventImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, @"type": DOMString, eventInitDict: DocumentPictureInPictureEventInit) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try DocumentPictureInPictureEventImpl.call_constructor(ctx, @"type", eventInitDict);
    }
