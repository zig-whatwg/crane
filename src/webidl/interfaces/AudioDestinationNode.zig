...
pub const AudioDestinationNode = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        AudioDestinationNodeImpl.init(instance);
    ...
    pub fn call_removeEventListener(instance: *runtime.Instance, type_: DOMString, callback: anyopaque, options: anyopaque) anyerror!void {
        ...
        return try AudioDestinationNodeImpl.call_removeEventListener(instance, type_, callback, options);
    }

    pub fn call_when(instance: *runtime.Instance, type_: DOMString, options: ObservableEventListenerOptions) anyerror!Observable {
        
        return try AudioDestinationNodeImpl.call_when(instance, type_, options);
    }

    pub fn call_dispatchEvent(instance: *runtime.Instance, event: Event) anyerror!bool {
        
        return try AudioDestinationNodeImpl.call_dispatchEvent(instance, event);
    }
    ...
    pub fn call_disconnect(instance: *runtime.Instance, args: DisconnectArgs) anyerror!void {
        switch (args) {
            .no_params => return try AudioDestinationNodeImpl.no_params(instance),
            .long => |arg| return try AudioDestinationNodeImpl.long(instance, arg),
            .AudioNode => |arg| return try AudioDestinationNodeImpl.AudioNode(instance, arg),
            .AudioNode_long => |a| return try AudioDestinationNodeImpl.AudioNode_long(instance, a.destinationNode, a.output),
            .AudioNode_long_long => |a| return try AudioDestinationNodeImpl.AudioNode_long_long(instance, a.destinationNode, a.output, a.input),
            .AudioParam => |arg| return try AudioDestinationNodeImpl.AudioParam(instance, arg),
            .AudioParam_long => |a| return try AudioDestinationNodeImpl.AudioParam_long(instance, a.destinationParam, a.output),
        }
    }
    ...
    pub fn call_addEventListener(instance: *runtime.Instance, type_: DOMString, callback: anyopaque, options: anyopaque) anyerror!void {
        ...
        return try AudioDestinationNodeImpl.call_addEventListener(instance, type_, callback, options);
    }
