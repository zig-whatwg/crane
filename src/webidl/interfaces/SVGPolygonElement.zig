...
const SVGAnimatedPoints = @import("mixins").SVGAnimatedPoints;
...
const SVGPointList = @import("SVGPointList.zig").SVGPointList;
...
pub const SVGPolygonElement = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        struct {
            ...
            _internal: ?*SVGPolygonElementImpl.InternalState = null,
        },
    );
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return SVGPolygonElementImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return SVGPolygonElementImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
