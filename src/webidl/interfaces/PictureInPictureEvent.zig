...
pub const PictureInPictureEvent = struct {
    ...
    pub fn initWithState(
        ...
        return PictureInPictureEventImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, @"type": DOMString, eventInitDict: PictureInPictureEventInit) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try PictureInPictureEventImpl.call_constructor(ctx, @"type", eventInitDict);
    }
