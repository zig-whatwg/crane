...
const MIDIOutputMap = @import("MIDIOutputMap.zig").MIDIOutputMap;
const EventListener = @import("EventListener.zig").EventListener;
const MIDIInputMap = @import("MIDIInputMap.zig").MIDIInputMap;
...
pub const MIDIAccess = struct {
    ...
    pub fn initWithState(
        ...
        return MIDIAccessImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
