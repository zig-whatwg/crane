...
const HTMLTableCellElement = @import("HTMLTableCellElement.zig").HTMLTableCellElement;
...
pub const HTMLTableRowElement = struct {
    ...
    pub fn initWithState(
        ...
        return HTMLTableRowElementImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context) !*runtime.Instance {
        ...
        return try HTMLTableRowElementImpl.call_constructor(ctx);
    }
