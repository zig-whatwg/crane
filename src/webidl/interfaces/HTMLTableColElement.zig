...
pub const HTMLTableColElement = struct {
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return HTMLTableColElementImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return HTMLTableColElementImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context) !*runtime.Instance {
        ...
        return try HTMLTableColElementImpl.call_constructor(ctx);
    }
