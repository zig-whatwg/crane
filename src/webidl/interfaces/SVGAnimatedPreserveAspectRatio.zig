...
const SVGPreserveAspectRatio = @import("SVGPreserveAspectRatio.zig").SVGPreserveAspectRatio;
...
pub const SVGAnimatedPreserveAspectRatio = struct {
    ...
    pub fn initWithState(
        ...
        return SVGAnimatedPreserveAspectRatioImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
