...
pub const MIDIConnectionEvent = struct {
    ...
    pub fn initWithState(
        ...
        return MIDIConnectionEventImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, @"type": DOMString, eventInitDict: webidl.Opt(MIDIConnectionEventInit)) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try MIDIConnectionEventImpl.call_constructor(ctx, @"type", eventInitDict);
    }
