...
pub const TrustedHTML = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        Meta.MixinTypes,
        struct {
            _internal: ?*TrustedHTMLImpl.InternalState = null,
        },
    );
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return TrustedHTMLImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return TrustedHTMLImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn serialize(instance: *runtime.Instance) anyerror!runtime.USVString {
        return try TrustedHTMLImpl.serialize(instance);
    }
