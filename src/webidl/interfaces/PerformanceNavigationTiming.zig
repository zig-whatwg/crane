...
pub const PerformanceNavigationTiming = struct {
    pub const Meta = struct {
        ...
        pub const BaseType = PerformanceResourceTiming.State;
        pub const ParentInterface = PerformanceResourceTiming;
    ...
    pub fn initWithState(
        ...
        return PerformanceNavigationTimingImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
