...
pub const XRLayerEvent = struct {
    ...
    pub fn initWithState(
        ...
        return XRLayerEventImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, @"type": DOMString, eventInitDict: XRLayerEventInit) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try XRLayerEventImpl.call_constructor(ctx, @"type", eventInitDict);
    }
