...
pub const HTMLDetailsElement = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        struct {
            ...
            open: bool = undefined,
            _internal: ?*HTMLDetailsElementImpl.InternalState = null,
        },
    );
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return HTMLDetailsElementImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return HTMLDetailsElementImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context) !*runtime.Instance {
        ...
        return try HTMLDetailsElementImpl.call_constructor(ctx);
    }
