...
pub const HTMLPreElement = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        struct {
            width: i32 = undefined,
            _internal: ?*HTMLPreElementImpl.InternalState = null,
        },
    );
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return HTMLPreElementImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return HTMLPreElementImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
