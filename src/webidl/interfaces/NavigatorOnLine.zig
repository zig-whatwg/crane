...
pub const NavigatorOnLine = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        struct {
            ...
            _internal: ?*NavigatorOnLineImpl.InternalState = null,
        },
    );
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return NavigatorOnLineImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return NavigatorOnLineImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
