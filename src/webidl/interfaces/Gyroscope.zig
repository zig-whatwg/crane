...
pub const Gyroscope = struct {
    ...
    /// WebIDL constructor
    pub fn call_constructor(allocator: std.mem.Allocator, ctx: runtime.Context, sensorOptions: webidl.Opt(GyroscopeSensorOptions)) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try GyroscopeImpl.call_constructor(allocator, ctx, sensorOptions.value);
    }
