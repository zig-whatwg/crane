...
pub const Gyroscope = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        struct {
            ...
            y: ?f64 = null,
            z: ?f64 = null,
            _internal: ?*GyroscopeImpl.InternalState = null,
        },
    );
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return GyroscopeImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return GyroscopeImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, sensorOptions: webidl.Opt(GyroscopeSensorOptions)) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try GyroscopeImpl.call_constructor(ctx, sensorOptions);
    }
