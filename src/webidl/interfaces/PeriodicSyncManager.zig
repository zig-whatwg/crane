...
pub const PeriodicSyncManager = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        Meta.MixinTypes,
        struct {
            _internal: ?*PeriodicSyncManagerImpl.InternalState = null,
        },
    );
    ...
    pub fn initWithState(
        ...
        return PeriodicSyncManagerImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_unregister(instance: *runtime.Instance, tag: DOMString) anyerror!runtime.JSValue {
