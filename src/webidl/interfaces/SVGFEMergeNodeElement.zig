...
const SVGFEMergeNodeElementImpl = @import("impls").SVGFEMergeNodeElement;
...
pub const SVGFEMergeNodeElement = struct {
    pub const Meta = struct {
        pub const name = "SVGFEMergeNodeElement";
    ...
    pub const State = runtime.FlattenedState(
        ...
        struct {
            ...
            _internal: ?*SVGFEMergeNodeElementImpl.InternalState = null,
        },
    );
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return SVGFEMergeNodeElementImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return SVGFEMergeNodeElementImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
