...
const Accelerometer = @import("Accelerometer.zig").Accelerometer;
...
pub const GravitySensor = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        Meta.MixinTypes,
        struct {
            _internal: ?*GravitySensorImpl.InternalState = null,
        },
    );
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return GravitySensorImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return GravitySensorImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, options: webidl.Opt(AccelerometerSensorOptions)) !*runtime.Instance {
        ...
        return try GravitySensorImpl.call_constructor(ctx, options);
    }
