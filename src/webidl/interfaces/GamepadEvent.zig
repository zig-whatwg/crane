...
pub const GamepadEvent = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        Meta.MixinTypes,
        struct {
            gamepad: *runtime.Instance = undefined,
    ...
    pub fn initWithState(
        ...
        return GamepadEventImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, @"type": DOMString, eventInitDict: GamepadEventInit) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try GamepadEventImpl.call_constructor(ctx, @"type", eventInitDict);
    }
