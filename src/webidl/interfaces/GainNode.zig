...
pub const GainNode = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        struct {
            ...
            _internal: ?*GainNodeImpl.InternalState = null,
        },
    );
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return GainNodeImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return GainNodeImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, context: *runtime.Instance, options: webidl.Opt(GainOptions)) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try GainNodeImpl.call_constructor(ctx, context, options);
    }
