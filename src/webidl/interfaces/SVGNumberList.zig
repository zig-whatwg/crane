...
pub const SVGNumberList = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        struct {
            ...
            _internal: ?*SVGNumberListImpl.InternalState = null,
        },
    );
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return SVGNumberListImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return SVGNumberListImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_setter(instance: *runtime.Instance, index: u32, newItem: *runtime.Instance) anyerror!void {
        ...
        return try SVGNumberListImpl.call_setter(instance, index, newItem);
    }
