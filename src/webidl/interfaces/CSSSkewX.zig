...
pub const CSSSkewX = struct {
    ...
    pub fn initWithState(
        ...
        return CSSSkewXImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, ax: *runtime.Instance) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try CSSSkewXImpl.call_constructor(ctx, ax);
    }
