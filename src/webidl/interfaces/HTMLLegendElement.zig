...
pub const HTMLLegendElement = struct {
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return HTMLLegendElementImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return HTMLLegendElementImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context) !*runtime.Instance {
        ...
        return try HTMLLegendElementImpl.call_constructor(ctx);
    }
