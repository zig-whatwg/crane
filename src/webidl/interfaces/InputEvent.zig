...
pub const InputEvent = struct {
    ...
    pub fn initWithState(
        ...
        return InputEventImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, @"type": DOMString, eventInitDict: webidl.Opt(InputEventInit)) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try InputEventImpl.call_constructor(ctx, @"type", eventInitDict);
    }
