...
pub const HTMLUnknownElement = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        Meta.MixinTypes,
        struct {
            _internal: ?*HTMLUnknownElementImpl.InternalState = null,
        },
    );
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return HTMLUnknownElementImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return HTMLUnknownElementImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
