...
pub const CSSKeyframeRule = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        return CSSKeyframeRuleImpl.init(allocator, State, &vtable);
    }
    ...
    pub fn get_cssText(instance: *runtime.Instance) anyerror!anyopaque {
        return try CSSKeyframeRuleImpl.get_cssText(instance);
    }

    pub fn set_cssText(instance: *runtime.Instance, value: anyopaque) anyerror!void {
        try CSSKeyframeRuleImpl.set_cssText(instance, value);
    }

    pub fn get_parentRule(instance: *runtime.Instance) anyerror!CSSRule {
        return try CSSKeyframeRuleImpl.get_parentRule(instance);
    }

    pub fn get_parentStyleSheet(instance: *runtime.Instance) anyerror!CSSStyleSheet {
        return try CSSKeyframeRuleImpl.get_parentStyleSheet(instance);
    }

    pub fn get_type(instance: *runtime.Instance) anyerror!u16 {
        return try CSSKeyframeRuleImpl.get_type(instance);
    }

    pub fn get_keyText(instance: *runtime.Instance) anyerror!anyopaque {
        return try CSSKeyframeRuleImpl.get_keyText(instance);
    }

    pub fn set_keyText(instance: *runtime.Instance, value: anyopaque) anyerror!void {
