...
pub const NavigatorLogin = struct {
    ...
    pub const vtable = runtime.buildVTable(NavigatorLogin, .{
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        return NavigatorLoginImpl.init(allocator, State, &vtable);
    }
    ...
    pub fn call_setStatus(instance: *runtime.Instance, status: LoginStatus) anyerror!anyopaque {
