...
pub const USBIsochronousInTransferPacket = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        struct {
            ...
            _internal: ?*USBIsochronousInTransferPacketImpl.InternalState = null,
        },
    );
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return USBIsochronousInTransferPacketImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return USBIsochronousInTransferPacketImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, status: USBTransferStatus, data: webidl.Opt(?runtime.JSValue)) !*runtime.Instance {
        ...
        return try USBIsochronousInTransferPacketImpl.call_constructor(ctx, status, data);
    }
