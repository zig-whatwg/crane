...
pub const DOMPoint = struct {
    pub const Meta = struct {
        ...
        pub const BaseType = DOMPointReadOnly.State;
        pub const ParentInterface = DOMPointReadOnly;
    ...
    pub fn initWithState(
        ...
        return DOMPointImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, x: webidl.Opt(f64), y: webidl.Opt(f64), z: webidl.Opt(f64), w: webidl.Opt(f64)) !*runtime.Instance {
        ...
        return try DOMPointImpl.call_constructor(ctx, x, y, z, w);
    }
    ...
    pub fn call_static_fromPoint(instance: *runtime.Instance, other: webidl.Opt(DOMPointInit)) anyerror!*runtime.Instance {
        ...
        return try DOMPointImpl.call_static_fromPoint(instance, other);
    }
