...
pub const ContentVisibilityAutoStateChangeEvent = struct {
    ...
    /// WebIDL constructor
    pub fn call_constructor(allocator: std.mem.Allocator, ctx: runtime.Context, @"type": DOMString, eventInitDict: ContentVisibilityAutoStateChangeEventInit) !*runtime.Instance {
