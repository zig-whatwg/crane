...
pub const DocumentTimeline = struct {
    ...
    pub fn initWithState(
        ...
        return DocumentTimelineImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, options: webidl.Opt(DocumentTimelineOptions)) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try DocumentTimelineImpl.call_constructor(ctx, options);
    }
