...
pub const ScrollTimeline = struct {
    ...
    pub fn initWithState(
        ...
        return ScrollTimelineImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, options: webidl.Opt(ScrollTimelineOptions)) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try ScrollTimelineImpl.call_constructor(ctx, options);
    }
