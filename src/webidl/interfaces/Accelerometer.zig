...
pub const Accelerometer = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        return AccelerometerImpl.init(allocator, State, &vtable);
    }
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, options: AccelerometerSensorOptions) !*runtime.Instance {
        ...
        try AccelerometerImpl.constructor(instance, options);
        
        return instance;
    }

    pub fn get_activated(instance: *runtime.Instance) anyerror!bool {
        return try AccelerometerImpl.get_activated(instance);
    }

    pub fn get_hasReading(instance: *runtime.Instance) anyerror!bool {
        return try AccelerometerImpl.get_hasReading(instance);
    }

    pub fn get_timestamp(instance: *runtime.Instance) anyerror!DOMHighResTimeStamp {
        return try AccelerometerImpl.get_timestamp(instance);
    }

    pub fn get_onreading(instance: *runtime.Instance) anyerror!EventHandler {
        return try AccelerometerImpl.get_onreading(instance);
    }

    pub fn set_onreading(instance: *runtime.Instance, value: EventHandler) anyerror!void {
        try AccelerometerImpl.set_onreading(instance, value);
    }

    pub fn get_onactivate(instance: *runtime.Instance) anyerror!EventHandler {
        return try AccelerometerImpl.get_onactivate(instance);
    }

    pub fn set_onactivate(instance: *runtime.Instance, value: EventHandler) anyerror!void {
        try AccelerometerImpl.set_onactivate(instance, value);
    }

    pub fn get_onerror(instance: *runtime.Instance) anyerror!EventHandler {
        return try AccelerometerImpl.get_onerror(instance);
    }

    pub fn set_onerror(instance: *runtime.Instance, value: EventHandler) anyerror!void {
        try AccelerometerImpl.set_onerror(instance, value);
    }
    ...
    pub fn call_dispatchEvent(instance: *runtime.Instance, event: Event) anyerror!bool {
        ...
        return try AccelerometerImpl.call_dispatchEvent(instance, event);
    }

    pub fn call_stop(instance: *runtime.Instance) anyerror!void {
        return try AccelerometerImpl.call_stop(instance);
    }

    pub fn call_when(instance: *runtime.Instance, @"type": DOMString, options: ObservableEventListenerOptions) anyerror!Observable {
        
        return try AccelerometerImpl.call_when(instance, @"type", options);
    }

    pub fn call_start(instance: *runtime.Instance) anyerror!void {
        return try AccelerometerImpl.call_start(instance);
    }

    pub fn call_addEventListener(instance: *runtime.Instance, @"type": DOMString, callback: EventListener, options: anyopaque) anyerror!void {
        
        return try AccelerometerImpl.call_addEventListener(instance, @"type", callback, options);
    }

    pub fn call_removeEventListener(instance: *runtime.Instance, @"type": DOMString, callback: EventListener, options: anyopaque) anyerror!void {
        
        return try AccelerometerImpl.call_removeEventListener(instance, @"type", callback, options);
    }
