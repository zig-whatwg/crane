...
pub const HTMLMapElement = struct {
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return HTMLMapElementImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        ...
        return try HTMLMapElementImpl.call_constructor(allocator, ctx);
    }
    ...
    pub fn get_areas(instance: *runtime.Instance) anyerror!HTMLCollection {
        ...
        if (state.own.cached_areas) |cached| {
            return cached;
        }
