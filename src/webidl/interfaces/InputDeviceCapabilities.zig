...
pub const InputDeviceCapabilities = struct {
    ...
    pub fn initWithState(
        ...
        return InputDeviceCapabilitiesImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, deviceInitDict: webidl.Opt(InputDeviceCapabilitiesInit)) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try InputDeviceCapabilitiesImpl.call_constructor(ctx, deviceInitDict);
    }
