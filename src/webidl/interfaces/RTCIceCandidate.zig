...
pub const RTCIceCandidate = struct {
    ...
    pub fn initWithState(
        ...
        return RTCIceCandidateImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, candidateInitDict: webidl.Opt(RTCLocalIceCandidateInit)) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try RTCIceCandidateImpl.call_constructor(ctx, candidateInitDict);
    }
