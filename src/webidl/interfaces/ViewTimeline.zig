...
pub const ViewTimeline = struct {
    pub const Meta = struct {
        ...
        pub const BaseType = ScrollTimeline.State;
        pub const ParentInterface = ScrollTimeline;
    ...
    pub fn initWithState(
        ...
        return ViewTimelineImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, options: webidl.Opt(ViewTimelineOptions)) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try ViewTimelineImpl.call_constructor(ctx, options);
    }
