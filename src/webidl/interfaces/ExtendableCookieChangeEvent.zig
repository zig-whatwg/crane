...
pub const ExtendableCookieChangeEvent = struct {
    ...
    pub fn initWithState(
        ...
        return ExtendableCookieChangeEventImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, @"type": DOMString, eventInitDict: webidl.Opt(ExtendableCookieChangeEventInit)) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try ExtendableCookieChangeEventImpl.call_constructor(ctx, @"type", eventInitDict);
    }
