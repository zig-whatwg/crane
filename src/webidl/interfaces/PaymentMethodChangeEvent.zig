...
pub const PaymentMethodChangeEvent = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        return PaymentMethodChangeEventImpl.init(allocator, State, &vtable);
    }
    ...
    /// WebIDL constructor
    pub fn call_constructor(allocator: std.mem.Allocator, @"type": DOMString, eventInitDict: PaymentMethodChangeEventInit) !*runtime.Instance {
        const instance = try init(allocator);
        errdefer deinit(instance);
        
        try PaymentMethodChangeEventImpl.constructor(instance, @"type", eventInitDict);
    ...
    pub fn call_initEvent(instance: *runtime.Instance, @"type": DOMString, bubbles: bool, cancelable: bool) anyerror!void {
        ...
        return try PaymentMethodChangeEventImpl.call_initEvent(instance, @"type", bubbles, cancelable);
    }
