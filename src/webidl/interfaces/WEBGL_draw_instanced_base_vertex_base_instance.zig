...
pub const WEBGL_draw_instanced_base_vertex_base_instance = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        Meta.MixinTypes,
        struct {
            _internal: ?*WEBGL_draw_instanced_base_vertex_base_instanceImpl.InternalState = null,
        },
    );
    ...
    pub fn initWithState(
        ...
        return WEBGL_draw_instanced_base_vertex_base_instanceImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
