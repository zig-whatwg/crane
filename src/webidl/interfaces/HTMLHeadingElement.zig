...
pub const HTMLHeadingElement = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        struct {
            ...
            _internal: ?*HTMLHeadingElementImpl.InternalState = null,
        },
    );
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return HTMLHeadingElementImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return HTMLHeadingElementImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
