...
pub const Text = struct {
    ...
    pub const vtable = runtime.buildVTable(Text, .{
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        return TextImpl.init(allocator, State, &vtable);
    }
    ...
    pub fn set_nodeValue(instance: *runtime.Instance, value: DOMString) anyerror!void {
        ...
        try TextImpl.set_nodeValue(instance, value);
    }

    /// Extended attributes: [CEReactions]
    pub fn get_textContent(instance: *runtime.Instance) anyerror!DOMString {
        return try TextImpl.get_textContent(instance);
    }
    ...
    pub fn call_isDefaultNamespace(instance: *runtime.Instance, namespace: DOMString) anyerror!bool {
        ...
        return try TextImpl.call_isDefaultNamespace(instance, namespace);
    }

    pub fn call_compareDocumentPosition(instance: *runtime.Instance, other: Node) anyerror!u16 {
        
        return try TextImpl.call_compareDocumentPosition(instance, other);
    }

    pub fn call_contains(instance: *runtime.Instance, other: Node) anyerror!bool {
        
        return try TextImpl.call_contains(instance, other);
    }
    ...
    pub fn call_remove(instance: *runtime.Instance) anyerror!void {
        ...
        return try TextImpl.call_remove(instance);
    }

    pub fn call_replaceData(instance: *runtime.Instance, offset: u32, count: u32, data: DOMString) anyerror!void {
        
        return try TextImpl.call_replaceData(instance, offset, count, data);
    }

    pub fn call_removeEventListener(instance: *runtime.Instance, @"type": DOMString, callback: EventListener, options: anyopaque) anyerror!void {
        
        return try TextImpl.call_removeEventListener(instance, @"type", callback, options);
    }
    ...
    pub fn call_cloneNode(instance: *runtime.Instance, subtree: bool) anyerror!Node {
        ...
        return try TextImpl.call_cloneNode(instance, subtree);
    }

    pub fn call_getRootNode(instance: *runtime.Instance, options: GetRootNodeOptions) anyerror!Node {
        
        return try TextImpl.call_getRootNode(instance, options);
    }

    pub fn call_substringData(instance: *runtime.Instance, offset: u32, count: u32) anyerror!DOMString {
        
        return try TextImpl.call_substringData(instance, offset, count);
    }

    pub fn call_dispatchEvent(instance: *runtime.Instance, event: Event) anyerror!bool {
        
        return try TextImpl.call_dispatchEvent(instance, event);
    }
    ...
    pub fn call_replaceWith(instance: *runtime.Instance, nodes: anyopaque) anyerror!void {
        ...
        return try TextImpl.call_replaceWith(instance, nodes);
    }
    ...
    pub fn call_isSameNode(instance: *runtime.Instance, otherNode: Node) anyerror!bool {
        ...
        return try TextImpl.call_isSameNode(instance, otherNode);
    }
    ...
    pub fn call_lookupPrefix(instance: *runtime.Instance, namespace: DOMString) anyerror!DOMString {
        ...
        return try TextImpl.call_lookupPrefix(instance, namespace);
    }

    pub fn call_when(instance: *runtime.Instance, @"type": DOMString, options: ObservableEventListenerOptions) anyerror!Observable {
        
        return try TextImpl.call_when(instance, @"type", options);
    }
    ...
    pub fn call_insertBefore(instance: *runtime.Instance, node: Node, child: Node) anyerror!Node {
        ...
        return try TextImpl.call_insertBefore(instance, node, child);
    }
    ...
    pub fn call_before(instance: *runtime.Instance, nodes: anyopaque) anyerror!void {
        ...
        return try TextImpl.call_before(instance, nodes);
    }
    ...
    pub fn call_after(instance: *runtime.Instance, nodes: anyopaque) anyerror!void {
        ...
        return try TextImpl.call_after(instance, nodes);
    }

    pub fn call_appendData(instance: *runtime.Instance, data: DOMString) anyerror!void {
        
        return try TextImpl.call_appendData(instance, data);
    }

    pub fn call_lookupNamespaceURI(instance: *runtime.Instance, prefix: DOMString) anyerror!DOMString {
        
        return try TextImpl.call_lookupNamespaceURI(instance, prefix);
    }

    pub fn call_addEventListener(instance: *runtime.Instance, @"type": DOMString, callback: EventListener, options: anyopaque) anyerror!void {
        
        return try TextImpl.call_addEventListener(instance, @"type", callback, options);
    }
    ...
    pub fn call_appendChild(instance: *runtime.Instance, node: Node) anyerror!Node {
        ...
        return try TextImpl.call_appendChild(instance, node);
    }

    pub fn call_hasChildNodes(instance: *runtime.Instance) anyerror!bool {
        return try TextImpl.call_hasChildNodes(instance);
    }

    pub fn call_insertData(instance: *runtime.Instance, offset: u32, data: DOMString) anyerror!void {
        
        return try TextImpl.call_insertData(instance, offset, data);
    }
    ...
    pub fn call_removeChild(instance: *runtime.Instance, child: Node) anyerror!Node {
        ...
        return try TextImpl.call_removeChild(instance, child);
    }
    ...
    pub fn call_normalize(instance: *runtime.Instance) anyerror!void {
        ...
        return try TextImpl.call_normalize(instance);
    }

    pub fn call_isEqualNode(instance: *runtime.Instance, otherNode: Node) anyerror!bool {
        
        return try TextImpl.call_isEqualNode(instance, otherNode);
    }
    ...
    pub fn call_replaceChild(instance: *runtime.Instance, node: Node, child: Node) anyerror!Node {
        ...
        return try TextImpl.call_replaceChild(instance, node, child);
    }
    ...
    pub fn call_deleteData(instance: *runtime.Instance, offset: u32, count: u32) anyerror!void {
        ...
        return try TextImpl.call_deleteData(instance, offset, count);
    }
