...
pub const HTMLTimeElement = struct {
    pub const Meta = struct {
        ...
        pub const properties = .{
            .{ "dateTime", "get_dateTime", "set_dateTime" },
        };
    ...
    pub const State = runtime.FlattenedState(
        ...
        Meta.MixinTypes,
        struct {
            dateTime: typedefs.DOMString = undefined,
            _internal: ?*HTMLTimeElementImpl.InternalState = null,
        },
    );
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return HTMLTimeElementImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return HTMLTimeElementImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
