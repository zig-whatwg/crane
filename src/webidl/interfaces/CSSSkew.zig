...
pub const CSSSkew = struct {
    ...
    pub fn initWithState(
        ...
        return CSSSkewImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, ax: *runtime.Instance, ay: *runtime.Instance) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try CSSSkewImpl.call_constructor(ctx, ax, ay);
    }
