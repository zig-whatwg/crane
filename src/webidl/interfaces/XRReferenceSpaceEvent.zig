...
pub const XRReferenceSpaceEvent = struct {
    ...
    pub fn initWithState(
        ...
        return XRReferenceSpaceEventImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, @"type": DOMString, eventInitDict: XRReferenceSpaceEventInit) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try XRReferenceSpaceEventImpl.call_constructor(ctx, @"type", eventInitDict);
    }
