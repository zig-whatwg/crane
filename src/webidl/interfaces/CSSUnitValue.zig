...
pub const CSSUnitValue = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        CSSUnitValueImpl.init(instance);
    ...
    pub fn call_parse(instance: *runtime.Instance, args: ParseArgs) anyerror!CSSStyleValue {
        switch (args) {
            .USVString_USVString => |a| return try CSSUnitValueImpl.USVString_USVString(instance, a.property, a.cssText),
            .USVString => |arg| return try CSSUnitValueImpl.USVString(instance, arg),
        }
    }
