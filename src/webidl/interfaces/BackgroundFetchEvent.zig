...
const BackgroundFetchRegistration = @import("BackgroundFetchRegistration.zig").BackgroundFetchRegistration;
...
pub const BackgroundFetchEvent = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        struct {
            ...
            _internal: ?*BackgroundFetchEventImpl.InternalState = null,
        },
    );
    ...
    pub fn initWithState(
        ...
        return BackgroundFetchEventImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, @"type": DOMString, init_data: BackgroundFetchEventInit) !*runtime.Instance {
        ...
        return try BackgroundFetchEventImpl.call_constructor(ctx, @"type", init_data);
    }
