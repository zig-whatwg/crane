...
pub const BackgroundFetchEvent = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        return BackgroundFetchEventImpl.init(allocator, State, &vtable);
    }
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, @"type": DOMString, init_data: BackgroundFetchEventInit) !*runtime.Instance {
        ...
        try BackgroundFetchEventImpl.constructor(instance, @"type", init_data);
    ...
    pub fn call_initEvent(instance: *runtime.Instance, @"type": DOMString, bubbles: bool, cancelable: bool) anyerror!void {
        ...
        return try BackgroundFetchEventImpl.call_initEvent(instance, @"type", bubbles, cancelable);
    }
