...
pub const AudioProcessingEvent = struct {
    ...
    pub fn initWithState(
        ...
        return AudioProcessingEventImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, @"type": DOMString, eventInitDict: AudioProcessingEventInit) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try AudioProcessingEventImpl.call_constructor(ctx, @"type", eventInitDict);
    }
