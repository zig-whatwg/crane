...
pub const GPURenderPassEncoder = struct {
    ...
    pub fn call_setBindGroup__1(instance: *runtime.Instance, index: GPUIndex32, bindGroup: ?*runtime.Instance, dynamicOffsetsData: runtime.JSValue, dynamicOffsetsDataStart: GPUSize64, dynamicOffsetsDataLength: GPUSize32) anyerror!void {
        if (comptime @hasDecl(GPURenderPassEncoderImpl, "call_setBindGroup__1")) {
            return try GPURenderPassEncoderImpl.call_setBindGroup__1(instance, index, bindGroup, dynamicOffsetsData, dynamicOffsetsDataStart, dynamicOffsetsDataLength);
        } else {
