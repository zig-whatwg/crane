...
pub const CSSVariableReferenceValue = struct {
    ...
    pub fn initWithState(
        ...
        return CSSVariableReferenceValueImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, variable: runtime.USVString, fallback: webidl.Opt(?*runtime.Instance)) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try CSSVariableReferenceValueImpl.call_constructor(ctx, variable, fallback);
    }
