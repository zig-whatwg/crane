...
pub const AudioEncoder = struct {
    ...
    pub fn call_dispatchEvent(instance: *runtime.Instance, event: Event) anyerror!bool {
        ...
        return try AudioEncoderImpl.call_dispatchEvent(instance, event);
    }
    ...
    pub fn call_encode(instance: *runtime.Instance, data: AudioData) anyerror!void {
    ...
    pub fn call_isConfigSupported(instance: *runtime.Instance, config: AudioEncoderConfig) anyerror!anyopaque {
