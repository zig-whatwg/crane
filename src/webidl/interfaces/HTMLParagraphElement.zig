...
pub const HTMLParagraphElement = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        struct {
            ...
            _internal: ?*HTMLParagraphElementImpl.InternalState = null,
        },
    );
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return HTMLParagraphElementImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return HTMLParagraphElementImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context) !*runtime.Instance {
        ...
        return try HTMLParagraphElementImpl.call_constructor(ctx);
    }
    ...
    pub fn get_align(instance: *runtime.Instance) anyerror!DOMString {
        if (comptime @hasDecl(HTMLParagraphElementImpl, "get_align")) return try HTMLParagraphElementImpl.get_align(instance);
    ...
    pub fn set_align(instance: *runtime.Instance, value: DOMString) anyerror!void {
        ...
        if (comptime @hasDecl(HTMLParagraphElementImpl, "set_align")) return try HTMLParagraphElementImpl.set_align(instance, value);
