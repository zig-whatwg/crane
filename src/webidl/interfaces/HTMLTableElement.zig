...
const HTMLTableSectionElement = @import("HTMLTableSectionElement.zig").HTMLTableSectionElement;
...
const HTMLTableCaptionElement = @import("HTMLTableCaptionElement.zig").HTMLTableCaptionElement;
...
const HTMLTableRowElement = @import("HTMLTableRowElement.zig").HTMLTableRowElement;
...
pub const HTMLTableElement = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        struct {
            ...
            frame: typedefs.DOMString = undefined,
            rules: typedefs.DOMString = undefined,
            summary: typedefs.DOMString = undefined,
            width: typedefs.DOMString = undefined,
            bgColor: typedefs.DOMString = undefined,
            cellPadding: typedefs.DOMString = undefined,
            cellSpacing: typedefs.DOMString = undefined,
    ...
    pub fn initWithState(
        ...
        return HTMLTableElementImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context) !*runtime.Instance {
        ...
        return try HTMLTableElementImpl.call_constructor(ctx);
    }
