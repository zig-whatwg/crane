...
pub const CSSValueList = struct {
    pub const Meta = struct {
        ...
        pub const BaseType = CSSValue.State;
    ...
    pub const State = runtime.FlattenedState(
        ...
        struct {
            ...
            _internal: ?*CSSValueListImpl.InternalState = null,
        },
    );
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return CSSValueListImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return CSSValueListImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
