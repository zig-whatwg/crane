...
const HIDDevice = @import("HIDDevice.zig").HIDDevice;
...
pub const HIDInputReportEvent = struct {
    ...
    pub fn initWithState(
        ...
        return HIDInputReportEventImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, @"type": DOMString, eventInitDict: HIDInputReportEventInit) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try HIDInputReportEventImpl.call_constructor(ctx, @"type", eventInitDict);
    }
