...
pub const OffscreenCanvasRenderingContext2D = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        OffscreenCanvasRenderingContext2DImpl.init(instance);
    ...
    pub fn get_canvas(instance: *runtime.Instance) anyerror!OffscreenCanvas {
    ...
    pub fn call_isPointInPath(instance: *runtime.Instance, args: IsPointInPathArgs) anyerror!bool {
        switch (args) {
            .unrestricted double_unrestricted double_CanvasFillRule => |a| return try OffscreenCanvasRenderingContext2DImpl.unrestricted double_unrestricted double_CanvasFillRule(instance, a.x, a.y, a.fillRule),
            .Path2D_unrestricted double_unrestricted double_CanvasFillRule => |a| return try OffscreenCanvasRenderingContext2DImpl.Path2D_unrestricted double_unrestricted double_CanvasFillRule(instance, a.path, a.x, a.y, a.fillRule),
        }
    }
    ...
    pub fn call_clip(instance: *runtime.Instance, args: ClipArgs) anyerror!void {
        switch (args) {
            .CanvasFillRule => |arg| return try OffscreenCanvasRenderingContext2DImpl.CanvasFillRule(instance, arg),
            .Path2D_CanvasFillRule => |a| return try OffscreenCanvasRenderingContext2DImpl.Path2D_CanvasFillRule(instance, a.path, a.fillRule),
        }
    }
    ...
    pub fn call_stroke(instance: *runtime.Instance, args: StrokeArgs) anyerror!void {
        switch (args) {
            .no_params => return try OffscreenCanvasRenderingContext2DImpl.no_params(instance),
            .Path2D => |arg| return try OffscreenCanvasRenderingContext2DImpl.Path2D(instance, arg),
        }
    }
    ...
    pub fn call_drawImage(instance: *runtime.Instance, args: DrawImageArgs) anyerror!void {
        switch (args) {
            .CanvasImageSource_unrestricted double_unrestricted double => |a| return try OffscreenCanvasRenderingContext2DImpl.CanvasImageSource_unrestricted double_unrestricted double(instance, a.image, a.dx, a.dy),
            .CanvasImageSource_unrestricted double_unrestricted double_unrestricted double_unrestricted double => |a| return try OffscreenCanvasRenderingContext2DImpl.CanvasImageSource_unrestricted double_unrestricted double_unrestricted double_unrestricted double(instance, a.image, a.dx, a.dy, a.dw, a.dh),
            .CanvasImageSource_unrestricted double_unrestricted double_unrestricted double_unrestricted double_unrestricted double_unrestricted double_unrestricted double_unrestricted double => |a| return try OffscreenCanvasRenderingContext2DImpl.CanvasImageSource_unrestricted double_unrestricted double_unrestricted double_unrestricted double_unrestricted double_unrestricted double_unrestricted double_unrestricted double(instance, a.image, a.sx, a.sy, a.sw, a.sh, a.dx, a.dy, a.dw, a.dh),
        }
    }
    ...
    pub fn call_isPointInStroke(instance: *runtime.Instance, args: IsPointInStrokeArgs) anyerror!bool {
        switch (args) {
            .unrestricted double_unrestricted double => |a| return try OffscreenCanvasRenderingContext2DImpl.unrestricted double_unrestricted double(instance, a.x, a.y),
            .Path2D_unrestricted double_unrestricted double => |a| return try OffscreenCanvasRenderingContext2DImpl.Path2D_unrestricted double_unrestricted double(instance, a.path, a.x, a.y),
        }
    }
    ...
    pub fn call_createImageData(instance: *runtime.Instance, args: CreateImageDataArgs) anyerror!ImageData {
        switch (args) {
            .long_long_ImageDataSettings => |a| return try OffscreenCanvasRenderingContext2DImpl.long_long_ImageDataSettings(instance, a.sw, a.sh, a.settings),
            .ImageData => |arg| return try OffscreenCanvasRenderingContext2DImpl.ImageData(instance, arg),
        }
    }
    ...
    pub fn call_setTransform(instance: *runtime.Instance, args: SetTransformArgs) anyerror!void {
        switch (args) {
            .unrestricted double_unrestricted double_unrestricted double_unrestricted double_unrestricted double_unrestricted double => |a| return try OffscreenCanvasRenderingContext2DImpl.unrestricted double_unrestricted double_unrestricted double_unrestricted double_unrestricted double_unrestricted double(instance, a.a, a.b, a.c, a.d, a.e, a.f),
            .DOMMatrix2DInit => |arg| return try OffscreenCanvasRenderingContext2DImpl.DOMMatrix2DInit(instance, arg),
        }
    }
    ...
    pub fn call_putImageData(instance: *runtime.Instance, args: PutImageDataArgs) anyerror!void {
        switch (args) {
            .ImageData_long_long => |a| return try OffscreenCanvasRenderingContext2DImpl.ImageData_long_long(instance, a.imageData, a.dx, a.dy),
            .ImageData_long_long_long_long_long_long => |a| return try OffscreenCanvasRenderingContext2DImpl.ImageData_long_long_long_long_long_long(instance, a.imageData, a.dx, a.dy, a.dirtyX, a.dirtyY, a.dirtyWidth, a.dirtyHeight),
        }
    }
