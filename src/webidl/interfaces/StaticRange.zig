...
pub const StaticRange = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        Meta.MixinTypes,
        struct {
            _internal: ?*StaticRangeImpl.InternalState = null,
        },
    );
    ...
    pub fn initWithState(
        ...
        return StaticRangeImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, init_data: StaticRangeInit) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try StaticRangeImpl.call_constructor(ctx, init_data);
    }
