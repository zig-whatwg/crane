...
pub const HTMLQuoteElement = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        struct {
            ...
            _internal: ?*HTMLQuoteElementImpl.InternalState = null,
        },
    );
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return HTMLQuoteElementImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return HTMLQuoteElementImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
