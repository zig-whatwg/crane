...
pub const TaskController = struct {
    pub const Meta = struct {
        ...
        pub const BaseType = AbortController.State;
        pub const ParentInterface = AbortController;
    ...
    pub fn initWithState(
        ...
        return TaskControllerImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, init_data: webidl.Opt(TaskControllerInit)) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try TaskControllerImpl.call_constructor(ctx, init_data);
    }
