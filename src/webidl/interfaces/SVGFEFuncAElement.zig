...
const SVGFEFuncAElementImpl = @import("impls").SVGFEFuncAElement;
...
pub const SVGFEFuncAElement = struct {
    pub const Meta = struct {
        pub const name = "SVGFEFuncAElement";
    ...
    pub const State = runtime.FlattenedState(
        ...
        Meta.MixinTypes,
        struct {
            _internal: ?*SVGFEFuncAElementImpl.InternalState = null,
        },
    );
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return SVGFEFuncAElementImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return SVGFEFuncAElementImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
