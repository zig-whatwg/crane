...
pub const PerformanceResourceTiming = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        Meta.MixinTypes,
        struct {
            initiatorType: typedefs.DOMString = undefined,
            deliveryType: typedefs.DOMString = undefined,
            nextHopProtocol: runtime.ByteString = undefined,
            workerStart: typedefs.DOMHighResTimeStamp = undefined,
            redirectStart: typedefs.DOMHighResTimeStamp = undefined,
            redirectEnd: typedefs.DOMHighResTimeStamp = undefined,
            fetchStart: typedefs.DOMHighResTimeStamp = undefined,
            domainLookupStart: typedefs.DOMHighResTimeStamp = undefined,
            domainLookupEnd: typedefs.DOMHighResTimeStamp = undefined,
            connectStart: typedefs.DOMHighResTimeStamp = undefined,
            connectEnd: typedefs.DOMHighResTimeStamp = undefined,
            secureConnectionStart: typedefs.DOMHighResTimeStamp = undefined,
            requestStart: typedefs.DOMHighResTimeStamp = undefined,
            finalResponseHeadersStart: typedefs.DOMHighResTimeStamp = undefined,
            ...
            renderBlockingStatus: enums.RenderBlockingStatusType = undefined,
            contentType: typedefs.DOMString = undefined,
            contentEncoding: typedefs.DOMString = undefined,
            serverTiming: runtime.JSValue = undefined,
    ...
    pub fn initWithState(
        ...
        return PerformanceResourceTimingImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_toJSON(instance: *runtime.Instance) anyerror!PerformanceResourceTimingToJSON {
