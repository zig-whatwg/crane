...
const SVGFEFloodElementImpl = @import("impls").SVGFEFloodElement;
...
pub const SVGFEFloodElement = struct {
    pub const Meta = struct {
        pub const name = "SVGFEFloodElement";
    ...
    pub const State = runtime.FlattenedState(
        ...
        struct {
            ...
            _internal: ?*SVGFEFloodElementImpl.InternalState = null,
        },
    );
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return SVGFEFloodElementImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return SVGFEFloodElementImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
