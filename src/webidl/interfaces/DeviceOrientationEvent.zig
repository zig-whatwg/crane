...
pub const DeviceOrientationEvent = struct {
    ...
    pub fn initWithState(
        ...
        return DeviceOrientationEventImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, @"type": DOMString, eventInitDict: webidl.Opt(DeviceOrientationEventInit)) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try DeviceOrientationEventImpl.call_constructor(ctx, @"type", eventInitDict);
    }
