...
const SVGFEFuncRElementImpl = @import("impls").SVGFEFuncRElement;
const mixins = @import("mixins");
const typedefs = @import("typedefs");
const enums = @import("enums");
const dictionaries = @import("dictionaries");
const SVGComponentTransferFunctionElement = @import("interfaces").SVGComponentTransferFunctionElement;
...
pub const SVGFEFuncRElement = struct {
    pub const Meta = struct {
        pub const name = "SVGFEFuncRElement";
    ...
    pub const State = runtime.FlattenedState(
        ...
        Meta.MixinTypes,
        struct {
            _internal: ?*SVGFEFuncRElementImpl.InternalState = null,
        },
    );
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return SVGFEFuncRElementImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return SVGFEFuncRElementImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
