...
pub const HashChangeEvent = struct {
    ...
    pub fn initWithState(
        ...
        return HashChangeEventImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, @"type": DOMString, eventInitDict: webidl.Opt(HashChangeEventInit)) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try HashChangeEventImpl.call_constructor(ctx, @"type", eventInitDict);
    }
