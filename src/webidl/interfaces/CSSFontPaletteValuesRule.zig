...
pub const CSSFontPaletteValuesRule = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        return CSSFontPaletteValuesRuleImpl.init(allocator, State, &vtable);
    }
    ...
    pub fn get_cssText(instance: *runtime.Instance) anyerror!anyopaque {
        return try CSSFontPaletteValuesRuleImpl.get_cssText(instance);
    }

    pub fn set_cssText(instance: *runtime.Instance, value: anyopaque) anyerror!void {
        try CSSFontPaletteValuesRuleImpl.set_cssText(instance, value);
    }

    pub fn get_parentRule(instance: *runtime.Instance) anyerror!CSSRule {
        return try CSSFontPaletteValuesRuleImpl.get_parentRule(instance);
    }

    pub fn get_parentStyleSheet(instance: *runtime.Instance) anyerror!CSSStyleSheet {
        return try CSSFontPaletteValuesRuleImpl.get_parentStyleSheet(instance);
    }

    pub fn get_type(instance: *runtime.Instance) anyerror!u16 {
        return try CSSFontPaletteValuesRuleImpl.get_type(instance);
    }
    ...
    pub fn get_basePalette(instance: *runtime.Instance) anyerror!anyopaque {
        return try CSSFontPaletteValuesRuleImpl.get_basePalette(instance);
    }

    pub fn get_overrideColors(instance: *runtime.Instance) anyerror!anyopaque {
