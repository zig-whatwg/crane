...
const SVGFEFuncGElementImpl = @import("impls").SVGFEFuncGElement;
...
pub const SVGFEFuncGElement = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        Meta.MixinTypes,
        struct {
            _internal: ?*SVGFEFuncGElementImpl.InternalState = null,
        },
    );
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return SVGFEFuncGElementImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return SVGFEFuncGElementImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
