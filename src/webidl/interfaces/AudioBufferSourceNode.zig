...
pub const AudioBufferSourceNode = struct {
    ...
    pub fn initWithState(
        ...
        return AudioBufferSourceNodeImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, context: *runtime.Instance, options: webidl.Opt(AudioBufferSourceOptions)) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try AudioBufferSourceNodeImpl.call_constructor(ctx, context, options);
    }
