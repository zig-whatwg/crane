...
pub const SVGStopElement = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        struct {
            ...
            cached_offset: ?*runtime.Instance = null,
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return SVGStopElementImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return SVGStopElementImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn get_offset(instance: *runtime.Instance) anyerror!*runtime.Instance {
        ...
        if (state.own.cached_offset) |cached| {
            return cached;
        }
        const value = try SVGStopElementImpl.get_offset(instance);
        state.own.cached_offset = value;
        return value;
    }
