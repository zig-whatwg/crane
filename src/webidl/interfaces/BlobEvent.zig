...
pub const BlobEvent = struct {
    ...
    pub fn initWithState(
        ...
        return BlobEventImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, @"type": DOMString, eventInitDict: BlobEventInit) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try BlobEventImpl.call_constructor(ctx, @"type", eventInitDict);
    }
