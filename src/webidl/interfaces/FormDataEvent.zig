...
pub const FormDataEvent = struct {
    ...
    pub const State = runtime.FlattenedState(
        ...
        Meta.MixinTypes,
        struct {
            formData: *runtime.Instance = undefined,
            _internal: ?*FormDataEventImpl.InternalState = null,
        },
    );
    ...
    pub fn init(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
        return FormDataEventImpl.init(allocator, State, &vtable, ctx);
    }
    ...
    pub fn initWithState(
        ...
        return FormDataEventImpl.init(allocator, StateType, vtable_ptr, ctx);
    }
    ...
    pub fn call_constructor(ctx: runtime.Context, @"type": DOMString, eventInitDict: FormDataEventInit) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try FormDataEventImpl.call_constructor(ctx, @"type", eventInitDict);
    }
