...
pub const FormDataEvent = struct {
    ...
    /// WebIDL constructor
    pub fn call_constructor(allocator: std.mem.Allocator, ctx: runtime.Context, @"type": DOMString, eventInitDict: FormDataEventInit) !*runtime.Instance {
        // Directly return result from impl.call_constructor
        return try FormDataEventImpl.call_constructor(allocator, ctx, @"type", eventInitDict);
    }
