...
const WindowControlsOverlayGeometryChangeEvent = @import("interfaces").WindowControlsOverlayGeometryChangeEvent;
...
pub fn get_titlebarAreaRect(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
