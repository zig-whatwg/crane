...
pub fn call_constructor(allocator: std.mem.Allocator, ctx: runtime.Context, form: webidl.Optional(*runtime.Instance), submitter: webidl.Optional(?*runtime.Instance)) !*runtime.Instance {
    _ = form;
    _ = submitter;
