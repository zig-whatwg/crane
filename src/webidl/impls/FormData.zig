...
pub fn call_constructor(allocator: std.mem.Allocator, ctx: runtime.Context, form: interfaces.HTMLFormElement, submitter: interfaces.HTMLElement) !*runtime.Instance {
