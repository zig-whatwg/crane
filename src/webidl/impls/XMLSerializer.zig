...
//! ============================================================================
//!
//! Implementation stub for XMLSerializer interface
//!
...
const XMLSerializer = interfaces.XMLSerializer;
...
pub fn call_constructor(allocator: std.mem.Allocator, ctx: runtime.Context) !*runtime.Instance {
    ...
    const instance = try init(allocator, State, &XMLSerializer.vtable, ctx);
