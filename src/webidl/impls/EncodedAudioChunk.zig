...
pub fn call_constructor(ctx: runtime.Context, init_data: dictionaries.EncodedAudioChunkInit) !*runtime.Instance {
    // Create instance through init()
    const instance = try init(ctx.allocator, State, &EncodedAudioChunk.vtable, ctx);
