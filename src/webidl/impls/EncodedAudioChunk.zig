...
//! ============================================================================
//!
//! Implementation stub for EncodedAudioChunk interface
//!
...
const EncodedAudioChunk = interfaces.EncodedAudioChunk;
...
pub fn call_constructor(allocator: std.mem.Allocator, ctx: runtime.Context, init_data: dictionaries.EncodedAudioChunkInit) !*runtime.Instance {
    // Create instance through init()
    const instance = try init(allocator, State, &EncodedAudioChunk.vtable, ctx);
