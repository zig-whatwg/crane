//! Implementation for HTMLPreElement interface
//!
...
const HTMLPreElement = @import("interfaces").HTMLPreElement;

pub const State = HTMLPreElement.State;
...
/// Setter for width
pub fn set_width(instance: *runtime.Instance, value: i32) ImplError!void {
    _ = instance;
    _ = value;
    // TODO: Implement setter
    return error.NotImplemented;
