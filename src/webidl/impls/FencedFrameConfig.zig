...
//! ============================================================================
//!
//! Implementation stub for FencedFrameConfig interface
//!
...
const FencedFrameConfig = interfaces.FencedFrameConfig;
...
pub fn call_constructor(allocator: std.mem.Allocator, ctx: runtime.Context, url: runtime.USVString) !*runtime.Instance {
    ...
    const instance = try init(allocator, State, &FencedFrameConfig.vtable, ctx);
