...
const XRPermissionStatus = @import("interfaces").XRPermissionStatus;
...
/// Getter for granted
pub fn get_granted(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
...
/// Setter for granted
pub fn set_granted(instance: *runtime.Instance, value: anyopaque) ImplError!void {
    _ = instance;
    _ = value;
    // TODO: Implement setter
    return error.NotImplemented;
