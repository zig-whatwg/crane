//! Implementation for MIDIOutput interface
//!
...
const MIDIOutput = @import("interfaces").MIDIOutput;
...
/// Operation: send
pub fn call_send(instance: *runtime.Instance, data: anyopaque, timestamp: anyopaque) ImplError!void {
    _ = instance;
    _ = data;
    _ = timestamp;
    // TODO: Implement operation
