...
//! ============================================================================
//!
//! Implementation stub for SVGFETurbulenceElement interface
//!
...
const SVGFETurbulenceElement = interfaces.SVGFETurbulenceElement;

pub const State = SVGFETurbulenceElement.State;
