...
/// Operation: getFile
pub fn call_getFile(instance: *runtime.Instance, path: anyopaque, options: anyopaque, successCallback: anyopaque, errorCallback: anyopaque) ImplError!void {
    _ = instance;
    _ = path;
    _ = options;
    _ = successCallback;
...
pub fn call_getDirectory(instance: *runtime.Instance, path: anyopaque, options: anyopaque, successCallback: anyopaque, errorCallback: anyopaque) ImplError!void {
    _ = instance;
    _ = path;
    _ = options;
    _ = successCallback;
