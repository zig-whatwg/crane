...
const HTMLAnchorElement = @import("interfaces").HTMLAnchorElement;
...
/// Getter for ping
pub fn get_ping(instance: *runtime.Instance) ImplError!runtime.DOMString {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
...
/// Setter for ping
pub fn set_ping(instance: *runtime.Instance, value: runtime.DOMString) ImplError!void {
    _ = instance;
    _ = value;
    // TODO: Implement setter
    return error.NotImplemented;
