...
pub fn call_constructor(ctx: runtime.Context, options: dictionaries.ProfilerInitOptions) !*runtime.Instance {
    // Create instance through init()
    const instance = try init(ctx.allocator, State, &Profiler.vtable, ctx);
