...
//! ============================================================================
//!
//! Implementation stub for IdentityProvider interface
//!
...
/// Operation: resolve
pub fn call_resolve(instance: *runtime.Instance, token: *const anyopaque, options: webidl.Opt(dictionaries.IdentityResolveOptions)) ImplError!*const anyopaque {
    _ = instance;
    _ = token;
    _ = options;
