...
pub fn call_constructor(ctx: runtime.Context, message: webidl.Opt(runtime.DOMString), options: dictionaries.GPUPipelineErrorInit) !*runtime.Instance {
    // Create instance through init()
    const instance = try init(ctx.allocator, State, &GPUPipelineError.vtable, ctx);
