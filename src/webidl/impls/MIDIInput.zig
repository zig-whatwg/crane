//! Implementation for MIDIInput interface
//!
...
const MIDIInput = @import("interfaces").MIDIInput;

pub const State = MIDIInput.State;
...
pub fn get_onmidimessage(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
...
pub fn set_onmidimessage(instance: *runtime.Instance, value: anyopaque) ImplError!void {
    _ = instance;
    _ = value;
    // TODO: Implement setter
    return error.NotImplemented;
