...
//! ============================================================================
//!
//! Implementation stub for SFrameDecrypterStream interface
//!
...
const SFrameDecrypterStream = interfaces.SFrameDecrypterStream;

pub const State = SFrameDecrypterStream.State;
...
pub fn call_constructor(allocator: std.mem.Allocator, ctx: runtime.Context, options: dictionaries.SFrameTransformOptions) !*runtime.Instance {
    ...
    const instance = try init(allocator, State, &SFrameDecrypterStream.vtable, ctx);
