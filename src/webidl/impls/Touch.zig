...
pub fn call_constructor(ctx: runtime.Context, touchInitDict: dictionaries.TouchInit) !*runtime.Instance {
    // Create instance through init()
    const instance = try init(ctx.allocator, State, &Touch.vtable, ctx);
