...
const CSSFontPaletteValuesRule = @import("interfaces").CSSFontPaletteValuesRule;
...
pub fn get_basePalette(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
...
pub fn get_overrideColors(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
