...
const TextEvent = @import("interfaces").TextEvent;
...
pub fn call_initTextEvent(instance: *runtime.Instance, type: runtime.DOMString, bubbles: bool, cancelable: bool, view: anyopaque, data: runtime.DOMString) ImplError!void {
    _ = instance;
    _ = type;
    _ = bubbles;
    _ = cancelable;
