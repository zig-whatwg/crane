...
const HashChangeEvent = @import("interfaces").HashChangeEvent;
...
/// Getter for oldURL
pub fn get_oldURL(instance: *runtime.Instance) ImplError!runtime.DOMString {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
...
/// Getter for newURL
pub fn get_newURL(instance: *runtime.Instance) ImplError!runtime.DOMString {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
