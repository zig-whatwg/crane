...
//! ============================================================================
//!
//! Implementation stub for CSSKeywordValue interface
//!
...
const CSSKeywordValue = interfaces.CSSKeywordValue;
...
pub fn call_constructor(allocator: std.mem.Allocator, ctx: runtime.Context, value: runtime.USVString) !*runtime.Instance {
    ...
    const instance = try init(allocator, State, &CSSKeywordValue.vtable, ctx);
