...
const MediaKeyMessageEvent = @import("interfaces").MediaKeyMessageEvent;
...
pub fn get_messageType(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
...
/// Getter for message
pub fn get_message(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
