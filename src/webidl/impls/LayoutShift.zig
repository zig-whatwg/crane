...
const LayoutShift = @import("interfaces").LayoutShift;
...
pub fn get_lastInputTime(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
...
/// Getter for sources
pub fn get_sources(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
