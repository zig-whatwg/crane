...
const TimeEvent = @import("interfaces").TimeEvent;
...
pub fn call_initTimeEvent(instance: *runtime.Instance, typeArg: runtime.DOMString, viewArg: anyopaque, detailArg: i32) ImplError!void {
    _ = instance;
    _ = typeArg;
    _ = viewArg;
    _ = detailArg;
