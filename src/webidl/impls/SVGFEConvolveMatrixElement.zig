...
//! ============================================================================
//!
//! Implementation stub for SVGFEConvolveMatrixElement interface
//!
...
const SVGFEConvolveMatrixElement = interfaces.SVGFEConvolveMatrixElement;

pub const State = SVGFEConvolveMatrixElement.State;
