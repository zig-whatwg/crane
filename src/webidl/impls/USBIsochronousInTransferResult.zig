...
//! ============================================================================
//!
//! Implementation stub for USBIsochronousInTransferResult interface
//!
...
pub fn call_constructor(allocator: std.mem.Allocator, ctx: runtime.Context, packets: *const anyopaque, data: ?*const anyopaque) !*runtime.Instance {
