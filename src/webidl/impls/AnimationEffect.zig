...
/// Operation: replace
pub fn call_replace(instance: *runtime.Instance, effects: []const *runtime.Instance) ImplError!void {
    _ = instance;
    _ = effects;
    return error.NotImplemented;
}
...
/// Operation: before
pub fn call_before(instance: *runtime.Instance, effects: []const *runtime.Instance) ImplError!void {
    _ = instance;
    _ = effects;
    return error.NotImplemented;
}
...
/// Operation: after
pub fn call_after(instance: *runtime.Instance, effects: []const *runtime.Instance) ImplError!void {
    _ = instance;
    _ = effects;
    return error.NotImplemented;
}
