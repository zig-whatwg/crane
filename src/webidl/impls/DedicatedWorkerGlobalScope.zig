...
const DedicatedWorkerGlobalScope = @import("interfaces").DedicatedWorkerGlobalScope;
...
pub fn get_onrtctransform(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
...
pub fn set_onrtctransform(instance: *runtime.Instance, value: anyopaque) ImplError!void {
    _ = instance;
    _ = value;
    // TODO: Implement setter
    return error.NotImplemented;
