//! Implementation for CSSCustomMediaRule interface
//!
...
const CSSCustomMediaRule = @import("interfaces").CSSCustomMediaRule;

pub const State = CSSCustomMediaRule.State;
...
/// Getter for query
pub fn get_query(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
