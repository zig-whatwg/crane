...
const BackgroundFetchUpdateUIEvent = @import("interfaces").BackgroundFetchUpdateUIEvent;
...
/// Operation: updateUI
pub fn call_updateUI(instance: *runtime.Instance, options: anyopaque) ImplError!anyopaque {
    _ = instance;
    _ = options;
    // TODO: Implement operation
    return error.NotImplemented;
