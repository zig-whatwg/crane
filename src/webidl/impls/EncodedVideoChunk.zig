...
pub fn call_constructor(ctx: runtime.Context, init_data: dictionaries.EncodedVideoChunkInit) !*runtime.Instance {
    // Create instance through init()
    const instance = try init(ctx.allocator, State, &EncodedVideoChunk.vtable, ctx);
