...
//! ============================================================================
//!
//! Implementation stub for SVGFEPointLightElement interface
//!
...
const SVGFEPointLightElement = interfaces.SVGFEPointLightElement;

pub const State = SVGFEPointLightElement.State;
