...
pub fn call_constructor(ctx: runtime.Context, l: typedefs.CSSColorPercent, a: typedefs.CSSColorNumber, b: typedefs.CSSColorNumber, alpha: webidl.Opt(typedefs.CSSColorPercent)) !*runtime.Instance {
    // Create instance through init()
    const instance = try init(ctx.allocator, State, &CSSLab.vtable, ctx);
