//! Implementation for CSSLab interface
//!
...
const CSSLab = @import("interfaces").CSSLab;
...
pub fn constructor(instance: *runtime.Instance, l: anyopaque, a: anyopaque, b: anyopaque, alpha: anyopaque) !void {
    _ = instance;
    _ = l;
    _ = a;
    _ = b;
...
/// Getter for a
pub fn get_a(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
...
/// Setter for a
pub fn set_a(instance: *runtime.Instance, value: anyopaque) ImplError!void {
    _ = instance;
    _ = value;
    // TODO: Implement setter
    return error.NotImplemented;
