...
const CSSScopeRule = @import("interfaces").CSSScopeRule;
...
/// Getter for start
pub fn get_start(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
...
/// Getter for end
pub fn get_end(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
