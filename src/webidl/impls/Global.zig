...
pub fn call_constructor(ctx: runtime.Context, descriptor: dictionaries.GlobalDescriptor, v: webidl.Opt(runtime.JSValue)) !*runtime.Instance {
    // Create instance through init()
    const instance = try init(ctx.allocator, State, &Global.vtable, ctx);
