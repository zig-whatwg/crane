...
pub fn call_constructor(ctx: runtime.Context, @"type": runtime.DOMString, readingEventInitDict: dictionaries.NDEFReadingEventInit) !*runtime.Instance {
    // Create instance through init()
    const instance = try init(ctx.allocator, State, &NDEFReadingEvent.vtable, ctx);
