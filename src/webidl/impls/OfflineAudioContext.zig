...
const OfflineAudioContext = @import("interfaces").OfflineAudioContext;
...
pub fn call_startRendering(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement operation
    return error.NotImplemented;
}
...
/// Operation: suspend
pub fn call_suspend(instance: *runtime.Instance, suspendTime: f64) ImplError!anyopaque {
    _ = instance;
    _ = suspendTime;
    // TODO: Implement operation
    return error.NotImplemented;
