...
const InputEvent = @import("interfaces").InputEvent;
...
pub fn get_dataTransfer(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
...
pub fn call_getTargetRanges(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement operation
    return error.NotImplemented;
}
