//! Implementation for FileSystemFileEntry interface
//!
...
const FileSystemFileEntry = @import("interfaces").FileSystemFileEntry;
...
/// Operation: file
pub fn call_file(instance: *runtime.Instance, successCallback: anyopaque, errorCallback: anyopaque) ImplError!void {
    _ = instance;
    _ = successCallback;
    _ = errorCallback;
    // TODO: Implement operation
