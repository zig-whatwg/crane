...
pub fn get_manufacturerData(instance: *runtime.Instance) ImplError!interfaces.BluetoothManufacturerDataFilter {
    _ = instance;
    return error.NotImplemented;
}

/// Getter for serviceData
pub fn get_serviceData(instance: *runtime.Instance) ImplError!interfaces.BluetoothServiceDataFilter {
    _ = instance;
    return error.NotImplemented;
}
