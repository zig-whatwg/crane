...
//! ============================================================================
//!
//! Implementation stub for DeprecationReportBody interface
//!
...
const DeprecationReportBody = interfaces.DeprecationReportBody;
...
pub fn get_anticipatedRemoval(instance: *runtime.Instance) ImplError!?*const anyopaque {
    _ = instance;
    return null;
}
