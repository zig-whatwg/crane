//! Implementation for XRHand interface
...
const XRHand = interfaces.XRHand;

pub const State = XRHand.State;
...
/// Operation: get
pub fn call_get(instance: *runtime.Instance, key: enums.XRHandJoint) anyerror!*runtime.Instance {
    _ = instance;
    _ = key;
    return error.NotImplemented;
}
...
pub fn getEntriesInternal(instance: *runtime.Instance) ?[]const IterableEntry {
    _ = instance;
    return null; // TODO: Implement when XRHand is fully implemented
}
