...
pub fn call_constructor(ctx: runtime.Context, args: interfaces.CSSRotate.ConstructorArgs) !*runtime.Instance {
    // Create instance through init()
    const instance = try init(ctx.allocator, State, &CSSRotate.vtable, ctx);
