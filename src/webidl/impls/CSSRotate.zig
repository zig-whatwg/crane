...
const CSSRotate = @import("interfaces").CSSRotate;
...
pub fn constructor(instance: *runtime.Instance, angle: anyopaque) !void {
    _ = instance;
    _ = angle;
...
/// Getter for angle
pub fn get_angle(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
...
/// Setter for angle
pub fn set_angle(instance: *runtime.Instance, value: anyopaque) ImplError!void {
    _ = instance;
    _ = value;
    // TODO: Implement setter
    return error.NotImplemented;
