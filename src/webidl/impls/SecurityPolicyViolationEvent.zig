...
const SecurityPolicyViolationEvent = @import("interfaces").SecurityPolicyViolationEvent;
...
pub fn get_blockedURI(instance: *runtime.Instance) ImplError!runtime.DOMString {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
...
pub fn get_disposition(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
