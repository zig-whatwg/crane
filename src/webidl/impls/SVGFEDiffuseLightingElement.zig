...
//! ============================================================================
//!
//! Implementation stub for SVGFEDiffuseLightingElement interface
//!
...
const SVGFEDiffuseLightingElement = interfaces.SVGFEDiffuseLightingElement;

pub const State = SVGFEDiffuseLightingElement.State;
