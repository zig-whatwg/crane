//! Implementation for CSSTransition interface
//!
...
const CSSTransition = @import("interfaces").CSSTransition;

pub const State = CSSTransition.State;
...
pub fn get_transitionProperty(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
