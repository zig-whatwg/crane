...
//! ============================================================================
//!
//! Implementation stub for SVGFEGaussianBlurElement interface
//!
...
const SVGFEGaussianBlurElement = interfaces.SVGFEGaussianBlurElement;

pub const State = SVGFEGaussianBlurElement.State;
