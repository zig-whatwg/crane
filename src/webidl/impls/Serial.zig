...
//! ============================================================================
//!
//! Implementation stub for Serial interface
//!
...
pub fn call_requestPort(instance: *runtime.Instance, options: webidl.Opt(dictionaries.SerialPortRequestOptions)) ImplError!*const anyopaque {
    _ = instance;
    _ = options;
    return error.NotImplemented;
}
