...
pub fn call_initStorageEvent(instance: *runtime.Instance, @"type": runtime.DOMString, bubbles: bool, cancelable: bool, key: runtime.DOMString, oldValue: runtime.DOMString, newValue: runtime.DOMString, url: runtime.DOMString, storageArea: anyopaque) ImplError!void {
    _ = instance;
    _ = @"type";
    _ = bubbles;
    _ = cancelable;
