...
const StorageEvent = @import("interfaces").StorageEvent;
...
/// Getter for newValue
pub fn get_newValue(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
...
pub fn get_storageArea(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
...
pub fn call_initStorageEvent(instance: *runtime.Instance, type: runtime.DOMString, bubbles: bool, cancelable: bool, key: anyopaque, oldValue: anyopaque, newValue: anyopaque, url: runtime.DOMString, storageArea: anyopaque) ImplError!void {
    _ = instance;
    _ = type;
    _ = bubbles;
    _ = cancelable;
