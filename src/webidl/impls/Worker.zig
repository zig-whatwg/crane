...
//! ============================================================================
//!
//! Implementation stub for Worker interface
//!
...
pub fn call_constructor(allocator: std.mem.Allocator, ctx: runtime.Context, scriptURL: runtime.DOMString, options: dictionaries.WorkerOptions) !*runtime.Instance {
