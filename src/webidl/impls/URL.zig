...
pub fn get_searchParams(instance: *runtime.Instance) ImplError!interfaces.URLSearchParams {
    _ = instance;
    return error.NotImplemented;
}
...
/// Operation: parse
pub fn call_parse(instance: *runtime.Instance, url: runtime.USVString, base: runtime.USVString) ImplError!interfaces.URL {
    _ = instance;
    _ = url;
    _ = base;
    return error.NotImplemented;
