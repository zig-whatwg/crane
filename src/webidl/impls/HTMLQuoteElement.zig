//! Implementation for HTMLQuoteElement interface
//!
...
const HTMLQuoteElement = @import("interfaces").HTMLQuoteElement;

pub const State = HTMLQuoteElement.State;
...
/// Getter for cite
pub fn get_cite(instance: *runtime.Instance) ImplError!runtime.DOMString {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
...
/// Setter for cite
pub fn set_cite(instance: *runtime.Instance, value: runtime.DOMString) ImplError!void {
    _ = instance;
    _ = value;
    // TODO: Implement setter
    return error.NotImplemented;
