//! Implementation for HTMLSelectedContentElement interface
//!
...
const HTMLSelectedContentElement = @import("interfaces").HTMLSelectedContentElement;

pub const State = HTMLSelectedContentElement.State;
