...
/// Getter for device
pub fn get_device(instance: *runtime.Instance) ImplError!interfaces.BluetoothDevice {
    _ = instance;
...
pub fn get_manufacturerData(instance: *runtime.Instance) ImplError!interfaces.BluetoothManufacturerDataMap {
    _ = instance;
    return error.NotImplemented;
}

/// Getter for serviceData
pub fn get_serviceData(instance: *runtime.Instance) ImplError!interfaces.BluetoothServiceDataMap {
    _ = instance;
    return error.NotImplemented;
}
