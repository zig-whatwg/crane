...
const XRHitTestResult = interfaces.XRHitTestResult;
...
/// Operation: getPose
pub fn call_getPose(instance: *runtime.Instance, baseSpace: interfaces.XRSpace) ImplError!interfaces.XRPose {
    _ = instance;
    _ = baseSpace;
    return error.NotImplemented;
}
