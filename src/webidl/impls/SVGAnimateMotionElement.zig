//! Implementation for SVGAnimateMotionElement interface
//!
...
const SVGAnimateMotionElement = @import("interfaces").SVGAnimateMotionElement;

pub const State = SVGAnimateMotionElement.State;
