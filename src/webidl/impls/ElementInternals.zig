...
/// Getter for states
pub fn get_states(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
...
pub fn call_setFormValue(instance: *runtime.Instance, value: anyopaque, state: anyopaque) ImplError!void {
    _ = instance;
    _ = value;
    _ = state;
...
pub fn call_setValidity(instance: *runtime.Instance, flags: anyopaque, message: runtime.DOMString, anchor: anyopaque) ImplError!void {
    _ = instance;
    _ = flags;
    _ = message;
    _ = anchor;
