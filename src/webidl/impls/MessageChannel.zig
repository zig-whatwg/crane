...
/// Getter for port1
pub fn get_port1(instance: *runtime.Instance) ImplError!interfaces.MessagePort {
    _ = instance;
    return error.NotImplemented;
}

/// Getter for port2
pub fn get_port2(instance: *runtime.Instance) ImplError!interfaces.MessagePort {
    _ = instance;
    return error.NotImplemented;
}
