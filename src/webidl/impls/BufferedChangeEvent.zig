//! Implementation for BufferedChangeEvent interface
...
pub fn call_constructor(ctx: runtime.Context, @"type": runtime.DOMString, eventInitDict: webidl.Opt(dictionaries.BufferedChangeEventInit)) !*runtime.Instance {
    // Create instance through init()
    const instance = try init(ctx.allocator, State, &BufferedChangeEvent.vtable, ctx);
