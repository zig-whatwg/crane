...
pub fn constructor(instance: *runtime.Instance, path: anyopaque) !void {
    _ = instance;
    _ = path;
...
/// Operation: addPath
pub fn call_addPath(instance: *runtime.Instance, path: anyopaque, transform: anyopaque) ImplError!void {
    _ = instance;
    _ = path;
    _ = transform;
