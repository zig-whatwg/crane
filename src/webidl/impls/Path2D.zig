...
//! ============================================================================
//!
//! Implementation stub for Path2D interface
//!
...
/// Operation: addPath
pub fn call_addPath(instance: *runtime.Instance, path: *runtime.Instance, transform: webidl.Opt(dictionaries.DOMMatrix2DInit)) ImplError!void {
    _ = instance;
    _ = path;
    _ = transform;
    return error.NotImplemented;
