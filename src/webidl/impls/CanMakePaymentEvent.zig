//! Implementation for CanMakePaymentEvent interface
//!
...
const CanMakePaymentEvent = @import("interfaces").CanMakePaymentEvent;

pub const State = CanMakePaymentEvent.State;
...
pub fn call_respondWith(instance: *runtime.Instance, canMakePaymentResponse: anyopaque) ImplError!void {
    _ = instance;
