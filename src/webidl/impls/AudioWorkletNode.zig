...
pub fn call_constructor(allocator: std.mem.Allocator, ctx: runtime.Context, context: interfaces.BaseAudioContext, name: runtime.DOMString, options: dictionaries.AudioWorkletNodeOptions) !*runtime.Instance {
...
pub fn get_parameters(instance: *runtime.Instance) ImplError!interfaces.AudioParamMap {
    _ = instance;
    return error.NotImplemented;
}

/// Getter for port
pub fn get_port(instance: *runtime.Instance) ImplError!interfaces.MessagePort {
    _ = instance;
    return error.NotImplemented;
}
