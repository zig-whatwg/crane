...
pub fn call_addListener(instance: *runtime.Instance, callback: anyopaque) ImplError!void {
    _ = instance;
    _ = callback;
    // TODO: Implement operation
    return error.NotImplemented;
...
pub fn call_removeListener(instance: *runtime.Instance, callback: anyopaque) ImplError!void {
    _ = instance;
    _ = callback;
    // TODO: Implement operation
    return error.NotImplemented;
