...
const XRInputSourceEvent = @import("interfaces").XRInputSourceEvent;
...
/// Getter for frame
pub fn get_frame(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
...
pub fn get_inputSource(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
