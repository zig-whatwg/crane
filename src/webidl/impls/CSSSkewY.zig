...
const CSSSkewY = interfaces.CSSSkewY;
...
pub fn call_constructor(allocator: std.mem.Allocator, ctx: runtime.Context, ay: interfaces.CSSNumericValue) !*runtime.Instance {
    // Create instance through init()
    const instance = try init(allocator, State, &CSSSkewY.vtable, ctx);
