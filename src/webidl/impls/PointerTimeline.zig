...
pub fn call_constructor(ctx: runtime.Context, options: webidl.Opt(dictionaries.PointerTimelineOptions)) !*runtime.Instance {
    // Create instance through init()
    const instance = try init(ctx.allocator, State, &PointerTimeline.vtable, ctx);
