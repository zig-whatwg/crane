...
//! ============================================================================
//!
//! Implementation stub for CSSParserFunction interface
//!
...
const CSSParserFunction = interfaces.CSSParserFunction;
...
/// Getter for args
pub fn get_args(instance: *runtime.Instance) ImplError!*const anyopaque {
    _ = instance;
    return error.NotImplemented;
}
