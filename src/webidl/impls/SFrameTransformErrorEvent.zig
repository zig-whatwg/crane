...
const SFrameTransformErrorEvent = @import("interfaces").SFrameTransformErrorEvent;
...
pub fn get_errorType(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
...
/// Getter for keyID
pub fn get_keyID(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
