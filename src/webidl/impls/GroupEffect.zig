...
//! ============================================================================
//!
//! Implementation stub for GroupEffect interface
//!
...
/// Operation: append
pub fn call_append(instance: *runtime.Instance, effects: []const *runtime.Instance) ImplError!void {
    _ = instance;
    _ = effects;
    return error.NotImplemented;
}
...
/// Operation: prepend
pub fn call_prepend(instance: *runtime.Instance, effects: []const *runtime.Instance) ImplError!void {
    _ = instance;
    _ = effects;
    return error.NotImplemented;
}
