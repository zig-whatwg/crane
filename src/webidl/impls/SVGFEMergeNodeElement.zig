...
//! ============================================================================
//!
//! Implementation stub for SVGFEMergeNodeElement interface
//!
...
const SVGFEMergeNodeElement = interfaces.SVGFEMergeNodeElement;

pub const State = SVGFEMergeNodeElement.State;
