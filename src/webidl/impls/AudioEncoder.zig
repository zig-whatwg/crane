...
//! ============================================================================
//!
//! Implementation stub for AudioEncoder interface
//!
...
pub fn call_constructor(allocator: std.mem.Allocator, ctx: runtime.Context, init_data: dictionaries.AudioEncoderInit) !*runtime.Instance {
    // Create instance through init()
    const instance = try init(allocator, State, &AudioEncoder.vtable, ctx);
...
pub fn call_isConfigSupported(instance: *runtime.Instance, config: dictionaries.AudioEncoderConfig) ImplError!*const anyopaque {
    _ = instance;
    _ = config;
    return error.NotImplemented;
}
...
/// Operation: configure
pub fn call_configure(instance: *runtime.Instance, config: dictionaries.AudioEncoderConfig) ImplError!void {
    _ = instance;
    _ = config;
    return error.NotImplemented;
}
