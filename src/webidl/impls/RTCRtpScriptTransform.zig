...
pub fn call_constructor(allocator: std.mem.Allocator, ctx: runtime.Context, worker: interfaces.Worker, options: *const anyopaque, transfer: *const anyopaque) !*runtime.Instance {
