...
pub fn call_constructor(ctx: runtime.Context, options: webidl.Opt(dictionaries.TextFormatInit)) !*runtime.Instance {
    // Create instance through init()
    const instance = try init(ctx.allocator, State, &TextFormat.vtable, ctx);
