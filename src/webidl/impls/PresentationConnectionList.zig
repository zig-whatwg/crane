...
//! ============================================================================
//!
//! Implementation stub for PresentationConnectionList interface
//!
...
const PresentationConnectionList = interfaces.PresentationConnectionList;

pub const State = PresentationConnectionList.State;
...
pub fn get_connections(instance: *runtime.Instance) ImplError!*const anyopaque {
    _ = instance;
