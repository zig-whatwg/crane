...
//! ============================================================================
//!
//! Implementation stub for PerformanceLongTaskTiming interface
//!
...
const PerformanceLongTaskTiming = interfaces.PerformanceLongTaskTiming;

pub const State = PerformanceLongTaskTiming.State;
...
pub fn get_attribution(instance: *runtime.Instance) ImplError!*const anyopaque {
    _ = instance;
    return error.NotImplemented;
}
