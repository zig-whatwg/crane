...
/// Operation: map
pub fn call_map(instance: *runtime.Instance, mapper: callbacks.Mapper) ImplError!interfaces.Observable {
    _ = instance;
    _ = mapper;
...
/// Operation: inspect
pub fn call_inspect(instance: *runtime.Instance, inspectorUnion: typedefs.ObservableInspectorUnion) ImplError!interfaces.Observable {
    _ = instance;
    _ = inspectorUnion;
    return error.NotImplemented;
}
...
/// Operation: takeUntil
pub fn call_takeUntil(instance: *runtime.Instance, value: *const anyopaque) ImplError!interfaces.Observable {
    _ = instance;
    _ = value;
    return error.NotImplemented;
}
...
/// Operation: filter
pub fn call_filter(instance: *runtime.Instance, predicate: callbacks.Predicate) ImplError!interfaces.Observable {
    _ = instance;
    _ = predicate;
    return error.NotImplemented;
}
...
/// Operation: switchMap
pub fn call_switchMap(instance: *runtime.Instance, mapper: callbacks.Mapper) ImplError!interfaces.Observable {
    _ = instance;
    _ = mapper;
    return error.NotImplemented;
}
...
/// Operation: finally
pub fn call_finally(instance: *runtime.Instance, callback: callbacks.VoidFunction) ImplError!interfaces.Observable {
    _ = instance;
    _ = callback;
    return error.NotImplemented;
}
...
/// Operation: take
pub fn call_take(instance: *runtime.Instance, amount: u64) ImplError!interfaces.Observable {
    _ = instance;
    _ = amount;
    return error.NotImplemented;
}
...
/// Operation: drop
pub fn call_drop(instance: *runtime.Instance, amount: u64) ImplError!interfaces.Observable {
    _ = instance;
    _ = amount;
    return error.NotImplemented;
}
...
/// Operation: flatMap
pub fn call_flatMap(instance: *runtime.Instance, mapper: callbacks.Mapper) ImplError!interfaces.Observable {
    _ = instance;
    _ = mapper;
    return error.NotImplemented;
}
...
/// Operation: from
pub fn call_from(instance: *runtime.Instance, value: *const anyopaque) ImplError!interfaces.Observable {
    _ = instance;
    _ = value;
    return error.NotImplemented;
}
...
/// Operation: catch
pub fn call_catch(instance: *runtime.Instance, callback: callbacks.CatchCallback) ImplError!interfaces.Observable {
    _ = instance;
    _ = callback;
    return error.NotImplemented;
}
