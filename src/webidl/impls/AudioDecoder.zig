...
const AudioDecoder = interfaces.AudioDecoder;
...
pub fn call_constructor(allocator: std.mem.Allocator, ctx: runtime.Context, init_data: dictionaries.AudioDecoderInit) !*runtime.Instance {
    // Create instance through init()
    const instance = try init(allocator, State, &AudioDecoder.vtable, ctx);
...
pub fn call_isConfigSupported(instance: *runtime.Instance, config: dictionaries.AudioDecoderConfig) ImplError!*const anyopaque {
    _ = instance;
    _ = config;
    return error.NotImplemented;
}
...
/// Operation: decode
pub fn call_decode(instance: *runtime.Instance, chunk: interfaces.EncodedAudioChunk) ImplError!void {
    _ = instance;
    _ = chunk;
    return error.NotImplemented;
}
...
/// Operation: configure
pub fn call_configure(instance: *runtime.Instance, config: dictionaries.AudioDecoderConfig) ImplError!void {
    _ = instance;
    _ = config;
    return error.NotImplemented;
}
