...
pub fn call_constructor(ctx: runtime.Context, init_data: dictionaries.AudioDecoderInit) !*runtime.Instance {
    // Create instance through init()
    const instance = try init(ctx.allocator, State, &AudioDecoder.vtable, ctx);
...
pub fn call_static_isConfigSupported(instance: *runtime.Instance, config: dictionaries.AudioDecoderConfig) anyerror!runtime.JSValue {
    _ = instance;
    _ = config;
    return error.NotImplemented;
}
...
/// Operation: configure
pub fn call_configure(instance: *runtime.Instance, config: dictionaries.AudioDecoderConfig) anyerror!void {
    _ = instance;
    _ = config;
    return error.NotImplemented;
}
