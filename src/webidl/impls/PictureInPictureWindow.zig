...
//! ============================================================================
//!
//! Implementation stub for PictureInPictureWindow interface
//!
...
const PictureInPictureWindow = interfaces.PictureInPictureWindow;

pub const State = PictureInPictureWindow.State;
