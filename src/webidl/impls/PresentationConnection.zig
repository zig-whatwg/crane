...
/// Getter for state
pub fn get_state(instance: *runtime.Instance) anyerror!enums.PresentationConnectionState {
    _ = instance;
    return error.NotImplemented;
}
...
pub fn get_onterminate(instance: *runtime.Instance) anyerror!typedefs.EventHandler {
    _ = instance;
    return error.NotImplemented;
}
...
pub fn set_onterminate(instance: *runtime.Instance, value: typedefs.EventHandler) anyerror!void {
    _ = instance;
    _ = value;
    return error.NotImplemented;
}
...
/// Operation: send
pub fn call_send(instance: *runtime.Instance, message: runtime.DOMString) anyerror!void {
    _ = instance;
    _ = message;
    return error.NotImplemented;
}
