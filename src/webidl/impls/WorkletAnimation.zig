...
pub fn call_constructor(allocator: std.mem.Allocator, ctx: runtime.Context, animatorName: runtime.DOMString, effects: *const anyopaque, timeline: interfaces.AnimationTimeline, options: *const anyopaque) !*runtime.Instance {
