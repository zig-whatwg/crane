//! Implementation for SVGUseElementShadowRoot interface
//!
...
const SVGUseElementShadowRoot = @import("interfaces").SVGUseElementShadowRoot;

pub const State = SVGUseElementShadowRoot.State;
...
pub fn get_slotAssignment(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
...
/// Getter for host
pub fn get_host(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
