...
//! ============================================================================
//!
//! Implementation stub for SFrameSenderTransform interface
//!
...
const SFrameSenderTransform = interfaces.SFrameSenderTransform;

pub const State = SFrameSenderTransform.State;
...
pub fn call_constructor(ctx: runtime.Context, options: webidl.Opt(dictionaries.SFrameTransformOptions)) !*runtime.Instance {
    ...
    const instance = try init(ctx.allocator, State, &SFrameSenderTransform.vtable, ctx);
