...
const OfflineAudioCompletionEvent = @import("interfaces").OfflineAudioCompletionEvent;
...
pub fn get_renderedBuffer(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
