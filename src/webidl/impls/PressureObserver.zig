...
pub fn call_constructor(ctx: runtime.Context, callback: callbacks.PressureUpdateCallback) !*runtime.Instance {
    // Create instance through init()
    const instance = try init(ctx.allocator, State, &PressureObserver.vtable, ctx);
...
/// Operation: observe
pub fn call_observe(instance: *runtime.Instance, source: enums.PressureSource, options: webidl.Opt(dictionaries.PressureObserverOptions)) anyerror!runtime.JSValue {
    _ = instance;
    _ = source;
    _ = options;
    return error.NotImplemented;
