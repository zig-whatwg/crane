//! Implementation for TextTrackList interface
//!
...
const TextTrackList = interfaces.TextTrackList;

pub const State = TextTrackList.State;
...
pub fn call_getTrackById(instance: *runtime.Instance, id: runtime.DOMString) ImplError!interfaces.TextTrack {
    _ = instance;
    _ = id;
    return error.NotImplemented;
}
