...
/// Getter for list
pub fn get_list(instance: *runtime.Instance) ImplError!interfaces.HTMLDataListElement {
    _ = instance;
    return error.NotImplemented;
}
...
pub fn get_webkitEntries(instance: *runtime.Instance) ImplError!*const anyopaque {
    _ = instance;
    return error.NotImplemented;
}
...
/// Setter for files
pub fn set_files(instance: *runtime.Instance, value: interfaces.FileList) ImplError!void {
    _ = instance;
    _ = value;
    return error.NotImplemented;
}
...
pub fn set_valueAsDate(instance: *runtime.Instance, value: *const anyopaque) ImplError!void {
    _ = instance;
    _ = value;
    return error.NotImplemented;
}
