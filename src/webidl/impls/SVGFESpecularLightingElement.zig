...
//! ============================================================================
//!
//! Implementation stub for SVGFESpecularLightingElement interface
//!
...
const SVGFESpecularLightingElement = interfaces.SVGFESpecularLightingElement;

pub const State = SVGFESpecularLightingElement.State;
