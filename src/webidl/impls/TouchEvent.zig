...
/// Getter for touches
pub fn get_touches(instance: *runtime.Instance) ImplError!interfaces.TouchList {
    _ = instance;
    return error.NotImplemented;
}

/// Getter for targetTouches
pub fn get_targetTouches(instance: *runtime.Instance) ImplError!interfaces.TouchList {
    _ = instance;
    return error.NotImplemented;
}

/// Getter for changedTouches
pub fn get_changedTouches(instance: *runtime.Instance) ImplError!interfaces.TouchList {
    _ = instance;
    return error.NotImplemented;
}
