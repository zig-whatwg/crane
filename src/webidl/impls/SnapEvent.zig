...
const SnapEvent = @import("interfaces").SnapEvent;
...
pub fn get_snapTargetBlock(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
...
pub fn get_snapTargetInline(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
