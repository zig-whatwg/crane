//! Implementation for FontFaceSetLoadEvent interface
//!
...
pub fn call_constructor(allocator: std.mem.Allocator, ctx: runtime.Context, @"type": *const anyopaque, eventInitDict: dictionaries.FontFaceSetLoadEventInit) !*runtime.Instance {
