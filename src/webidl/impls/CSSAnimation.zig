//! Implementation for CSSAnimation interface
//!
...
const CSSAnimation = @import("interfaces").CSSAnimation;

pub const State = CSSAnimation.State;
...
/// Getter for animationName
pub fn get_animationName(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
