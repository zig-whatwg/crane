...
const FileReader = @import("interfaces").FileReader;
...
pub fn call_readAsArrayBuffer(instance: *runtime.Instance, blob: anyopaque) ImplError!void {
    _ = instance;
    _ = blob;
    // TODO: Implement operation
    return error.NotImplemented;
...
pub fn call_readAsBinaryString(instance: *runtime.Instance, blob: anyopaque) ImplError!void {
    _ = instance;
    _ = blob;
    // TODO: Implement operation
    return error.NotImplemented;
...
pub fn call_readAsText(instance: *runtime.Instance, blob: anyopaque, encoding: runtime.DOMString) ImplError!void {
    _ = instance;
    _ = blob;
    _ = encoding;
    // TODO: Implement operation
...
pub fn call_readAsDataURL(instance: *runtime.Instance, blob: anyopaque) ImplError!void {
    _ = instance;
    _ = blob;
    // TODO: Implement operation
    return error.NotImplemented;
