...
pub fn init(
    ...
    // HTMLLIElement has no additional initialization
    return instance;
}

/// Deinitialize instance
pub fn deinit(instance: *runtime.Instance) void {
    // HTMLLIElement has no additional cleanup
...
pub fn call_constructor(ctx: runtime.Context) !*runtime.Instance {
    ...
    const instance = try init(ctx.allocator, State, &HTMLLIElement.vtable, ctx);
