//! Implementation for PushSubscriptionOptions interface
//!
...
pub const State = PushSubscriptionOptions.State;
...
pub fn get_applicationServerKey(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
