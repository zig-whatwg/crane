...
pub fn call_constructor(ctx: runtime.Context, length: typedefs.CSSPerspectiveValue) !*runtime.Instance {
    // Create instance through init()
    const instance = try init(ctx.allocator, State, &CSSPerspective.vtable, ctx);
