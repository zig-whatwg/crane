//! Implementation for InterestGroupScoringScriptRunnerGlobalScope interface
//!
...
const InterestGroupScoringScriptRunnerGlobalScope = @import("interfaces").InterestGroupScoringScriptRunnerGlobalScope;

pub const State = InterestGroupScoringScriptRunnerGlobalScope.State;
