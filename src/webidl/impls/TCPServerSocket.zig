...
pub fn call_constructor(ctx: runtime.Context, localAddress: runtime.DOMString, options: webidl.Opt(dictionaries.TCPServerSocketOptions)) !*runtime.Instance {
    // Create instance through init()
    const instance = try init(ctx.allocator, State, &TCPServerSocket.vtable, ctx);
