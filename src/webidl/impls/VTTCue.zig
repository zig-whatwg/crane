...
pub fn call_constructor(ctx: runtime.Context, startTime: f64, endTime: f64, text: runtime.DOMString) !*runtime.Instance {
    // Create instance through init()
    const instance = try init(ctx.allocator, State, &VTTCue.vtable, ctx);
