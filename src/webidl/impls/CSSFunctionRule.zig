//! Implementation for CSSFunctionRule interface
//!
...
const CSSFunctionRule = @import("interfaces").CSSFunctionRule;

pub const State = CSSFunctionRule.State;
...
pub fn get_returnType(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
