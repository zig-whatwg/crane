...
const CSSPropertyRule = @import("interfaces").CSSPropertyRule;
...
/// Getter for syntax
pub fn get_syntax(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
...
pub fn get_initialValue(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
