...
//! ============================================================================
//!
//! Implementation stub for SVGFEColorMatrixElement interface
//!
...
const SVGFEColorMatrixElement = interfaces.SVGFEColorMatrixElement;

pub const State = SVGFEColorMatrixElement.State;
