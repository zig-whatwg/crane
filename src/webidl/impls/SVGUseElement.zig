...
const SVGUseElement = interfaces.SVGUseElement;
...
pub fn get_instanceRoot(instance: *runtime.Instance) ImplError!interfaces.SVGElement {
    _ = instance;
    return error.NotImplemented;
}

/// Getter for animatedInstanceRoot
pub fn get_animatedInstanceRoot(instance: *runtime.Instance) ImplError!interfaces.SVGElement {
    _ = instance;
    return error.NotImplemented;
}
