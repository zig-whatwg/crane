//! Implementation for SVGUseElement interface
//!
...
pub const State = SVGUseElement.State;
...
/// Getter for instanceRoot
pub fn get_instanceRoot(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}

/// Getter for animatedInstanceRoot
pub fn get_animatedInstanceRoot(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
