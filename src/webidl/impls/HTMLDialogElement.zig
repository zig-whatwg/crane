...
pub fn init(
    ...
    // HTMLDialogElement has no additional initialization
    return instance;
}

/// Deinitialize instance
pub fn deinit(instance: *runtime.Instance) void {
    // HTMLDialogElement has no additional cleanup
...
pub fn call_constructor(ctx: runtime.Context) !*runtime.Instance {
    ...
    const instance = try init(ctx.allocator, State, &HTMLDialogElement.vtable, ctx);
