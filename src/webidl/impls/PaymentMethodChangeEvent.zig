...
const PaymentMethodChangeEvent = @import("interfaces").PaymentMethodChangeEvent;
...
pub fn get_methodDetails(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
...
pub fn call_updateWith(instance: *runtime.Instance, detailsPromise: anyopaque) ImplError!void {
    _ = instance;
    _ = detailsPromise;
    // TODO: Implement operation
    return error.NotImplemented;
