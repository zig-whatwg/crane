...
//! ============================================================================
//!
//! Implementation stub for ClipboardChangeEvent interface
//!
...
const ClipboardChangeEvent = interfaces.ClipboardChangeEvent;

pub const State = ClipboardChangeEvent.State;
...
pub fn call_constructor(ctx: runtime.Context, @"type": runtime.DOMString, eventInitDict: webidl.Opt(dictionaries.ClipboardChangeEventInit)) !*runtime.Instance {
    // Create instance through init() - use ctx.allocator for consistency with deinit
    const instance = try init(ctx.allocator, State, &ClipboardChangeEvent.vtable, ctx);
