...
//! ============================================================================
//!
//! Implementation stub for SVGFECompositeElement interface
//!
...
const SVGFECompositeElement = interfaces.SVGFECompositeElement;

pub const State = SVGFECompositeElement.State;
