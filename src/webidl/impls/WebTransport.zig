...
pub fn get_reliability(instance: *runtime.Instance) anyerror!enums.WebTransportReliabilityMode {
    _ = instance;
    return error.NotImplemented;
}

/// Getter for congestionControl
pub fn get_congestionControl(instance: *runtime.Instance) anyerror!enums.WebTransportCongestionControl {
    _ = instance;
    return error.NotImplemented;
}
...
/// Operation: close
pub fn call_close(instance: *runtime.Instance, closeInfo: webidl.Opt(dictionaries.WebTransportCloseInfo)) anyerror!void {
    _ = instance;
    _ = closeInfo;
    return error.NotImplemented;
}
