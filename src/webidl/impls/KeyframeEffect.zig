...
/// Setter for target
pub fn set_target(instance: *runtime.Instance, value: interfaces.Element) ImplError!void {
    _ = instance;
    _ = value;
    return error.NotImplemented;
}
...
pub fn set_pseudoElement(instance: *runtime.Instance, value: *const anyopaque) ImplError!void {
    _ = instance;
    _ = value;
    return error.NotImplemented;
}
