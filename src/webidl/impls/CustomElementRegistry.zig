...
/// Operation: upgrade
pub fn call_upgrade(instance: *runtime.Instance, root: interfaces.Node) ImplError!void {
    _ = instance;
    _ = root;
    return error.NotImplemented;
}
...
pub fn call_initialize(instance: *runtime.Instance, root: interfaces.Node) ImplError!void {
    _ = instance;
    _ = root;
    return error.NotImplemented;
}
