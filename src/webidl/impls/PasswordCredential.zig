...
const PasswordCredential = interfaces.PasswordCredential;
...
pub fn call_constructor(allocator: std.mem.Allocator, ctx: runtime.Context, form: interfaces.HTMLFormElement) !*runtime.Instance {
    // Create instance through init()
    const instance = try init(allocator, State, &PasswordCredential.vtable, ctx);
