...
pub fn call_constructor(allocator: std.mem.Allocator, ctx: runtime.Context, stream: interfaces.MediaStream, options: dictionaries.MediaRecorderOptions) !*runtime.Instance {
