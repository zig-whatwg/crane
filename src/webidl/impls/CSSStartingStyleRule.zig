//! Implementation for CSSStartingStyleRule interface
//!
...
const CSSStartingStyleRule = @import("interfaces").CSSStartingStyleRule;

pub const State = CSSStartingStyleRule.State;
