...
//! ============================================================================
//!
//! Implementation stub for SFrameDecrypterManager interface
//!
...
const SFrameDecrypterManager = interfaces.SFrameDecrypterManager;

pub const State = SFrameDecrypterManager.State;
