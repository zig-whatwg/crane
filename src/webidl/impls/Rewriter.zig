...
pub fn call_rewriteStreaming(instance: *runtime.Instance, input: runtime.DOMString, options: dictionaries.RewriterRewriteOptions) ImplError!interfaces.ReadableStream {
    _ = instance;
    _ = input;
    _ = options;
    return error.NotImplemented;
