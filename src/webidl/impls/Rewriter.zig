...
pub fn call_availability(instance: *runtime.Instance, options: webidl.Opt(dictionaries.RewriterCreateCoreOptions)) anyerror!*const anyopaque {
    _ = instance;
    _ = options;
    return error.NotImplemented;
}
...
/// Operation: rewrite
pub fn call_rewrite(instance: *runtime.Instance, input: runtime.DOMString, options: webidl.Opt(dictionaries.RewriterRewriteOptions)) anyerror!*const anyopaque {
    _ = instance;
    _ = input;
    _ = options;
    return error.NotImplemented;
...
pub fn call_measureInputUsage(instance: *runtime.Instance, input: runtime.DOMString, options: webidl.Opt(dictionaries.RewriterRewriteOptions)) anyerror!*const anyopaque {
    _ = instance;
    _ = input;
    _ = options;
    return error.NotImplemented;
...
/// Operation: create
pub fn call_create(instance: *runtime.Instance, options: webidl.Opt(dictionaries.RewriterCreateOptions)) anyerror!*const anyopaque {
    _ = instance;
    _ = options;
    return error.NotImplemented;
}
