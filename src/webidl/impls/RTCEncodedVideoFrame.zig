...
pub fn call_constructor(ctx: runtime.Context, originalFrame: *runtime.Instance, options: webidl.Opt(dictionaries.RTCEncodedVideoFrameOptions)) !*runtime.Instance {
    // Create instance through init()
    const instance = try init(ctx.allocator, State, &RTCEncodedVideoFrame.vtable, ctx);
