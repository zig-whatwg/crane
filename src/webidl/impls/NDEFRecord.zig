...
pub fn call_constructor(ctx: runtime.Context, recordInit: dictionaries.NDEFRecordInit) !*runtime.Instance {
    // Create instance through init()
    const instance = try init(ctx.allocator, State, &NDEFRecord.vtable, ctx);
