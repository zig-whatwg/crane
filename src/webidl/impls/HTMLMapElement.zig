//! Implementation for HTMLMapElement interface
//!
...
const HTMLMapElement = @import("interfaces").HTMLMapElement;

pub const State = HTMLMapElement.State;
...
/// Getter for areas
pub fn get_areas(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
