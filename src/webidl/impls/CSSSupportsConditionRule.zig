//! Implementation for CSSSupportsConditionRule interface
//!
...
const CSSSupportsConditionRule = @import("interfaces").CSSSupportsConditionRule;

pub const State = CSSSupportsConditionRule.State;
