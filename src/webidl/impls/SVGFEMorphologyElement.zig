...
//! ============================================================================
//!
//! Implementation stub for SVGFEMorphologyElement interface
//!
...
const SVGFEMorphologyElement = interfaces.SVGFEMorphologyElement;

pub const State = SVGFEMorphologyElement.State;
