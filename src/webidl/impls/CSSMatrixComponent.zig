...
const CSSMatrixComponent = @import("interfaces").CSSMatrixComponent;
...
pub fn constructor(instance: *runtime.Instance, matrix: anyopaque, options: anyopaque) !void {
    _ = instance;
    _ = matrix;
    _ = options;
...
/// Setter for matrix
pub fn set_matrix(instance: *runtime.Instance, value: anyopaque) ImplError!void {
    _ = instance;
    _ = value;
    // TODO: Implement setter
    return error.NotImplemented;
