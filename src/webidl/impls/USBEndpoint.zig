...
//! ============================================================================
//!
//! Implementation stub for USBEndpoint interface
//!
...
pub fn call_constructor(allocator: std.mem.Allocator, ctx: runtime.Context, alternate: *runtime.Instance, endpointNumber: u8, direction: enums.USBDirection) !*runtime.Instance {
