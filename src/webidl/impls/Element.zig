...
//! ============================================================================
//!
//! Implementation stub for Element interface
//!
...
pub fn get_outerHTML(instance: *runtime.Instance) ImplError!runtime.DOMString {
    _ = instance;
    return error.NotImplemented;
}
...
pub fn set_outerHTML(instance: *runtime.Instance, value: runtime.DOMString) ImplError!void {
    _ = instance;
    _ = value;
    return error.NotImplemented;
}
...
pub fn call_setAttributeNS(instance: *runtime.Instance, namespace: ?runtime.DOMString, qualifiedName: runtime.DOMString, value: runtime.DOMString) ImplError!void {
    _ = instance;
    _ = namespace;
    _ = qualifiedName;
    _ = value;
...
pub fn call_insertAdjacentHTML(instance: *runtime.Instance, position: runtime.DOMString, string: runtime.DOMString) ImplError!void {
    _ = instance;
    _ = position;
    _ = string;
    return error.NotImplemented;
