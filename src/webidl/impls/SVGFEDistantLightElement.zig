...
//! ============================================================================
//!
//! Implementation stub for SVGFEDistantLightElement interface
//!
...
const SVGFEDistantLightElement = interfaces.SVGFEDistantLightElement;

pub const State = SVGFEDistantLightElement.State;
