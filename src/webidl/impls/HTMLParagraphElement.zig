//! Implementation for HTMLParagraphElement interface
//!
...
const HTMLParagraphElement = @import("interfaces").HTMLParagraphElement;

pub const State = HTMLParagraphElement.State;
