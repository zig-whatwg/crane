...
//! ============================================================================
//!
//! Implementation stub for CharacteristicEventHandlers interface
//!
...
const CharacteristicEventHandlers = interfaces.CharacteristicEventHandlers;

pub const State = CharacteristicEventHandlers.State;
