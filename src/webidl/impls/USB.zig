...
//! ============================================================================
//!
//! Implementation stub for USB interface
//!
...
pub fn call_requestDevice(instance: *runtime.Instance, options: dictionaries.USBDeviceRequestOptions) ImplError!*const anyopaque {
    _ = instance;
    _ = options;
    return error.NotImplemented;
}
