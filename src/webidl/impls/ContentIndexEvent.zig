...
pub fn call_constructor(ctx: runtime.Context, @"type": runtime.DOMString, init_data: dictionaries.ContentIndexEventInit) !*runtime.Instance {
    // Create instance through init()
    const instance = try init(ctx.allocator, State, &ContentIndexEvent.vtable, ctx);
