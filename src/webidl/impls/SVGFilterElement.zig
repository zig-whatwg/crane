...
//! ============================================================================
//!
//! Implementation stub for SVGFilterElement interface
//!
...
const SVGFilterElement = interfaces.SVGFilterElement;

pub const State = SVGFilterElement.State;
