...
const RTCIdentityProviderGlobalScope = @import("interfaces").RTCIdentityProviderGlobalScope;
...
pub fn get_rtcIdentityProvider(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
