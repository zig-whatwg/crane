...
pub fn call_constructor(ctx: runtime.Context, @"type": runtime.DOMString, priorityChangeEventInitDict: dictionaries.TaskPriorityChangeEventInit) !*runtime.Instance {
    // Create instance through init()
    const instance = try init(ctx.allocator, State, &TaskPriorityChangeEvent.vtable, ctx);
