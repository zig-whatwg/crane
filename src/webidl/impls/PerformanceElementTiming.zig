//! Implementation for PerformanceElementTiming interface
//!
...
const PerformanceElementTiming = @import("interfaces").PerformanceElementTiming;

pub const State = PerformanceElementTiming.State;
...
pub fn get_renderTime(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
...
/// Getter for loadTime
pub fn get_loadTime(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
...
/// Getter for element
pub fn get_element(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
