...
pub fn get_frequency(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
...
/// Getter for Q
pub fn get_Q(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
...
/// Getter for gain
pub fn get_gain(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
...
pub fn call_getFrequencyResponse(instance: *runtime.Instance, frequencyHz: anyopaque, magResponse: anyopaque, phaseResponse: anyopaque) ImplError!void {
    _ = instance;
    _ = frequencyHz;
    _ = magResponse;
    _ = phaseResponse;
