...
const RTCPeerConnectionIceErrorEvent = @import("interfaces").RTCPeerConnectionIceErrorEvent;
...
pub fn get_errorText(instance: *runtime.Instance) ImplError!runtime.DOMString {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
