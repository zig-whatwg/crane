...
//! ============================================================================
//!
//! Implementation stub for SpeechSynthesisUtterance interface
//!
...
pub fn call_constructor(allocator: std.mem.Allocator, ctx: runtime.Context, text: webidl.Opt(runtime.DOMString)) !*runtime.Instance {
...
/// Getter for voice
pub fn get_voice(instance: *runtime.Instance) ImplError!?*runtime.Instance {
    _ = instance;
    return null;
}
...
/// Setter for voice
pub fn set_voice(instance: *runtime.Instance, value: *runtime.Instance) ImplError!void {
    _ = instance;
    _ = value;
    return error.NotImplemented;
}
