...
pub fn get_onrelease(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
...
pub fn set_onrelease(instance: *runtime.Instance, value: anyopaque) ImplError!void {
    _ = instance;
    _ = value;
...
/// Operation: release
pub fn call_release(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement operation
    return error.NotImplemented;
}
