...
const HTMLFencedFrameElement = @import("interfaces").HTMLFencedFrameElement;
...
/// Getter for config
pub fn get_config(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
...
/// Setter for config
pub fn set_config(instance: *runtime.Instance, value: anyopaque) ImplError!void {
    _ = instance;
    _ = value;
    // TODO: Implement setter
    return error.NotImplemented;
