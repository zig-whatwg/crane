...
const XRInputSourcesChangeEvent = @import("interfaces").XRInputSourcesChangeEvent;
...
/// Getter for added
pub fn get_added(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
...
/// Getter for removed
pub fn get_removed(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
