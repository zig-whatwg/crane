//! Implementation for SVGStopElement interface
//!
...
const SVGStopElement = @import("interfaces").SVGStopElement;

pub const State = SVGStopElement.State;
...
/// Getter for offset
pub fn get_offset(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
