...
pub fn call_writeStreaming(instance: *runtime.Instance, input: runtime.DOMString, options: dictionaries.WriterWriteOptions) ImplError!interfaces.ReadableStream {
    _ = instance;
    _ = input;
    _ = options;
    return error.NotImplemented;
