...
const HTMLParamElement = interfaces.HTMLParamElement;
...
pub fn init(
    ...
    // HTMLParamElement has no additional initialization
    return instance;
}

/// Deinitialize instance
pub fn deinit(instance: *runtime.Instance) void {
    // HTMLParamElement has no additional cleanup
...
pub fn call_constructor(ctx: runtime.Context) !*runtime.Instance {
    ...
    const instance = try init(ctx.allocator, State, &HTMLParamElement.vtable, ctx);
