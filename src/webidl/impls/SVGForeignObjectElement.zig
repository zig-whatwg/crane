//! Implementation for SVGForeignObjectElement interface
//!
...
const SVGForeignObjectElement = @import("interfaces").SVGForeignObjectElement;

pub const State = SVGForeignObjectElement.State;
