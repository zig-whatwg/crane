//! Implementation for SVGClipPathElement interface
//!
...
const SVGClipPathElement = @import("interfaces").SVGClipPathElement;

pub const State = SVGClipPathElement.State;
...
pub fn get_clipPathUnits(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
