...
const NavigateEvent = @import("interfaces").NavigateEvent;
...
/// Getter for formData
pub fn get_formData(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
...
pub fn get_downloadRequest(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
...
pub fn get_sourceElement(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
...
/// Operation: intercept
pub fn call_intercept(instance: *runtime.Instance, options: anyopaque) ImplError!void {
    _ = instance;
    _ = options;
    // TODO: Implement operation
    return error.NotImplemented;
