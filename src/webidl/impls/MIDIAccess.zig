...
/// Getter for inputs
pub fn get_inputs(instance: *runtime.Instance) ImplError!interfaces.MIDIInputMap {
    _ = instance;
    return error.NotImplemented;
}

/// Getter for outputs
pub fn get_outputs(instance: *runtime.Instance) ImplError!interfaces.MIDIOutputMap {
    _ = instance;
    return error.NotImplemented;
}
