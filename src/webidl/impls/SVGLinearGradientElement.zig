//! Implementation for SVGLinearGradientElement interface
//!
...
const SVGLinearGradientElement = @import("interfaces").SVGLinearGradientElement;

pub const State = SVGLinearGradientElement.State;
