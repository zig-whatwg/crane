//! Implementation for CanvasCaptureMediaStreamTrack interface
//!
...
const CanvasCaptureMediaStreamTrack = @import("interfaces").CanvasCaptureMediaStreamTrack;

pub const State = CanvasCaptureMediaStreamTrack.State;
