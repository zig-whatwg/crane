...
pub fn call_constructor(ctx: runtime.Context, @"type": runtime.DOMString, options: webidl.Opt(dictionaries.TextUpdateEventInit)) !*runtime.Instance {
    // Create instance through init()
    const instance = try init(ctx.allocator, State, &TextUpdateEvent.vtable, ctx);
