...
/// Getter for metadata
pub fn get_metadata(instance: *runtime.Instance) ImplError!interfaces.MediaMetadata {
    _ = instance;
...
/// Setter for metadata
pub fn set_metadata(instance: *runtime.Instance, value: interfaces.MediaMetadata) ImplError!void {
    _ = instance;
    _ = value;
    return error.NotImplemented;
}
