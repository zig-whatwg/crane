...
const MessageEvent = @import("interfaces").MessageEvent;
...
pub fn call_initMessageEvent(instance: *runtime.Instance, type: runtime.DOMString, bubbles: bool, cancelable: bool, data: anyopaque, origin: runtime.DOMString, lastEventId: runtime.DOMString, source: anyopaque, ports: anyopaque) ImplError!void {
    _ = instance;
    _ = type;
    _ = bubbles;
    _ = cancelable;
