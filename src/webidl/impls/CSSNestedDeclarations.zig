//! Implementation for CSSNestedDeclarations interface
//!
...
const CSSNestedDeclarations = @import("interfaces").CSSNestedDeclarations;

pub const State = CSSNestedDeclarations.State;
