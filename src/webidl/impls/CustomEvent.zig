...
const CustomEvent = @import("interfaces").CustomEvent;
...
pub fn call_initCustomEvent(instance: *runtime.Instance, type: runtime.DOMString, bubbles: bool, cancelable: bool, detail: anyopaque) ImplError!void {
    _ = instance;
    _ = type;
    _ = bubbles;
    _ = cancelable;
