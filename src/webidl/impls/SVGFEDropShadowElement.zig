...
//! ============================================================================
//!
//! Implementation stub for SVGFEDropShadowElement interface
//!
...
const SVGFEDropShadowElement = interfaces.SVGFEDropShadowElement;

pub const State = SVGFEDropShadowElement.State;
