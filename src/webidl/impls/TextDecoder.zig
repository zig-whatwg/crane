...
/// Operation: decode
pub fn call_decode(instance: *runtime.Instance, input: typedefs.AllowSharedBufferSource, options: dictionaries.TextDecodeOptions) ImplError!runtime.USVString {
    _ = instance;
    _ = input;
    _ = options;
    return error.NotImplemented;
