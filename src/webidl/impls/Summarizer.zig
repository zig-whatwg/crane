...
const Summarizer = @import("interfaces").Summarizer;
...
/// Operation: summarize
pub fn call_summarize(instance: *runtime.Instance, input: runtime.DOMString, options: anyopaque) ImplError!anyopaque {
    _ = instance;
    _ = input;
    _ = options;
    // TODO: Implement operation
...
pub fn call_summarizeStreaming(instance: *runtime.Instance, input: runtime.DOMString, options: anyopaque) ImplError!anyopaque {
    _ = instance;
    _ = input;
    _ = options;
    // TODO: Implement operation
