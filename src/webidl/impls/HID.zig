//! Implementation for HID interface
...
const HID = interfaces.HID;

pub const State = HID.State;
...
pub fn call_requestDevice(instance: *runtime.Instance, options: dictionaries.HIDDeviceRequestOptions) anyerror!runtime.JSValue {
    _ = instance;
    _ = options;
    return error.NotImplemented;
}
