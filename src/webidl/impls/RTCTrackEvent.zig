...
const RTCTrackEvent = @import("interfaces").RTCTrackEvent;
...
/// Getter for streams
pub fn get_streams(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
...
pub fn get_transceiver(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
