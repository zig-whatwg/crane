...
pub fn call_constructor(ctx: runtime.Context, init_data: dictionaries.VideoEncoderInit) !*runtime.Instance {
    // Create instance through init()
    const instance = try init(ctx.allocator, State, &VideoEncoder.vtable, ctx);
...
pub fn call_isConfigSupported(instance: *runtime.Instance, config: dictionaries.VideoEncoderConfig) anyerror!runtime.JSValue {
    _ = instance;
    _ = config;
    return error.NotImplemented;
}