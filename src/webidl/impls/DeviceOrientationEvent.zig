...
const DeviceOrientationEvent = @import("interfaces").DeviceOrientationEvent;
...
pub fn call_requestPermission(instance: *runtime.Instance, absolute: bool) ImplError!anyopaque {
    _ = instance;
    _ = absolute;
    // TODO: Implement operation
    return error.NotImplemented;
