...
const FetchEvent = @import("interfaces").FetchEvent;
...
pub fn get_preloadResponse(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
...
/// Getter for handled
pub fn get_handled(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
...
pub fn call_respondWith(instance: *runtime.Instance, r: anyopaque) ImplError!void {
    _ = instance;
    _ = r;
    // TODO: Implement operation
    return error.NotImplemented;
