...
/// Operation: _any
pub fn call_static_any(instance: *runtime.Instance, signals: runtime.JSValue, init_data: webidl.Opt(dictionaries.TaskSignalAnyInit)) anyerror!*runtime.Instance {
    _ = instance;
    _ = signals;
    _ = init_data;
    return error.NotImplemented;
