//! Implementation for CSSLayerStatementRule interface
//!
...
const CSSLayerStatementRule = @import("interfaces").CSSLayerStatementRule;

pub const State = CSSLayerStatementRule.State;
...
/// Getter for nameList
pub fn get_nameList(instance: *runtime.Instance) ImplError!anyopaque {
    _ = instance;
    // TODO: Implement getter
    return error.NotImplemented;
}
