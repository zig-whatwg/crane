...
//! ============================================================================
//!
//! Implementation stub for CSSParserQualifiedRule interface
//!
...
const CSSParserQualifiedRule = interfaces.CSSParserQualifiedRule;
...
pub fn call_constructor(allocator: std.mem.Allocator, ctx: runtime.Context, prelude: *const anyopaque, body: *const anyopaque) !*runtime.Instance {
    ...
    const instance = try init(allocator, State, &CSSParserQualifiedRule.vtable, ctx);
