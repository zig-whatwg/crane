...
pub fn call_constructor(ctx: runtime.Context, sensorOptions: webidl.Opt(dictionaries.SensorOptions)) !*runtime.Instance {
    // Create instance through init()
    const instance = try init(ctx.allocator, State, &AmbientLightSensor.vtable, ctx);
