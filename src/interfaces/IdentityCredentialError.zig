...
const IdentityCredentialErrorImpl = @import("../impls/IdentityCredentialError.zig");
...
pub const IdentityCredentialError = struct {
    ...
    pub const vtable = runtime.buildVTable(IdentityCredentialError, .{
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        IdentityCredentialErrorImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        IdentityCredentialErrorImpl.deinit(state);
    }
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, message: runtime.DOMString, options: anyopaque) !*runtime.Instance {
        ...
        const state = instance.getState(State);
        try IdentityCredentialErrorImpl.constructor(state, message, options);
    ...
    pub fn get_name(instance: *runtime.Instance) runtime.DOMString {
        const state = instance.getState(State);
        return IdentityCredentialErrorImpl.get_name(state);
    }

    pub fn get_message(instance: *runtime.Instance) runtime.DOMString {
        const state = instance.getState(State);
        return IdentityCredentialErrorImpl.get_message(state);
    }

    pub fn get_code(instance: *runtime.Instance) u16 {
        const state = instance.getState(State);
        return IdentityCredentialErrorImpl.get_code(state);
    }

    pub fn get_error(instance: *runtime.Instance) runtime.DOMString {
        const state = instance.getState(State);
        return IdentityCredentialErrorImpl.get_error(state);
    }

    pub fn get_url(instance: *runtime.Instance) runtime.USVString {
        const state = instance.getState(State);
        return IdentityCredentialErrorImpl.get_url(state);
    }
