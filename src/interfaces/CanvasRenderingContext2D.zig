...
const CanvasRenderingContext2DImpl = @import("../impls/CanvasRenderingContext2D.zig");
...
const CanvasUserInterface = @import("CanvasUserInterface.zig");
...
pub const CanvasRenderingContext2D = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        CanvasRenderingContext2DImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        CanvasRenderingContext2DImpl.deinit(state);
    }
    ...
    pub fn call_isPointInPath(instance: *runtime.Instance, args: IsPointInPathArgs) bool {
        const state = instance.getState(State);
        switch (args) {
            .unrestricted double_unrestricted double_CanvasFillRule => |a| return CanvasRenderingContext2DImpl.unrestricted double_unrestricted double_CanvasFillRule(state, a.x, a.y, a.fillRule),
            .Path2D_unrestricted double_unrestricted double_CanvasFillRule => |a| return CanvasRenderingContext2DImpl.Path2D_unrestricted double_unrestricted double_CanvasFillRule(state, a.path, a.x, a.y, a.fillRule),
        }
    }

    pub fn call_getLineDash(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CanvasRenderingContext2DImpl.call_getLineDash(state);
    }
    ...
    pub fn call_ellipse(instance: *runtime.Instance, x: f64, y: f64, radiusX: f64, radiusY: f64, rotation: f64, startAngle: f64, endAngle: f64, counterclockwise: bool) anyopaque {
        ...
        return CanvasRenderingContext2DImpl.call_ellipse(state, x, y, radiusX, radiusY, rotation, startAngle, endAngle, counterclockwise);
    }

    pub fn call_clearRect(instance: *runtime.Instance, x: f64, y: f64, w: f64, h: f64) anyopaque {
        const state = instance.getState(State);
        
        return CanvasRenderingContext2DImpl.call_clearRect(state, x, y, w, h);
    }

    pub fn call_createConicGradient(instance: *runtime.Instance, startAngle: f64, x: f64, y: f64) anyopaque {
        const state = instance.getState(State);
        
        return CanvasRenderingContext2DImpl.call_createConicGradient(state, startAngle, x, y);
    }

    pub fn call_transform(instance: *runtime.Instance, a: f64, b: f64, c: f64, d: f64, e: f64, f: f64) anyopaque {
        const state = instance.getState(State);
        
        return CanvasRenderingContext2DImpl.call_transform(state, a, b, c, d, e, f);
    }

    pub fn call_restore(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CanvasRenderingContext2DImpl.call_restore(state);
    }
    ...
    pub fn call_clip(instance: *runtime.Instance, args: ClipArgs) anyopaque {
        const state = instance.getState(State);
        switch (args) {
            .CanvasFillRule => |arg| return CanvasRenderingContext2DImpl.CanvasFillRule(state, arg),
            .Path2D_CanvasFillRule => |a| return CanvasRenderingContext2DImpl.Path2D_CanvasFillRule(state, a.path, a.fillRule),
        }
    }

    pub fn call_reset(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CanvasRenderingContext2DImpl.call_reset(state);
    }

    pub fn call_strokeText(instance: *runtime.Instance, text: runtime.DOMString, x: f64, y: f64, maxWidth: f64) anyopaque {
        const state = instance.getState(State);
        
        return CanvasRenderingContext2DImpl.call_strokeText(state, text, x, y, maxWidth);
    }
    ...
    pub fn call_stroke(instance: *runtime.Instance, args: StrokeArgs) anyopaque {
        const state = instance.getState(State);
        switch (args) {
            .no_params => return CanvasRenderingContext2DImpl.no_params(state),
            .Path2D => |arg| return CanvasRenderingContext2DImpl.Path2D(state, arg),
        }
    }
    ...
    pub fn call_drawImage(instance: *runtime.Instance, args: DrawImageArgs) anyopaque {
        const state = instance.getState(State);
        switch (args) {
            .CanvasImageSource_unrestricted double_unrestricted double => |a| return CanvasRenderingContext2DImpl.CanvasImageSource_unrestricted double_unrestricted double(state, a.image, a.dx, a.dy),
            .CanvasImageSource_unrestricted double_unrestricted double_unrestricted double_unrestricted double => |a| return CanvasRenderingContext2DImpl.CanvasImageSource_unrestricted double_unrestricted double_unrestricted double_unrestricted double(state, a.image, a.dx, a.dy, a.dw, a.dh),
            .CanvasImageSource_unrestricted double_unrestricted double_unrestricted double_unrestricted double_unrestricted double_unrestricted double_unrestricted double_unrestricted double => |a| return CanvasRenderingContext2DImpl.CanvasImageSource_unrestricted double_unrestricted double_unrestricted double_unrestricted double_unrestricted double_unrestricted double_unrestricted double_unrestricted double(state, a.image, a.sx, a.sy, a.sw, a.sh, a.dx, a.dy, a.dw, a.dh),
        }
    }
    ...
    pub fn call_getImageData(instance: *runtime.Instance, sx: i32, sy: i32, sw: i32, sh: i32, settings: anyopaque) anyopaque {
        ...
        return CanvasRenderingContext2DImpl.call_getImageData(state, sx, sy, sw, sh, settings);
    }
    ...
    pub fn call_arc(instance: *runtime.Instance, x: f64, y: f64, radius: f64, startAngle: f64, endAngle: f64, counterclockwise: bool) anyopaque {
        ...
        return CanvasRenderingContext2DImpl.call_arc(state, x, y, radius, startAngle, endAngle, counterclockwise);
    }
    ...
    pub fn call_getTransform(instance: *runtime.Instance) anyopaque {
        ...
        return CanvasRenderingContext2DImpl.call_getTransform(state);
    }

    pub fn call_createRadialGradient(instance: *runtime.Instance, x0: f64, y0: f64, r0: f64, x1: f64, y1: f64, r1: f64) anyopaque {
        const state = instance.getState(State);
        
        return CanvasRenderingContext2DImpl.call_createRadialGradient(state, x0, y0, r0, x1, y1, r1);
    }
    ...
    pub fn call_drawFocusIfNeeded(instance: *runtime.Instance, args: DrawFocusIfNeededArgs) anyopaque {
        const state = instance.getState(State);
        switch (args) {
            .Element => |arg| return CanvasRenderingContext2DImpl.Element(state, arg),
            .Path2D_Element => |a| return CanvasRenderingContext2DImpl.Path2D_Element(state, a.path, a.element),
        }
    }

    pub fn call_closePath(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CanvasRenderingContext2DImpl.call_closePath(state);
    }

    pub fn call_roundRect(instance: *runtime.Instance, x: f64, y: f64, w: f64, h: f64, radii: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return CanvasRenderingContext2DImpl.call_roundRect(state, x, y, w, h, radii);
    }

    pub fn call_createPattern(instance: *runtime.Instance, image: anyopaque, repetition: runtime.DOMString) anyopaque {
        const state = instance.getState(State);
        
        return CanvasRenderingContext2DImpl.call_createPattern(state, image, repetition);
    }

    pub fn call_lineTo(instance: *runtime.Instance, x: f64, y: f64) anyopaque {
        const state = instance.getState(State);
        
        return CanvasRenderingContext2DImpl.call_lineTo(state, x, y);
    }

    pub fn call_resetTransform(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CanvasRenderingContext2DImpl.call_resetTransform(state);
    }

    pub fn call_arcTo(instance: *runtime.Instance, x1: f64, y1: f64, x2: f64, y2: f64, radius: f64) anyopaque {
        const state = instance.getState(State);
        
        return CanvasRenderingContext2DImpl.call_arcTo(state, x1, y1, x2, y2, radius);
    }

    pub fn call_getContextAttributes(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CanvasRenderingContext2DImpl.call_getContextAttributes(state);
    }

    pub fn call_setLineDash(instance: *runtime.Instance, segments: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return CanvasRenderingContext2DImpl.call_setLineDash(state, segments);
    }

    pub fn call_save(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CanvasRenderingContext2DImpl.call_save(state);
    }

    pub fn call_moveTo(instance: *runtime.Instance, x: f64, y: f64) anyopaque {
        const state = instance.getState(State);
        
        return CanvasRenderingContext2DImpl.call_moveTo(state, x, y);
    }

    pub fn call_quadraticCurveTo(instance: *runtime.Instance, cpx: f64, cpy: f64, x: f64, y: f64) anyopaque {
        const state = instance.getState(State);
        
        return CanvasRenderingContext2DImpl.call_quadraticCurveTo(state, cpx, cpy, x, y);
    }

    pub fn call_isContextLost(instance: *runtime.Instance) bool {
        const state = instance.getState(State);
        return CanvasRenderingContext2DImpl.call_isContextLost(state);
    }
    ...
    pub fn call_isPointInStroke(instance: *runtime.Instance, args: IsPointInStrokeArgs) bool {
        const state = instance.getState(State);
        switch (args) {
            .unrestricted double_unrestricted double => |a| return CanvasRenderingContext2DImpl.unrestricted double_unrestricted double(state, a.x, a.y),
            .Path2D_unrestricted double_unrestricted double => |a| return CanvasRenderingContext2DImpl.Path2D_unrestricted double_unrestricted double(state, a.path, a.x, a.y),
        }
    }
    ...
    pub fn call_bezierCurveTo(instance: *runtime.Instance, cp1x: f64, cp1y: f64, cp2x: f64, cp2y: f64, x: f64, y: f64) anyopaque {
        ...
        return CanvasRenderingContext2DImpl.call_bezierCurveTo(state, cp1x, cp1y, cp2x, cp2y, x, y);
    }

    pub fn call_rotate(instance: *runtime.Instance, angle: f64) anyopaque {
        const state = instance.getState(State);
        
        return CanvasRenderingContext2DImpl.call_rotate(state, angle);
    }
    ...
    pub fn call_createImageData(instance: *runtime.Instance, args: CreateImageDataArgs) anyopaque {
        const state = instance.getState(State);
        switch (args) {
            .long_long_ImageDataSettings => |a| return CanvasRenderingContext2DImpl.long_long_ImageDataSettings(state, a.sw, a.sh, a.settings),
            .ImageData => |arg| return CanvasRenderingContext2DImpl.ImageData(state, arg),
        }
    }
    ...
    pub fn call_scale(instance: *runtime.Instance, x: f64, y: f64) anyopaque {
        ...
        return CanvasRenderingContext2DImpl.call_scale(state, x, y);
    }

    pub fn call_translate(instance: *runtime.Instance, x: f64, y: f64) anyopaque {
        const state = instance.getState(State);
        
        return CanvasRenderingContext2DImpl.call_translate(state, x, y);
    }

    pub fn call_createLinearGradient(instance: *runtime.Instance, x0: f64, y0: f64, x1: f64, y1: f64) anyopaque {
        const state = instance.getState(State);
        
        return CanvasRenderingContext2DImpl.call_createLinearGradient(state, x0, y0, x1, y1);
    }

    pub fn call_strokeRect(instance: *runtime.Instance, x: f64, y: f64, w: f64, h: f64) anyopaque {
        const state = instance.getState(State);
        
        return CanvasRenderingContext2DImpl.call_strokeRect(state, x, y, w, h);
    }
    ...
    pub fn call_setTransform(instance: *runtime.Instance, args: SetTransformArgs) anyopaque {
        const state = instance.getState(State);
        switch (args) {
            .unrestricted double_unrestricted double_unrestricted double_unrestricted double_unrestricted double_unrestricted double => |a| return CanvasRenderingContext2DImpl.unrestricted double_unrestricted double_unrestricted double_unrestricted double_unrestricted double_unrestricted double(state, a.a, a.b, a.c, a.d, a.e, a.f),
            .DOMMatrix2DInit => |arg| return CanvasRenderingContext2DImpl.DOMMatrix2DInit(state, arg),
        }
    }
    ...
    pub fn call_fillRect(instance: *runtime.Instance, x: f64, y: f64, w: f64, h: f64) anyopaque {
        ...
        return CanvasRenderingContext2DImpl.call_fillRect(state, x, y, w, h);
    }

    pub fn call_beginPath(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CanvasRenderingContext2DImpl.call_beginPath(state);
    }

    pub fn call_fillText(instance: *runtime.Instance, text: runtime.DOMString, x: f64, y: f64, maxWidth: f64) anyopaque {
        const state = instance.getState(State);
        
        return CanvasRenderingContext2DImpl.call_fillText(state, text, x, y, maxWidth);
    }

    pub fn call_measureText(instance: *runtime.Instance, text: runtime.DOMString) anyopaque {
        const state = instance.getState(State);
        
        return CanvasRenderingContext2DImpl.call_measureText(state, text);
    }
    ...
    pub fn call_putImageData(instance: *runtime.Instance, args: PutImageDataArgs) anyopaque {
        const state = instance.getState(State);
        switch (args) {
            .ImageData_long_long => |a| return CanvasRenderingContext2DImpl.ImageData_long_long(state, a.imageData, a.dx, a.dy),
            .ImageData_long_long_long_long_long_long => |a| return CanvasRenderingContext2DImpl.ImageData_long_long_long_long_long_long(state, a.imageData, a.dx, a.dy, a.dirtyX, a.dirtyY, a.dirtyWidth, a.dirtyHeight),
        }
    }
