...
const BackgroundFetchEventImpl = @import("../impls/BackgroundFetchEvent.zig");
...
pub const BackgroundFetchEvent = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        BackgroundFetchEventImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        BackgroundFetchEventImpl.deinit(state);
    }
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, type_: runtime.DOMString, init: anyopaque) !*runtime.Instance {
        ...
        const state = instance.getState(State);
        try BackgroundFetchEventImpl.constructor(state, type_, init);
