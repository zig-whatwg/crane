...
const SensorErrorEventImpl = @import("../impls/SensorErrorEvent.zig");
...
pub const SensorErrorEvent = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        SensorErrorEventImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        SensorErrorEventImpl.deinit(state);
    }
    ...
    /// WebIDL constructor
    pub fn call_constructor(allocator: std.mem.Allocator, type_: runtime.DOMString, errorEventInitDict: anyopaque) !*runtime.Instance {
        const instance = try init(allocator);
        errdefer deinit(instance);
        
        const state = instance.getState(State);
        try SensorErrorEventImpl.constructor(state, type_, errorEventInitDict);
