...
const NavigatorNetworkInformationImpl = @import("../impls/NavigatorNetworkInformation.zig");
...
pub const NavigatorNetworkInformation = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        NavigatorNetworkInformationImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        NavigatorNetworkInformationImpl.deinit(state);
    }
    ...
    pub fn get_connection(instance: *runtime.Instance) anyopaque {
        ...
        const value = NavigatorNetworkInformationImpl.get_connection(state);
