...
const CSSLCHImpl = @import("../impls/CSSLCH.zig");
...
pub const CSSLCH = struct {
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, l: anyopaque, c: anyopaque, h: anyopaque, alpha: anyopaque) !*runtime.Instance {
        ...
        const state = instance.getState(State);
        try CSSLCHImpl.constructor(state, l, c, h, alpha);
    ...
    pub fn call_parseAll(instance: *runtime.Instance, property: runtime.USVString, cssText: runtime.USVString) anyopaque {
        ...
        return CSSLCHImpl.call_parseAll(state, property, cssText);
    }
    ...
    pub fn call_parse(instance: *runtime.Instance, args: ParseArgs) anyopaque {
        const state = instance.getState(State);
        switch (args) {
            .USVString_USVString => |a| return CSSLCHImpl.USVString_USVString(state, a.property, a.cssText),
            .USVString => |arg| return CSSLCHImpl.USVString(state, arg),
        }
    }
