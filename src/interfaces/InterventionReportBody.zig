...
const InterventionReportBodyImpl = @import("../impls/InterventionReportBody.zig");
...
pub const InterventionReportBody = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        InterventionReportBodyImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        InterventionReportBodyImpl.deinit(state);
    }
    ...
    pub fn get_id(instance: *runtime.Instance) runtime.DOMString {
        const state = instance.getState(State);
        return InterventionReportBodyImpl.get_id(state);
    }

    pub fn get_message(instance: *runtime.Instance) runtime.DOMString {
        const state = instance.getState(State);
        return InterventionReportBodyImpl.get_message(state);
    }

    pub fn get_sourceFile(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return InterventionReportBodyImpl.get_sourceFile(state);
    }

    pub fn get_lineNumber(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return InterventionReportBodyImpl.get_lineNumber(state);
    }

    pub fn get_columnNumber(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return InterventionReportBodyImpl.get_columnNumber(state);
    }

    /// Extended attributes: [Default]
    pub fn call_toJSON(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return InterventionReportBodyImpl.call_toJSON(state);
    }
