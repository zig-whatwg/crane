...
const SyncEventImpl = @import("../impls/SyncEvent.zig");
...
pub const SyncEvent = struct {
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, type_: runtime.DOMString, init: anyopaque) !*runtime.Instance {
        ...
        const state = instance.getState(State);
        try SyncEventImpl.constructor(state, type_, init);
