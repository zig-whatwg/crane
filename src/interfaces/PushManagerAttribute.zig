...
const PushManagerAttributeImpl = @import("../impls/PushManagerAttribute.zig");
...
pub const PushManagerAttribute = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        PushManagerAttributeImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        PushManagerAttributeImpl.deinit(state);
    }
    ...
    pub fn get_pushManager(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return PushManagerAttributeImpl.get_pushManager(state);
    }
