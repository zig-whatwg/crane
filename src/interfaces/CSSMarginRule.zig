...
const CSSMarginRuleImpl = @import("../impls/CSSMarginRule.zig");
...
pub const CSSMarginRule = struct {
    ...
    pub const vtable = runtime.buildVTable(CSSMarginRule, .{
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        CSSMarginRuleImpl.deinit(state);
    }
    ...
    pub fn get_name(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSMarginRuleImpl.get_name(state);
    }
    ...
    pub fn get_style(instance: *runtime.Instance) anyopaque {
        ...
        const value = CSSMarginRuleImpl.get_style(state);
