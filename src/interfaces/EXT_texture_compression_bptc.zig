...
const EXT_texture_compression_bptcImpl = @import("../impls/EXT_texture_compression_bptc.zig");
...
pub const EXT_texture_compression_bptc = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        EXT_texture_compression_bptcImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        EXT_texture_compression_bptcImpl.deinit(state);
    }
