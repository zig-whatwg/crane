...
const DestroyableModelImpl = @import("../impls/DestroyableModel.zig");
...
pub const DestroyableModel = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        DestroyableModelImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        DestroyableModelImpl.deinit(state);
    }
    ...
    pub fn call_destroy(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return DestroyableModelImpl.call_destroy(state);
    }
