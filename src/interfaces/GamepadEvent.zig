...
const GamepadEventImpl = @import("../impls/GamepadEvent.zig");
...
pub const GamepadEvent = struct {
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, type_: runtime.DOMString, eventInitDict: anyopaque) !*runtime.Instance {
        ...
        const state = instance.getState(State);
        try GamepadEventImpl.constructor(state, type_, eventInitDict);
    ...
    pub fn get_gamepad(instance: *runtime.Instance) anyopaque {
        ...
        const value = GamepadEventImpl.get_gamepad(state);
