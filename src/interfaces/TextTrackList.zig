...
const TextTrackListImpl = @import("../impls/TextTrackList.zig");
...
pub const TextTrackList = struct {
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        TextTrackListImpl.deinit(state);
    }
    ...
    pub fn get_length(instance: *runtime.Instance) u32 {
        const state = instance.getState(State);
        return TextTrackListImpl.get_length(state);
    }

    pub fn get_onchange(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return TextTrackListImpl.get_onchange(state);
    }

    pub fn set_onchange(instance: *runtime.Instance, value: anyopaque) void {
        const state = instance.getState(State);
        TextTrackListImpl.set_onchange(state, value);
    }

    pub fn get_onaddtrack(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return TextTrackListImpl.get_onaddtrack(state);
    }

    pub fn set_onaddtrack(instance: *runtime.Instance, value: anyopaque) void {
        const state = instance.getState(State);
        TextTrackListImpl.set_onaddtrack(state, value);
    }

    pub fn get_onremovetrack(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return TextTrackListImpl.get_onremovetrack(state);
    }

    pub fn set_onremovetrack(instance: *runtime.Instance, value: anyopaque) void {
        const state = instance.getState(State);
        TextTrackListImpl.set_onremovetrack(state, value);
    }

    pub fn call_dispatchEvent(instance: *runtime.Instance, event: anyopaque) bool {
        const state = instance.getState(State);
        
        return TextTrackListImpl.call_dispatchEvent(state, event);
    }

    pub fn call_getTrackById(instance: *runtime.Instance, id: runtime.DOMString) anyopaque {
        const state = instance.getState(State);
        
        return TextTrackListImpl.call_getTrackById(state, id);
    }

    pub fn call_when(instance: *runtime.Instance, type_: runtime.DOMString, options: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return TextTrackListImpl.call_when(state, type_, options);
    }

    pub fn call_addEventListener(instance: *runtime.Instance, type_: runtime.DOMString, callback: anyopaque, options: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return TextTrackListImpl.call_addEventListener(state, type_, callback, options);
    }

    pub fn call_removeEventListener(instance: *runtime.Instance, type_: runtime.DOMString, callback: anyopaque, options: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return TextTrackListImpl.call_removeEventListener(state, type_, callback, options);
    }
