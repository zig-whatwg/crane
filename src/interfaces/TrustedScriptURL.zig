...
const TrustedScriptURLImpl = @import("../impls/TrustedScriptURL.zig");
...
pub const TrustedScriptURL = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        TrustedScriptURLImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        TrustedScriptURLImpl.deinit(state);
    }
    ...
    pub fn call_toJSON(instance: *runtime.Instance) runtime.USVString {
        const state = instance.getState(State);
        return TrustedScriptURLImpl.call_toJSON(state);
    }
