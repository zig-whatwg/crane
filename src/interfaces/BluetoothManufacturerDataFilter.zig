...
const BluetoothManufacturerDataFilterImpl = @import("../impls/BluetoothManufacturerDataFilter.zig");
...
pub const BluetoothManufacturerDataFilter = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        BluetoothManufacturerDataFilterImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        BluetoothManufacturerDataFilterImpl.deinit(state);
    }
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, init: anyopaque) !*runtime.Instance {
        ...
        const state = instance.getState(State);
        try BluetoothManufacturerDataFilterImpl.constructor(state, init);
