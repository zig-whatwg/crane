...
const WebTransportErrorImpl = @import("../impls/WebTransportError.zig");
...
pub const WebTransportError = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        WebTransportErrorImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        WebTransportErrorImpl.deinit(state);
    }
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, message: runtime.DOMString, options: anyopaque) !*runtime.Instance {
        ...
        const state = instance.getState(State);
        try WebTransportErrorImpl.constructor(state, message, options);
    ...
    pub fn get_name(instance: *runtime.Instance) runtime.DOMString {
        const state = instance.getState(State);
        return WebTransportErrorImpl.get_name(state);
    }

    pub fn get_message(instance: *runtime.Instance) runtime.DOMString {
        const state = instance.getState(State);
        return WebTransportErrorImpl.get_message(state);
    }

    pub fn get_code(instance: *runtime.Instance) u16 {
        const state = instance.getState(State);
        return WebTransportErrorImpl.get_code(state);
    }

    pub fn get_source(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return WebTransportErrorImpl.get_source(state);
    }

    pub fn get_streamErrorCode(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return WebTransportErrorImpl.get_streamErrorCode(state);
    }
