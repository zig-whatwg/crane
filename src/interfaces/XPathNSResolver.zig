...
const XPathNSResolverImpl = @import("../impls/XPathNSResolver.zig");
...
pub const XPathNSResolver = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        XPathNSResolverImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        XPathNSResolverImpl.deinit(state);
    }
    ...
    pub fn call_lookupNamespaceURI(instance: *runtime.Instance, prefix: anyopaque) anyopaque {
        ...
        return XPathNSResolverImpl.call_lookupNamespaceURI(state, prefix);
    }
