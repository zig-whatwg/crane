...
const CSSMathNegateImpl = @import("../impls/CSSMathNegate.zig");
...
pub const CSSMathNegate = struct {
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        CSSMathNegateImpl.deinit(state);
    }
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, arg: anyopaque) !*runtime.Instance {
        ...
        const state = instance.getState(State);
        try CSSMathNegateImpl.constructor(state, arg);
    ...
    pub fn call_parse(instance: *runtime.Instance, args: ParseArgs) anyopaque {
        const state = instance.getState(State);
        switch (args) {
            .USVString_USVString => |a| return CSSMathNegateImpl.USVString_USVString(state, a.property, a.cssText),
            .USVString => |arg| return CSSMathNegateImpl.USVString(state, arg),
        }
    }

    pub fn call_type(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSMathNegateImpl.call_type(state);
    }
