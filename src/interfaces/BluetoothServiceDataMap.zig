...
const BluetoothServiceDataMapImpl = @import("../impls/BluetoothServiceDataMap.zig");
...
pub const BluetoothServiceDataMap = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        BluetoothServiceDataMapImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        BluetoothServiceDataMapImpl.deinit(state);
    }
