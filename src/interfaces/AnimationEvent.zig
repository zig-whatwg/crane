...
const AnimationEventImpl = @import("../impls/AnimationEvent.zig");
...
pub const AnimationEvent = struct {
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        AnimationEventImpl.deinit(state);
    }
    ...
    /// WebIDL constructor
    pub fn call_constructor(allocator: std.mem.Allocator, type_: anyopaque, animationEventInitDict: anyopaque) !*runtime.Instance {
        const instance = try init(allocator);
        errdefer deinit(instance);
        
        const state = instance.getState(State);
        try AnimationEventImpl.constructor(state, type_, animationEventInitDict);
