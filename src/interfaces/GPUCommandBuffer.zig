...
const GPUCommandBufferImpl = @import("../impls/GPUCommandBuffer.zig");
...
pub const GPUCommandBuffer = struct {
    ...
    pub const vtable = runtime.buildVTable(GPUCommandBuffer, .{
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        GPUCommandBufferImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        GPUCommandBufferImpl.deinit(state);
    }
    ...
    pub fn get_label(instance: *runtime.Instance) runtime.USVString {
        const state = instance.getState(State);
        return GPUCommandBufferImpl.get_label(state);
    }

    pub fn set_label(instance: *runtime.Instance, value: runtime.USVString) void {
        const state = instance.getState(State);
        GPUCommandBufferImpl.set_label(state, value);
    }
