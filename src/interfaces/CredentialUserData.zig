...
const CredentialUserDataImpl = @import("../impls/CredentialUserData.zig");
...
pub const CredentialUserData = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        CredentialUserDataImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        CredentialUserDataImpl.deinit(state);
    }
    ...
    pub fn get_name(instance: *runtime.Instance) runtime.USVString {
        const state = instance.getState(State);
        return CredentialUserDataImpl.get_name(state);
    }

    pub fn get_iconURL(instance: *runtime.Instance) runtime.USVString {
        const state = instance.getState(State);
        return CredentialUserDataImpl.get_iconURL(state);
    }
