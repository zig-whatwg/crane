...
const SVGAnimatedLengthListImpl = @import("../impls/SVGAnimatedLengthList.zig");
...
pub const SVGAnimatedLengthList = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        SVGAnimatedLengthListImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        SVGAnimatedLengthListImpl.deinit(state);
    }
    ...
    pub fn get_baseVal(instance: *runtime.Instance) anyopaque {
        ...
        const value = SVGAnimatedLengthListImpl.get_baseVal(state);
    ...
    pub fn get_animVal(instance: *runtime.Instance) anyopaque {
        ...
        const value = SVGAnimatedLengthListImpl.get_animVal(state);
