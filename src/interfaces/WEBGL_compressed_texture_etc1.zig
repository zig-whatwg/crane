...
const WEBGL_compressed_texture_etc1Impl = @import("../impls/WEBGL_compressed_texture_etc1.zig");
...
pub const WEBGL_compressed_texture_etc1 = struct {
    ...
    pub const vtable = runtime.buildVTable(WEBGL_compressed_texture_etc1, .{
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        WEBGL_compressed_texture_etc1Impl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        WEBGL_compressed_texture_etc1Impl.deinit(state);
    }
