...
const WorkletGroupEffectImpl = @import("../impls/WorkletGroupEffect.zig");
...
pub const WorkletGroupEffect = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        WorkletGroupEffectImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        WorkletGroupEffectImpl.deinit(state);
    }
    ...
    pub fn call_getChildren(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return WorkletGroupEffectImpl.call_getChildren(state);
    }
