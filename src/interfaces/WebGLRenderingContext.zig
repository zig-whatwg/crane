...
const WebGLRenderingContextImpl = @import("../impls/WebGLRenderingContext.zig");
const WebGLRenderingContextBase = @import("WebGLRenderingContextBase.zig");
const WebGLRenderingContextOverloads = @import("WebGLRenderingContextOverloads.zig");
...
pub const WebGLRenderingContext = struct {
    ...
    pub const vtable = runtime.buildVTable(WebGLRenderingContext, .{
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        WebGLRenderingContextImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        WebGLRenderingContextImpl.deinit(state);
    }
    ...
    pub fn call_vertexAttrib4f(instance: *runtime.Instance, index: anyopaque, x: anyopaque, y: anyopaque, z: anyopaque, w: anyopaque) anyopaque {
        ...
        return WebGLRenderingContextImpl.call_vertexAttrib4f(state, index, x, y, z, w);
    }

    pub fn call_uniformMatrix4fv(instance: *runtime.Instance, location: anyopaque, transpose: anyopaque, value: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return WebGLRenderingContextImpl.call_uniformMatrix4fv(state, location, transpose, value);
    }
    ...
    pub fn call_vertexAttribPointer(instance: *runtime.Instance, index: anyopaque, size: anyopaque, type_: anyopaque, normalized: anyopaque, stride: anyopaque, offset: anyopaque) anyopaque {
        ...
        return WebGLRenderingContextImpl.call_vertexAttribPointer(state, index, size, type_, normalized, stride, offset);
    }
    ...
    pub fn call_uniform4f(instance: *runtime.Instance, location: anyopaque, x: anyopaque, y: anyopaque, z: anyopaque, w: anyopaque) anyopaque {
        ...
        return WebGLRenderingContextImpl.call_uniform4f(state, location, x, y, z, w);
    }
    ...
    pub fn call_readPixels(instance: *runtime.Instance, x: anyopaque, y: anyopaque, width: anyopaque, height: anyopaque, format: anyopaque, type_: anyopaque, pixels: anyopaque) anyopaque {
        ...
        return WebGLRenderingContextImpl.call_readPixels(state, x, y, width, height, format, type_, pixels);
    }
    ...
    pub fn call_stencilOpSeparate(instance: *runtime.Instance, face: anyopaque, fail: anyopaque, zfail: anyopaque, zpass: anyopaque) anyopaque {
        ...
        return WebGLRenderingContextImpl.call_stencilOpSeparate(state, face, fail, zfail, zpass);
    }

    pub fn call_generateMipmap(instance: *runtime.Instance, target: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return WebGLRenderingContextImpl.call_generateMipmap(state, target);
    }

    pub fn call_getActiveAttrib(instance: *runtime.Instance, program: anyopaque, index: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return WebGLRenderingContextImpl.call_getActiveAttrib(state, program, index);
    }
    ...
    pub fn call_texImage2D(instance: *runtime.Instance, args: TexImage2DArgs) anyopaque {
        const state = instance.getState(State);
        switch (args) {
            .GLenum_GLint_GLint_GLsizei_GLsizei_GLint_GLenum_GLenum_ArrayBufferView? => |a| return WebGLRenderingContextImpl.GLenum_GLint_GLint_GLsizei_GLsizei_GLint_GLenum_GLenum_ArrayBufferView?(state, a.target, a.level, a.internalformat, a.width, a.height, a.border, a.format, a.type_, a.pixels),
            .GLenum_GLint_GLint_GLenum_GLenum_TexImageSource => |a| return WebGLRenderingContextImpl.GLenum_GLint_GLint_GLenum_GLenum_TexImageSource(state, a.target, a.level, a.internalformat, a.format, a.type_, a.source),
        }
    }
    ...
    pub fn call_blendFunc(instance: *runtime.Instance, sfactor: anyopaque, dfactor: anyopaque) anyopaque {
        ...
        return WebGLRenderingContextImpl.call_blendFunc(state, sfactor, dfactor);
    }
    ...
    pub fn call_getFramebufferAttachmentParameter(instance: *runtime.Instance, target: anyopaque, attachment: anyopaque, pname: anyopaque) anyopaque {
        ...
        return WebGLRenderingContextImpl.call_getFramebufferAttachmentParameter(state, target, attachment, pname);
    }
    ...
    pub fn call_isEnabled(instance: *runtime.Instance, cap: anyopaque) anyopaque {
        ...
        return WebGLRenderingContextImpl.call_isEnabled(state, cap);
    }
    ...
    pub fn call_copyTexSubImage2D(instance: *runtime.Instance, target: anyopaque, level: anyopaque, xoffset: anyopaque, yoffset: anyopaque, x: anyopaque, y: anyopaque, width: anyopaque, height: anyopaque) anyopaque {
        ...
        return WebGLRenderingContextImpl.call_copyTexSubImage2D(state, target, level, xoffset, yoffset, x, y, width, height);
    }

    pub fn call_uniform3fv(instance: *runtime.Instance, location: anyopaque, v: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return WebGLRenderingContextImpl.call_uniform3fv(state, location, v);
    }

    /// Extended attributes: [WebGLHandlesContextLoss]
    pub fn call_getContextAttributes(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return WebGLRenderingContextImpl.call_getContextAttributes(state);
    }
    ...
    pub fn call_drawElements(instance: *runtime.Instance, mode: anyopaque, count: anyopaque, type_: anyopaque, offset: anyopaque) anyopaque {
        ...
        return WebGLRenderingContextImpl.call_drawElements(state, mode, count, type_, offset);
    }

    pub fn call_bindBuffer(instance: *runtime.Instance, target: anyopaque, buffer: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return WebGLRenderingContextImpl.call_bindBuffer(state, target, buffer);
    }
    ...
    pub fn call_isShader(instance: *runtime.Instance, shader: anyopaque) anyopaque {
        ...
        return WebGLRenderingContextImpl.call_isShader(state, shader);
    }

    pub fn call_getParameter(instance: *runtime.Instance, pname: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return WebGLRenderingContextImpl.call_getParameter(state, pname);
    }
    ...
    pub fn call_makeXRCompatible(instance: *runtime.Instance) anyopaque {
        ...
        return WebGLRenderingContextImpl.call_makeXRCompatible(state);
    }

    pub fn call_getSupportedExtensions(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return WebGLRenderingContextImpl.call_getSupportedExtensions(state);
    }
    ...
    pub fn call_compressedTexImage2D(instance: *runtime.Instance, target: anyopaque, level: anyopaque, internalformat: anyopaque, width: anyopaque, height: anyopaque, border: anyopaque, data: anyopaque) anyopaque {
        ...
        return WebGLRenderingContextImpl.call_compressedTexImage2D(state, target, level, internalformat, width, height, border, data);
    }

    pub fn call_clearStencil(instance: *runtime.Instance, s: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return WebGLRenderingContextImpl.call_clearStencil(state, s);
    }

    pub fn call_drawingBufferStorage(instance: *runtime.Instance, sizedFormat: anyopaque, width: u32, height: u32) anyopaque {
        const state = instance.getState(State);
        
        return WebGLRenderingContextImpl.call_drawingBufferStorage(state, sizedFormat, width, height);
    }

    pub fn call_enable(instance: *runtime.Instance, cap: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return WebGLRenderingContextImpl.call_enable(state, cap);
    }
    ...
    pub fn call_renderbufferStorage(instance: *runtime.Instance, target: anyopaque, internalformat: anyopaque, width: anyopaque, height: anyopaque) anyopaque {
        ...
        return WebGLRenderingContextImpl.call_renderbufferStorage(state, target, internalformat, width, height);
    }

    pub fn call_getVertexAttrib(instance: *runtime.Instance, index: anyopaque, pname: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return WebGLRenderingContextImpl.call_getVertexAttrib(state, index, pname);
    }

    pub fn call_clearDepth(instance: *runtime.Instance, depth: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return WebGLRenderingContextImpl.call_clearDepth(state, depth);
    }

    pub fn call_shaderSource(instance: *runtime.Instance, shader: anyopaque, source: runtime.DOMString) anyopaque {
        const state = instance.getState(State);
        
        return WebGLRenderingContextImpl.call_shaderSource(state, shader, source);
    }
    ...
    pub fn call_blendFuncSeparate(instance: *runtime.Instance, srcRGB: anyopaque, dstRGB: anyopaque, srcAlpha: anyopaque, dstAlpha: anyopaque) anyopaque {
        ...
        return WebGLRenderingContextImpl.call_blendFuncSeparate(state, srcRGB, dstRGB, srcAlpha, dstAlpha);
    }

    pub fn call_uniform3iv(instance: *runtime.Instance, location: anyopaque, v: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return WebGLRenderingContextImpl.call_uniform3iv(state, location, v);
    }
    ...
    pub fn call_texSubImage2D(instance: *runtime.Instance, args: TexSubImage2DArgs) anyopaque {
        const state = instance.getState(State);
        switch (args) {
            .GLenum_GLint_GLint_GLint_GLsizei_GLsizei_GLenum_GLenum_ArrayBufferView? => |a| return WebGLRenderingContextImpl.GLenum_GLint_GLint_GLint_GLsizei_GLsizei_GLenum_GLenum_ArrayBufferView?(state, a.target, a.level, a.xoffset, a.yoffset, a.width, a.height, a.format, a.type_, a.pixels),
            .GLenum_GLint_GLint_GLint_GLenum_GLenum_TexImageSource => |a| return WebGLRenderingContextImpl.GLenum_GLint_GLint_GLint_GLenum_GLenum_TexImageSource(state, a.target, a.level, a.xoffset, a.yoffset, a.format, a.type_, a.source),
        }
    }
    ...
    pub fn call_framebufferTexture2D(instance: *runtime.Instance, target: anyopaque, attachment: anyopaque, textarget: anyopaque, texture: anyopaque, level: anyopaque) anyopaque {
        ...
        return WebGLRenderingContextImpl.call_framebufferTexture2D(state, target, attachment, textarget, texture, level);
    }

    pub fn call_createProgram(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return WebGLRenderingContextImpl.call_createProgram(state);
    }

    pub fn call_uniform1fv(instance: *runtime.Instance, location: anyopaque, v: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return WebGLRenderingContextImpl.call_uniform1fv(state, location, v);
    }

    pub fn call_getProgramInfoLog(instance: *runtime.Instance, program: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return WebGLRenderingContextImpl.call_getProgramInfoLog(state, program);
    }

    pub fn call_createShader(instance: *runtime.Instance, type_: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return WebGLRenderingContextImpl.call_createShader(state, type_);
    }

    pub fn call_deleteProgram(instance: *runtime.Instance, program: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return WebGLRenderingContextImpl.call_deleteProgram(state, program);
    }

    pub fn call_useProgram(instance: *runtime.Instance, program: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return WebGLRenderingContextImpl.call_useProgram(state, program);
    }
    ...
    pub fn call_bufferData(instance: *runtime.Instance, args: BufferDataArgs) anyopaque {
        const state = instance.getState(State);
        switch (args) {
            .GLenum_GLsizeiptr_GLenum => |a| return WebGLRenderingContextImpl.GLenum_GLsizeiptr_GLenum(state, a.target, a.size, a.usage),
            .GLenum_AllowSharedBufferSource?_GLenum => |a| return WebGLRenderingContextImpl.GLenum_AllowSharedBufferSource?_GLenum(state, a.target, a.data, a.usage),
        }
    }
    ...
    pub fn call_getTexParameter(instance: *runtime.Instance, target: anyopaque, pname: anyopaque) anyopaque {
        ...
        return WebGLRenderingContextImpl.call_getTexParameter(state, target, pname);
    }

    pub fn call_blendColor(instance: *runtime.Instance, red: anyopaque, green: anyopaque, blue: anyopaque, alpha: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return WebGLRenderingContextImpl.call_blendColor(state, red, green, blue, alpha);
    }

    pub fn call_frontFace(instance: *runtime.Instance, mode: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return WebGLRenderingContextImpl.call_frontFace(state, mode);
    }
    ...
    pub fn call_stencilFuncSeparate(instance: *runtime.Instance, face: anyopaque, func: anyopaque, ref: anyopaque, mask: anyopaque) anyopaque {
        ...
        return WebGLRenderingContextImpl.call_stencilFuncSeparate(state, face, func, ref, mask);
    }
    ...
    pub fn call_isFramebuffer(instance: *runtime.Instance, framebuffer: anyopaque) anyopaque {
        ...
        return WebGLRenderingContextImpl.call_isFramebuffer(state, framebuffer);
    }

    pub fn call_finish(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return WebGLRenderingContextImpl.call_finish(state);
    }
    ...
    pub fn call_checkFramebufferStatus(instance: *runtime.Instance, target: anyopaque) anyopaque {
        ...
        return WebGLRenderingContextImpl.call_checkFramebufferStatus(state, target);
    }

    pub fn call_getRenderbufferParameter(instance: *runtime.Instance, target: anyopaque, pname: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return WebGLRenderingContextImpl.call_getRenderbufferParameter(state, target, pname);
    }
    ...
    pub fn call_isTexture(instance: *runtime.Instance, texture: anyopaque) anyopaque {
        ...
        return WebGLRenderingContextImpl.call_isTexture(state, texture);
    }

    pub fn call_linkProgram(instance: *runtime.Instance, program: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return WebGLRenderingContextImpl.call_linkProgram(state, program);
    }

    pub fn call_pixelStorei(instance: *runtime.Instance, pname: anyopaque, param: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return WebGLRenderingContextImpl.call_pixelStorei(state, pname, param);
    }
    ...
    pub fn call_compressedTexSubImage2D(instance: *runtime.Instance, target: anyopaque, level: anyopaque, xoffset: anyopaque, yoffset: anyopaque, width: anyopaque, height: anyopaque, format: anyopaque, data: anyopaque) anyopaque {
        ...
        return WebGLRenderingContextImpl.call_compressedTexSubImage2D(state, target, level, xoffset, yoffset, width, height, format, data);
    }

    pub fn call_bindRenderbuffer(instance: *runtime.Instance, target: anyopaque, renderbuffer: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return WebGLRenderingContextImpl.call_bindRenderbuffer(state, target, renderbuffer);
    }

    pub fn call_depthFunc(instance: *runtime.Instance, func: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return WebGLRenderingContextImpl.call_depthFunc(state, func);
    }
    ...
    pub fn call_getVertexAttribOffset(instance: *runtime.Instance, index: anyopaque, pname: anyopaque) anyopaque {
        ...
        return WebGLRenderingContextImpl.call_getVertexAttribOffset(state, index, pname);
    }

    pub fn call_getShaderParameter(instance: *runtime.Instance, shader: anyopaque, pname: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return WebGLRenderingContextImpl.call_getShaderParameter(state, shader, pname);
    }
    ...
    pub fn call_uniform4i(instance: *runtime.Instance, location: anyopaque, x: anyopaque, y: anyopaque, z: anyopaque, w: anyopaque) anyopaque {
        ...
        return WebGLRenderingContextImpl.call_uniform4i(state, location, x, y, z, w);
    }
