...
const OrientationSensorImpl = @import("../impls/OrientationSensor.zig");
...
pub const OrientationSensor = struct {
    ...
    pub const State = runtime.FlattenedState(
        struct {
            quaternion: ?FrozenArray<double> = null,
        },
        Meta.BaseType,
        Meta.MixinTypes,
    );

    pub const vtable = runtime.buildVTable(OrientationSensor, .{
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        OrientationSensorImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        OrientationSensorImpl.deinit(state);
    }
    ...
    pub fn get_activated(instance: *runtime.Instance) bool {
        const state = instance.getState(State);
        return OrientationSensorImpl.get_activated(state);
    }

    pub fn get_hasReading(instance: *runtime.Instance) bool {
        const state = instance.getState(State);
        return OrientationSensorImpl.get_hasReading(state);
    }

    pub fn get_timestamp(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return OrientationSensorImpl.get_timestamp(state);
    }

    pub fn get_onreading(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return OrientationSensorImpl.get_onreading(state);
    }

    pub fn set_onreading(instance: *runtime.Instance, value: anyopaque) void {
        const state = instance.getState(State);
        OrientationSensorImpl.set_onreading(state, value);
    }

    pub fn get_onactivate(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return OrientationSensorImpl.get_onactivate(state);
    }

    pub fn set_onactivate(instance: *runtime.Instance, value: anyopaque) void {
        const state = instance.getState(State);
        OrientationSensorImpl.set_onactivate(state, value);
    }

    pub fn get_onerror(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return OrientationSensorImpl.get_onerror(state);
    }

    pub fn set_onerror(instance: *runtime.Instance, value: anyopaque) void {
        const state = instance.getState(State);
        OrientationSensorImpl.set_onerror(state, value);
    }

    pub fn get_quaternion(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return OrientationSensorImpl.get_quaternion(state);
    }

    pub fn call_populateMatrix(instance: *runtime.Instance, targetMatrix: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return OrientationSensorImpl.call_populateMatrix(state, targetMatrix);
    }

    pub fn call_stop(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return OrientationSensorImpl.call_stop(state);
    }

    pub fn call_when(instance: *runtime.Instance, type_: runtime.DOMString, options: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return OrientationSensorImpl.call_when(state, type_, options);
    }

    pub fn call_dispatchEvent(instance: *runtime.Instance, event: anyopaque) bool {
        const state = instance.getState(State);
        
        return OrientationSensorImpl.call_dispatchEvent(state, event);
    }

    pub fn call_start(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return OrientationSensorImpl.call_start(state);
    }

    pub fn call_addEventListener(instance: *runtime.Instance, type_: runtime.DOMString, callback: anyopaque, options: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return OrientationSensorImpl.call_addEventListener(state, type_, callback, options);
    }

    pub fn call_removeEventListener(instance: *runtime.Instance, type_: runtime.DOMString, callback: anyopaque, options: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return OrientationSensorImpl.call_removeEventListener(state, type_, callback, options);
    }
