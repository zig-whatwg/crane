...
const SVGTestsImpl = @import("../impls/SVGTests.zig");
...
pub const SVGTests = struct {
    ...
    pub fn get_requiredExtensions(instance: *runtime.Instance) anyopaque {
        ...
        const value = SVGTestsImpl.get_requiredExtensions(state);
    ...
    pub fn get_systemLanguage(instance: *runtime.Instance) anyopaque {
        ...
        const value = SVGTestsImpl.get_systemLanguage(state);
