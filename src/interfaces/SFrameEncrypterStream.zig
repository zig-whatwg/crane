...
const SFrameEncrypterStreamImpl = @import("../impls/SFrameEncrypterStream.zig");
...
pub const SFrameEncrypterStream = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        SFrameEncrypterStreamImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        SFrameEncrypterStreamImpl.deinit(state);
    }
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, options: anyopaque) !*runtime.Instance {
        ...
        const state = instance.getState(State);
        try SFrameEncrypterStreamImpl.constructor(state, options);
    ...
    pub fn get_readable(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return SFrameEncrypterStreamImpl.get_readable(state);
    }

    pub fn get_writable(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return SFrameEncrypterStreamImpl.get_writable(state);
    }

    pub fn get_onerror(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return SFrameEncrypterStreamImpl.get_onerror(state);
    }

    pub fn set_onerror(instance: *runtime.Instance, value: anyopaque) void {
        const state = instance.getState(State);
        SFrameEncrypterStreamImpl.set_onerror(state, value);
    }

    pub fn call_dispatchEvent(instance: *runtime.Instance, event: anyopaque) bool {
        const state = instance.getState(State);
        
        return SFrameEncrypterStreamImpl.call_dispatchEvent(state, event);
    }

    pub fn call_setEncryptionKey(instance: *runtime.Instance, key: anyopaque, keyID: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return SFrameEncrypterStreamImpl.call_setEncryptionKey(state, key, keyID);
    }

    pub fn call_when(instance: *runtime.Instance, type_: runtime.DOMString, options: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return SFrameEncrypterStreamImpl.call_when(state, type_, options);
    }

    pub fn call_addEventListener(instance: *runtime.Instance, type_: runtime.DOMString, callback: anyopaque, options: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return SFrameEncrypterStreamImpl.call_addEventListener(state, type_, callback, options);
    }

    pub fn call_removeEventListener(instance: *runtime.Instance, type_: runtime.DOMString, callback: anyopaque, options: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return SFrameEncrypterStreamImpl.call_removeEventListener(state, type_, callback, options);
    }
