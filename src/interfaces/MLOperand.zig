...
const MLOperandImpl = @import("../impls/MLOperand.zig");
...
pub const MLOperand = struct {
    ...
    pub fn get_dataType(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return MLOperandImpl.get_dataType(state);
    }

    pub fn get_shape(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return MLOperandImpl.get_shape(state);
    }
