...
const XPathEvaluatorImpl = @import("../impls/XPathEvaluator.zig");
...
pub const XPathEvaluator = struct {
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        XPathEvaluatorImpl.deinit(state);
    }
    ...
    pub fn call_constructor(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        const state = instance.getState(State);
        try XPathEvaluatorImpl.constructor(state);
    ...
    pub fn call_createNSResolver(instance: *runtime.Instance, nodeResolver: anyopaque) anyopaque {
        ...
        return XPathEvaluatorImpl.call_createNSResolver(state, nodeResolver);
    }
    ...
    pub fn call_evaluate(instance: *runtime.Instance, expression: runtime.DOMString, contextNode: anyopaque, resolver: anyopaque, type_: u16, result: anyopaque) anyopaque {
        ...
        return XPathEvaluatorImpl.call_evaluate(state, expression, contextNode, resolver, type_, result);
    }
    ...
    pub fn call_createExpression(instance: *runtime.Instance, expression: runtime.DOMString, resolver: anyopaque) anyopaque {
        ...
        return XPathEvaluatorImpl.call_createExpression(state, expression, resolver);
    }
