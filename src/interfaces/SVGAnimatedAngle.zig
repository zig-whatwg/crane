...
const SVGAnimatedAngleImpl = @import("../impls/SVGAnimatedAngle.zig");
...
pub const SVGAnimatedAngle = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        SVGAnimatedAngleImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        SVGAnimatedAngleImpl.deinit(state);
    }
    ...
    pub fn get_baseVal(instance: *runtime.Instance) anyopaque {
        ...
        const value = SVGAnimatedAngleImpl.get_baseVal(state);
    ...
    pub fn get_animVal(instance: *runtime.Instance) anyopaque {
        ...
        const value = SVGAnimatedAngleImpl.get_animVal(state);
