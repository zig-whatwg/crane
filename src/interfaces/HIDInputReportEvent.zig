...
const HIDInputReportEventImpl = @import("../impls/HIDInputReportEvent.zig");
...
pub const HIDInputReportEvent = struct {
    ...
    pub const vtable = runtime.buildVTable(HIDInputReportEvent, .{
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        HIDInputReportEventImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        HIDInputReportEventImpl.deinit(state);
    }
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, type_: runtime.DOMString, eventInitDict: anyopaque) !*runtime.Instance {
        ...
        const state = instance.getState(State);
        try HIDInputReportEventImpl.constructor(state, type_, eventInitDict);
    ...
    pub fn get_device(instance: *runtime.Instance) anyopaque {
        ...
        const value = HIDInputReportEventImpl.get_device(state);
        state.cached_device = value;
        return value;
    }

    pub fn get_reportId(instance: *runtime.Instance) u8 {
        const state = instance.getState(State);
        return HIDInputReportEventImpl.get_reportId(state);
    }

    pub fn get_data(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return HIDInputReportEventImpl.get_data(state);
    }

    pub fn call_stopImmediatePropagation(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return HIDInputReportEventImpl.call_stopImmediatePropagation(state);
    }

    pub fn call_initEvent(instance: *runtime.Instance, type_: runtime.DOMString, bubbles: bool, cancelable: bool) anyopaque {
        const state = instance.getState(State);
        
        return HIDInputReportEventImpl.call_initEvent(state, type_, bubbles, cancelable);
    }

    pub fn call_composedPath(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return HIDInputReportEventImpl.call_composedPath(state);
    }

    pub fn call_stopPropagation(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return HIDInputReportEventImpl.call_stopPropagation(state);
    }

    pub fn call_preventDefault(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return HIDInputReportEventImpl.call_preventDefault(state);
    }
