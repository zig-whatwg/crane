...
const GPUObjectBaseImpl = @import("../impls/GPUObjectBase.zig");
...
pub const GPUObjectBase = struct {
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        GPUObjectBaseImpl.deinit(state);
    }
    ...
    pub fn get_label(instance: *runtime.Instance) runtime.USVString {
        const state = instance.getState(State);
        return GPUObjectBaseImpl.get_label(state);
    }

    pub fn set_label(instance: *runtime.Instance, value: runtime.USVString) void {
        const state = instance.getState(State);
        GPUObjectBaseImpl.set_label(state, value);
    }
