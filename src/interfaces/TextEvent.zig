...
const TextEventImpl = @import("../impls/TextEvent.zig");
...
pub const TextEvent = struct {
    ...
    pub fn call_initUIEvent(instance: *runtime.Instance, typeArg: runtime.DOMString, bubblesArg: bool, cancelableArg: bool, viewArg: anyopaque, detailArg: i32) anyopaque {
        ...
        return TextEventImpl.call_initUIEvent(state, typeArg, bubblesArg, cancelableArg, viewArg, detailArg);
    }

    pub fn call_composedPath(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return TextEventImpl.call_composedPath(state);
    }

    pub fn call_stopPropagation(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return TextEventImpl.call_stopPropagation(state);
    }

    pub fn call_initTextEvent(instance: *runtime.Instance, type_: runtime.DOMString, bubbles: bool, cancelable: bool, view: anyopaque, data: runtime.DOMString) anyopaque {
        const state = instance.getState(State);
        
        return TextEventImpl.call_initTextEvent(state, type_, bubbles, cancelable, view, data);
    }

    pub fn call_preventDefault(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return TextEventImpl.call_preventDefault(state);
    }
