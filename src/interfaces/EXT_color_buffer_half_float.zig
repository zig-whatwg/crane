...
const EXT_color_buffer_half_floatImpl = @import("../impls/EXT_color_buffer_half_float.zig");
...
pub const EXT_color_buffer_half_float = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        EXT_color_buffer_half_floatImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        EXT_color_buffer_half_floatImpl.deinit(state);
    }
