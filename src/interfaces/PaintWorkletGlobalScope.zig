...
const PaintWorkletGlobalScopeImpl = @import("../impls/PaintWorkletGlobalScope.zig");
...
pub const PaintWorkletGlobalScope = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        PaintWorkletGlobalScopeImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        PaintWorkletGlobalScopeImpl.deinit(state);
    }
    ...
    pub fn get_devicePixelRatio(instance: *runtime.Instance) f64 {
        const state = instance.getState(State);
        return PaintWorkletGlobalScopeImpl.get_devicePixelRatio(state);
    }

    pub fn call_registerPaint(instance: *runtime.Instance, name: runtime.DOMString, paintCtor: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return PaintWorkletGlobalScopeImpl.call_registerPaint(state, name, paintCtor);
    }
