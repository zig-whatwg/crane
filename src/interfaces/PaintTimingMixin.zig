...
const PaintTimingMixinImpl = @import("../impls/PaintTimingMixin.zig");
...
pub const PaintTimingMixin = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        PaintTimingMixinImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        PaintTimingMixinImpl.deinit(state);
    }
    ...
    pub fn get_paintTime(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return PaintTimingMixinImpl.get_paintTime(state);
    }

    pub fn get_presentationTime(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return PaintTimingMixinImpl.get_presentationTime(state);
    }
