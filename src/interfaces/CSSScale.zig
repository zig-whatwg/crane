...
const CSSScaleImpl = @import("../impls/CSSScale.zig");
...
pub const CSSScale = struct {
    ...
    pub const vtable = runtime.buildVTable(CSSScale, .{
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, x: anyopaque, y: anyopaque, z: anyopaque) !*runtime.Instance {
        ...
        const state = instance.getState(State);
        try CSSScaleImpl.constructor(state, x, y, z);
