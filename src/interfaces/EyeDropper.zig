...
const EyeDropperImpl = @import("../impls/EyeDropper.zig");
...
pub const EyeDropper = struct {
    ...
    pub fn call_constructor(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        const state = instance.getState(State);
        try EyeDropperImpl.constructor(state);
    ...
    pub fn call_open(instance: *runtime.Instance, options: anyopaque) anyopaque {
        ...
        return EyeDropperImpl.call_open(state, options);
    }
