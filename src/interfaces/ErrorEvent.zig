...
const ErrorEventImpl = @import("../impls/ErrorEvent.zig");
...
pub const ErrorEvent = struct {
    ...
    pub const State = runtime.FlattenedState(
        struct {
            ...
            colno: u32 = undefined,
            error: anyopaque = undefined,
        },
        Meta.BaseType,
        Meta.MixinTypes,
    );

    pub const vtable = runtime.buildVTable(ErrorEvent, .{
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, type_: runtime.DOMString, eventInitDict: anyopaque) !*runtime.Instance {
        ...
        const state = instance.getState(State);
        try ErrorEventImpl.constructor(state, type_, eventInitDict);
