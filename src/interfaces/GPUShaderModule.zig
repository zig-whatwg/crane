...
const GPUShaderModuleImpl = @import("../impls/GPUShaderModule.zig");
...
pub const GPUShaderModule = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        GPUShaderModuleImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        GPUShaderModuleImpl.deinit(state);
    }
    ...
    pub fn get_label(instance: *runtime.Instance) runtime.USVString {
        const state = instance.getState(State);
        return GPUShaderModuleImpl.get_label(state);
    }

    pub fn set_label(instance: *runtime.Instance, value: runtime.USVString) void {
        const state = instance.getState(State);
        GPUShaderModuleImpl.set_label(state, value);
    }

    pub fn call_getCompilationInfo(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return GPUShaderModuleImpl.call_getCompilationInfo(state);
    }
