...
const WebTransportBidirectionalStreamImpl = @import("../impls/WebTransportBidirectionalStream.zig");
...
pub const WebTransportBidirectionalStream = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        WebTransportBidirectionalStreamImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        WebTransportBidirectionalStreamImpl.deinit(state);
    }
    ...
    pub fn get_readable(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return WebTransportBidirectionalStreamImpl.get_readable(state);
    }

    pub fn get_writable(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return WebTransportBidirectionalStreamImpl.get_writable(state);
    }
