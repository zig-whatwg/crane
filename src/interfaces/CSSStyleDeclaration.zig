...
const CSSStyleDeclarationImpl = @import("../impls/CSSStyleDeclaration.zig");
...
pub const CSSStyleDeclaration = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        CSSStyleDeclarationImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        CSSStyleDeclarationImpl.deinit(state);
    }
    ...
    pub fn get_cssText(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSStyleDeclarationImpl.get_cssText(state);
    }
    ...
    pub fn set_cssText(instance: *runtime.Instance, value: anyopaque) void {
        ...
        CSSStyleDeclarationImpl.set_cssText(state, value);
    }

    pub fn get_length(instance: *runtime.Instance) u32 {
        const state = instance.getState(State);
        return CSSStyleDeclarationImpl.get_length(state);
    }

    pub fn get_parentRule(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSStyleDeclarationImpl.get_parentRule(state);
    }
    ...
    pub fn call_item(instance: *runtime.Instance, args: ItemArgs) anyopaque {
        const state = instance.getState(State);
        switch (args) {
            .long => |arg| return CSSStyleDeclarationImpl.long(state, arg),
            .long => |arg| return CSSStyleDeclarationImpl.long(state, arg),
        }
    }
    ...
    pub fn call_removeProperty(instance: *runtime.Instance, args: RemovePropertyArgs) anyopaque {
        const state = instance.getState(State);
        switch (args) {
            .CSSOMString => |arg| return CSSStyleDeclarationImpl.CSSOMString(state, arg),
            .string => |arg| return CSSStyleDeclarationImpl.string(state, arg),
        }
    }
    ...
    pub fn call_setProperty(instance: *runtime.Instance, args: SetPropertyArgs) anyopaque {
        const state = instance.getState(State);
        switch (args) {
            .CSSOMString_CSSOMString_CSSOMString => |a| return CSSStyleDeclarationImpl.CSSOMString_CSSOMString_CSSOMString(state, a.property, a.value, a.priority),
            .string_string_string => |a| return CSSStyleDeclarationImpl.string_string_string(state, a.propertyName, a.value, a.priority),
        }
    }
    ...
    pub fn call_getPropertyCSSValue(instance: *runtime.Instance, propertyName: runtime.DOMString) anyopaque {
        ...
        return CSSStyleDeclarationImpl.call_getPropertyCSSValue(state, propertyName);
    }
