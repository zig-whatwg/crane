...
const PopStateEventImpl = @import("../impls/PopStateEvent.zig");
...
pub const PopStateEvent = struct {
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        PopStateEventImpl.deinit(state);
    }
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, type_: runtime.DOMString, eventInitDict: anyopaque) !*runtime.Instance {
        ...
        const state = instance.getState(State);
        try PopStateEventImpl.constructor(state, type_, eventInitDict);
