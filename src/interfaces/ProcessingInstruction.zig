...
const ProcessingInstructionImpl = @import("../impls/ProcessingInstruction.zig");
...
pub const ProcessingInstruction = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        ProcessingInstructionImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        ProcessingInstructionImpl.deinit(state);
    }
    ...
    pub fn get_nodeType(instance: *runtime.Instance) u16 {
        const state = instance.getState(State);
        return ProcessingInstructionImpl.get_nodeType(state);
    }

    pub fn get_nodeName(instance: *runtime.Instance) runtime.DOMString {
        const state = instance.getState(State);
        return ProcessingInstructionImpl.get_nodeName(state);
    }

    pub fn get_baseURI(instance: *runtime.Instance) runtime.USVString {
        const state = instance.getState(State);
        return ProcessingInstructionImpl.get_baseURI(state);
    }

    pub fn get_isConnected(instance: *runtime.Instance) bool {
        const state = instance.getState(State);
        return ProcessingInstructionImpl.get_isConnected(state);
    }

    pub fn get_ownerDocument(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return ProcessingInstructionImpl.get_ownerDocument(state);
    }

    pub fn get_parentNode(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return ProcessingInstructionImpl.get_parentNode(state);
    }

    pub fn get_parentElement(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return ProcessingInstructionImpl.get_parentElement(state);
    }
    ...
    pub fn get_childNodes(instance: *runtime.Instance) anyopaque {
        ...
        const value = ProcessingInstructionImpl.get_childNodes(state);
    ...
    pub fn get_firstChild(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return ProcessingInstructionImpl.get_firstChild(state);
    }

    pub fn get_lastChild(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return ProcessingInstructionImpl.get_lastChild(state);
    }

    pub fn get_previousSibling(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return ProcessingInstructionImpl.get_previousSibling(state);
    }

    pub fn get_nextSibling(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return ProcessingInstructionImpl.get_nextSibling(state);
    }

    /// Extended attributes: [CEReactions]
    pub fn get_nodeValue(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return ProcessingInstructionImpl.get_nodeValue(state);
    }
    ...
    pub fn set_nodeValue(instance: *runtime.Instance, value: anyopaque) void {
        ...
        ProcessingInstructionImpl.set_nodeValue(state, value);
    }

    /// Extended attributes: [CEReactions]
    pub fn get_textContent(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return ProcessingInstructionImpl.get_textContent(state);
    }
    ...
    pub fn call_isDefaultNamespace(instance: *runtime.Instance, namespace: anyopaque) bool {
        ...
        return ProcessingInstructionImpl.call_isDefaultNamespace(state, namespace);
    }

    pub fn call_compareDocumentPosition(instance: *runtime.Instance, other: anyopaque) u16 {
        const state = instance.getState(State);
        
        return ProcessingInstructionImpl.call_compareDocumentPosition(state, other);
    }

    pub fn call_contains(instance: *runtime.Instance, other: anyopaque) bool {
        const state = instance.getState(State);
        
        return ProcessingInstructionImpl.call_contains(state, other);
    }
    ...
    pub fn call_remove(instance: *runtime.Instance) anyopaque {
        ...
        return ProcessingInstructionImpl.call_remove(state);
    }

    pub fn call_replaceData(instance: *runtime.Instance, offset: u32, count: u32, data: runtime.DOMString) anyopaque {
        const state = instance.getState(State);
        
        return ProcessingInstructionImpl.call_replaceData(state, offset, count, data);
    }

    pub fn call_removeEventListener(instance: *runtime.Instance, type_: runtime.DOMString, callback: anyopaque, options: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return ProcessingInstructionImpl.call_removeEventListener(state, type_, callback, options);
    }
    ...
    pub fn call_cloneNode(instance: *runtime.Instance, subtree: bool) anyopaque {
        ...
        return ProcessingInstructionImpl.call_cloneNode(state, subtree);
    }

    pub fn call_getRootNode(instance: *runtime.Instance, options: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return ProcessingInstructionImpl.call_getRootNode(state, options);
    }

    pub fn call_substringData(instance: *runtime.Instance, offset: u32, count: u32) runtime.DOMString {
        const state = instance.getState(State);
        
        return ProcessingInstructionImpl.call_substringData(state, offset, count);
    }

    pub fn call_dispatchEvent(instance: *runtime.Instance, event: anyopaque) bool {
        const state = instance.getState(State);
        
        return ProcessingInstructionImpl.call_dispatchEvent(state, event);
    }
    ...
    pub fn call_replaceWith(instance: *runtime.Instance, nodes: anyopaque) anyopaque {
        ...
        return ProcessingInstructionImpl.call_replaceWith(state, nodes);
    }

    pub fn call_isSameNode(instance: *runtime.Instance, otherNode: anyopaque) bool {
        const state = instance.getState(State);
        
        return ProcessingInstructionImpl.call_isSameNode(state, otherNode);
    }

    pub fn call_lookupPrefix(instance: *runtime.Instance, namespace: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return ProcessingInstructionImpl.call_lookupPrefix(state, namespace);
    }

    pub fn call_when(instance: *runtime.Instance, type_: runtime.DOMString, options: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return ProcessingInstructionImpl.call_when(state, type_, options);
    }
    ...
    pub fn call_insertBefore(instance: *runtime.Instance, node: anyopaque, child: anyopaque) anyopaque {
        ...
        return ProcessingInstructionImpl.call_insertBefore(state, node, child);
    }
    ...
    pub fn call_before(instance: *runtime.Instance, nodes: anyopaque) anyopaque {
        ...
        return ProcessingInstructionImpl.call_before(state, nodes);
    }
    ...
    pub fn call_after(instance: *runtime.Instance, nodes: anyopaque) anyopaque {
        ...
        return ProcessingInstructionImpl.call_after(state, nodes);
    }

    pub fn call_appendData(instance: *runtime.Instance, data: runtime.DOMString) anyopaque {
        const state = instance.getState(State);
        
        return ProcessingInstructionImpl.call_appendData(state, data);
    }

    pub fn call_lookupNamespaceURI(instance: *runtime.Instance, prefix: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return ProcessingInstructionImpl.call_lookupNamespaceURI(state, prefix);
    }

    pub fn call_addEventListener(instance: *runtime.Instance, type_: runtime.DOMString, callback: anyopaque, options: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return ProcessingInstructionImpl.call_addEventListener(state, type_, callback, options);
    }
    ...
    pub fn call_appendChild(instance: *runtime.Instance, node: anyopaque) anyopaque {
        ...
        return ProcessingInstructionImpl.call_appendChild(state, node);
    }

    pub fn call_hasChildNodes(instance: *runtime.Instance) bool {
        const state = instance.getState(State);
        return ProcessingInstructionImpl.call_hasChildNodes(state);
    }

    pub fn call_insertData(instance: *runtime.Instance, offset: u32, data: runtime.DOMString) anyopaque {
        const state = instance.getState(State);
        
        return ProcessingInstructionImpl.call_insertData(state, offset, data);
    }
    ...
    pub fn call_removeChild(instance: *runtime.Instance, child: anyopaque) anyopaque {
        ...
        return ProcessingInstructionImpl.call_removeChild(state, child);
    }
    ...
    pub fn call_normalize(instance: *runtime.Instance) anyopaque {
        ...
        return ProcessingInstructionImpl.call_normalize(state);
    }

    pub fn call_isEqualNode(instance: *runtime.Instance, otherNode: anyopaque) bool {
        const state = instance.getState(State);
        
        return ProcessingInstructionImpl.call_isEqualNode(state, otherNode);
    }
    ...
    pub fn call_replaceChild(instance: *runtime.Instance, node: anyopaque, child: anyopaque) anyopaque {
        ...
        return ProcessingInstructionImpl.call_replaceChild(state, node, child);
    }

    pub fn call_deleteData(instance: *runtime.Instance, offset: u32, count: u32) anyopaque {
        const state = instance.getState(State);
        
        return ProcessingInstructionImpl.call_deleteData(state, offset, count);
    }
