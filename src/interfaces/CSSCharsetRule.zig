...
const CSSCharsetRuleImpl = @import("../impls/CSSCharsetRule.zig");
...
pub const CSSCharsetRule = struct {
    ...
    pub const vtable = runtime.buildVTable(CSSCharsetRule, .{
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        CSSCharsetRuleImpl.deinit(state);
    }
    ...
    pub fn get_encoding(instance: *runtime.Instance) runtime.DOMString {
        const state = instance.getState(State);
        return CSSCharsetRuleImpl.get_encoding(state);
    }

    pub fn set_encoding(instance: *runtime.Instance, value: runtime.DOMString) void {
        const state = instance.getState(State);
        CSSCharsetRuleImpl.set_encoding(state, value);
    }
