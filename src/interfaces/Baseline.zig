...
const BaselineImpl = @import("../impls/Baseline.zig");
...
pub const Baseline = struct {
    ...
    pub fn get_name(instance: *runtime.Instance) runtime.DOMString {
        const state = instance.getState(State);
        return BaselineImpl.get_name(state);
    }

    pub fn get_value(instance: *runtime.Instance) f64 {
        const state = instance.getState(State);
        return BaselineImpl.get_value(state);
    }
