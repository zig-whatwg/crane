...
const CSSNestedDeclarationsImpl = @import("../impls/CSSNestedDeclarations.zig");
...
pub const CSSNestedDeclarations = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        CSSNestedDeclarationsImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        CSSNestedDeclarationsImpl.deinit(state);
    }
    ...
    pub fn get_cssText(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSNestedDeclarationsImpl.get_cssText(state);
    }

    pub fn set_cssText(instance: *runtime.Instance, value: anyopaque) void {
        const state = instance.getState(State);
        CSSNestedDeclarationsImpl.set_cssText(state, value);
    }

    pub fn get_parentRule(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSNestedDeclarationsImpl.get_parentRule(state);
    }

    pub fn get_parentStyleSheet(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSNestedDeclarationsImpl.get_parentStyleSheet(state);
    }

    pub fn get_type(instance: *runtime.Instance) u16 {
        const state = instance.getState(State);
        return CSSNestedDeclarationsImpl.get_type(state);
    }
    ...
    pub fn get_style(instance: *runtime.Instance) anyopaque {
        ...
        const value = CSSNestedDeclarationsImpl.get_style(state);
