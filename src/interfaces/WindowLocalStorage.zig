...
const WindowLocalStorageImpl = @import("../impls/WindowLocalStorage.zig");
...
pub const WindowLocalStorage = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        WindowLocalStorageImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        WindowLocalStorageImpl.deinit(state);
    }
    ...
    pub fn get_localStorage(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return WindowLocalStorageImpl.get_localStorage(state);
    }
