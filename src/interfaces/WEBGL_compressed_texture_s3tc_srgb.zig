...
const WEBGL_compressed_texture_s3tc_srgbImpl = @import("../impls/WEBGL_compressed_texture_s3tc_srgb.zig");
...
pub const WEBGL_compressed_texture_s3tc_srgb = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        WEBGL_compressed_texture_s3tc_srgbImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        WEBGL_compressed_texture_s3tc_srgbImpl.deinit(state);
    }
