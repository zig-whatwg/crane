...
const SVGAnimatedTransformListImpl = @import("../impls/SVGAnimatedTransformList.zig");
...
pub const SVGAnimatedTransformList = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        SVGAnimatedTransformListImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        SVGAnimatedTransformListImpl.deinit(state);
    }
    ...
    pub fn get_baseVal(instance: *runtime.Instance) anyopaque {
        ...
        const value = SVGAnimatedTransformListImpl.get_baseVal(state);
    ...
    pub fn get_animVal(instance: *runtime.Instance) anyopaque {
        ...
        const value = SVGAnimatedTransformListImpl.get_animVal(state);
