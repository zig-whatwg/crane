...
const PageRevealEventImpl = @import("../impls/PageRevealEvent.zig");
...
pub const PageRevealEvent = struct {
    ...
    pub const vtable = runtime.buildVTable(PageRevealEvent, .{
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        PageRevealEventImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        PageRevealEventImpl.deinit(state);
    }
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, type_: runtime.DOMString, eventInitDict: anyopaque) !*runtime.Instance {
        ...
        const state = instance.getState(State);
        try PageRevealEventImpl.constructor(state, type_, eventInitDict);
