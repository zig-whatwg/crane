...
const MIDIMessageEventImpl = @import("../impls/MIDIMessageEvent.zig");
...
pub const MIDIMessageEvent = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        MIDIMessageEventImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        MIDIMessageEventImpl.deinit(state);
    }
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, type_: runtime.DOMString, eventInitDict: anyopaque) !*runtime.Instance {
        ...
        const state = instance.getState(State);
        try MIDIMessageEventImpl.constructor(state, type_, eventInitDict);
