...
const TextDecoderStreamImpl = @import("../impls/TextDecoderStream.zig");
...
pub const TextDecoderStream = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        TextDecoderStreamImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        TextDecoderStreamImpl.deinit(state);
    }
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, label: runtime.DOMString, options: anyopaque) !*runtime.Instance {
        ...
        const state = instance.getState(State);
        try TextDecoderStreamImpl.constructor(state, label, options);
    ...
    pub fn get_encoding(instance: *runtime.Instance) runtime.DOMString {
        const state = instance.getState(State);
        return TextDecoderStreamImpl.get_encoding(state);
    }

    pub fn get_fatal(instance: *runtime.Instance) bool {
        const state = instance.getState(State);
        return TextDecoderStreamImpl.get_fatal(state);
    }

    pub fn get_ignoreBOM(instance: *runtime.Instance) bool {
        const state = instance.getState(State);
        return TextDecoderStreamImpl.get_ignoreBOM(state);
    }

    pub fn get_readable(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return TextDecoderStreamImpl.get_readable(state);
    }

    pub fn get_writable(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return TextDecoderStreamImpl.get_writable(state);
    }
