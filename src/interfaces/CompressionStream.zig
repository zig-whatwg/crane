...
const CompressionStreamImpl = @import("../impls/CompressionStream.zig");
...
pub const CompressionStream = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        CompressionStreamImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        CompressionStreamImpl.deinit(state);
    }
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, format: anyopaque) !*runtime.Instance {
        ...
        const state = instance.getState(State);
        try CompressionStreamImpl.constructor(state, format);
    ...
    pub fn get_readable(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CompressionStreamImpl.get_readable(state);
    }

    pub fn get_writable(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CompressionStreamImpl.get_writable(state);
    }
