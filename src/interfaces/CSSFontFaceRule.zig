...
const CSSFontFaceRuleImpl = @import("../impls/CSSFontFaceRule.zig");
...
pub const CSSFontFaceRule = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        CSSFontFaceRuleImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        CSSFontFaceRuleImpl.deinit(state);
    }
    ...
    pub fn get_style(instance: *runtime.Instance) anyopaque {
        ...
        const value = CSSFontFaceRuleImpl.get_style(state);
    ...
    pub fn get_style(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSFontFaceRuleImpl.get_style(state);
    }
