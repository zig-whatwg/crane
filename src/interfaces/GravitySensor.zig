...
const GravitySensorImpl = @import("../impls/GravitySensor.zig");
...
pub const GravitySensor = struct {
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        GravitySensorImpl.deinit(state);
    }
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, options: anyopaque) !*runtime.Instance {
        ...
        const state = instance.getState(State);
        try GravitySensorImpl.constructor(state, options);
    ...
    pub fn get_activated(instance: *runtime.Instance) bool {
        const state = instance.getState(State);
        return GravitySensorImpl.get_activated(state);
    }

    pub fn get_hasReading(instance: *runtime.Instance) bool {
        const state = instance.getState(State);
        return GravitySensorImpl.get_hasReading(state);
    }

    pub fn get_timestamp(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return GravitySensorImpl.get_timestamp(state);
    }

    pub fn get_onreading(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return GravitySensorImpl.get_onreading(state);
    }

    pub fn set_onreading(instance: *runtime.Instance, value: anyopaque) void {
        const state = instance.getState(State);
        GravitySensorImpl.set_onreading(state, value);
    }

    pub fn get_onactivate(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return GravitySensorImpl.get_onactivate(state);
    }

    pub fn set_onactivate(instance: *runtime.Instance, value: anyopaque) void {
        const state = instance.getState(State);
        GravitySensorImpl.set_onactivate(state, value);
    }

    pub fn get_onerror(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return GravitySensorImpl.get_onerror(state);
    }

    pub fn set_onerror(instance: *runtime.Instance, value: anyopaque) void {
        const state = instance.getState(State);
        GravitySensorImpl.set_onerror(state, value);
    }

    pub fn get_x(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return GravitySensorImpl.get_x(state);
    }

    pub fn get_y(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return GravitySensorImpl.get_y(state);
    }

    pub fn get_z(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return GravitySensorImpl.get_z(state);
    }

    pub fn call_dispatchEvent(instance: *runtime.Instance, event: anyopaque) bool {
        const state = instance.getState(State);
        
        return GravitySensorImpl.call_dispatchEvent(state, event);
    }

    pub fn call_stop(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return GravitySensorImpl.call_stop(state);
    }

    pub fn call_when(instance: *runtime.Instance, type_: runtime.DOMString, options: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return GravitySensorImpl.call_when(state, type_, options);
    }

    pub fn call_start(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return GravitySensorImpl.call_start(state);
    }

    pub fn call_addEventListener(instance: *runtime.Instance, type_: runtime.DOMString, callback: anyopaque, options: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return GravitySensorImpl.call_addEventListener(state, type_, callback, options);
    }

    pub fn call_removeEventListener(instance: *runtime.Instance, type_: runtime.DOMString, callback: anyopaque, options: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return GravitySensorImpl.call_removeEventListener(state, type_, callback, options);
    }
