...
const CookieChangeEventImpl = @import("../impls/CookieChangeEvent.zig");
...
pub const CookieChangeEvent = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        CookieChangeEventImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        CookieChangeEventImpl.deinit(state);
    }
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, type_: runtime.DOMString, eventInitDict: anyopaque) !*runtime.Instance {
        ...
        const state = instance.getState(State);
        try CookieChangeEventImpl.constructor(state, type_, eventInitDict);
    ...
    pub fn get_changed(instance: *runtime.Instance) anyopaque {
        ...
        const value = CookieChangeEventImpl.get_changed(state);
    ...
    pub fn get_deleted(instance: *runtime.Instance) anyopaque {
        ...
        const value = CookieChangeEventImpl.get_deleted(state);
    ...
    pub fn call_stopImmediatePropagation(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CookieChangeEventImpl.call_stopImmediatePropagation(state);
    }

    pub fn call_initEvent(instance: *runtime.Instance, type_: runtime.DOMString, bubbles: bool, cancelable: bool) anyopaque {
        const state = instance.getState(State);
        
        return CookieChangeEventImpl.call_initEvent(state, type_, bubbles, cancelable);
    }

    pub fn call_composedPath(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CookieChangeEventImpl.call_composedPath(state);
    }

    pub fn call_stopPropagation(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CookieChangeEventImpl.call_stopPropagation(state);
    }

    pub fn call_preventDefault(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CookieChangeEventImpl.call_preventDefault(state);
    }
