...
const AudioScheduledSourceNodeImpl = @import("../impls/AudioScheduledSourceNode.zig");
...
pub const AudioScheduledSourceNode = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        AudioScheduledSourceNodeImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        AudioScheduledSourceNodeImpl.deinit(state);
    }
    ...
    pub fn get_context(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return AudioScheduledSourceNodeImpl.get_context(state);
    }

    pub fn get_numberOfInputs(instance: *runtime.Instance) u32 {
        const state = instance.getState(State);
        return AudioScheduledSourceNodeImpl.get_numberOfInputs(state);
    }

    pub fn get_numberOfOutputs(instance: *runtime.Instance) u32 {
        const state = instance.getState(State);
        return AudioScheduledSourceNodeImpl.get_numberOfOutputs(state);
    }

    pub fn get_channelCount(instance: *runtime.Instance) u32 {
        const state = instance.getState(State);
        return AudioScheduledSourceNodeImpl.get_channelCount(state);
    }

    pub fn set_channelCount(instance: *runtime.Instance, value: u32) void {
        const state = instance.getState(State);
        AudioScheduledSourceNodeImpl.set_channelCount(state, value);
    }

    pub fn get_channelCountMode(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return AudioScheduledSourceNodeImpl.get_channelCountMode(state);
    }

    pub fn set_channelCountMode(instance: *runtime.Instance, value: anyopaque) void {
        const state = instance.getState(State);
        AudioScheduledSourceNodeImpl.set_channelCountMode(state, value);
    }

    pub fn get_channelInterpretation(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return AudioScheduledSourceNodeImpl.get_channelInterpretation(state);
    }

    pub fn set_channelInterpretation(instance: *runtime.Instance, value: anyopaque) void {
        const state = instance.getState(State);
        AudioScheduledSourceNodeImpl.set_channelInterpretation(state, value);
    }

    pub fn get_onended(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return AudioScheduledSourceNodeImpl.get_onended(state);
    }

    pub fn set_onended(instance: *runtime.Instance, value: anyopaque) void {
        const state = instance.getState(State);
        AudioScheduledSourceNodeImpl.set_onended(state, value);
    }

    pub fn call_removeEventListener(instance: *runtime.Instance, type_: runtime.DOMString, callback: anyopaque, options: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return AudioScheduledSourceNodeImpl.call_removeEventListener(state, type_, callback, options);
    }

    pub fn call_stop(instance: *runtime.Instance, when: f64) anyopaque {
        const state = instance.getState(State);
        
        return AudioScheduledSourceNodeImpl.call_stop(state, when);
    }

    pub fn call_when(instance: *runtime.Instance, type_: runtime.DOMString, options: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return AudioScheduledSourceNodeImpl.call_when(state, type_, options);
    }

    pub fn call_dispatchEvent(instance: *runtime.Instance, event: anyopaque) bool {
        const state = instance.getState(State);
        
        return AudioScheduledSourceNodeImpl.call_dispatchEvent(state, event);
    }
    ...
    pub fn call_disconnect(instance: *runtime.Instance, args: DisconnectArgs) anyopaque {
        const state = instance.getState(State);
        switch (args) {
            .no_params => return AudioScheduledSourceNodeImpl.no_params(state),
            .long => |arg| return AudioScheduledSourceNodeImpl.long(state, arg),
            .AudioNode => |arg| return AudioScheduledSourceNodeImpl.AudioNode(state, arg),
            .AudioNode_long => |a| return AudioScheduledSourceNodeImpl.AudioNode_long(state, a.destinationNode, a.output),
            .AudioNode_long_long => |a| return AudioScheduledSourceNodeImpl.AudioNode_long_long(state, a.destinationNode, a.output, a.input),
            .AudioParam => |arg| return AudioScheduledSourceNodeImpl.AudioParam(state, arg),
            .AudioParam_long => |a| return AudioScheduledSourceNodeImpl.AudioParam_long(state, a.destinationParam, a.output),
        }
    }
    ...
    pub fn call_start(instance: *runtime.Instance, when: f64) anyopaque {
        ...
        return AudioScheduledSourceNodeImpl.call_start(state, when);
    }
    ...
    pub fn call_addEventListener(instance: *runtime.Instance, type_: runtime.DOMString, callback: anyopaque, options: anyopaque) anyopaque {
        ...
        return AudioScheduledSourceNodeImpl.call_addEventListener(state, type_, callback, options);
    }
