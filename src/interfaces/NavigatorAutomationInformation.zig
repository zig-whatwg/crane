...
const NavigatorAutomationInformationImpl = @import("../impls/NavigatorAutomationInformation.zig");
...
pub const NavigatorAutomationInformation = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        NavigatorAutomationInformationImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        NavigatorAutomationInformationImpl.deinit(state);
    }
    ...
    pub fn get_webdriver(instance: *runtime.Instance) bool {
        const state = instance.getState(State);
        return NavigatorAutomationInformationImpl.get_webdriver(state);
    }
