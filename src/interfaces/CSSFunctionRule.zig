...
const CSSFunctionRuleImpl = @import("../impls/CSSFunctionRule.zig");
...
pub const CSSFunctionRule = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        CSSFunctionRuleImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        CSSFunctionRuleImpl.deinit(state);
    }
    ...
    pub fn get_cssRules(instance: *runtime.Instance) anyopaque {
        ...
        const value = CSSFunctionRuleImpl.get_cssRules(state);
    ...
    pub fn get_name(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSFunctionRuleImpl.get_name(state);
    }

    pub fn get_returnType(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSFunctionRuleImpl.get_returnType(state);
    }

    pub fn call_deleteRule(instance: *runtime.Instance, index: u32) anyopaque {
        const state = instance.getState(State);
        
        return CSSFunctionRuleImpl.call_deleteRule(state, index);
    }

    pub fn call_insertRule(instance: *runtime.Instance, rule: anyopaque, index: u32) u32 {
        const state = instance.getState(State);
        
        return CSSFunctionRuleImpl.call_insertRule(state, rule, index);
    }

    pub fn call_getParameters(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSFunctionRuleImpl.call_getParameters(state);
    }
