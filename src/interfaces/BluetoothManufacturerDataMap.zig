...
const BluetoothManufacturerDataMapImpl = @import("../impls/BluetoothManufacturerDataMap.zig");
...
pub const BluetoothManufacturerDataMap = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        BluetoothManufacturerDataMapImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        BluetoothManufacturerDataMapImpl.deinit(state);
    }
