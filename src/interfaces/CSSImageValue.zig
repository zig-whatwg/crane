...
const CSSImageValueImpl = @import("../impls/CSSImageValue.zig");
...
pub const CSSImageValue = struct {
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        CSSImageValueImpl.deinit(state);
    }
    ...
    pub fn call_parseAll(instance: *runtime.Instance, property: runtime.USVString, cssText: runtime.USVString) anyopaque {
        ...
        return CSSImageValueImpl.call_parseAll(state, property, cssText);
    }
    ...
    pub fn call_parse(instance: *runtime.Instance, property: runtime.USVString, cssText: runtime.USVString) anyopaque {
        ...
        return CSSImageValueImpl.call_parse(state, property, cssText);
    }
