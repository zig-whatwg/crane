...
const KHR_parallel_shader_compileImpl = @import("../impls/KHR_parallel_shader_compile.zig");
...
pub const KHR_parallel_shader_compile = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        KHR_parallel_shader_compileImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        KHR_parallel_shader_compileImpl.deinit(state);
    }
