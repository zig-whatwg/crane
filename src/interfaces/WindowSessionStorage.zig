...
const WindowSessionStorageImpl = @import("../impls/WindowSessionStorage.zig");
...
pub const WindowSessionStorage = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        WindowSessionStorageImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        WindowSessionStorageImpl.deinit(state);
    }
    ...
    pub fn get_sessionStorage(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return WindowSessionStorageImpl.get_sessionStorage(state);
    }
