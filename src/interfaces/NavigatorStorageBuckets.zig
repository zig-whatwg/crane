...
const NavigatorStorageBucketsImpl = @import("../impls/NavigatorStorageBuckets.zig");
...
pub const NavigatorStorageBuckets = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        NavigatorStorageBucketsImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        NavigatorStorageBucketsImpl.deinit(state);
    }
    ...
    pub fn get_storageBuckets(instance: *runtime.Instance) anyopaque {
        ...
        const value = NavigatorStorageBucketsImpl.get_storageBuckets(state);
