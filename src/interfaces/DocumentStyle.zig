...
const DocumentStyleImpl = @import("../impls/DocumentStyle.zig");
...
pub const DocumentStyle = struct {
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        DocumentStyleImpl.deinit(state);
    }
    ...
    pub fn get_styleSheets(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return DocumentStyleImpl.get_styleSheets(state);
    }
