...
const SharedStorageClearMethodImpl = @import("../impls/SharedStorageClearMethod.zig");
...
pub const SharedStorageClearMethod = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        SharedStorageClearMethodImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        SharedStorageClearMethodImpl.deinit(state);
    }
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, options: anyopaque) !*runtime.Instance {
        ...
        const state = instance.getState(State);
        try SharedStorageClearMethodImpl.constructor(state, options);
