...
const ReadableStreamDefaultControllerImpl = @import("../impls/ReadableStreamDefaultController.zig");
...
pub const ReadableStreamDefaultController = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        ReadableStreamDefaultControllerImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        ReadableStreamDefaultControllerImpl.deinit(state);
    }
    ...
    pub fn get_desiredSize(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return ReadableStreamDefaultControllerImpl.get_desiredSize(state);
    }

    pub fn call_error(instance: *runtime.Instance, e: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return ReadableStreamDefaultControllerImpl.call_error(state, e);
    }

    pub fn call_close(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return ReadableStreamDefaultControllerImpl.call_close(state);
    }

    pub fn call_enqueue(instance: *runtime.Instance, chunk: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return ReadableStreamDefaultControllerImpl.call_enqueue(state, chunk);
    }
