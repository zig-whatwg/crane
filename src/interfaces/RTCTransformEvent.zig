...
const RTCTransformEventImpl = @import("../impls/RTCTransformEvent.zig");
...
pub const RTCTransformEvent = struct {
    ...
    pub const vtable = runtime.buildVTable(RTCTransformEvent, .{
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        RTCTransformEventImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        RTCTransformEventImpl.deinit(state);
    }
