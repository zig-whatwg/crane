...
const USBOutTransferResultImpl = @import("../impls/USBOutTransferResult.zig");
...
pub const USBOutTransferResult = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        USBOutTransferResultImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        USBOutTransferResultImpl.deinit(state);
    }
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, status: anyopaque, bytesWritten: u32) !*runtime.Instance {
        ...
        const state = instance.getState(State);
        try USBOutTransferResultImpl.constructor(state, status, bytesWritten);
    ...
    pub fn get_bytesWritten(instance: *runtime.Instance) u32 {
        const state = instance.getState(State);
        return USBOutTransferResultImpl.get_bytesWritten(state);
    }

    pub fn get_status(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return USBOutTransferResultImpl.get_status(state);
    }
