...
const DOMMatrixReadOnlyImpl = @import("../impls/DOMMatrixReadOnly.zig");
...
pub const DOMMatrixReadOnly = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        DOMMatrixReadOnlyImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        DOMMatrixReadOnlyImpl.deinit(state);
    }
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, init: anyopaque) !*runtime.Instance {
        ...
        const state = instance.getState(State);
        try DOMMatrixReadOnlyImpl.constructor(state, init);
    ...
    pub fn get_a(instance: *runtime.Instance) f64 {
        const state = instance.getState(State);
        return DOMMatrixReadOnlyImpl.get_a(state);
    }

    pub fn get_b(instance: *runtime.Instance) f64 {
        const state = instance.getState(State);
        return DOMMatrixReadOnlyImpl.get_b(state);
    }

    pub fn get_c(instance: *runtime.Instance) f64 {
        const state = instance.getState(State);
        return DOMMatrixReadOnlyImpl.get_c(state);
    }

    pub fn get_d(instance: *runtime.Instance) f64 {
        const state = instance.getState(State);
        return DOMMatrixReadOnlyImpl.get_d(state);
    }

    pub fn get_e(instance: *runtime.Instance) f64 {
        const state = instance.getState(State);
        return DOMMatrixReadOnlyImpl.get_e(state);
    }

    pub fn get_f(instance: *runtime.Instance) f64 {
        const state = instance.getState(State);
        return DOMMatrixReadOnlyImpl.get_f(state);
    }

    pub fn get_m11(instance: *runtime.Instance) f64 {
        const state = instance.getState(State);
        return DOMMatrixReadOnlyImpl.get_m11(state);
    }

    pub fn get_m12(instance: *runtime.Instance) f64 {
        const state = instance.getState(State);
        return DOMMatrixReadOnlyImpl.get_m12(state);
    }

    pub fn get_m13(instance: *runtime.Instance) f64 {
        const state = instance.getState(State);
        return DOMMatrixReadOnlyImpl.get_m13(state);
    }

    pub fn get_m14(instance: *runtime.Instance) f64 {
        const state = instance.getState(State);
        return DOMMatrixReadOnlyImpl.get_m14(state);
    }

    pub fn get_m21(instance: *runtime.Instance) f64 {
        const state = instance.getState(State);
        return DOMMatrixReadOnlyImpl.get_m21(state);
    }

    pub fn get_m22(instance: *runtime.Instance) f64 {
        const state = instance.getState(State);
        return DOMMatrixReadOnlyImpl.get_m22(state);
    }

    pub fn get_m23(instance: *runtime.Instance) f64 {
        const state = instance.getState(State);
        return DOMMatrixReadOnlyImpl.get_m23(state);
    }

    pub fn get_m24(instance: *runtime.Instance) f64 {
        const state = instance.getState(State);
        return DOMMatrixReadOnlyImpl.get_m24(state);
    }

    pub fn get_m31(instance: *runtime.Instance) f64 {
        const state = instance.getState(State);
        return DOMMatrixReadOnlyImpl.get_m31(state);
    }

    pub fn get_m32(instance: *runtime.Instance) f64 {
        const state = instance.getState(State);
        return DOMMatrixReadOnlyImpl.get_m32(state);
    }

    pub fn get_m33(instance: *runtime.Instance) f64 {
        const state = instance.getState(State);
        return DOMMatrixReadOnlyImpl.get_m33(state);
    }

    pub fn get_m34(instance: *runtime.Instance) f64 {
        const state = instance.getState(State);
        return DOMMatrixReadOnlyImpl.get_m34(state);
    }

    pub fn get_m41(instance: *runtime.Instance) f64 {
        const state = instance.getState(State);
        return DOMMatrixReadOnlyImpl.get_m41(state);
    }

    pub fn get_m42(instance: *runtime.Instance) f64 {
        const state = instance.getState(State);
        return DOMMatrixReadOnlyImpl.get_m42(state);
    }

    pub fn get_m43(instance: *runtime.Instance) f64 {
        const state = instance.getState(State);
        return DOMMatrixReadOnlyImpl.get_m43(state);
    }

    pub fn get_m44(instance: *runtime.Instance) f64 {
        const state = instance.getState(State);
        return DOMMatrixReadOnlyImpl.get_m44(state);
    }

    pub fn get_is2D(instance: *runtime.Instance) bool {
        const state = instance.getState(State);
        return DOMMatrixReadOnlyImpl.get_is2D(state);
    }

    pub fn get_isIdentity(instance: *runtime.Instance) bool {
        const state = instance.getState(State);
        return DOMMatrixReadOnlyImpl.get_isIdentity(state);
    }

    /// Extended attributes: [NewObject]
    pub fn call_fromFloat32Array(instance: *runtime.Instance, array32: anyopaque) anyopaque {
        const state = instance.getState(State);
        // [NewObject] - Caller owns the returned object
        
        return DOMMatrixReadOnlyImpl.call_fromFloat32Array(state, array32);
    }
    ...
    pub fn call_flipX(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        // [NewObject] - Caller owns the returned object
        return DOMMatrixReadOnlyImpl.call_flipX(state);
    }
    ...
    pub fn call_scale3d(instance: *runtime.Instance, scale: f64, originX: f64, originY: f64, originZ: f64) anyopaque {
        ...
        return DOMMatrixReadOnlyImpl.call_scale3d(state, scale, originX, originY, originZ);
    }

    /// Extended attributes: [NewObject]
    pub fn call_fromFloat64Array(instance: *runtime.Instance, array64: anyopaque) anyopaque {
        const state = instance.getState(State);
        // [NewObject] - Caller owns the returned object
        
        return DOMMatrixReadOnlyImpl.call_fromFloat64Array(state, array64);
    }

    /// Extended attributes: [NewObject]
    pub fn call_fromMatrix(instance: *runtime.Instance, other: anyopaque) anyopaque {
        const state = instance.getState(State);
        // [NewObject] - Caller owns the returned object
        
        return DOMMatrixReadOnlyImpl.call_fromMatrix(state, other);
    }
    ...
    pub fn call_rotateAxisAngle(instance: *runtime.Instance, x: f64, y: f64, z: f64, angle: f64) anyopaque {
        ...
        return DOMMatrixReadOnlyImpl.call_rotateAxisAngle(state, x, y, z, angle);
    }
    ...
    pub fn call_skewY(instance: *runtime.Instance, sy: f64) anyopaque {
        ...
        return DOMMatrixReadOnlyImpl.call_skewY(state, sy);
    }
    ...
    pub fn call_rotate(instance: *runtime.Instance, rotX: f64, rotY: f64, rotZ: f64) anyopaque {
        ...
        return DOMMatrixReadOnlyImpl.call_rotate(state, rotX, rotY, rotZ);
    }
    ...
    pub fn call_inverse(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        // [NewObject] - Caller owns the returned object
        return DOMMatrixReadOnlyImpl.call_inverse(state);
    }
    ...
    pub fn call_toFloat64Array(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        // [NewObject] - Caller owns the returned object
        return DOMMatrixReadOnlyImpl.call_toFloat64Array(state);
    }
    ...
    pub fn call_scale(instance: *runtime.Instance, scaleX: f64, scaleY: f64, scaleZ: f64, originX: f64, originY: f64, originZ: f64) anyopaque {
        ...
        return DOMMatrixReadOnlyImpl.call_scale(state, scaleX, scaleY, scaleZ, originX, originY, originZ);
    }
    ...
    pub fn call_translate(instance: *runtime.Instance, tx: f64, ty: f64, tz: f64) anyopaque {
        ...
        return DOMMatrixReadOnlyImpl.call_translate(state, tx, ty, tz);
    }
    ...
    pub fn call_multiply(instance: *runtime.Instance, other: anyopaque) anyopaque {
        ...
        return DOMMatrixReadOnlyImpl.call_multiply(state, other);
    }
    ...
    pub fn call_transformPoint(instance: *runtime.Instance, point: anyopaque) anyopaque {
        ...
        return DOMMatrixReadOnlyImpl.call_transformPoint(state, point);
    }
    ...
    pub fn call_skewX(instance: *runtime.Instance, sx: f64) anyopaque {
        ...
        return DOMMatrixReadOnlyImpl.call_skewX(state, sx);
    }

    /// Extended attributes: [Default]
    pub fn call_toJSON(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return DOMMatrixReadOnlyImpl.call_toJSON(state);
    }
    ...
    pub fn call_scaleNonUniform(instance: *runtime.Instance, scaleX: f64, scaleY: f64) anyopaque {
        ...
        return DOMMatrixReadOnlyImpl.call_scaleNonUniform(state, scaleX, scaleY);
    }
    ...
    pub fn call_flipY(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        // [NewObject] - Caller owns the returned object
        return DOMMatrixReadOnlyImpl.call_flipY(state);
    }
    ...
    pub fn call_toFloat32Array(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        // [NewObject] - Caller owns the returned object
        return DOMMatrixReadOnlyImpl.call_toFloat32Array(state);
    }
    ...
    pub fn call_rotateFromVector(instance: *runtime.Instance, x: f64, y: f64) anyopaque {
        ...
        return DOMMatrixReadOnlyImpl.call_rotateFromVector(state, x, y);
    }
