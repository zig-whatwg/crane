...
const HIDImpl = @import("../impls/HID.zig");
...
pub const HID = struct {
    ...
    pub fn call_requestDevice(instance: *runtime.Instance, options: anyopaque) anyopaque {
        ...
        return HIDImpl.call_requestDevice(state, options);
    }

    pub fn call_addEventListener(instance: *runtime.Instance, type_: runtime.DOMString, callback: anyopaque, options: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return HIDImpl.call_addEventListener(state, type_, callback, options);
    }

    pub fn call_removeEventListener(instance: *runtime.Instance, type_: runtime.DOMString, callback: anyopaque, options: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return HIDImpl.call_removeEventListener(state, type_, callback, options);
    }
