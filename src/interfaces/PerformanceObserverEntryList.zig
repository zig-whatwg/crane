...
const PerformanceObserverEntryListImpl = @import("../impls/PerformanceObserverEntryList.zig");
...
pub const PerformanceObserverEntryList = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        PerformanceObserverEntryListImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        PerformanceObserverEntryListImpl.deinit(state);
    }
    ...
    pub fn call_getEntries(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return PerformanceObserverEntryListImpl.call_getEntries(state);
    }

    pub fn call_getEntriesByType(instance: *runtime.Instance, type_: runtime.DOMString) anyopaque {
        const state = instance.getState(State);
        
        return PerformanceObserverEntryListImpl.call_getEntriesByType(state, type_);
    }

    pub fn call_getEntriesByName(instance: *runtime.Instance, name: runtime.DOMString, type_: runtime.DOMString) anyopaque {
        const state = instance.getState(State);
        
        return PerformanceObserverEntryListImpl.call_getEntriesByName(state, name, type_);
    }
