...
const WEBGL_debug_renderer_infoImpl = @import("../impls/WEBGL_debug_renderer_info.zig");
...
pub const WEBGL_debug_renderer_info = struct {
    ...
    pub const vtable = runtime.buildVTable(WEBGL_debug_renderer_info, .{
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        WEBGL_debug_renderer_infoImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        WEBGL_debug_renderer_infoImpl.deinit(state);
    }
