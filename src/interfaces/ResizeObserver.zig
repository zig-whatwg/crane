...
const ResizeObserverImpl = @import("../impls/ResizeObserver.zig");
...
pub const ResizeObserver = struct {
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        ResizeObserverImpl.deinit(state);
    }
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, callback: anyopaque) !*runtime.Instance {
        ...
        const state = instance.getState(State);
        try ResizeObserverImpl.constructor(state, callback);
    ...
    pub fn call_observe(instance: *runtime.Instance, target: anyopaque, options: anyopaque) anyopaque {
        ...
        return ResizeObserverImpl.call_observe(state, target, options);
    }

    pub fn call_unobserve(instance: *runtime.Instance, target: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return ResizeObserverImpl.call_unobserve(state, target);
    }

    pub fn call_disconnect(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return ResizeObserverImpl.call_disconnect(state);
    }
