...
const CSSMathMaxImpl = @import("../impls/CSSMathMax.zig");
const CSSMathValue = @import("CSSMathValue.zig");

pub const CSSMathMax = struct {
    pub const Meta = struct {
        pub const name = "CSSMathMax";
    ...
    pub const vtable = runtime.buildVTable(CSSMathMax, .{
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, args: anyopaque) !*runtime.Instance {
        ...
        const state = instance.getState(State);
        try CSSMathMaxImpl.constructor(state, args);
    ...
    pub fn call_parse(instance: *runtime.Instance, args: ParseArgs) anyopaque {
        const state = instance.getState(State);
        switch (args) {
            .USVString_USVString => |a| return CSSMathMaxImpl.USVString_USVString(state, a.property, a.cssText),
            .USVString => |arg| return CSSMathMaxImpl.USVString(state, arg),
        }
    }

    pub fn call_type(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSMathMaxImpl.call_type(state);
    }
