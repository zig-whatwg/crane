...
const WorkerGlobalScopeImpl = @import("../impls/WorkerGlobalScope.zig");
...
pub const WorkerGlobalScope = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        WorkerGlobalScopeImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        WorkerGlobalScopeImpl.deinit(state);
    }
    ...
    pub fn get_indexedDB(instance: *runtime.Instance) anyopaque {
        ...
        const value = WorkerGlobalScopeImpl.get_indexedDB(state);
    ...
    pub fn get_trustedTypes(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return WorkerGlobalScopeImpl.get_trustedTypes(state);
    }

    /// Extended attributes: [Replaceable]
    pub fn get_performance(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return WorkerGlobalScopeImpl.get_performance(state);
    }
    ...
    pub fn get_caches(instance: *runtime.Instance) anyopaque {
        ...
        const value = WorkerGlobalScopeImpl.get_caches(state);
    ...
    pub fn get_scheduler(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return WorkerGlobalScopeImpl.get_scheduler(state);
    }
    ...
    pub fn get_crypto(instance: *runtime.Instance) anyopaque {
        ...
        const value = WorkerGlobalScopeImpl.get_crypto(state);
    ...
    pub fn call_when(instance: *runtime.Instance, type_: runtime.DOMString, options: anyopaque) anyopaque {
        ...
        return WorkerGlobalScopeImpl.call_when(state, type_, options);
    }

    pub fn call_reportError(instance: *runtime.Instance, e: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return WorkerGlobalScopeImpl.call_reportError(state, e);
    }

    pub fn call_setInterval(instance: *runtime.Instance, handler: anyopaque, timeout: i32, arguments: anyopaque) i32 {
        const state = instance.getState(State);
        
        return WorkerGlobalScopeImpl.call_setInterval(state, handler, timeout, arguments);
    }

    pub fn call_clearInterval(instance: *runtime.Instance, id: i32) anyopaque {
        const state = instance.getState(State);
        
        return WorkerGlobalScopeImpl.call_clearInterval(state, id);
    }

    pub fn call_importScripts(instance: *runtime.Instance, urls: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return WorkerGlobalScopeImpl.call_importScripts(state, urls);
    }

    pub fn call_setTimeout(instance: *runtime.Instance, handler: anyopaque, timeout: i32, arguments: anyopaque) i32 {
        const state = instance.getState(State);
        
        return WorkerGlobalScopeImpl.call_setTimeout(state, handler, timeout, arguments);
    }

    pub fn call_addEventListener(instance: *runtime.Instance, type_: runtime.DOMString, callback: anyopaque, options: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return WorkerGlobalScopeImpl.call_addEventListener(state, type_, callback, options);
    }

    pub fn call_removeEventListener(instance: *runtime.Instance, type_: runtime.DOMString, callback: anyopaque, options: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return WorkerGlobalScopeImpl.call_removeEventListener(state, type_, callback, options);
    }
    ...
    pub fn call_fetch(instance: *runtime.Instance, input: anyopaque, init: anyopaque) anyopaque {
        ...
        return WorkerGlobalScopeImpl.call_fetch(state, input, init);
    }

    pub fn call_atob(instance: *runtime.Instance, data: runtime.DOMString) runtime.ByteString {
        const state = instance.getState(State);
        
        return WorkerGlobalScopeImpl.call_atob(state, data);
    }

    pub fn call_btoa(instance: *runtime.Instance, data: runtime.DOMString) runtime.DOMString {
        const state = instance.getState(State);
        
        return WorkerGlobalScopeImpl.call_btoa(state, data);
    }

    pub fn call_dispatchEvent(instance: *runtime.Instance, event: anyopaque) bool {
        const state = instance.getState(State);
        
        return WorkerGlobalScopeImpl.call_dispatchEvent(state, event);
    }
    ...
    pub fn call_createImageBitmap(instance: *runtime.Instance, args: CreateImageBitmapArgs) anyopaque {
        const state = instance.getState(State);
        switch (args) {
            .ImageBitmapSource_ImageBitmapOptions => |a| return WorkerGlobalScopeImpl.ImageBitmapSource_ImageBitmapOptions(state, a.image, a.options),
            .ImageBitmapSource_long_long_long_long_ImageBitmapOptions => |a| return WorkerGlobalScopeImpl.ImageBitmapSource_long_long_long_long_ImageBitmapOptions(state, a.image, a.sx, a.sy, a.sw, a.sh, a.options),
        }
    }
    ...
    pub fn call_queueMicrotask(instance: *runtime.Instance, callback: anyopaque) anyopaque {
        ...
        return WorkerGlobalScopeImpl.call_queueMicrotask(state, callback);
    }

    pub fn call_structuredClone(instance: *runtime.Instance, value: anyopaque, options: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return WorkerGlobalScopeImpl.call_structuredClone(state, value, options);
    }

    pub fn call_clearTimeout(instance: *runtime.Instance, id: i32) anyopaque {
        const state = instance.getState(State);
        
        return WorkerGlobalScopeImpl.call_clearTimeout(state, id);
    }
