...
const CSSStylePropertiesImpl = @import("../impls/CSSStyleProperties.zig");
...
pub const CSSStyleProperties = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        CSSStylePropertiesImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        CSSStylePropertiesImpl.deinit(state);
    }
    ...
    pub fn get_cssText(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSStylePropertiesImpl.get_cssText(state);
    }
    ...
    pub fn set_cssText(instance: *runtime.Instance, value: anyopaque) void {
        ...
        CSSStylePropertiesImpl.set_cssText(state, value);
    }

    pub fn get_length(instance: *runtime.Instance) u32 {
        const state = instance.getState(State);
        return CSSStylePropertiesImpl.get_length(state);
    }

    pub fn get_parentRule(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSStylePropertiesImpl.get_parentRule(state);
    }
    ...
    pub fn get_cssFloat(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSStylePropertiesImpl.get_cssFloat(state);
    }

    /// Extended attributes: [CEReactions], [LegacyNullToEmptyString]
    pub fn set_cssFloat(instance: *runtime.Instance, value: anyopaque) void {
        const state = instance.getState(State);
        // [CEReactions] - Trigger Custom Element lifecycle callbacks
        runtime.CEReactions.begin();
        defer runtime.CEReactions.end();
        
        CSSStylePropertiesImpl.set_cssFloat(state, value);
    }
    ...
    pub fn call_item(instance: *runtime.Instance, args: ItemArgs) anyopaque {
        const state = instance.getState(State);
        switch (args) {
            .long => |arg| return CSSStylePropertiesImpl.long(state, arg),
            .long => |arg| return CSSStylePropertiesImpl.long(state, arg),
        }
    }
    ...
    pub fn call_removeProperty(instance: *runtime.Instance, args: RemovePropertyArgs) anyopaque {
        const state = instance.getState(State);
        switch (args) {
            .CSSOMString => |arg| return CSSStylePropertiesImpl.CSSOMString(state, arg),
            .string => |arg| return CSSStylePropertiesImpl.string(state, arg),
        }
    }
    ...
    pub fn call_setProperty(instance: *runtime.Instance, args: SetPropertyArgs) anyopaque {
        const state = instance.getState(State);
        switch (args) {
            .CSSOMString_CSSOMString_CSSOMString => |a| return CSSStylePropertiesImpl.CSSOMString_CSSOMString_CSSOMString(state, a.property, a.value, a.priority),
            .string_string_string => |a| return CSSStylePropertiesImpl.string_string_string(state, a.propertyName, a.value, a.priority),
        }
    }
    ...
    pub fn call_getPropertyCSSValue(instance: *runtime.Instance, propertyName: runtime.DOMString) anyopaque {
        ...
        return CSSStylePropertiesImpl.call_getPropertyCSSValue(state, propertyName);
    }
