...
const VideoDecoderImpl = @import("../impls/VideoDecoder.zig");
...
pub const VideoDecoder = struct {
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, init: anyopaque) !*runtime.Instance {
        ...
        const state = instance.getState(State);
        try VideoDecoderImpl.constructor(state, init);
    ...
    pub fn get_state(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return VideoDecoderImpl.get_state(state);
    }

    pub fn get_decodeQueueSize(instance: *runtime.Instance) u32 {
        const state = instance.getState(State);
        return VideoDecoderImpl.get_decodeQueueSize(state);
    }

    pub fn get_ondequeue(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return VideoDecoderImpl.get_ondequeue(state);
    }

    pub fn set_ondequeue(instance: *runtime.Instance, value: anyopaque) void {
        const state = instance.getState(State);
        VideoDecoderImpl.set_ondequeue(state, value);
    }

    pub fn call_decode(instance: *runtime.Instance, chunk: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return VideoDecoderImpl.call_decode(state, chunk);
    }

    pub fn call_when(instance: *runtime.Instance, type_: runtime.DOMString, options: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return VideoDecoderImpl.call_when(state, type_, options);
    }

    pub fn call_dispatchEvent(instance: *runtime.Instance, event: anyopaque) bool {
        const state = instance.getState(State);
        
        return VideoDecoderImpl.call_dispatchEvent(state, event);
    }

    pub fn call_flush(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return VideoDecoderImpl.call_flush(state);
    }

    pub fn call_isConfigSupported(instance: *runtime.Instance, config: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return VideoDecoderImpl.call_isConfigSupported(state, config);
    }

    pub fn call_reset(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return VideoDecoderImpl.call_reset(state);
    }

    pub fn call_configure(instance: *runtime.Instance, config: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return VideoDecoderImpl.call_configure(state, config);
    }

    pub fn call_close(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return VideoDecoderImpl.call_close(state);
    }

    pub fn call_addEventListener(instance: *runtime.Instance, type_: runtime.DOMString, callback: anyopaque, options: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return VideoDecoderImpl.call_addEventListener(state, type_, callback, options);
    }

    pub fn call_removeEventListener(instance: *runtime.Instance, type_: runtime.DOMString, callback: anyopaque, options: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return VideoDecoderImpl.call_removeEventListener(state, type_, callback, options);
    }
