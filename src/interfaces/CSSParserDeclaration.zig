...
const CSSParserDeclarationImpl = @import("../impls/CSSParserDeclaration.zig");
...
pub const CSSParserDeclaration = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        CSSParserDeclarationImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        CSSParserDeclarationImpl.deinit(state);
    }
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, name: runtime.DOMString, body: anyopaque) !*runtime.Instance {
        ...
        const state = instance.getState(State);
        try CSSParserDeclarationImpl.constructor(state, name, body);
    ...
    pub fn get_name(instance: *runtime.Instance) runtime.DOMString {
        const state = instance.getState(State);
        return CSSParserDeclarationImpl.get_name(state);
    }

    pub fn get_body(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSParserDeclarationImpl.get_body(state);
    }
