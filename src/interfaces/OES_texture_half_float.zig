...
const OES_texture_half_floatImpl = @import("../impls/OES_texture_half_float.zig");
...
pub const OES_texture_half_float = struct {
    ...
    pub const vtable = runtime.buildVTable(OES_texture_half_float, .{
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        OES_texture_half_floatImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        OES_texture_half_floatImpl.deinit(state);
    }
