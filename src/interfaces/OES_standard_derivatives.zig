...
const OES_standard_derivativesImpl = @import("../impls/OES_standard_derivatives.zig");
...
pub const OES_standard_derivatives = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        OES_standard_derivativesImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        OES_standard_derivativesImpl.deinit(state);
    }
