...
const MessageEventTargetImpl = @import("../impls/MessageEventTarget.zig");
...
pub const MessageEventTarget = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        MessageEventTargetImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        MessageEventTargetImpl.deinit(state);
    }
    ...
    pub fn get_onmessage(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return MessageEventTargetImpl.get_onmessage(state);
    }

    pub fn set_onmessage(instance: *runtime.Instance, value: anyopaque) void {
        const state = instance.getState(State);
        MessageEventTargetImpl.set_onmessage(state, value);
    }

    pub fn get_onmessageerror(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return MessageEventTargetImpl.get_onmessageerror(state);
    }

    pub fn set_onmessageerror(instance: *runtime.Instance, value: anyopaque) void {
        const state = instance.getState(State);
        MessageEventTargetImpl.set_onmessageerror(state, value);
    }
