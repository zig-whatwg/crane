...
const NavigationEventImpl = @import("../impls/NavigationEvent.zig");
...
pub const NavigationEvent = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        NavigationEventImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        NavigationEventImpl.deinit(state);
    }
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, type_: runtime.DOMString, eventInitDict: anyopaque) !*runtime.Instance {
        ...
        const state = instance.getState(State);
        try NavigationEventImpl.constructor(state, type_, eventInitDict);
    ...
    pub fn call_initUIEvent(instance: *runtime.Instance, typeArg: runtime.DOMString, bubblesArg: bool, cancelableArg: bool, viewArg: anyopaque, detailArg: i32) anyopaque {
        ...
        return NavigationEventImpl.call_initUIEvent(state, typeArg, bubblesArg, cancelableArg, viewArg, detailArg);
    }

    pub fn call_preventDefault(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return NavigationEventImpl.call_preventDefault(state);
    }
