...
const ChannelMergerNodeImpl = @import("../impls/ChannelMergerNode.zig");
...
pub const ChannelMergerNode = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        ChannelMergerNodeImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        ChannelMergerNodeImpl.deinit(state);
    }
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, context: anyopaque, options: anyopaque) !*runtime.Instance {
        ...
        const state = instance.getState(State);
        try ChannelMergerNodeImpl.constructor(state, context, options);
    ...
    pub fn get_context(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return ChannelMergerNodeImpl.get_context(state);
    }

    pub fn get_numberOfInputs(instance: *runtime.Instance) u32 {
        const state = instance.getState(State);
        return ChannelMergerNodeImpl.get_numberOfInputs(state);
    }

    pub fn get_numberOfOutputs(instance: *runtime.Instance) u32 {
        const state = instance.getState(State);
        return ChannelMergerNodeImpl.get_numberOfOutputs(state);
    }

    pub fn get_channelCount(instance: *runtime.Instance) u32 {
        const state = instance.getState(State);
        return ChannelMergerNodeImpl.get_channelCount(state);
    }

    pub fn set_channelCount(instance: *runtime.Instance, value: u32) void {
        const state = instance.getState(State);
        ChannelMergerNodeImpl.set_channelCount(state, value);
    }

    pub fn get_channelCountMode(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return ChannelMergerNodeImpl.get_channelCountMode(state);
    }

    pub fn set_channelCountMode(instance: *runtime.Instance, value: anyopaque) void {
        const state = instance.getState(State);
        ChannelMergerNodeImpl.set_channelCountMode(state, value);
    }

    pub fn get_channelInterpretation(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return ChannelMergerNodeImpl.get_channelInterpretation(state);
    }

    pub fn set_channelInterpretation(instance: *runtime.Instance, value: anyopaque) void {
        const state = instance.getState(State);
        ChannelMergerNodeImpl.set_channelInterpretation(state, value);
    }

    pub fn call_removeEventListener(instance: *runtime.Instance, type_: runtime.DOMString, callback: anyopaque, options: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return ChannelMergerNodeImpl.call_removeEventListener(state, type_, callback, options);
    }

    pub fn call_when(instance: *runtime.Instance, type_: runtime.DOMString, options: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return ChannelMergerNodeImpl.call_when(state, type_, options);
    }

    pub fn call_dispatchEvent(instance: *runtime.Instance, event: anyopaque) bool {
        const state = instance.getState(State);
        
        return ChannelMergerNodeImpl.call_dispatchEvent(state, event);
    }
    ...
    pub fn call_disconnect(instance: *runtime.Instance, args: DisconnectArgs) anyopaque {
        const state = instance.getState(State);
        switch (args) {
            .no_params => return ChannelMergerNodeImpl.no_params(state),
            .long => |arg| return ChannelMergerNodeImpl.long(state, arg),
            .AudioNode => |arg| return ChannelMergerNodeImpl.AudioNode(state, arg),
            .AudioNode_long => |a| return ChannelMergerNodeImpl.AudioNode_long(state, a.destinationNode, a.output),
            .AudioNode_long_long => |a| return ChannelMergerNodeImpl.AudioNode_long_long(state, a.destinationNode, a.output, a.input),
            .AudioParam => |arg| return ChannelMergerNodeImpl.AudioParam(state, arg),
            .AudioParam_long => |a| return ChannelMergerNodeImpl.AudioParam_long(state, a.destinationParam, a.output),
        }
    }
    ...
    pub fn call_addEventListener(instance: *runtime.Instance, type_: runtime.DOMString, callback: anyopaque, options: anyopaque) anyopaque {
        ...
        return ChannelMergerNodeImpl.call_addEventListener(state, type_, callback, options);
    }
