...
const PressureRecordImpl = @import("../impls/PressureRecord.zig");
...
pub const PressureRecord = struct {
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        PressureRecordImpl.deinit(state);
    }
    ...
    pub fn get_source(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return PressureRecordImpl.get_source(state);
    }

    pub fn get_state(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return PressureRecordImpl.get_state(state);
    }

    pub fn get_time(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return PressureRecordImpl.get_time(state);
    }

    /// Extended attributes: [Default]
    pub fn call_toJSON(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return PressureRecordImpl.call_toJSON(state);
    }
