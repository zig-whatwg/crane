...
const CSSMathInvertImpl = @import("../impls/CSSMathInvert.zig");
const CSSMathValue = @import("CSSMathValue.zig");

pub const CSSMathInvert = struct {
    pub const Meta = struct {
        pub const name = "CSSMathInvert";
    ...
    pub const vtable = runtime.buildVTable(CSSMathInvert, .{
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        CSSMathInvertImpl.deinit(state);
    }
    ...
    /// WebIDL constructor
    pub fn call_constructor(allocator: std.mem.Allocator, arg: anyopaque) !*runtime.Instance {
        const instance = try init(allocator);
        errdefer deinit(instance);
        
        const state = instance.getState(State);
        try CSSMathInvertImpl.constructor(state, arg);
    ...
    pub fn call_parse(instance: *runtime.Instance, args: ParseArgs) anyopaque {
        const state = instance.getState(State);
        switch (args) {
            .USVString_USVString => |a| return CSSMathInvertImpl.USVString_USVString(state, a.property, a.cssText),
            .USVString => |arg| return CSSMathInvertImpl.USVString(state, arg),
        }
    }

    pub fn call_type(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSMathInvertImpl.call_type(state);
    }
