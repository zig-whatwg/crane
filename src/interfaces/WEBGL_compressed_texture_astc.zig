...
const WEBGL_compressed_texture_astcImpl = @import("../impls/WEBGL_compressed_texture_astc.zig");
...
pub const WEBGL_compressed_texture_astc = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        WEBGL_compressed_texture_astcImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        WEBGL_compressed_texture_astcImpl.deinit(state);
    }
    ...
    pub fn call_getSupportedProfiles(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return WEBGL_compressed_texture_astcImpl.call_getSupportedProfiles(state);
    }
