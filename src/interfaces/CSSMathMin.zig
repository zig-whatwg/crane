...
const CSSMathMinImpl = @import("../impls/CSSMathMin.zig");
...
pub const CSSMathMin = struct {
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, args: anyopaque) !*runtime.Instance {
        ...
        const state = instance.getState(State);
        try CSSMathMinImpl.constructor(state, args);
    ...
    pub fn call_parse(instance: *runtime.Instance, args: ParseArgs) anyopaque {
        const state = instance.getState(State);
        switch (args) {
            .USVString_USVString => |a| return CSSMathMinImpl.USVString_USVString(state, a.property, a.cssText),
            .USVString => |arg| return CSSMathMinImpl.USVString(state, arg),
        }
    }

    pub fn call_type(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSMathMinImpl.call_type(state);
    }
