...
const WEBGL_clip_cull_distanceImpl = @import("../impls/WEBGL_clip_cull_distance.zig");
...
pub const WEBGL_clip_cull_distance = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        WEBGL_clip_cull_distanceImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        WEBGL_clip_cull_distanceImpl.deinit(state);
    }
