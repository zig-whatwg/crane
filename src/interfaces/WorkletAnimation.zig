...
const WorkletAnimationImpl = @import("../impls/WorkletAnimation.zig");
...
pub const WorkletAnimation = struct {
    ...
    pub const vtable = runtime.buildVTable(WorkletAnimation, .{
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        WorkletAnimationImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        WorkletAnimationImpl.deinit(state);
    }
    ...
    /// WebIDL constructor
    pub fn call_constructor(allocator: std.mem.Allocator, animatorName: runtime.DOMString, effects: anyopaque, timeline: anyopaque, options: anyopaque) !*runtime.Instance {
        const instance = try init(allocator);
        errdefer deinit(instance);
        
        const state = instance.getState(State);
        try WorkletAnimationImpl.constructor(state, animatorName, effects, timeline, options);
    ...
    pub fn get_trigger(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return WorkletAnimationImpl.get_trigger(state);
    }

    pub fn set_trigger(instance: *runtime.Instance, value: anyopaque) void {
        const state = instance.getState(State);
        WorkletAnimationImpl.set_trigger(state, value);
    }

    pub fn get_rangeStart(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return WorkletAnimationImpl.get_rangeStart(state);
    }

    pub fn set_rangeStart(instance: *runtime.Instance, value: anyopaque) void {
        const state = instance.getState(State);
        WorkletAnimationImpl.set_rangeStart(state, value);
    }

    pub fn get_rangeEnd(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return WorkletAnimationImpl.get_rangeEnd(state);
    }

    pub fn set_rangeEnd(instance: *runtime.Instance, value: anyopaque) void {
        const state = instance.getState(State);
        WorkletAnimationImpl.set_rangeEnd(state, value);
    }

    pub fn get_overallProgress(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return WorkletAnimationImpl.get_overallProgress(state);
    }

    pub fn get_animatorName(instance: *runtime.Instance) runtime.DOMString {
        const state = instance.getState(State);
        return WorkletAnimationImpl.get_animatorName(state);
    }

    pub fn call_updatePlaybackRate(instance: *runtime.Instance, playbackRate: f64) anyopaque {
        const state = instance.getState(State);
        
        return WorkletAnimationImpl.call_updatePlaybackRate(state, playbackRate);
    }

    pub fn call_reverse(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return WorkletAnimationImpl.call_reverse(state);
    }

    pub fn call_persist(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return WorkletAnimationImpl.call_persist(state);
    }

    pub fn call_when(instance: *runtime.Instance, type_: runtime.DOMString, options: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return WorkletAnimationImpl.call_when(state, type_, options);
    }
    ...
    pub fn call_commitStyles(instance: *runtime.Instance) anyopaque {
        ...
        return WorkletAnimationImpl.call_commitStyles(state);
    }

    pub fn call_dispatchEvent(instance: *runtime.Instance, event: anyopaque) bool {
        const state = instance.getState(State);
        
        return WorkletAnimationImpl.call_dispatchEvent(state, event);
    }

    pub fn call_pause(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return WorkletAnimationImpl.call_pause(state);
    }

    pub fn call_play(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return WorkletAnimationImpl.call_play(state);
    }

    pub fn call_cancel(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return WorkletAnimationImpl.call_cancel(state);
    }

    pub fn call_finish(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return WorkletAnimationImpl.call_finish(state);
    }

    pub fn call_addEventListener(instance: *runtime.Instance, type_: runtime.DOMString, callback: anyopaque, options: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return WorkletAnimationImpl.call_addEventListener(state, type_, callback, options);
    }

    pub fn call_removeEventListener(instance: *runtime.Instance, type_: runtime.DOMString, callback: anyopaque, options: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return WorkletAnimationImpl.call_removeEventListener(state, type_, callback, options);
    }
