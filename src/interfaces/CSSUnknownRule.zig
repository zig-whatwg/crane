...
const CSSUnknownRuleImpl = @import("../impls/CSSUnknownRule.zig");
...
pub const CSSUnknownRule = struct {
    ...
    pub const vtable = runtime.buildVTable(CSSUnknownRule, .{
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        CSSUnknownRuleImpl.deinit(state);
    }
