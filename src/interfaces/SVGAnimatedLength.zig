...
const SVGAnimatedLengthImpl = @import("../impls/SVGAnimatedLength.zig");
...
pub const SVGAnimatedLength = struct {
    ...
    pub const vtable = runtime.buildVTable(SVGAnimatedLength, .{
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        SVGAnimatedLengthImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        SVGAnimatedLengthImpl.deinit(state);
    }
    ...
    pub fn get_baseVal(instance: *runtime.Instance) anyopaque {
        ...
        const value = SVGAnimatedLengthImpl.get_baseVal(state);
    ...
    pub fn get_animVal(instance: *runtime.Instance) anyopaque {
        ...
        const value = SVGAnimatedLengthImpl.get_animVal(state);
