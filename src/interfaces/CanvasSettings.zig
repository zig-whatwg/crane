...
const CanvasSettingsImpl = @import("../impls/CanvasSettings.zig");
...
pub const CanvasSettings = struct {
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        CanvasSettingsImpl.deinit(state);
    }
    ...
    pub fn call_getContextAttributes(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CanvasSettingsImpl.call_getContextAttributes(state);
    }
