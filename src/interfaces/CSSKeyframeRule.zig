...
const CSSKeyframeRuleImpl = @import("../impls/CSSKeyframeRule.zig");
...
pub const CSSKeyframeRule = struct {
    ...
    pub const vtable = runtime.buildVTable(CSSKeyframeRule, .{
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        CSSKeyframeRuleImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        CSSKeyframeRuleImpl.deinit(state);
    }
    ...
    pub fn get_keyText(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSKeyframeRuleImpl.get_keyText(state);
    }

    pub fn set_keyText(instance: *runtime.Instance, value: anyopaque) void {
        const state = instance.getState(State);
        CSSKeyframeRuleImpl.set_keyText(state, value);
    }
    ...
    pub fn get_style(instance: *runtime.Instance) anyopaque {
        ...
        const value = CSSKeyframeRuleImpl.get_style(state);
