...
const GyroscopeImpl = @import("../impls/Gyroscope.zig");
const Sensor = @import("Sensor.zig");

pub const Gyroscope = struct {
    pub const Meta = struct {
        pub const name = "Gyroscope";
    ...
    pub const vtable = runtime.buildVTable(Gyroscope, .{
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, sensorOptions: anyopaque) !*runtime.Instance {
        ...
        const state = instance.getState(State);
        try GyroscopeImpl.constructor(state, sensorOptions);
