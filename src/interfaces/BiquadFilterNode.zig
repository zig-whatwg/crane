...
const BiquadFilterNodeImpl = @import("../impls/BiquadFilterNode.zig");
...
pub const BiquadFilterNode = struct {
    ...
    pub const vtable = runtime.buildVTable(BiquadFilterNode, .{
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        BiquadFilterNodeImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        BiquadFilterNodeImpl.deinit(state);
    }
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, context: anyopaque, options: anyopaque) !*runtime.Instance {
        ...
        const state = instance.getState(State);
        try BiquadFilterNodeImpl.constructor(state, context, options);
    ...
    pub fn get_context(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return BiquadFilterNodeImpl.get_context(state);
    }

    pub fn get_numberOfInputs(instance: *runtime.Instance) u32 {
        const state = instance.getState(State);
        return BiquadFilterNodeImpl.get_numberOfInputs(state);
    }

    pub fn get_numberOfOutputs(instance: *runtime.Instance) u32 {
        const state = instance.getState(State);
        return BiquadFilterNodeImpl.get_numberOfOutputs(state);
    }

    pub fn get_channelCount(instance: *runtime.Instance) u32 {
        const state = instance.getState(State);
        return BiquadFilterNodeImpl.get_channelCount(state);
    }

    pub fn set_channelCount(instance: *runtime.Instance, value: u32) void {
        const state = instance.getState(State);
        BiquadFilterNodeImpl.set_channelCount(state, value);
    }

    pub fn get_channelCountMode(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return BiquadFilterNodeImpl.get_channelCountMode(state);
    }

    pub fn set_channelCountMode(instance: *runtime.Instance, value: anyopaque) void {
        const state = instance.getState(State);
        BiquadFilterNodeImpl.set_channelCountMode(state, value);
    }

    pub fn get_channelInterpretation(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return BiquadFilterNodeImpl.get_channelInterpretation(state);
    }

    pub fn set_channelInterpretation(instance: *runtime.Instance, value: anyopaque) void {
        const state = instance.getState(State);
        BiquadFilterNodeImpl.set_channelInterpretation(state, value);
    }

    pub fn get_type(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return BiquadFilterNodeImpl.get_type(state);
    }

    pub fn set_type(instance: *runtime.Instance, value: anyopaque) void {
        const state = instance.getState(State);
        BiquadFilterNodeImpl.set_type(state, value);
    }

    pub fn get_frequency(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return BiquadFilterNodeImpl.get_frequency(state);
    }

    pub fn get_detune(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return BiquadFilterNodeImpl.get_detune(state);
    }

    pub fn get_Q(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return BiquadFilterNodeImpl.get_Q(state);
    }

    pub fn get_gain(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return BiquadFilterNodeImpl.get_gain(state);
    }

    pub fn call_removeEventListener(instance: *runtime.Instance, type_: runtime.DOMString, callback: anyopaque, options: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return BiquadFilterNodeImpl.call_removeEventListener(state, type_, callback, options);
    }
    ...
    pub fn call_getFrequencyResponse(instance: *runtime.Instance, frequencyHz: anyopaque, magResponse: anyopaque, phaseResponse: anyopaque) anyopaque {
        ...
        return BiquadFilterNodeImpl.call_getFrequencyResponse(state, frequencyHz, magResponse, phaseResponse);
    }

    pub fn call_when(instance: *runtime.Instance, type_: runtime.DOMString, options: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return BiquadFilterNodeImpl.call_when(state, type_, options);
    }

    pub fn call_dispatchEvent(instance: *runtime.Instance, event: anyopaque) bool {
        const state = instance.getState(State);
        
        return BiquadFilterNodeImpl.call_dispatchEvent(state, event);
    }
    ...
    pub fn call_disconnect(instance: *runtime.Instance, args: DisconnectArgs) anyopaque {
        const state = instance.getState(State);
        switch (args) {
            .no_params => return BiquadFilterNodeImpl.no_params(state),
            .long => |arg| return BiquadFilterNodeImpl.long(state, arg),
            .AudioNode => |arg| return BiquadFilterNodeImpl.AudioNode(state, arg),
            .AudioNode_long => |a| return BiquadFilterNodeImpl.AudioNode_long(state, a.destinationNode, a.output),
            .AudioNode_long_long => |a| return BiquadFilterNodeImpl.AudioNode_long_long(state, a.destinationNode, a.output, a.input),
            .AudioParam => |arg| return BiquadFilterNodeImpl.AudioParam(state, arg),
            .AudioParam_long => |a| return BiquadFilterNodeImpl.AudioParam_long(state, a.destinationParam, a.output),
        }
    }
    ...
    pub fn call_addEventListener(instance: *runtime.Instance, type_: runtime.DOMString, callback: anyopaque, options: anyopaque) anyopaque {
        ...
        return BiquadFilterNodeImpl.call_addEventListener(state, type_, callback, options);
    }
