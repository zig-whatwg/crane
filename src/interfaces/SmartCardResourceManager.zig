...
const SmartCardResourceManagerImpl = @import("../impls/SmartCardResourceManager.zig");
...
pub const SmartCardResourceManager = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        SmartCardResourceManagerImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        SmartCardResourceManagerImpl.deinit(state);
    }
    ...
    pub fn call_establishContext(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return SmartCardResourceManagerImpl.call_establishContext(state);
    }
