...
const NodeListImpl = @import("../impls/NodeList.zig");
...
pub const NodeList = struct {
    ...
    pub fn get_length(instance: *runtime.Instance) u32 {
        const state = instance.getState(State);
        return NodeListImpl.get_length(state);
    }

    pub fn call_item(instance: *runtime.Instance, index: u32) anyopaque {
        const state = instance.getState(State);
        
        return NodeListImpl.call_item(state, index);
    }
