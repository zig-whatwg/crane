...
const GainNodeImpl = @import("../impls/GainNode.zig");
...
pub const GainNode = struct {
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, context: anyopaque, options: anyopaque) !*runtime.Instance {
        ...
        const state = instance.getState(State);
        try GainNodeImpl.constructor(state, context, options);
    ...
    pub fn call_disconnect(instance: *runtime.Instance, args: DisconnectArgs) anyopaque {
        const state = instance.getState(State);
        switch (args) {
            .no_params => return GainNodeImpl.no_params(state),
            .long => |arg| return GainNodeImpl.long(state, arg),
            .AudioNode => |arg| return GainNodeImpl.AudioNode(state, arg),
            .AudioNode_long => |a| return GainNodeImpl.AudioNode_long(state, a.destinationNode, a.output),
            .AudioNode_long_long => |a| return GainNodeImpl.AudioNode_long_long(state, a.destinationNode, a.output, a.input),
            .AudioParam => |arg| return GainNodeImpl.AudioParam(state, arg),
            .AudioParam_long => |a| return GainNodeImpl.AudioParam_long(state, a.destinationParam, a.output),
        }
    }
    ...
    pub fn call_addEventListener(instance: *runtime.Instance, type_: runtime.DOMString, callback: anyopaque, options: anyopaque) anyopaque {
        ...
        return GainNodeImpl.call_addEventListener(state, type_, callback, options);
    }
