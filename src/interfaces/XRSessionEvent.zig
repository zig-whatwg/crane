...
const XRSessionEventImpl = @import("../impls/XRSessionEvent.zig");
...
pub const XRSessionEvent = struct {
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        XRSessionEventImpl.deinit(state);
    }
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, type_: runtime.DOMString, eventInitDict: anyopaque) !*runtime.Instance {
        ...
        const state = instance.getState(State);
        try XRSessionEventImpl.constructor(state, type_, eventInitDict);
    ...
    pub fn get_session(instance: *runtime.Instance) anyopaque {
        ...
        const value = XRSessionEventImpl.get_session(state);
