...
const WebTransportSendGroupImpl = @import("../impls/WebTransportSendGroup.zig");
...
pub const WebTransportSendGroup = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        WebTransportSendGroupImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        WebTransportSendGroupImpl.deinit(state);
    }
    ...
    pub fn call_getStats(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return WebTransportSendGroupImpl.call_getStats(state);
    }
