...
const SVGLengthListImpl = @import("../impls/SVGLengthList.zig");
...
pub const SVGLengthList = struct {
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        SVGLengthListImpl.deinit(state);
    }
