...
const ToggleEventImpl = @import("../impls/ToggleEvent.zig");
...
pub const ToggleEvent = struct {
    ...
    pub const vtable = runtime.buildVTable(ToggleEvent, .{
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, type_: runtime.DOMString, eventInitDict: anyopaque) !*runtime.Instance {
        ...
        const state = instance.getState(State);
        try ToggleEventImpl.constructor(state, type_, eventInitDict);
