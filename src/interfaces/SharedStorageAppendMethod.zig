...
const SharedStorageAppendMethodImpl = @import("../impls/SharedStorageAppendMethod.zig");
...
pub const SharedStorageAppendMethod = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        SharedStorageAppendMethodImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        SharedStorageAppendMethodImpl.deinit(state);
    }
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, key: runtime.DOMString, value: runtime.DOMString, options: anyopaque) !*runtime.Instance {
        ...
        const state = instance.getState(State);
        try SharedStorageAppendMethodImpl.constructor(state, key, value, options);
