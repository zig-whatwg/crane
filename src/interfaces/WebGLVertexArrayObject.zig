...
const WebGLVertexArrayObjectImpl = @import("../impls/WebGLVertexArrayObject.zig");
...
pub const WebGLVertexArrayObject = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        WebGLVertexArrayObjectImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        WebGLVertexArrayObjectImpl.deinit(state);
    }
    ...
    pub fn get_label(instance: *runtime.Instance) runtime.USVString {
        const state = instance.getState(State);
        return WebGLVertexArrayObjectImpl.get_label(state);
    }

    pub fn set_label(instance: *runtime.Instance, value: runtime.USVString) void {
        const state = instance.getState(State);
        WebGLVertexArrayObjectImpl.set_label(state, value);
    }
