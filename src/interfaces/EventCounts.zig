...
const EventCountsImpl = @import("../impls/EventCounts.zig");
...
pub const EventCounts = struct {
    ...
    pub const vtable = runtime.buildVTable(EventCounts, .{
