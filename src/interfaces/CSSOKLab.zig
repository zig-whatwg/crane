...
const CSSOKLabImpl = @import("../impls/CSSOKLab.zig");
...
pub const CSSOKLab = struct {
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, l: anyopaque, a: anyopaque, b: anyopaque, alpha: anyopaque) !*runtime.Instance {
        ...
        const state = instance.getState(State);
        try CSSOKLabImpl.constructor(state, l, a, b, alpha);
    ...
    pub fn call_parseAll(instance: *runtime.Instance, property: runtime.USVString, cssText: runtime.USVString) anyopaque {
        ...
        return CSSOKLabImpl.call_parseAll(state, property, cssText);
    }
    ...
    pub fn call_parse(instance: *runtime.Instance, args: ParseArgs) anyopaque {
        const state = instance.getState(State);
        switch (args) {
            .USVString_USVString => |a| return CSSOKLabImpl.USVString_USVString(state, a.property, a.cssText),
            .USVString => |arg| return CSSOKLabImpl.USVString(state, arg),
        }
    }
