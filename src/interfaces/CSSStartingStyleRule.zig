...
const CSSStartingStyleRuleImpl = @import("../impls/CSSStartingStyleRule.zig");
...
pub const CSSStartingStyleRule = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        CSSStartingStyleRuleImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        CSSStartingStyleRuleImpl.deinit(state);
    }
    ...
    pub fn get_cssText(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSStartingStyleRuleImpl.get_cssText(state);
    }

    pub fn set_cssText(instance: *runtime.Instance, value: anyopaque) void {
        const state = instance.getState(State);
        CSSStartingStyleRuleImpl.set_cssText(state, value);
    }

    pub fn get_parentRule(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSStartingStyleRuleImpl.get_parentRule(state);
    }

    pub fn get_parentStyleSheet(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSStartingStyleRuleImpl.get_parentStyleSheet(state);
    }

    pub fn get_type(instance: *runtime.Instance) u16 {
        const state = instance.getState(State);
        return CSSStartingStyleRuleImpl.get_type(state);
    }
    ...
    pub fn get_cssRules(instance: *runtime.Instance) anyopaque {
        ...
        const value = CSSStartingStyleRuleImpl.get_cssRules(state);
    ...
    pub fn call_deleteRule(instance: *runtime.Instance, index: u32) anyopaque {
        ...
        return CSSStartingStyleRuleImpl.call_deleteRule(state, index);
    }

    pub fn call_insertRule(instance: *runtime.Instance, rule: anyopaque, index: u32) u32 {
        const state = instance.getState(State);
        
        return CSSStartingStyleRuleImpl.call_insertRule(state, rule, index);
    }
