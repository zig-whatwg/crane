...
const BluetoothServiceDataFilterImpl = @import("../impls/BluetoothServiceDataFilter.zig");
...
pub const BluetoothServiceDataFilter = struct {
    ...
    pub const vtable = runtime.buildVTable(BluetoothServiceDataFilter, .{
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        BluetoothServiceDataFilterImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        BluetoothServiceDataFilterImpl.deinit(state);
    }
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, init: anyopaque) !*runtime.Instance {
        ...
        const state = instance.getState(State);
        try BluetoothServiceDataFilterImpl.constructor(state, init);
