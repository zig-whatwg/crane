...
const GPUPipelineLayoutImpl = @import("../impls/GPUPipelineLayout.zig");
...
pub const GPUPipelineLayout = struct {
    ...
    pub const vtable = runtime.buildVTable(GPUPipelineLayout, .{
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        GPUPipelineLayoutImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        GPUPipelineLayoutImpl.deinit(state);
    }
    ...
    pub fn get_label(instance: *runtime.Instance) runtime.USVString {
        const state = instance.getState(State);
        return GPUPipelineLayoutImpl.get_label(state);
    }

    pub fn set_label(instance: *runtime.Instance, value: runtime.USVString) void {
        const state = instance.getState(State);
        GPUPipelineLayoutImpl.set_label(state, value);
    }
