...
const SharedStorageDeleteMethodImpl = @import("../impls/SharedStorageDeleteMethod.zig");
...
pub const SharedStorageDeleteMethod = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        SharedStorageDeleteMethodImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        SharedStorageDeleteMethodImpl.deinit(state);
    }
    ...
    /// WebIDL constructor
    pub fn call_constructor(allocator: std.mem.Allocator, key: runtime.DOMString, options: anyopaque) !*runtime.Instance {
        const instance = try init(allocator);
        errdefer deinit(instance);
        
        const state = instance.getState(State);
        try SharedStorageDeleteMethodImpl.constructor(state, key, options);
