...
const USBInTransferResultImpl = @import("../impls/USBInTransferResult.zig");
...
pub const USBInTransferResult = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        USBInTransferResultImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        USBInTransferResultImpl.deinit(state);
    }
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, status: anyopaque, data: anyopaque) !*runtime.Instance {
        ...
        const state = instance.getState(State);
        try USBInTransferResultImpl.constructor(state, status, data);
    ...
    pub fn get_data(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return USBInTransferResultImpl.get_data(state);
    }

    pub fn get_status(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return USBInTransferResultImpl.get_status(state);
    }
