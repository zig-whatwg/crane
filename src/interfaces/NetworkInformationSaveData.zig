...
const NetworkInformationSaveDataImpl = @import("../impls/NetworkInformationSaveData.zig");
...
pub const NetworkInformationSaveData = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        NetworkInformationSaveDataImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        NetworkInformationSaveDataImpl.deinit(state);
    }
    ...
    pub fn get_saveData(instance: *runtime.Instance) bool {
        ...
        const value = NetworkInformationSaveDataImpl.get_saveData(state);
