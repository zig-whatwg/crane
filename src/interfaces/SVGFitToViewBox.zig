...
const SVGFitToViewBoxImpl = @import("../impls/SVGFitToViewBox.zig");
...
pub const SVGFitToViewBox = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        SVGFitToViewBoxImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        SVGFitToViewBoxImpl.deinit(state);
    }
    ...
    pub fn get_viewBox(instance: *runtime.Instance) anyopaque {
        ...
        const value = SVGFitToViewBoxImpl.get_viewBox(state);
    ...
    pub fn get_preserveAspectRatio(instance: *runtime.Instance) anyopaque {
        ...
        const value = SVGFitToViewBoxImpl.get_preserveAspectRatio(state);
