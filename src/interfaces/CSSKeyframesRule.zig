...
const CSSKeyframesRuleImpl = @import("../impls/CSSKeyframesRule.zig");
...
pub const CSSKeyframesRule = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        CSSKeyframesRuleImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        CSSKeyframesRuleImpl.deinit(state);
    }
    ...
    pub fn get_cssText(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSKeyframesRuleImpl.get_cssText(state);
    }

    pub fn set_cssText(instance: *runtime.Instance, value: anyopaque) void {
        const state = instance.getState(State);
        CSSKeyframesRuleImpl.set_cssText(state, value);
    }

    pub fn get_parentRule(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSKeyframesRuleImpl.get_parentRule(state);
    }

    pub fn get_parentStyleSheet(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSKeyframesRuleImpl.get_parentStyleSheet(state);
    }

    pub fn get_type(instance: *runtime.Instance) u16 {
        const state = instance.getState(State);
        return CSSKeyframesRuleImpl.get_type(state);
    }
    ...
    pub fn get_name(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSKeyframesRuleImpl.get_name(state);
    }

    pub fn set_name(instance: *runtime.Instance, value: anyopaque) void {
        const state = instance.getState(State);
        CSSKeyframesRuleImpl.set_name(state, value);
    }

    pub fn get_cssRules(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSKeyframesRuleImpl.get_cssRules(state);
    }

    pub fn get_length(instance: *runtime.Instance) u32 {
        const state = instance.getState(State);
        return CSSKeyframesRuleImpl.get_length(state);
    }

    pub fn call_deleteRule(instance: *runtime.Instance, select: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return CSSKeyframesRuleImpl.call_deleteRule(state, select);
    }

    pub fn call_findRule(instance: *runtime.Instance, select: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return CSSKeyframesRuleImpl.call_findRule(state, select);
    }

    pub fn call_appendRule(instance: *runtime.Instance, rule: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return CSSKeyframesRuleImpl.call_appendRule(state, rule);
    }
