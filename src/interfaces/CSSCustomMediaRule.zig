...
const CSSCustomMediaRuleImpl = @import("../impls/CSSCustomMediaRule.zig");
...
pub const CSSCustomMediaRule = struct {
    ...
    pub const vtable = runtime.buildVTable(CSSCustomMediaRule, .{
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        CSSCustomMediaRuleImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        CSSCustomMediaRuleImpl.deinit(state);
    }
    ...
    pub fn get_cssText(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSCustomMediaRuleImpl.get_cssText(state);
    }

    pub fn set_cssText(instance: *runtime.Instance, value: anyopaque) void {
        const state = instance.getState(State);
        CSSCustomMediaRuleImpl.set_cssText(state, value);
    }

    pub fn get_parentRule(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSCustomMediaRuleImpl.get_parentRule(state);
    }

    pub fn get_parentStyleSheet(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSCustomMediaRuleImpl.get_parentStyleSheet(state);
    }

    pub fn get_type(instance: *runtime.Instance) u16 {
        const state = instance.getState(State);
        return CSSCustomMediaRuleImpl.get_type(state);
    }
    ...
    pub fn get_name(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSCustomMediaRuleImpl.get_name(state);
    }

    pub fn get_query(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSCustomMediaRuleImpl.get_query(state);
    }
