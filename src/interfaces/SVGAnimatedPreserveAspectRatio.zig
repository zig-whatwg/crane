...
const SVGAnimatedPreserveAspectRatioImpl = @import("../impls/SVGAnimatedPreserveAspectRatio.zig");
...
pub const SVGAnimatedPreserveAspectRatio = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        SVGAnimatedPreserveAspectRatioImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        SVGAnimatedPreserveAspectRatioImpl.deinit(state);
    }
    ...
    pub fn get_baseVal(instance: *runtime.Instance) anyopaque {
        ...
        const value = SVGAnimatedPreserveAspectRatioImpl.get_baseVal(state);
    ...
    pub fn get_animVal(instance: *runtime.Instance) anyopaque {
        ...
        const value = SVGAnimatedPreserveAspectRatioImpl.get_animVal(state);
