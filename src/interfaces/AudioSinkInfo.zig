...
const AudioSinkInfoImpl = @import("../impls/AudioSinkInfo.zig");
...
pub const AudioSinkInfo = struct {
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        AudioSinkInfoImpl.deinit(state);
    }
    ...
    pub fn get_type(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return AudioSinkInfoImpl.get_type(state);
    }
