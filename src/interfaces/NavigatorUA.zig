...
const NavigatorUAImpl = @import("../impls/NavigatorUA.zig");
...
pub const NavigatorUA = struct {
    ...
    pub fn get_userAgentData(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return NavigatorUAImpl.get_userAgentData(state);
    }
