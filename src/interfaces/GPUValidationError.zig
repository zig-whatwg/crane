...
const GPUValidationErrorImpl = @import("../impls/GPUValidationError.zig");
...
pub const GPUValidationError = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        GPUValidationErrorImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        GPUValidationErrorImpl.deinit(state);
    }
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, message: runtime.DOMString) !*runtime.Instance {
        ...
        const state = instance.getState(State);
        try GPUValidationErrorImpl.constructor(state, message);
    ...
    pub fn get_message(instance: *runtime.Instance) runtime.DOMString {
        const state = instance.getState(State);
        return GPUValidationErrorImpl.get_message(state);
    }
