...
const SpeechSynthesisErrorEventImpl = @import("../impls/SpeechSynthesisErrorEvent.zig");
const SpeechSynthesisEvent = @import("SpeechSynthesisEvent.zig");
...
pub const SpeechSynthesisErrorEvent = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        SpeechSynthesisErrorEventImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        SpeechSynthesisErrorEventImpl.deinit(state);
    }
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, type_: runtime.DOMString, eventInitDict: anyopaque) !*runtime.Instance {
        ...
        const state = instance.getState(State);
        try SpeechSynthesisErrorEventImpl.constructor(state, type_, eventInitDict);
    ...
    pub fn get_type(instance: *runtime.Instance) runtime.DOMString {
        const state = instance.getState(State);
        return SpeechSynthesisErrorEventImpl.get_type(state);
    }

    pub fn get_target(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return SpeechSynthesisErrorEventImpl.get_target(state);
    }

    pub fn get_srcElement(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return SpeechSynthesisErrorEventImpl.get_srcElement(state);
    }

    pub fn get_currentTarget(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return SpeechSynthesisErrorEventImpl.get_currentTarget(state);
    }

    pub fn get_eventPhase(instance: *runtime.Instance) u16 {
        const state = instance.getState(State);
        return SpeechSynthesisErrorEventImpl.get_eventPhase(state);
    }

    pub fn get_cancelBubble(instance: *runtime.Instance) bool {
        const state = instance.getState(State);
        return SpeechSynthesisErrorEventImpl.get_cancelBubble(state);
    }

    pub fn set_cancelBubble(instance: *runtime.Instance, value: bool) void {
        const state = instance.getState(State);
        SpeechSynthesisErrorEventImpl.set_cancelBubble(state, value);
    }

    pub fn get_bubbles(instance: *runtime.Instance) bool {
        const state = instance.getState(State);
        return SpeechSynthesisErrorEventImpl.get_bubbles(state);
    }

    pub fn get_cancelable(instance: *runtime.Instance) bool {
        const state = instance.getState(State);
        return SpeechSynthesisErrorEventImpl.get_cancelable(state);
    }

    pub fn get_returnValue(instance: *runtime.Instance) bool {
        const state = instance.getState(State);
        return SpeechSynthesisErrorEventImpl.get_returnValue(state);
    }

    pub fn set_returnValue(instance: *runtime.Instance, value: bool) void {
        const state = instance.getState(State);
        SpeechSynthesisErrorEventImpl.set_returnValue(state, value);
    }

    pub fn get_defaultPrevented(instance: *runtime.Instance) bool {
        const state = instance.getState(State);
        return SpeechSynthesisErrorEventImpl.get_defaultPrevented(state);
    }

    pub fn get_composed(instance: *runtime.Instance) bool {
        const state = instance.getState(State);
        return SpeechSynthesisErrorEventImpl.get_composed(state);
    }

    /// Extended attributes: [LegacyUnforgeable]
    pub fn get_isTrusted(instance: *runtime.Instance) bool {
        const state = instance.getState(State);
        return SpeechSynthesisErrorEventImpl.get_isTrusted(state);
    }

    pub fn get_timeStamp(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return SpeechSynthesisErrorEventImpl.get_timeStamp(state);
    }

    pub fn get_utterance(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return SpeechSynthesisErrorEventImpl.get_utterance(state);
    }

    pub fn get_charIndex(instance: *runtime.Instance) u32 {
        const state = instance.getState(State);
        return SpeechSynthesisErrorEventImpl.get_charIndex(state);
    }

    pub fn get_charLength(instance: *runtime.Instance) u32 {
        const state = instance.getState(State);
        return SpeechSynthesisErrorEventImpl.get_charLength(state);
    }

    pub fn get_elapsedTime(instance: *runtime.Instance) f32 {
        const state = instance.getState(State);
        return SpeechSynthesisErrorEventImpl.get_elapsedTime(state);
    }

    pub fn get_name(instance: *runtime.Instance) runtime.DOMString {
        const state = instance.getState(State);
        return SpeechSynthesisErrorEventImpl.get_name(state);
    }

    pub fn get_error(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return SpeechSynthesisErrorEventImpl.get_error(state);
    }

    pub fn call_stopImmediatePropagation(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return SpeechSynthesisErrorEventImpl.call_stopImmediatePropagation(state);
    }

    pub fn call_initEvent(instance: *runtime.Instance, type_: runtime.DOMString, bubbles: bool, cancelable: bool) anyopaque {
        const state = instance.getState(State);
        
        return SpeechSynthesisErrorEventImpl.call_initEvent(state, type_, bubbles, cancelable);
    }

    pub fn call_composedPath(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return SpeechSynthesisErrorEventImpl.call_composedPath(state);
    }

    pub fn call_stopPropagation(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return SpeechSynthesisErrorEventImpl.call_stopPropagation(state);
    }

    pub fn call_preventDefault(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return SpeechSynthesisErrorEventImpl.call_preventDefault(state);
    }
