...
const EXT_texture_compression_rgtcImpl = @import("../impls/EXT_texture_compression_rgtc.zig");
...
pub const EXT_texture_compression_rgtc = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        EXT_texture_compression_rgtcImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        EXT_texture_compression_rgtcImpl.deinit(state);
    }
