...
const MediaStreamAudioSourceNodeImpl = @import("../impls/MediaStreamAudioSourceNode.zig");
...
pub const MediaStreamAudioSourceNode = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        MediaStreamAudioSourceNodeImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        MediaStreamAudioSourceNodeImpl.deinit(state);
    }
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, context: anyopaque, options: anyopaque) !*runtime.Instance {
        ...
        const state = instance.getState(State);
        try MediaStreamAudioSourceNodeImpl.constructor(state, context, options);
    ...
    pub fn get_context(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return MediaStreamAudioSourceNodeImpl.get_context(state);
    }

    pub fn get_numberOfInputs(instance: *runtime.Instance) u32 {
        const state = instance.getState(State);
        return MediaStreamAudioSourceNodeImpl.get_numberOfInputs(state);
    }

    pub fn get_numberOfOutputs(instance: *runtime.Instance) u32 {
        const state = instance.getState(State);
        return MediaStreamAudioSourceNodeImpl.get_numberOfOutputs(state);
    }

    pub fn get_channelCount(instance: *runtime.Instance) u32 {
        const state = instance.getState(State);
        return MediaStreamAudioSourceNodeImpl.get_channelCount(state);
    }

    pub fn set_channelCount(instance: *runtime.Instance, value: u32) void {
        const state = instance.getState(State);
        MediaStreamAudioSourceNodeImpl.set_channelCount(state, value);
    }

    pub fn get_channelCountMode(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return MediaStreamAudioSourceNodeImpl.get_channelCountMode(state);
    }

    pub fn set_channelCountMode(instance: *runtime.Instance, value: anyopaque) void {
        const state = instance.getState(State);
        MediaStreamAudioSourceNodeImpl.set_channelCountMode(state, value);
    }

    pub fn get_channelInterpretation(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return MediaStreamAudioSourceNodeImpl.get_channelInterpretation(state);
    }

    pub fn set_channelInterpretation(instance: *runtime.Instance, value: anyopaque) void {
        const state = instance.getState(State);
        MediaStreamAudioSourceNodeImpl.set_channelInterpretation(state, value);
    }

    /// Extended attributes: [SameObject]
    pub fn get_mediaStream(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        // [SameObject] - Return cached instance
        if (state.cached_mediaStream) |cached| {
            return cached;
        }
        const value = MediaStreamAudioSourceNodeImpl.get_mediaStream(state);
    ...
    pub fn call_removeEventListener(instance: *runtime.Instance, type_: runtime.DOMString, callback: anyopaque, options: anyopaque) anyopaque {
        ...
        return MediaStreamAudioSourceNodeImpl.call_removeEventListener(state, type_, callback, options);
    }

    pub fn call_when(instance: *runtime.Instance, type_: runtime.DOMString, options: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return MediaStreamAudioSourceNodeImpl.call_when(state, type_, options);
    }

    pub fn call_dispatchEvent(instance: *runtime.Instance, event: anyopaque) bool {
        const state = instance.getState(State);
        
        return MediaStreamAudioSourceNodeImpl.call_dispatchEvent(state, event);
    }
    ...
    pub fn call_disconnect(instance: *runtime.Instance, args: DisconnectArgs) anyopaque {
        const state = instance.getState(State);
        switch (args) {
            .no_params => return MediaStreamAudioSourceNodeImpl.no_params(state),
            .long => |arg| return MediaStreamAudioSourceNodeImpl.long(state, arg),
            .AudioNode => |arg| return MediaStreamAudioSourceNodeImpl.AudioNode(state, arg),
            .AudioNode_long => |a| return MediaStreamAudioSourceNodeImpl.AudioNode_long(state, a.destinationNode, a.output),
            .AudioNode_long_long => |a| return MediaStreamAudioSourceNodeImpl.AudioNode_long_long(state, a.destinationNode, a.output, a.input),
            .AudioParam => |arg| return MediaStreamAudioSourceNodeImpl.AudioParam(state, arg),
            .AudioParam_long => |a| return MediaStreamAudioSourceNodeImpl.AudioParam_long(state, a.destinationParam, a.output),
        }
    }
    ...
    pub fn call_addEventListener(instance: *runtime.Instance, type_: runtime.DOMString, callback: anyopaque, options: anyopaque) anyopaque {
        ...
        return MediaStreamAudioSourceNodeImpl.call_addEventListener(state, type_, callback, options);
    }
