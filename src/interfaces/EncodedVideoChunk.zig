...
const EncodedVideoChunkImpl = @import("../impls/EncodedVideoChunk.zig");
...
pub const EncodedVideoChunk = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        EncodedVideoChunkImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        EncodedVideoChunkImpl.deinit(state);
    }
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, init: anyopaque) !*runtime.Instance {
        ...
        const state = instance.getState(State);
        try EncodedVideoChunkImpl.constructor(state, init);
    ...
    pub fn get_type(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return EncodedVideoChunkImpl.get_type(state);
    }

    pub fn get_timestamp(instance: *runtime.Instance) i64 {
        const state = instance.getState(State);
        return EncodedVideoChunkImpl.get_timestamp(state);
    }

    pub fn get_duration(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return EncodedVideoChunkImpl.get_duration(state);
    }

    pub fn get_byteLength(instance: *runtime.Instance) u32 {
        const state = instance.getState(State);
        return EncodedVideoChunkImpl.get_byteLength(state);
    }

    pub fn call_copyTo(instance: *runtime.Instance, destination: anyopaque) anyopaque {
        const state = instance.getState(State);
        
        return EncodedVideoChunkImpl.call_copyTo(state, destination);
    }
