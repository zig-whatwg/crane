...
const CSSViewTransitionRuleImpl = @import("../impls/CSSViewTransitionRule.zig");
...
pub const CSSViewTransitionRule = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        CSSViewTransitionRuleImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        CSSViewTransitionRuleImpl.deinit(state);
    }
    ...
    pub fn get_cssText(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSViewTransitionRuleImpl.get_cssText(state);
    }

    pub fn set_cssText(instance: *runtime.Instance, value: anyopaque) void {
        const state = instance.getState(State);
        CSSViewTransitionRuleImpl.set_cssText(state, value);
    }

    pub fn get_parentRule(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSViewTransitionRuleImpl.get_parentRule(state);
    }

    pub fn get_parentStyleSheet(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSViewTransitionRuleImpl.get_parentStyleSheet(state);
    }

    pub fn get_type(instance: *runtime.Instance) u16 {
        const state = instance.getState(State);
        return CSSViewTransitionRuleImpl.get_type(state);
    }
    ...
    pub fn get_navigation(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSViewTransitionRuleImpl.get_navigation(state);
    }
    ...
    pub fn get_types(instance: *runtime.Instance) anyopaque {
        ...
        const value = CSSViewTransitionRuleImpl.get_types(state);
