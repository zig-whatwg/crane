...
const WEBGL_color_buffer_floatImpl = @import("../impls/WEBGL_color_buffer_float.zig");
...
pub const WEBGL_color_buffer_float = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        WEBGL_color_buffer_floatImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        WEBGL_color_buffer_floatImpl.deinit(state);
    }
