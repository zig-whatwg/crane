...
const SVGNumberListImpl = @import("../impls/SVGNumberList.zig");
...
pub const SVGNumberList = struct {
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        SVGNumberListImpl.deinit(state);
    }
