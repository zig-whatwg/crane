...
const XPathResultImpl = @import("../impls/XPathResult.zig");
...
pub const XPathResult = struct {
    ...
    pub fn get_resultType(instance: *runtime.Instance) u16 {
        const state = instance.getState(State);
        return XPathResultImpl.get_resultType(state);
    }

    pub fn get_numberValue(instance: *runtime.Instance) f64 {
        const state = instance.getState(State);
        return XPathResultImpl.get_numberValue(state);
    }

    pub fn get_stringValue(instance: *runtime.Instance) runtime.DOMString {
        const state = instance.getState(State);
        return XPathResultImpl.get_stringValue(state);
    }

    pub fn get_booleanValue(instance: *runtime.Instance) bool {
        const state = instance.getState(State);
        return XPathResultImpl.get_booleanValue(state);
    }

    pub fn get_singleNodeValue(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return XPathResultImpl.get_singleNodeValue(state);
    }

    pub fn get_invalidIteratorState(instance: *runtime.Instance) bool {
        const state = instance.getState(State);
        return XPathResultImpl.get_invalidIteratorState(state);
    }

    pub fn get_snapshotLength(instance: *runtime.Instance) u32 {
        const state = instance.getState(State);
        return XPathResultImpl.get_snapshotLength(state);
    }

    pub fn call_snapshotItem(instance: *runtime.Instance, index: u32) anyopaque {
        const state = instance.getState(State);
        
        return XPathResultImpl.call_snapshotItem(state, index);
    }

    pub fn call_iterateNext(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return XPathResultImpl.call_iterateNext(state);
    }
