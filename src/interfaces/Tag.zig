...
const TagImpl = @import("../impls/Tag.zig");
...
pub const Tag = struct {
    ...
    /// WebIDL constructor
    pub fn call_constructor(allocator: std.mem.Allocator, type_: anyopaque) !*runtime.Instance {
        const instance = try init(allocator);
        errdefer deinit(instance);
        
        const state = instance.getState(State);
        try TagImpl.constructor(state, type_);
