...
const GenericTransformStreamImpl = @import("../impls/GenericTransformStream.zig");
...
pub const GenericTransformStream = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        GenericTransformStreamImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        GenericTransformStreamImpl.deinit(state);
    }
    ...
    pub fn get_readable(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return GenericTransformStreamImpl.get_readable(state);
    }

    pub fn get_writable(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return GenericTransformStreamImpl.get_writable(state);
    }
