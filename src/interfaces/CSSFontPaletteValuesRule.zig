...
const CSSFontPaletteValuesRuleImpl = @import("../impls/CSSFontPaletteValuesRule.zig");
...
pub const CSSFontPaletteValuesRule = struct {
    ...
    pub const vtable = runtime.buildVTable(CSSFontPaletteValuesRule, .{
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        CSSFontPaletteValuesRuleImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        CSSFontPaletteValuesRuleImpl.deinit(state);
    }
    ...
    pub fn get_cssText(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSFontPaletteValuesRuleImpl.get_cssText(state);
    }

    pub fn set_cssText(instance: *runtime.Instance, value: anyopaque) void {
        const state = instance.getState(State);
        CSSFontPaletteValuesRuleImpl.set_cssText(state, value);
    }

    pub fn get_parentRule(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSFontPaletteValuesRuleImpl.get_parentRule(state);
    }

    pub fn get_parentStyleSheet(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSFontPaletteValuesRuleImpl.get_parentStyleSheet(state);
    }

    pub fn get_type(instance: *runtime.Instance) u16 {
        const state = instance.getState(State);
        return CSSFontPaletteValuesRuleImpl.get_type(state);
    }
    ...
    pub fn get_name(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSFontPaletteValuesRuleImpl.get_name(state);
    }

    pub fn get_fontFamily(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSFontPaletteValuesRuleImpl.get_fontFamily(state);
    }

    pub fn get_basePalette(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSFontPaletteValuesRuleImpl.get_basePalette(state);
    }

    pub fn get_overrideColors(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSFontPaletteValuesRuleImpl.get_overrideColors(state);
    }
