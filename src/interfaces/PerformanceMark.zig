...
const PerformanceMarkImpl = @import("../impls/PerformanceMark.zig");
...
pub const PerformanceMark = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        PerformanceMarkImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        PerformanceMarkImpl.deinit(state);
    }
    ...
    /// WebIDL constructor
    pub fn call_constructor(allocator: std.mem.Allocator, markName: runtime.DOMString, markOptions: anyopaque) !*runtime.Instance {
        const instance = try init(allocator);
        errdefer deinit(instance);
        
        const state = instance.getState(State);
        try PerformanceMarkImpl.constructor(state, markName, markOptions);
