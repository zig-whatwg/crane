...
const GPUPipelineErrorImpl = @import("../impls/GPUPipelineError.zig");
...
pub const GPUPipelineError = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        GPUPipelineErrorImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        GPUPipelineErrorImpl.deinit(state);
    }
    ...
    pub fn call_constructor(allocator: std.mem.Allocator, message: runtime.DOMString, options: anyopaque) !*runtime.Instance {
        ...
        const state = instance.getState(State);
        try GPUPipelineErrorImpl.constructor(state, message, options);
    ...
    pub fn get_name(instance: *runtime.Instance) runtime.DOMString {
        const state = instance.getState(State);
        return GPUPipelineErrorImpl.get_name(state);
    }

    pub fn get_message(instance: *runtime.Instance) runtime.DOMString {
        const state = instance.getState(State);
        return GPUPipelineErrorImpl.get_message(state);
    }

    pub fn get_code(instance: *runtime.Instance) u16 {
        const state = instance.getState(State);
        return GPUPipelineErrorImpl.get_code(state);
    }

    pub fn get_reason(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return GPUPipelineErrorImpl.get_reason(state);
    }
