...
const XPathEvaluatorBaseImpl = @import("../impls/XPathEvaluatorBase.zig");
...
pub const XPathEvaluatorBase = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        XPathEvaluatorBaseImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        XPathEvaluatorBaseImpl.deinit(state);
    }
    ...
    pub fn call_createNSResolver(instance: *runtime.Instance, nodeResolver: anyopaque) anyopaque {
        ...
        return XPathEvaluatorBaseImpl.call_createNSResolver(state, nodeResolver);
    }
    ...
    pub fn call_evaluate(instance: *runtime.Instance, expression: runtime.DOMString, contextNode: anyopaque, resolver: anyopaque, type_: u16, result: anyopaque) anyopaque {
        ...
        return XPathEvaluatorBaseImpl.call_evaluate(state, expression, contextNode, resolver, type_, result);
    }
    ...
    pub fn call_createExpression(instance: *runtime.Instance, expression: runtime.DOMString, resolver: anyopaque) anyopaque {
        ...
        return XPathEvaluatorBaseImpl.call_createExpression(state, expression, resolver);
    }
