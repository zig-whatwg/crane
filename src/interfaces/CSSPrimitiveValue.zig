...
const CSSPrimitiveValueImpl = @import("../impls/CSSPrimitiveValue.zig");
...
pub const CSSPrimitiveValue = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        CSSPrimitiveValueImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        CSSPrimitiveValueImpl.deinit(state);
    }
    ...
    pub fn get_cssText(instance: *runtime.Instance) runtime.DOMString {
        const state = instance.getState(State);
        return CSSPrimitiveValueImpl.get_cssText(state);
    }

    pub fn set_cssText(instance: *runtime.Instance, value: runtime.DOMString) void {
        const state = instance.getState(State);
        CSSPrimitiveValueImpl.set_cssText(state, value);
    }

    pub fn get_cssValueType(instance: *runtime.Instance) u16 {
        const state = instance.getState(State);
        return CSSPrimitiveValueImpl.get_cssValueType(state);
    }

    pub fn get_primitiveType(instance: *runtime.Instance) u16 {
        const state = instance.getState(State);
        return CSSPrimitiveValueImpl.get_primitiveType(state);
    }

    pub fn call_setStringValue(instance: *runtime.Instance, stringType: u16, stringValue: runtime.DOMString) void {
        const state = instance.getState(State);
        
        return CSSPrimitiveValueImpl.call_setStringValue(state, stringType, stringValue);
    }

    pub fn call_getFloatValue(instance: *runtime.Instance, unitType: u16) f32 {
        const state = instance.getState(State);
        
        return CSSPrimitiveValueImpl.call_getFloatValue(state, unitType);
    }

    pub fn call_getRGBColorValue(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSPrimitiveValueImpl.call_getRGBColorValue(state);
    }

    pub fn call_setFloatValue(instance: *runtime.Instance, unitType: u16, floatValue: f32) void {
        const state = instance.getState(State);
        
        return CSSPrimitiveValueImpl.call_setFloatValue(state, unitType, floatValue);
    }

    pub fn call_getStringValue(instance: *runtime.Instance) runtime.DOMString {
        const state = instance.getState(State);
        return CSSPrimitiveValueImpl.call_getStringValue(state);
    }

    pub fn call_getRectValue(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSPrimitiveValueImpl.call_getRectValue(state);
    }

    pub fn call_getCounterValue(instance: *runtime.Instance) anyopaque {
        const state = instance.getState(State);
        return CSSPrimitiveValueImpl.call_getCounterValue(state);
    }
