...
const SVGURIReferenceImpl = @import("../impls/SVGURIReference.zig");
...
pub const SVGURIReference = struct {
    ...
    pub fn init(allocator: std.mem.Allocator) !*runtime.Instance {
        ...
        SVGURIReferenceImpl.init(state);
    ...
    pub fn deinit(instance: *runtime.Instance) void {
        ...
        SVGURIReferenceImpl.deinit(state);
    }
    ...
    pub fn get_href(instance: *runtime.Instance) anyopaque {
        ...
        const value = SVGURIReferenceImpl.get_href(state);
