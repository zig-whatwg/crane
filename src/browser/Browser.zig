...
pub const Browser = struct {
    ...
    fn initBrowserWithIsolate(
        ...
        // Initialize ShadowRealm support (TC39 Stage 3, WHATWG ShadowRealmGlobalScope)
        // This registers the HostCreateShadowRealmContextCallback with V8, which is invoked
        // when JavaScript code executes `new ShadowRealm()`. The callback creates a new context
        // from the snapshot at the ShadowRealm index with [Exposed=ShadowRealm] interfaces.
    ...
    pub fn deinit(self: *Browser) void {
        ...
        if (self.isolate) |isolate| {
            ...
            // Clean up ShadowRealm callback data
