...
/// Returns the number of bytes written (1-4), or 0 if output buffer is too small.
...
/// Direct UTF-8 decode for EUC-KR (optimization path).
///
/// Decodes EUC-KR input bytes directly to UTF-8 output without
