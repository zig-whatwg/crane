...
///
/// Creates a persistent Global<Function> handle directly from a Local<Function>,
/// preserving function type information that may be lost when using v8_Value_ToGlobal.
///
/// @param isolate - Current V8 isolate
/// @param local_func - Local function pointer
/// @return New Global<Function>* or null if local is empty or not a function
pub extern fn v8_Function_ToGlobal(isolate: *Isolate, local_func: *Function) ?*Function;
